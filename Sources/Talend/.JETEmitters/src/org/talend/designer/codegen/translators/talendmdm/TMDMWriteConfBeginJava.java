...
public class TMDMWriteConfBeginJava
{
  ...
  protected final String TEXT_60 = "_FINISH\" + (this.queue==null?\"\":this.queue.hashCode()), \"true\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  ...
  protected final String TEXT_81 = NL + "\tString readFinishMarkWithPipeId_";
  protected final String TEXT_82 = " = \"";
  protected final String TEXT_83 = "_FINISH\"+(queue_";
  protected final String TEXT_84 = "==null?\"\":queue_";
  protected final String TEXT_85 = ".hashCode());" + NL + "\twhile(true) {" + NL + "\t\tif (!queue_";
