...
public class TGreenplumBulkExecBeginJava {
  ...
  protected final String TEXT_4 = NL + "\tdbschema_";
  protected final String TEXT_5 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_6 = "\");" + NL + "\t";
  protected final String TEXT_7 = NL + "\tdbschema_";
  protected final String TEXT_8 = " = ";
  protected final String TEXT_9 = ";" + NL + "\t";
  protected final String TEXT_10 = NL + "if(dbschema_";
  ...
  protected final String TEXT_18 = NL + "    String tmpTableName_";
  protected final String TEXT_19 = " = \"tmp_";
  protected final String TEXT_20 = "_\" + pid + Thread.currentThread().getId();";
  protected final String TEXT_21 = NL + "String bulkSQL_";
  protected final String TEXT_22 = " = \"COPY \\\"\" + ";
  protected final String TEXT_23 = "tmpTableName_";
  protected final String TEXT_24 = "tableName_";
  protected final String TEXT_25 = " ";
  protected final String TEXT_26 = " + \"\\\" ";
  protected final String TEXT_27 = "FROM '\" + ";
  protected final String TEXT_28 = " + \"' WITH \";";
  protected final String TEXT_29 = NL + "    bulkSQL_";
  protected final String TEXT_30 = " += \"BINARY ";
  protected final String TEXT_31 = "\";";
  protected final String TEXT_32 = NL + "    bulkSQL_";
  protected final String TEXT_33 = " += \"";
  protected final String TEXT_34 = " \" + \"DELIMITER AS '\" + ";
  protected final String TEXT_35 = " + \"' \";" + NL + "    bulkSQL_";
  protected final String TEXT_36 = " += \"NULL AS '\" + ";
  protected final String TEXT_37 = " + \"' \";";
  protected final String TEXT_38 = NL + "        bulkSQL_";
  protected final String TEXT_39 = " += \"CSV ";
  protected final String TEXT_40 = " QUOTE AS '\" + ";
  protected final String TEXT_41 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  protected final String TEXT_42 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_43 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  ...
  protected final String TEXT_51 = NL + "\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\tconn_";
  protected final String TEXT_52 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_62 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_81 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_82 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_83 = " = tableNameForSearch_";
  protected final String TEXT_84 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_85 = " = tableNameForSearch_";
  protected final String TEXT_86 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_87 = " = dbMetaData_";
  protected final String TEXT_88 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_89 = ", tableNameForSearch_";
  protected final String TEXT_90 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_91 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_92 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_93 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_97 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_98 = " = dbMetaData_";
  protected final String TEXT_99 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_100 = " = false;" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_105 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_106 = ".equalsIgnoreCase(";
  protected final String TEXT_107 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_108 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_109 = ") || dbschema_";
  protected final String TEXT_110 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_121 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_125 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_126 = ".equals(schema_";
  protected final String TEXT_127 = ") || (schema_";
  protected final String TEXT_128 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_129 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_138 = " = false;" + NL + "\t            String defaultSchema_";
  ...
  protected final String TEXT_191 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_198 = ".createStatement();" + NL + "                    stmtDrop_";
  ...
  protected final String TEXT_207 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_229 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_230 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_231 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_232 = NL + "        int keyCount_";
  protected final String TEXT_233 = " = ";
  protected final String TEXT_234 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_235 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_236 = " = tableName_";
  protected final String TEXT_237 = ";" + NL + "        tableName_";
  protected final String TEXT_238 = " = \"tmp_";
  protected final String TEXT_239 = "_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_242 = ".execute(\"";
  protected final String TEXT_243 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_244 = ".close();" + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_245 = " = conn_";
  protected final String TEXT_246 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_247 = ".execute(bulkSQL_";
  protected final String TEXT_248 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_249 = ".close();" + NL + "        tableName_";
  protected final String TEXT_250 = " = tmpTableName_";
  protected final String TEXT_251 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_252 = " = \"tmp_";
  protected final String TEXT_253 = "_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_254 = " = conn_";
  protected final String TEXT_255 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_256 = ".executeUpdate(\"";
  protected final String TEXT_257 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_258 = ".close();" + NL + "        tableName_";
  protected final String TEXT_259 = " = tmpTableName_";
  protected final String TEXT_260 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_261 = " = conn_";
  protected final String TEXT_262 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_263 = ".execute(\"";
  protected final String TEXT_264 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_265 = ".close();";
  protected final String TEXT_266 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_267 = " = conn_";
  protected final String TEXT_268 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_269 = ".execute(bulkSQL_";
  protected final String TEXT_270 = ");" + NL + "    stmtBulk_";
