...
public class TAmazonOracleConnectionBeginJava
{
  ...
  protected final String TEXT_101 = NL + "\t\tglobalMap.put(\"conn_";
  ...
  protected final String TEXT_110 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_111 = "\", ";
  protected final String TEXT_112 = ");" + NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_113 = "\",";
  protected final String TEXT_114 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
