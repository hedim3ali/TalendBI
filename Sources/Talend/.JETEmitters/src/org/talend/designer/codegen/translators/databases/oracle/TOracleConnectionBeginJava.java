...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_119 = ".getMetaData().getUserName());";
  protected final String TEXT_120 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_121 = "\", ";
  protected final String TEXT_122 = ");";
  protected final String TEXT_123 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_124 = "\",";
  protected final String TEXT_125 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
