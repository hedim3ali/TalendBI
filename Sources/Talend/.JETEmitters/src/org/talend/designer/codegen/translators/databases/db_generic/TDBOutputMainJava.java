...
public class TDBOutputMainJava {
  ...
  protected final String TEXT_62 = NL + "            try {";
  protected final String TEXT_63 = NL + "                updatedCount_";
  protected final String TEXT_64 = " = updatedCount_";
  protected final String TEXT_65 = " + pstmt_";
  protected final String TEXT_66 = ".executeUpdate(query_";
  protected final String TEXT_67 = ".toString().trim());";
  ...
  protected final String TEXT_71 = ".executeUpdate();";
  ...
  protected final String TEXT_99 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_100 = " = pstmt_";
  protected final String TEXT_101 = ".executeQuery(query_";
  protected final String TEXT_102 = ".toString().trim());" + NL + "    \t\tquery_";
  protected final String TEXT_103 = " = new StringBuffer(\"\");" + NL + "    \t\t";
  protected final String TEXT_104 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_105 = " = pstmt_";
  protected final String TEXT_106 = ".executeQuery();" + NL + "    \t\t";
  protected final String TEXT_107 = NL + "    \t\tint checkCount_";
  protected final String TEXT_108 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_109 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_110 = " = rs_";
  protected final String TEXT_111 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_123 = ".toString().trim());";
  protected final String TEXT_124 = NL + "                try {";
  protected final String TEXT_125 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_126 = " = updatedCount_";
  protected final String TEXT_127 = " + pstmtUpdate_";
  protected final String TEXT_128 = ".executeUpdate(query_";
  protected final String TEXT_129 = ".toString().trim());" + NL + "            \t";
  protected final String TEXT_130 = NL + "        \t\t\tupdatedCount_";
  ...
  protected final String TEXT_145 = NL + "                            rejectedCount_";
  protected final String TEXT_146 = " = rejectedCount_";
  protected final String TEXT_147 = " + 1;";
  protected final String TEXT_148 = NL + "                            ";
  protected final String TEXT_149 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_150 = NL + "                            ";
  protected final String TEXT_151 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_152 = ";" + NL + "                            ";
  protected final String TEXT_153 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_154 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_162 = NL + "                try {";
  protected final String TEXT_163 = NL + "                    insertedCount_";
  protected final String TEXT_164 = " = insertedCount_";
  protected final String TEXT_165 = " + pstmtInsert_";
  protected final String TEXT_166 = ".executeUpdate(query_";
  protected final String TEXT_167 = ".toString());";
  protected final String TEXT_168 = NL + "                    insertedCount_";
  protected final String TEXT_169 = " = insertedCount_";
  protected final String TEXT_170 = " + pstmtInsert_";
  ...
  protected final String TEXT_183 = NL + "                            rejectedCount_";
  ...
  protected final String TEXT_194 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_207 = NL + "    \t" + NL + "            try {";
  protected final String TEXT_208 = NL + "                updateFlag_";
  protected final String TEXT_209 = "=pstmtUpdate_";
  protected final String TEXT_210 = ".executeUpdate(query_";
  protected final String TEXT_211 = ".toString().trim());";
  protected final String TEXT_212 = NL + "                updateFlag_";
  protected final String TEXT_213 = "=pstmtUpdate_";
  protected final String TEXT_214 = ".executeUpdate();";
  protected final String TEXT_215 = NL + "                updatedCount_";
  protected final String TEXT_216 = " = updatedCount_";
  protected final String TEXT_217 = " + updateFlag_";
  protected final String TEXT_218 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_233 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_234 = NL + "                        ";
  protected final String TEXT_235 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_249 = NL + "                try {";
  protected final String TEXT_250 = NL + "                    insertedCount_";
  protected final String TEXT_251 = " = insertedCount_";
  protected final String TEXT_252 = " + pstmtInsert_";
  protected final String TEXT_253 = ".executeUpdate(query_";
  protected final String TEXT_254 = ".toString().trim());";
  protected final String TEXT_255 = NL + "                    insertedCount_";
  protected final String TEXT_256 = " = insertedCount_";
  protected final String TEXT_257 = " + pstmtInsert_";
  ...
  protected final String TEXT_270 = NL + "                            rejectedCount_";
  protected final String TEXT_271 = " = rejectedCount_";
  protected final String TEXT_272 = " + 1;";
  ...
  protected final String TEXT_279 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_280 = "++;";
  protected final String TEXT_281 = NL + "                    ";
  protected final String TEXT_282 = NL + "                        query_";
  protected final String TEXT_283 = " = ";
  protected final String TEXT_284 = ";";
  protected final String TEXT_285 = NL + "                globalMap.put(\"";
  protected final String TEXT_286 = "_QUERY\", query_";
  protected final String TEXT_287 = ".toString().trim());";
  protected final String TEXT_288 = NL + "            try {" + NL + "\t\t\t";
  protected final String TEXT_289 = NL + "               deletedCount_";
  protected final String TEXT_290 = " = deletedCount_";
  protected final String TEXT_291 = " + pstmt_";
  protected final String TEXT_292 = ".executeUpdate(query_";
  protected final String TEXT_293 = ".toString().trim());" + NL + "\t\t\t";
  protected final String TEXT_294 = NL + "               deletedCount_";
  protected final String TEXT_295 = " = deletedCount_";
  protected final String TEXT_296 = " + pstmt_";
  protected final String TEXT_297 = ".executeUpdate();" + NL + "\t\t\t";
  protected final String TEXT_298 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_309 = NL + "                        rejectedCount_";
  protected final String TEXT_310 = " = rejectedCount_";
  ...
  protected final String TEXT_318 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_319 = "++;" + NL + "    \t";
  protected final String TEXT_320 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_332 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_333 = " <= commitCounter_";
  protected final String TEXT_334 = ") {" + NL + "            " + NL + "            \tconn_";
  protected final String TEXT_335 = ".commit();" + NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_336 = "=0;" + NL + "            }\t" + NL + "    \t";
