...
public class TEXARowMainJava
{
  ...
  protected final String TEXT_33 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_34 = NL + "                ";
  protected final String TEXT_35 = ".errorMessage = e.getMessage();";
  protected final String TEXT_36 = NL + "                System.err.print(e.getMessage());";
  protected final String TEXT_37 = NL + "    }";
  protected final String TEXT_38 = NL + "    if(!whetherReject_";
  ...
  protected final String TEXT_53 = NL + "        commitCounter_";
  protected final String TEXT_54 = "++;" + NL + "        if(commitEvery_";
  protected final String TEXT_55 = " <= commitCounter_";
  protected final String TEXT_56 = ") {        " + NL + "        \tconn_";
  protected final String TEXT_57 = ".commit();        \t" + NL + "        \tcommitCounter_";
