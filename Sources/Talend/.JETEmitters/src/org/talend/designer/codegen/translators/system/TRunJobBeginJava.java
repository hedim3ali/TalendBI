...
public class TRunJobBeginJava
{
  ...
  protected final String TEXT_27 = ".add(dealChildJobLibrary_";
  protected final String TEXT_28 = ".replaceJarPathsFromCrcMap(\"";
  protected final String TEXT_29 = "\").replaceAll(\";\",classpathSeparator_";
  protected final String TEXT_30 = "));" + NL + "\t\t\t\t    ";
  protected final String TEXT_31 = NL + "\t\t\t\t    \t\tchildJob_commandLine_";
  protected final String TEXT_32 = ".add(\"";
  protected final String TEXT_33 = "\".replaceAll(\";\",classpathSeparator_";
  protected final String TEXT_34 = "));" + NL + "\t\t\t\t    ";
  protected final String TEXT_35 = NL + "\t\t\t\tchildJob_commandLine_Mapper_";
  protected final String TEXT_36 = ".put(\"";
  protected final String TEXT_37 = "\",childJob_commandLine_";
