...
public class TGSBucketDeleteMainJava
{
  ...
  protected final String TEXT_16 = ");" + NL + "" + NL + "\t}catch(org.jets3t.service.ServiceException e_";
  protected final String TEXT_17 = ") {";
  protected final String TEXT_18 = NL + "\t\tthrow(e_";
  protected final String TEXT_19 = ");";
  protected final String TEXT_20 = NL + "\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_21 = ":\");" + NL + "\t\tSystem.err.println(e_";
  protected final String TEXT_22 = ".getMessage());" + NL + "\t\tif(e_";
  protected final String TEXT_23 = ".getErrorCode()!=null){" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_24 = ".getErrorCode());" + NL + "\t\t}" + NL + "\t\tif(e_";
  protected final String TEXT_25 = ".getErrorMessage()!=null){" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_26 = ".getErrorMessage());" + NL + "\t\t}";
  protected final String TEXT_27 = NL + "\t}finally{" + NL + "\t\tif(service_";
  protected final String TEXT_28 = " !=null){" + NL + "\t\t\tservice_";
