...
public class TMaxDBOutputMainJava {
  ...
  protected final String TEXT_32 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_33 = NL + "                        ";
  protected final String TEXT_34 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_35 = ";";
  protected final String TEXT_36 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_53 = ".toString().trim());";
  protected final String TEXT_54 = NL + "            try {" + NL + "                updatedCount_";
  ...
  protected final String TEXT_67 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_68 = NL + "                        ";
  protected final String TEXT_69 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_70 = ";";
  protected final String TEXT_71 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_103 = " + pstmtUpdate_";
  protected final String TEXT_104 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_113 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_114 = NL + "                            ";
  protected final String TEXT_115 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_116 = ";";
  protected final String TEXT_117 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_124 = "_QUERY\", query_";
  protected final String TEXT_125 = ".toString().trim());";
  protected final String TEXT_126 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_127 = " = insertedCount_";
  protected final String TEXT_128 = " + pstmtInsert_";
  protected final String TEXT_129 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_142 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_143 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_144 = "++;" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_145 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_163 = "\t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_164 = " = pstmtUpdate_";
  protected final String TEXT_165 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_166 = " = updatedCount_";
  protected final String TEXT_167 = " + updateFlag_";
  ...
  protected final String TEXT_177 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_178 = NL + "                        ";
  protected final String TEXT_179 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_180 = ";";
  protected final String TEXT_181 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_182 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_183 = " == 0) {" + NL + "            \t";
  protected final String TEXT_184 = NL + "\t\t\t\tquery_";
  protected final String TEXT_185 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_196 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_224 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_225 = " = deletedCount_";
  protected final String TEXT_226 = " + pstmt_";
  protected final String TEXT_227 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_240 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_241 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_242 = "++;" + NL + "    \t";
  protected final String TEXT_243 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_251 = NL + "            commitCounter_";
  protected final String TEXT_252 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_253 = " <= commitCounter_";
  protected final String TEXT_254 = ") {" + NL + "            " + NL + "            \tconn_";
  protected final String TEXT_255 = ".commit();" + NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_256 = "=0;" + NL + "            " + NL + "            }\t" + NL + "    \t";
