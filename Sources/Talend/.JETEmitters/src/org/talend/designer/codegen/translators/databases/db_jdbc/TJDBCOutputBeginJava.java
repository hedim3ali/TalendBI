...
public class TJDBCOutputBeginJava {
  ...
  protected final String TEXT_25 = " " + NL + "\t\tif (null == connection_";
  ...
  protected final String TEXT_33 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_34 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  ...
  protected final String TEXT_38 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_39 = NL + "\t\t\tjava.lang.Class.forName(";
  protected final String TEXT_40 = ");" + NL + "\t\t\tString connectionString_";
  ...
  protected final String TEXT_49 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_52 = " = 0;         ";
  protected final String TEXT_53 = NL + "   int batchSize_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_56 = "=0;";
  protected final String TEXT_57 = " " + NL;
  protected final String TEXT_58 = NL + "\tjava.sql.Statement statementClear_";
  protected final String TEXT_59 = " = connection_";
  protected final String TEXT_60 = ".createStatement();" + NL + "\tdeletedCount_";
  protected final String TEXT_61 = " = deletedCount_";
  protected final String TEXT_62 = " + statementClear_";
  protected final String TEXT_63 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_64 = ");" + NL + "\t";
  protected final String TEXT_65 = NL + "\t\tString insert_";
  protected final String TEXT_66 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_79 = ".prepareStatement(update_";
  protected final String TEXT_80 = ");" + NL + "\t\t";
  protected final String TEXT_81 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_82 = " = connection_";
  protected final String TEXT_83 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_84 = " + \" WHERE ";
  protected final String TEXT_85 = "\");" + NL + "\t\tString insert_";
  protected final String TEXT_86 = " = \"INSERT INTO \" + ";
  protected final String TEXT_87 = " + \" (";
  protected final String TEXT_88 = ") VALUES (";
  protected final String TEXT_89 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_90 = " = connection_";
  protected final String TEXT_91 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_96 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_97 = " = connection_";
  protected final String TEXT_98 = ".prepareStatement(update_";
  ...
  protected final String TEXT_104 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_105 = " = connection_";
  protected final String TEXT_106 = ".prepareStatement(update_";
  protected final String TEXT_107 = ");" + NL + "\t\tString insert_";
  protected final String TEXT_108 = " = \"INSERT INTO \" + ";
  protected final String TEXT_109 = " + \" (";
  protected final String TEXT_110 = ") VALUES (";
  protected final String TEXT_111 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_112 = " = connection_";
  protected final String TEXT_113 = ".prepareStatement(insert_";
  protected final String TEXT_114 = ");" + NL + "\t\t";
  protected final String TEXT_115 = NL + "\t\tString delete_";
  protected final String TEXT_116 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_120 = ".prepareStatement(delete_";
  protected final String TEXT_121 = ");" + NL + "\t\t";
  protected final String TEXT_122 = NL + "        StringBuffer query_";
  protected final String TEXT_123 = " = null;" + NL + "       \t";
  protected final String TEXT_124 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_125 = " = insert_";
  ...
  protected final String TEXT_131 = NL + "\t\t\tupdate_";
  protected final String TEXT_132 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_133 = " = update_";
  protected final String TEXT_134 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_135 = " = insert_";
  protected final String TEXT_136 = ".split(\"\\\\?\");";
  protected final String TEXT_137 = NL + "\t\t\tdelete_";
  protected final String TEXT_138 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_139 = " = delete_";
  protected final String TEXT_140 = ".split(\"\\\\?\");";
  protected final String TEXT_141 = NL + "\t\t\treplace_";
  protected final String TEXT_142 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_143 = " = replace_";
  protected final String TEXT_144 = ".split(\"\\\\?\");";
  protected final String TEXT_145 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_146 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_147 = " = insertIgnore_";
