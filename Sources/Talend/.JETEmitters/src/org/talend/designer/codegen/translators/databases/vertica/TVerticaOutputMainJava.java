...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_26 = NL + "\t\ttry {" + NL + "\t\t\tinsertedCount_";
  protected final String TEXT_27 = " = insertedCount_";
  protected final String TEXT_28 = " + pstmt_";
  protected final String TEXT_29 = ".executeUpdate();" + NL + "\t\t\tnb_line_";
  ...
  protected final String TEXT_44 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_62 = NL + "\t\t\t\t\t\tquery_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_66 = "_QUERY\", query_";
  protected final String TEXT_67 = ".toString().trim());" + NL + "\t\t\t\t";
  protected final String TEXT_68 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\tpstmt_";
  protected final String TEXT_70 = ".addBatch();" + NL + "\t\t\tnb_line_";
  protected final String TEXT_71 = "++;" + NL + "\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\tbatchSizeCounter_";
  protected final String TEXT_73 = "++;" + NL + "\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\ttry {" + NL + "\t\t\t\tupdatedCount_";
  protected final String TEXT_75 = " = updatedCount_";
  protected final String TEXT_76 = " + pstmt_";
  protected final String TEXT_77 = ".executeUpdate();" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_78 = "++;" + NL + "\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\twhetherReject_";
  protected final String TEXT_79 = " = true;" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_89 = NL + "\t\t\t\t\t\trejectedCount_";
  protected final String TEXT_90 = " = rejectedCount_";
  protected final String TEXT_91 = " + 1;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_92 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_103 = NL + "\t" + NL + "\t\t\tjava.sql.ResultSet rs_";
  protected final String TEXT_104 = " = pstmt_";
  protected final String TEXT_105 = ".executeQuery();" + NL + "\t\t\tint checkCount_";
  protected final String TEXT_106 = " = -1;" + NL + "\t\t\twhile(rs_";
  protected final String TEXT_107 = ".next()) {" + NL + "\t\t\t\tcheckCount_";
  protected final String TEXT_108 = " = rs_";
  protected final String TEXT_109 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\tif(checkCount_";
  ...
  protected final String TEXT_128 = "_QUERY\", query_";
  protected final String TEXT_129 = ".toString().trim());" + NL + "\t\t\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tupdatedCount_";
  protected final String TEXT_131 = " = updatedCount_";
  protected final String TEXT_132 = " + pstmtUpdate_";
  protected final String TEXT_133 = ".executeUpdate();" + NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  ...
  protected final String TEXT_144 = NL + "\t\t\t\t\t\t\trejectedCount_";
  protected final String TEXT_145 = " = rejectedCount_";
  protected final String TEXT_146 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_147 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_148 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_149 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_159 = ".toString().trim());" + NL + "\t\t\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tinsertedCount_";
  protected final String TEXT_161 = " = insertedCount_";
  protected final String TEXT_162 = " + pstmtInsert_";
  protected final String TEXT_163 = ".executeUpdate();" + NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  protected final String TEXT_164 = " = true;" + NL + "\t\t\t\t\t";
  protected final String TEXT_165 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_166 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_167 = " = new ";
  protected final String TEXT_168 = "Struct();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_170 = ".";
  protected final String TEXT_171 = " = ";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t\t\t\t\trejectedCount_";
  protected final String TEXT_175 = " = rejectedCount_";
  protected final String TEXT_176 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_177 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_178 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_179 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_180 = NL + "\t\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_181 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tnb_line_";
  protected final String TEXT_182 = "++;" + NL + "\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\tint updateFlag_";
  ...
  protected final String TEXT_203 = ".toString().trim());" + NL + "\t\t\t\t";
  protected final String TEXT_204 = NL + "\t\t" + NL + "\t\t\ttry {" + NL + "\t\t\t\tupdateFlag_";
  protected final String TEXT_205 = "=pstmtUpdate_";
  protected final String TEXT_206 = ".executeUpdate();" + NL + "\t\t\t\tupdatedCount_";
  protected final String TEXT_207 = " = updatedCount_";
  protected final String TEXT_208 = " + updateFlag_";
  protected final String TEXT_209 = ";" + NL + "\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\twhetherReject_";
  protected final String TEXT_210 = " = true;" + NL + "\t\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_222 = " + 1;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_223 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_224 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_225 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_227 = NL + "\t\t\t}" + NL + "\t\t\tif(updateFlag_";
  protected final String TEXT_228 = " == 0) {" + NL + "\t\t\t\t";
  protected final String TEXT_229 = NL + "\t\t\t\tquery_";
  protected final String TEXT_230 = " = new StringBuffer(\"\");" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_238 = ".toString().trim());" + NL + "\t\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tinsertedCount_";
  protected final String TEXT_240 = " = insertedCount_";
  protected final String TEXT_241 = " + pstmtInsert_";
  protected final String TEXT_242 = ".executeUpdate(); " + NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  protected final String TEXT_243 = " = true;" + NL + "\t\t\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_253 = NL + "\t\t\t\t\t\t\trejectedCount_";
  protected final String TEXT_254 = " = rejectedCount_";
  protected final String TEXT_255 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_256 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_257 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_258 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_259 = NL + "\t\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tnb_line_";
  ...
  protected final String TEXT_275 = ".toString().trim());" + NL + "\t\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t";
  protected final String TEXT_277 = NL + "\t\t\tpstmt_";
  protected final String TEXT_278 = ".addBatch();" + NL + "\t\t\t";
  protected final String TEXT_279 = NL + "\t\t\tbatchSizeCounter_";
  ...
  protected final String TEXT_285 = ".executeUpdate();" + NL + "\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\twhetherReject_";
  protected final String TEXT_286 = " = true;" + NL + "\t\t\t\t";
  protected final String TEXT_287 = NL + "\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_296 = NL + "\t\t\t\t\t\trejectedCount_";
  protected final String TEXT_297 = " = rejectedCount_";
  protected final String TEXT_298 = " + 1;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_299 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_300 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_301 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_304 = NL + "\t\t\tnb_line_";
  protected final String TEXT_305 = "++;" + NL + "\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t   \t\t\tstmtBuilder_";
  protected final String TEXT_308 = ".append(\"|\");" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_309 = ".append(String.valueOf(";
  protected final String TEXT_310 = ".";
  protected final String TEXT_311 = "));" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_312 = ".append(\"|\"); " + NL + "\t\t\t   \t\t";
  protected final String TEXT_313 = NL + "\t\t\t   \t\t\tif(";
  protected final String TEXT_314 = ".";
  protected final String TEXT_315 = " == null){" + NL + "\t\t\t   \t\t\t\tstmtBuilder_";
  protected final String TEXT_316 = ".append(\"\");" + NL + "\t\t\t   \t\t\t}else{" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_317 = ".append(\"|\");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_318 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_319 = ".append(";
  protected final String TEXT_320 = ".";
  protected final String TEXT_321 = ".replaceAll(\"\\\\|\",\"\\\\\\\\|\"));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_323 = ".append(FormatterUtils.format_Date(";
  protected final String TEXT_324 = ".";
  protected final String TEXT_325 = ", ";
  protected final String TEXT_326 = "));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_328 = ".append(java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_329 = ".";
  protected final String TEXT_330 = ")).toString());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_331 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_332 = NL + "\t\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_333 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_334 = "), null, '.'));" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_335 = NL + "\t\t\t\t\t\t\t\t\t\t\t\tif (";
  protected final String TEXT_336 = ".";
  protected final String TEXT_337 = " != null) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tBigDecimal decimal_";
  protected final String TEXT_338 = " = new BigDecimal(";
  protected final String TEXT_339 = ".";
  protected final String TEXT_340 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_341 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_342 = "), null, '.'));" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_343 = NL + "\t\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_344 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_345 = ".";
  protected final String TEXT_346 = "), null, '.'));" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_348 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_349 = ".append(String.valueOf(";
  protected final String TEXT_350 = "));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_351 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_352 = ".append(String.valueOf(";
  protected final String TEXT_353 = ".";
  protected final String TEXT_354 = "));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_356 = ".append(\"|\");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_357 = NL + "\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_358 = ".append(\"";
  protected final String TEXT_359 = "\");" + NL + "\t\t\t";
  protected final String TEXT_360 = NL + "\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t" + NL + "\t\t\tnb_line_";
  protected final String TEXT_362 = "++;";
  protected final String TEXT_363 = NL + "\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_364 = "++;";
  protected final String TEXT_365 = NL + "\t\t\tif(!whetherReject_";
  ...
  protected final String TEXT_376 = NL + "\t\t\t\tif ( batchSize_";
  protected final String TEXT_377 = " <= batchSizeCounter_";
  protected final String TEXT_378 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_381 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_383 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_384 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_385 = NL + "\t\t\t\t\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_386 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_387 = ",template_";
  protected final String TEXT_388 = ");" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_389 = ".start();" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_390 = ".addStream(bais_";
  protected final String TEXT_391 = ");" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_392 = ".execute();" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_393 = ".finish();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_395 = ").executeCopyIn(template_";
  protected final String TEXT_396 = ", bais_";
  protected final String TEXT_397 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_398 = NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_399 = " = null;" + NL + "\t\t\t\t\t\tif (bais_";
  protected final String TEXT_400 = " != null) {" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_401 = ".close();" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_402 = " = null;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_403 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\t\t\t\tinsertedCount_";
  protected final String TEXT_406 = " += pstmt_";
  protected final String TEXT_407 = ". getUpdateCount();" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_414 = NL + "\t\t\t\t\t\t\t\tcopiedCount_";
  protected final String TEXT_415 = " += vcs_";
  protected final String TEXT_416 = ".getRowCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t\t\tcopiedCount_";
  ...
  protected final String TEXT_421 = " = 0; \t\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_422 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_424 = NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\tcommitCounter_";
  protected final String TEXT_427 = "++;" + NL + "\t\t\t\tif(commitEvery_";
  protected final String TEXT_428 = " <= commitCounter_";
  protected final String TEXT_429 = ") {" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_430 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\t\t\tif(batchSizeCounter_";
  protected final String TEXT_432 = " > 0){" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_433 = ".executeBatch();" + NL + "\t\t\t\t\t\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_434 = " = 0;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_435 = NL + "\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_436 = ".executeBatch(); " + NL + "\t\t\t\t\t\t";
  protected final String TEXT_437 = NL + "\t\t\t\t\t\tif (stmtBuilder_";
  protected final String TEXT_438 = " != null && stmtBuilder_";
  protected final String TEXT_439 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_440 = " start" + NL + "\t\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_441 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_442 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_443 = ").executeCopyIn(template_";
  protected final String TEXT_444 = ", bais_";
  protected final String TEXT_445 = ");" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_446 = " = null;" + NL + "\t\t\t\t\t\t\tif (bais_";
  protected final String TEXT_447 = " != null) {" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_448 = ".close();" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_449 = " = null;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_450 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_455 = NL + "\t\t\t\t\t\t\tupdatedCount_";
  ...
  protected final String TEXT_460 = ".getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_461 = NL + "\t\t\t\t\t\t\t\tcopiedCount_";
  protected final String TEXT_462 = " += stmt_";
  protected final String TEXT_463 = ".getUpdateCount();" + NL + "\t\t\t\t\t\t} // stmtBuilder_";
  protected final String TEXT_464 = " end" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_465 = "  " + NL + "\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_466 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_467 = NL + "\t\t\t\t\t\tSystem.out.println(e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_468 = NL + "\t\t\t\t" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_469 = NL + "\t   \t\t\t\tconn_";
  protected final String TEXT_470 = ".commit();" + NL + "\t\t\t\t\tcommitCounter_";
  protected final String TEXT_471 = "=0;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_425);
		...
		////////////commit every////////////
		if(!useExistingConnection && (!("VERTICA_6_1_X".equals(db_version) || "VERTICA_6_0".equals(db_version) || "VERTICA_5_1".equals(db_version)) || !"COPY".equals(dataAction))) {
			if(manualCommit) {
