...
public class TDB2SCDBeginJava {
  ...
  protected final String TEXT_10 = NL + "\t\t    String connectionString_";
  protected final String TEXT_11 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_12 = " + \":\" + ";
  protected final String TEXT_13 = " + \"/\" + ";
  protected final String TEXT_14 = ";    ";
  protected final String TEXT_15 = NL + "\t\t\tString connectionString_";
  protected final String TEXT_16 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_17 = " + \":\" + ";
  protected final String TEXT_18 = " + \"/\" + ";
  protected final String TEXT_19 = " + \":\" + ";
  protected final String TEXT_20 = ";";
  protected final String TEXT_21 = NL + "        java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_27 = " = null;" + NL + "    String schema_";
  protected final String TEXT_28 = " = ";
  protected final String TEXT_29 = ";" + NL + "    if(schema_";
  protected final String TEXT_30 = " == null || schema_";
  protected final String TEXT_31 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_32 = " = ";
  protected final String TEXT_33 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_34 = " = schema_";
  protected final String TEXT_35 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_36 = ";" + NL + "    }" + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_37 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_38 = " = null;    ";
  protected final String TEXT_39 = NL + "        String searching_";
  protected final String TEXT_40 = " = \"";
  protected final String TEXT_41 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_42 = " = connection_";
  protected final String TEXT_43 = ".prepareStatement(searching_";
  protected final String TEXT_44 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_45 = " = null;";
  protected final String TEXT_46 = NL + "        String search_";
  protected final String TEXT_47 = " = \"";
  protected final String TEXT_48 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_49 = " = connection_";
  protected final String TEXT_50 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_51 = " = statement_";
  protected final String TEXT_52 = ".executeQuery(search_";
  protected final String TEXT_53 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_54 = ", SCDStruct_";
  protected final String TEXT_55 = "> cache_";
  protected final String TEXT_56 = " = new java.util.HashMap<SCDSK_";
  ...
  protected final String TEXT_80 = " = null;" + NL + "                            } else {";
  protected final String TEXT_81 = NL + "                                ";
  protected final String TEXT_82 = ".";
  protected final String TEXT_83 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_84 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_85 = ")) {";
  protected final String TEXT_86 = NL + "                                ";
  protected final String TEXT_87 = ".";
  protected final String TEXT_88 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_89 = "' in '";
  protected final String TEXT_90 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_91 = NL + "                    }";
  protected final String TEXT_92 = NL + "                    timestamp_";
  protected final String TEXT_93 = " = resultSet_";
  protected final String TEXT_94 = ".getTimestamp(";
  protected final String TEXT_95 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_96 = " != null) {";
  protected final String TEXT_97 = NL + "                        ";
  protected final String TEXT_98 = ".";
  protected final String TEXT_99 = " = new java.util.Date(timestamp_";
  protected final String TEXT_100 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_101 = NL + "                        ";
  protected final String TEXT_102 = ".";
  protected final String TEXT_103 = " = null;" + NL + "                    }";
  protected final String TEXT_104 = NL + "                    if(resultSet_";
  protected final String TEXT_105 = ".getObject(";
  protected final String TEXT_106 = ") != null) {";
  protected final String TEXT_107 = NL + "                        ";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = " = resultSet_";
  protected final String TEXT_110 = ".get";
  protected final String TEXT_111 = "(";
  protected final String TEXT_112 = ");" + NL + "                    }";
  protected final String TEXT_113 = NL + "            cache_";
  protected final String TEXT_114 = ".put(sk_";
  protected final String TEXT_115 = ", row_";
  protected final String TEXT_116 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_117 = ".close();" + NL + "        statement_";
  protected final String TEXT_118 = ".close();";
  protected final String TEXT_119 = NL + "            System.out.println(\"[";
  protected final String TEXT_120 = "] comparison cache loaded\");";
  protected final String TEXT_121 = NL + "        ";
  protected final String TEXT_122 = " nextSurrogateKey_";
  protected final String TEXT_123 = " = 1;";
  protected final String TEXT_124 = NL + "            if(cache_";
  protected final String TEXT_125 = ".size() > 0) {";
  protected final String TEXT_126 = NL + "        String tmpQuery_";
  protected final String TEXT_127 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_128 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_129 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_130 = " = connection_";
  protected final String TEXT_131 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_132 = " = tmpStmt_";
  protected final String TEXT_133 = ".executeQuery(tmpQuery_";
  protected final String TEXT_134 = ");";
  protected final String TEXT_135 = NL + "        if(tmpRS_";
  protected final String TEXT_136 = ".next() && tmpRS_";
  protected final String TEXT_137 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_138 = " = tmpRS_";
  protected final String TEXT_139 = ".get";
  protected final String TEXT_140 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_141 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_142 = ".close();";
  protected final String TEXT_143 = NL + "            }            ";
  protected final String TEXT_144 = NL + "    String insertionSQL_";
  protected final String TEXT_145 = " = \"";
  protected final String TEXT_146 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_147 = " = connection_";
  protected final String TEXT_148 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_149 = ");";
  protected final String TEXT_150 = NL + "            insertionStatement_";
  protected final String TEXT_151 = ".setTimestamp(";
  protected final String TEXT_152 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_153 = "\")));";
  protected final String TEXT_154 = NL + "            insertionStatement_";
  protected final String TEXT_155 = ".setNull(";
  protected final String TEXT_156 = ", java.sql.Types.DATE);";
  protected final String TEXT_157 = NL + "            insertionStatement_";
  protected final String TEXT_158 = ".setTimestamp(";
  protected final String TEXT_159 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_160 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_161 = NL + "        String updateSQLForType1_";
  protected final String TEXT_162 = " = \"";
  protected final String TEXT_163 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_164 = " = connection_";
  protected final String TEXT_165 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_166 = ");        ";
  protected final String TEXT_167 = NL + "        String updateSQLForType2_";
  protected final String TEXT_168 = " = \"";
  protected final String TEXT_169 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_170 = " = connection_";
  protected final String TEXT_171 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_172 = ");";
  protected final String TEXT_173 = NL + "            updateForType2_";
  protected final String TEXT_174 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_175 = "\")));";
  protected final String TEXT_176 = NL + "        String updateSQLForType3_";
  protected final String TEXT_177 = " = \"";
  protected final String TEXT_178 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_179 = " = connection_";
  protected final String TEXT_180 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_181 = ");";
  protected final String TEXT_182 = NL + "        SCDSK_";
  protected final String TEXT_183 = " lookUpKey_";
  protected final String TEXT_184 = " = null;        ";
  protected final String TEXT_185 = NL + "    SCDStruct_";
  protected final String TEXT_186 = " lookUpValue_";
