...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_414 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_479 = NL + "        StringBuffer query_";
  protected final String TEXT_480 = " = null;" + NL + "       \t";
  protected final String TEXT_481 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_482 = " = insert_";
  protected final String TEXT_483 = ".split(\"\\\\?\");";
  protected final String TEXT_484 = NL + "\t\t\tupdate_";
  protected final String TEXT_485 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_503 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_538 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_539 = "++;" + NL + "                insertedCount_";
  ...
  protected final String TEXT_557 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_558 = NL + "                        ";
  protected final String TEXT_559 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_560 = ";";
  protected final String TEXT_561 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_562 = NL + "            }";
  protected final String TEXT_563 = NL + "                    ";
  protected final String TEXT_564 = NL + "                        query_";
  protected final String TEXT_565 = " = ";
  protected final String TEXT_566 = ";";
  protected final String TEXT_567 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_568 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_569 = ".";
  protected final String TEXT_570 = ", pstmt_";
  ...
  protected final String TEXT_589 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_590 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_591 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_592 = "++;";
  protected final String TEXT_593 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_594 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_595 = " = updatedCount_";
  protected final String TEXT_596 = " + pstmt_";
  protected final String TEXT_597 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_655 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_692 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_707 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_712 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_713 = "++;";
  protected final String TEXT_714 = NL + "            int updateFlag_";
  protected final String TEXT_715 = "=0;";
  ...
  protected final String TEXT_738 = "_QUERY\", query_";
  protected final String TEXT_739 = ".toString().trim());";
  protected final String TEXT_740 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_741 = "=pstmtUpdate_";
  protected final String TEXT_742 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_743 = " = updatedCount_";
  protected final String TEXT_744 = " + updateFlag_";
  protected final String TEXT_745 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_746 = " = true;";
  protected final String TEXT_747 = NL + "                    throw(e);";
  ...
  protected final String TEXT_764 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_765 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_766 = " == 0) {" + NL + "            \t";
  protected final String TEXT_767 = NL + "\t\t\t\tquery_";
  protected final String TEXT_768 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_769 = NL + "                        ";
  protected final String TEXT_770 = NL + "                            query_";
  protected final String TEXT_771 = " = ";
  protected final String TEXT_772 = ";";
  protected final String TEXT_773 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_782 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_783 = " = insertedCount_";
  protected final String TEXT_784 = " + pstmtInsert_";
  protected final String TEXT_785 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_786 = " = true;";
  protected final String TEXT_787 = NL + "                        throw(e);";
  protected final String TEXT_788 = NL + "                            ";
  protected final String TEXT_789 = " = new ";
  protected final String TEXT_790 = "Struct();";
  protected final String TEXT_791 = NL + "                                ";
  protected final String TEXT_792 = ".";
  protected final String TEXT_793 = " = ";
  protected final String TEXT_794 = ".";
  protected final String TEXT_795 = ";";
  protected final String TEXT_796 = NL + "                            rejectedCount_";
  protected final String TEXT_797 = " = rejectedCount_";
  protected final String TEXT_798 = " + 1;";
  protected final String TEXT_799 = NL + "                            ";
  protected final String TEXT_800 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_801 = NL + "                            ";
  protected final String TEXT_802 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_803 = ";";
  protected final String TEXT_804 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_805 = NL + "                }" + NL + "                " + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_820 = NL + "    \t\tpstmt_";
  protected final String TEXT_821 = ".addBatch();" + NL + "\t\t\t";
  ...
  protected final String TEXT_842 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_843 = NL + "                        ";
  protected final String TEXT_844 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_845 = ";";
  protected final String TEXT_846 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_847 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_848 = NL + "            nb_line_";
  ...
  protected final String TEXT_854 = "Struct();";
  ...
  protected final String TEXT_861 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_862 = " <= batchSizeCounter_";
  protected final String TEXT_863 = ") {                ";
  protected final String TEXT_864 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_865 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_866 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_867 = ": pstmt_";
  protected final String TEXT_868 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_869 = " += (countEach_";
  protected final String TEXT_870 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_875 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_876 = " += countSum_";
  protected final String TEXT_877 = ";" + NL + "            \t    \t";
  protected final String TEXT_878 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_879 = " += countSum_";
  protected final String TEXT_880 = ";" + NL + "            \t    \t";
  protected final String TEXT_881 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_882 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_883 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_884 = NL + "                }";
  protected final String TEXT_885 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_886 = NL + "            commitCounter_";
  protected final String TEXT_887 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_888 = "<=commitCounter_";
  protected final String TEXT_889 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_890 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_891 = " = 0;" + NL + "            " + NL + "            }" + NL + "        ";
