...
public class TPostgresqlSCDELTBeginJava {
  ...
  protected final String TEXT_59 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_60 = " = \"public\";" + NL + "            if(schema_";
  protected final String TEXT_61 = " == null || schema_";
  protected final String TEXT_62 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_63 = " = conn_";
  protected final String TEXT_64 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_65 = " = stmtSchema_";
  protected final String TEXT_66 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_67 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_68 = " = rsSchema_";
  protected final String TEXT_69 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_70 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_71 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  protected final String TEXT_72 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_73 = " = rsTable_";
  protected final String TEXT_74 = ".getString(\"TABLE_NAME\");" + NL + "                String schemaName_";
  protected final String TEXT_75 = " = rsTable_";
  protected final String TEXT_76 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_77 = ".equals(";
  protected final String TEXT_78 = ") " + NL + "                \t&& (schemaName_";
  protected final String TEXT_79 = ".equals(schema_";
  protected final String TEXT_80 = ") || ((schema_";
  protected final String TEXT_81 = " == null || schema_";
  protected final String TEXT_82 = ".trim().length() == 0) && defaultSchema_";
  protected final String TEXT_83 = ".equals(schemaName_";
  protected final String TEXT_84 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_85 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_86 = ".close();";
  protected final String TEXT_87 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_95 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_98 = ".execute(\"";
  protected final String TEXT_99 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_100 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_110 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_111 = ".close();";
  protected final String TEXT_112 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_113 = " = conn_";
  protected final String TEXT_114 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_115 = ".executeUpdate(\"";
  protected final String TEXT_116 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_117 = ".close();";
  protected final String TEXT_118 = NL + "        System.out.println(\"[";
  protected final String TEXT_119 = "] table action ";
  protected final String TEXT_120 = " done\\n\");";
  protected final String TEXT_121 = NL + "        String updateForType1_";
  protected final String TEXT_122 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_123 = " + \"\\\" d SET ";
  ...
  protected final String TEXT_127 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_130 = ".executeUpdate(updateForType1_";
  protected final String TEXT_131 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_132 = ".close();";
  protected final String TEXT_133 = NL + "            System.out.println(\"[";
  protected final String TEXT_134 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_135 = " + \"\\ndone\");";
  protected final String TEXT_136 = NL + "        String updateForType2_";
  protected final String TEXT_137 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_138 = " + \"\\\" d SET \\\"";
  protected final String TEXT_139 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_140 = "\"))) + \"'";
  protected final String TEXT_141 = ", \\\"";
  protected final String TEXT_142 = "\\\" = 0";
  protected final String TEXT_143 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_144 = " + \"\\\" t WHERE ";
  ...
  protected final String TEXT_153 = NL + "            System.out.println(\"[";
  protected final String TEXT_154 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_155 = " + \"\\ndone\");";
  protected final String TEXT_156 = NL + "        String insertForType2_";
  protected final String TEXT_157 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_158 = " + \"\\\"(";
  protected final String TEXT_159 = "\\\"";
  protected final String TEXT_160 = "\\\", ";
  protected final String TEXT_161 = ") SELECT ";
  protected final String TEXT_162 = "NEXTVAL('\" + ";
  protected final String TEXT_163 = " + \"'), ";
  protected final String TEXT_164 = "t.";
  protected final String TEXT_165 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_166 = "\"))) + \"', NULL";
  protected final String TEXT_167 = ", 1";
  protected final String TEXT_168 = ", d.\\\"";
  protected final String TEXT_169 = "\\\" + 1";
  protected final String TEXT_170 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_171 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_172 = " + \"\\\" d WHERE ";
  ...
  protected final String TEXT_176 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_177 = " = conn_";
  protected final String TEXT_178 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_179 = ".executeUpdate(insertForType2_";
  protected final String TEXT_180 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_181 = ".close();";
  protected final String TEXT_182 = NL + "            System.out.println(\"[";
  protected final String TEXT_183 = "] type2 new active row sql\\n\" + insertForType2_";
  protected final String TEXT_184 = " + \"\\ndone\");";
  protected final String TEXT_185 = NL + "    String insert_";
  protected final String TEXT_186 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_187 = " + \"\\\"(";
  protected final String TEXT_188 = "\\\"";
  protected final String TEXT_189 = "\\\", ";
  protected final String TEXT_190 = ") SELECT ";
  protected final String TEXT_191 = "NEXTVAL('\" + ";
  protected final String TEXT_192 = " + \"'), ";
  protected final String TEXT_193 = "t.";
  protected final String TEXT_194 = "\"";
  protected final String TEXT_195 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_196 = "\"))) + \"', NULL\"";
  protected final String TEXT_197 = NL + "    + \"";
  protected final String TEXT_198 = ", 1";
  protected final String TEXT_199 = ", 1";
  protected final String TEXT_200 = " FROM \\\"\" + " + NL + "    sourceTable_";
  protected final String TEXT_201 = " + \"\\\" t LEFT JOIN \\\"\" + tableName_";
  protected final String TEXT_202 = " + \"\\\" d ON ";
  protected final String TEXT_203 = " WHERE (";
  protected final String TEXT_204 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_207 = ".executeUpdate(insert_";
  protected final String TEXT_208 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_209 = ".close();";
  protected final String TEXT_210 = NL + "        System.out.println(\"[";
  protected final String TEXT_211 = "] new rows sql\\n\" + insert_";
