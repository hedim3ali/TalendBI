...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_40 = NL + "                            rejectedCount_";
  protected final String TEXT_41 = " = rejectedCount_";
  protected final String TEXT_42 = " + 1;";
  ...
  protected final String TEXT_61 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_62 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_63 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_64 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_65 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_66 = NL + "            try{" + NL + "                nb_line_";
  ...
  protected final String TEXT_70 = ".executeUpdate();" + NL + "            }catch(java.lang.Exception e)" + NL + "            {" + NL + "                whetherReject_";
  protected final String TEXT_71 = " = true;";
  protected final String TEXT_72 = NL + "\t                ";
  protected final String TEXT_73 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_74 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_75 = NL + "                    throw(e);";
  protected final String TEXT_76 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_77 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_103 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_104 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_105 = ".next())" + NL + "    \t\t{" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_106 = " = rs_";
  protected final String TEXT_107 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_108 = " > 0)" + NL + "    \t\t{" + NL + "    \t\t\t";
  ...
  protected final String TEXT_121 = ".executeUpdate();" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  protected final String TEXT_122 = " = true;";
  protected final String TEXT_123 = NL + "\t\t                ";
  protected final String TEXT_124 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_125 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_126 = NL + "                        throw(e);";
  protected final String TEXT_127 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_128 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_141 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_146 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\telse" + NL + "    \t\t{" + NL + "    \t\t\t";
  ...
  protected final String TEXT_152 = ".executeUpdate();" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  protected final String TEXT_153 = " = true;";
  protected final String TEXT_154 = NL + "\t\t                ";
  protected final String TEXT_155 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  ...
  protected final String TEXT_159 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_168 = NL + "                            rejectedCount_";
  protected final String TEXT_169 = " = rejectedCount_";
  protected final String TEXT_170 = " + 1;";
  protected final String TEXT_171 = NL + "                            ";
  protected final String TEXT_172 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_177 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_178 = "++;" + NL + "    \t\t";
  protected final String TEXT_179 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_190 = NL + "    \t" + NL + "            try{" + NL + "                updateFlag_";
  protected final String TEXT_191 = "=pstmtUpdate_";
  protected final String TEXT_192 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_193 = " = updatedCount_";
  protected final String TEXT_194 = "+updateFlag_";
  protected final String TEXT_195 = ";" + NL + "                " + NL + "            }catch(java.lang.Exception e)" + NL + "            {" + NL + "                whetherReject_";
  protected final String TEXT_196 = " = true;";
  protected final String TEXT_197 = NL + "\t                ";
  protected final String TEXT_198 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  ...
  protected final String TEXT_202 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_215 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_216 = NL + "                        ";
  protected final String TEXT_217 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_218 = ";";
  protected final String TEXT_219 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_220 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_221 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_222 = NL + "        \t\t\t    ";
  protected final String TEXT_223 = NL + "        \t\t\t    ";
  protected final String TEXT_224 = NL + "                try{" + NL + "                    insertedCount_";
  protected final String TEXT_225 = " = insertedCount_";
  protected final String TEXT_226 = " + pstmtInsert_";
  protected final String TEXT_227 = ".executeUpdate();" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_234 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_260 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_261 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_262 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_263 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_264 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_265 = NL + "        try{" + NL + "    \t    deletedCount_";
  protected final String TEXT_266 = " = deletedCount_";
  protected final String TEXT_267 = " + pstmt_";
  protected final String TEXT_268 = ".executeUpdate();" + NL + "        }catch(java.lang.Exception e)" + NL + "        {" + NL + "            whetherReject_";
  protected final String TEXT_269 = " = true;";
  protected final String TEXT_270 = NL + "\t            ";
  protected final String TEXT_271 = NL + "\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_272 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_273 = NL + "                throw(e);";
  protected final String TEXT_274 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_275 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_293 = NL + "        }" + NL + "        nb_line_";
  protected final String TEXT_294 = "++;" + NL + "\t\t\t";
  protected final String TEXT_295 = NL + "    \t";
  protected final String TEXT_296 = NL + "                log4jSb_";
  protected final String TEXT_297 = ".append(";
  protected final String TEXT_298 = ".";
  protected final String TEXT_299 = ");";
  protected final String TEXT_300 = NL + "                \tlog4jSb_";
  protected final String TEXT_301 = ".append(\"|\");";
  protected final String TEXT_302 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_303 = " - Writing the record \" + nb_line_";
  protected final String TEXT_304 = " + \" \" + log4jSb_";
  protected final String TEXT_305 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_306 = ".delete(0,log4jSb_";
  protected final String TEXT_307 = ".length());" + NL + "\t\t";
  ...
  protected final String TEXT_319 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_320 = " <= batchSizeCounter_";
  protected final String TEXT_321 = ") {                ";
  protected final String TEXT_322 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_323 = " = 0;" + NL + "            \t \t\t";
  protected final String TEXT_324 = NL + "    \t\t\t\t\tlog.debug(\"";
  protected final String TEXT_325 = " - Executing the ";
  protected final String TEXT_326 = " batch.\");" + NL + "    \t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_328 = ".executeBatch();                \t" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_329 = ".clearBatch();" + NL + "\t\t\t    \t\t";
  protected final String TEXT_330 = NL + "\t\t\t    \t\tlog.debug(\"";
  protected final String TEXT_331 = " - The ";
  protected final String TEXT_332 = " batch execution has succeeded.\");" + NL + "\t\t\t    \t\t";
  protected final String TEXT_333 = NL + "            \t    \t";
  protected final String TEXT_334 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_335 = " += pstmt_";
  protected final String TEXT_336 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_337 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_338 = " += pstmt_";
  protected final String TEXT_339 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_340 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_341 = " += pstmt_";
  protected final String TEXT_342 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_343 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_344 = NL + "\t\t                ";
  protected final String TEXT_345 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_346 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_348 = NL + "\t                ";
  protected final String TEXT_349 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_350 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_351 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_352 = NL + "                " + NL + "                }catch (java.sql.SQLException e){" + NL + "\t                ";
  protected final String TEXT_353 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_354 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_355 = NL + "                \t";
  protected final String TEXT_356 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_357 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_358 = NL + "                }";
  protected final String TEXT_359 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_360 = NL + "        \t    commitCounter_";
  protected final String TEXT_361 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_362 = " <= commitCounter_";
  protected final String TEXT_363 = "){" + NL + "\t\t\t\t";
  protected final String TEXT_364 = NL + "                try {" + NL + "            \t \t\t";
  protected final String TEXT_365 = NL + "    \t\t\t\t\tlog.debug(\"";
  protected final String TEXT_366 = " - Executing the ";
  protected final String TEXT_367 = " batch.\");" + NL + "    \t\t\t\t\t";
  protected final String TEXT_368 = NL + "                \t\tpstmt_";
  protected final String TEXT_369 = ".executeBatch();" + NL + "                \t\tpstmt_";
  protected final String TEXT_370 = ".clearBatch();" + NL + "\t\t\t    \t\t";
  protected final String TEXT_371 = NL + "\t\t\t    \t\tlog.debug(\"";
  protected final String TEXT_372 = " - The ";
  protected final String TEXT_373 = " batch execution has succeeded.\");" + NL + "\t\t\t    \t\t";
  protected final String TEXT_374 = NL + "            \t    \t";
  protected final String TEXT_375 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_376 = " += pstmt_";
  protected final String TEXT_377 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_378 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_379 = " += pstmt_";
  protected final String TEXT_380 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_381 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_382 = " += pstmt_";
  protected final String TEXT_383 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_384 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_385 = NL + "\t\t                ";
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_387 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_389 = NL + "\t\t                ";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_391 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_393 = NL + "                " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  ...
  protected final String TEXT_405 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_406 = " + \" records.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_407 = NL + "                \tconn_";
  protected final String TEXT_408 = ".commit();" + NL + "\t\t\t\t\t";
  protected final String TEXT_409 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_410 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_411 = NL + "                \tcommitCounter_";
  protected final String TEXT_412 = "=0;" + NL + "                " + NL + "                }\t" + NL + "    " + NL + "    \t";
