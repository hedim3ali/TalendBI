...
public class TSAPOutputBeginJava
{
  ...
  protected final String TEXT_30 = NL + "\t\tcom.sap.mw.jco.JCO.setMiddlewareProperty(\"jco.middleware.allow_start_of_programs\", \"ftp;sapftp;sapftpa;sapkprotp;http;saphttp;saphttpa\");" + NL + "\t\tclient_";
  protected final String TEXT_31 = ".setSapGui(2);" + NL + "\t\t";
  protected final String TEXT_32 = NL + "\t";
  protected final String TEXT_33 = " \t" + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_34 = "\", client_";
  protected final String TEXT_35 = ");" + NL + "      " + NL + "    com.sap.mw.jco.IRepository repository_";
  protected final String TEXT_36 = " = com.sap.mw.jco.JCO.createRepository(\"REPOSITORY\", client_";
  protected final String TEXT_37 = ");" + NL + "" + NL + "    com.sap.mw.jco.IFunctionTemplate functionTemplate_";
  protected final String TEXT_38 = " = repository_";
  protected final String TEXT_39 = ".getFunctionTemplate(";
  protected final String TEXT_40 = ");" + NL + "" + NL + "\tif(functionTemplate_";
  protected final String TEXT_41 = " == null){" + NL + "\t\tcom.sap.mw.jco.JCO.releaseClient(client_";
  protected final String TEXT_42 = ");" + NL + "\t\tthrow new RuntimeException(\"The RFC can't support the function: \" + ";
  protected final String TEXT_43 = " + \".\");" + NL + "\t}      " + NL + "\t" + NL + "    com.sap.mw.jco.JCO.Function function_";
  protected final String TEXT_44 = " = functionTemplate_";
  protected final String TEXT_45 = ".getFunction();" + NL + "" + NL + "    com.sap.mw.jco.JCO.ParameterList importParameterList_";
  protected final String TEXT_46 = " = function_";
  protected final String TEXT_47 = ".getImportParameterList();" + NL + "    com.sap.mw.jco.JCO.ParameterList exportParameterList_";
  protected final String TEXT_48 = " = function_";
  protected final String TEXT_49 = ".getExportParameterList();" + NL + "    com.sap.mw.jco.JCO.ParameterList tableParameterList_";
  protected final String TEXT_50 = " = function_";
  protected final String TEXT_51 = ".getTableParameterList();" + NL + "    " + NL + "    com.sap.mw.jco.JCO.Structure input_structure_";
  protected final String TEXT_52 = "=null;" + NL + "    com.sap.mw.jco.JCO.Table input_table_";
  protected final String TEXT_53 = "=null; " + NL + "    com.sap.mw.jco.JCO.Table table_input_";
  protected final String TEXT_54 = "=null; ";
  protected final String TEXT_55 = NL + "\tcom.sap.conn.jco.JCoDestination dest_";
  protected final String TEXT_56 = " = null;" + NL + "\t";
  protected final String TEXT_57 = "\t" + NL + "\t\tdest_";
  protected final String TEXT_58 = " = (com.sap.conn.jco.JCoDestination)globalMap.get(\"conn_";
  protected final String TEXT_59 = "\");" + NL + "\t";
  protected final String TEXT_60 = NL + "\t\torg.talend.sap.TalendDestinationData destinationData_";
  ...
  protected final String TEXT_94 = ");" + NL + "\tcom.sap.conn.jco.JCoRepository repository_";
  protected final String TEXT_95 = " = dest_";
  protected final String TEXT_96 = ".getRepository();" + NL + "\t" + NL + "\tcom.sap.conn.jco.JCoFunctionTemplate functionTemplate_";
  protected final String TEXT_97 = " = repository_";
  protected final String TEXT_98 = ".getFunctionTemplate(";
  protected final String TEXT_99 = ");" + NL + "\tif(functionTemplate_";
  protected final String TEXT_100 = " == null){" + NL + "\t\tcom.sap.conn.jco.JCoContext.end(dest_";
  protected final String TEXT_101 = ");" + NL + "\t\tthrow new RuntimeException(\"The RFC can't support the function: \" + ";
  protected final String TEXT_102 = " + \".\");" + NL + "\t}  " + NL + "\tcom.sap.conn.jco.JCoFunction function_";
  protected final String TEXT_103 = " = functionTemplate_";
  protected final String TEXT_104 = ".getFunction();" + NL + "\t" + NL + "\tcom.sap.conn.jco.JCoParameterList importParameterList_";
  protected final String TEXT_105 = " = function_";
  protected final String TEXT_106 = ".getImportParameterList();" + NL + "    com.sap.conn.jco.JCoParameterList exportParameterList_";
  protected final String TEXT_107 = " = function_";
  protected final String TEXT_108 = ".getExportParameterList();" + NL + "    com.sap.conn.jco.JCoParameterList tableParameterList_";
  protected final String TEXT_109 = " = function_";
  protected final String TEXT_110 = ".getTableParameterList();" + NL + "    " + NL + "    com.sap.conn.jco.JCoStructure input_structure_";
  protected final String TEXT_111 = "=null;" + NL + "    com.sap.conn.jco.JCoTable input_table_";
  protected final String TEXT_112 = "=null; " + NL + "    com.sap.conn.jco.JCoTable table_input_";
