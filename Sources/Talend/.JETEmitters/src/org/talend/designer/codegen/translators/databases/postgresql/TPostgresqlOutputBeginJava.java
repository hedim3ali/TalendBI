...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_80 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_86 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_91 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_92 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_93 = " - Creating table '\" + tableName_";
  protected final String TEXT_94 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_96 = ".execute((\"";
  protected final String TEXT_97 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_107 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_115 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_142 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_145 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_146 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_147 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_148 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_149 = ")== null){";
  protected final String TEXT_150 = "              ";
  protected final String TEXT_151 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_154 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_158 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_163 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_164 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_165 = " = tableNameForSearch_";
  protected final String TEXT_166 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_167 = " = tableNameForSearch_";
  protected final String TEXT_168 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_172 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_173 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_174 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_175 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_218 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_219 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_228 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_229 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_230 = " == null || dbschema_";
  protected final String TEXT_231 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_234 = " = stmtSchema_";
  protected final String TEXT_235 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_236 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_237 = " = rsSchema_";
  protected final String TEXT_238 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_239 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_240 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_255 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_256 = ".equals";
  protected final String TEXT_257 = "IgnoreCase";
  protected final String TEXT_258 = "(schema_";
  ...
  protected final String TEXT_280 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_294 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_303 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_309 = " - Drop table '\" + tableName_";
  protected final String TEXT_310 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_316 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_326 = ".execute(\"";
  protected final String TEXT_327 = ")\");";
  protected final String TEXT_328 = NL + "\t    \t    \t";
  protected final String TEXT_329 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_330 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_341 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_353 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_354 = " = stmtTruncCount_";
  protected final String TEXT_355 = ".executeQuery(\"";
  protected final String TEXT_356 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_360 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_366 = ".executeUpdate(\"";
  protected final String TEXT_367 = "\");" + NL + "   \t    \t";
  protected final String TEXT_368 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_369 = " - Truncate table '\" + tableName_";
  protected final String TEXT_370 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_371 = NL + "            while(rsTruncCount_";
  protected final String TEXT_372 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_376 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_387 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_396 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_409 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_417 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_423 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_429 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_434 = " + \"\\\" SET ";
  protected final String TEXT_435 = " WHERE ";
  protected final String TEXT_436 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_444 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_455 = NL + "\t    String delete_";
  protected final String TEXT_456 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_492 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_493 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  ...
  protected final String TEXT_498 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_499 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
