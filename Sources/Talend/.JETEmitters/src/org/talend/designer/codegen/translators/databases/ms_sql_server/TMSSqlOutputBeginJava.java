...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_87 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_88 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_89 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_95 = " - Drop table '\" + tableName_";
  protected final String TEXT_96 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_97 = NL + "            stmtDrop_";
  protected final String TEXT_98 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_102 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_116 = " - Create table '\" + tableName_";
  protected final String TEXT_117 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_124 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_143 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_144 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_153 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_154 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_155 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_156 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_157 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_158 = ")== null){";
  protected final String TEXT_159 = "              ";
  protected final String TEXT_160 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_161 = " = conn_";
  protected final String TEXT_162 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_163 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_164 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_165 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_166 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_167 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_201 = ".equals";
  protected final String TEXT_202 = "IgnoreCase";
  ...
  protected final String TEXT_228 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_308 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_312 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_318 = " - Drop table '\" + tableName_";
  protected final String TEXT_319 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_320 = NL + "                    stmtDrop_";
  protected final String TEXT_321 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_325 = " - Creating table '\" + tableName_";
  protected final String TEXT_326 = " + \"'.\" );" + NL + "\t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_328 = ".execute((\"";
  protected final String TEXT_329 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_339 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_343 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_344 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_350 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_356 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_360 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_361 = " = conn_";
  protected final String TEXT_362 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_363 = " = stmtTruncCount_";
  protected final String TEXT_364 = ".executeQuery(\"";
  protected final String TEXT_365 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_366 = " = conn_";
  protected final String TEXT_367 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_368 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_369 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_378 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_396 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_405 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_419 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_420 = " = conn_";
  protected final String TEXT_421 = ".prepareStatement(insert_";
  protected final String TEXT_422 = ");";
  protected final String TEXT_423 = NL + "        ";
  protected final String TEXT_424 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_425 = " = null;    " + NL + "\t\tString keyPsmt_";
  protected final String TEXT_426 = " = conn_";
  protected final String TEXT_427 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_428 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_429 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_430 = ",insert_";
  protected final String TEXT_431 = ",keyPsmt_";
  ...
  protected final String TEXT_494 = NL + "    \t" + NL + "    class BufferLine_";
  protected final String TEXT_495 = " {";
  protected final String TEXT_496 = NL + "                ";
  protected final String TEXT_497 = " ";
  protected final String TEXT_498 = ";                ";
  protected final String TEXT_499 = "   " + NL + "    " + NL + "        public BufferLine_";
  protected final String TEXT_500 = "(";
  protected final String TEXT_501 = NL + "                    ,";
  protected final String TEXT_502 = NL + "                ";
  protected final String TEXT_503 = " ";
  protected final String TEXT_504 = " " + NL + "        ){";
  protected final String TEXT_505 = NL + "                    this.";
  protected final String TEXT_506 = " = ";
  protected final String TEXT_507 = ";              ";
  protected final String TEXT_508 = "   \t                " + NL + "        }" + NL + "    }" + NL + "    " + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_509 = "> sInsertColValueList";
  protected final String TEXT_510 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_511 = " sInsertColValue";
  protected final String TEXT_512 = " = null; " + NL + "    " + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_513 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_514 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_515 = ".append(\"(";
  protected final String TEXT_516 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_517 = "-1) extendInsertValueStmt_";
  protected final String TEXT_518 = ".append(\",\");" + NL + "    }" + NL + "   " + NL + "\tString insert_";
  protected final String TEXT_519 = " = \"INSERT INTO \"+";
  protected final String TEXT_520 = "+\" (";
  protected final String TEXT_521 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_522 = ".toString();" + NL + "\t" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_523 = " =  conn_";
  protected final String TEXT_524 = ".prepareStatement(insert_";
  protected final String TEXT_525 = ");" + NL + "      " + NL + "    String insertColName";
  protected final String TEXT_526 = " = \"";
  protected final String TEXT_527 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_528 = " =  \"";
  protected final String TEXT_529 = "\"; " + NL + "    int rowCount";
  ...
  protected final String TEXT_561 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_562 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_563 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_564 = "\") == true;";
  protected final String TEXT_565 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_566 = " = conn_";
  protected final String TEXT_567 = ".createStatement();";
  ...
  protected final String TEXT_572 = NL + "     \t\tstmt_";
  protected final String TEXT_573 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_574 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_575 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_576 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_577 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
