...
public class TVectorWiseOutputMainJava {
  ...
  protected final String TEXT_34 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_83 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_84 = " = pstmt_";
  protected final String TEXT_85 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_86 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_87 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_88 = " = rs_";
  protected final String TEXT_89 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_109 = " + pstmtUpdate_";
  ...
  protected final String TEXT_135 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_136 = " = insertedCount_";
  protected final String TEXT_137 = " + pstmtInsert_";
  protected final String TEXT_138 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_150 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_176 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_177 = "=pstmtUpdate_";
  protected final String TEXT_178 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_179 = " = updatedCount_";
  protected final String TEXT_180 = " + updateFlag_";
  protected final String TEXT_181 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_198 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_199 = " == 0) {" + NL + "            \t";
  protected final String TEXT_200 = NL + "\t\t\t\tquery_";
  protected final String TEXT_201 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_209 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_210 = " = insertedCount_";
  protected final String TEXT_211 = " + pstmtInsert_";
  protected final String TEXT_212 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_229 = NL + "                }" + NL + "            }" + NL + "           " + NL + "            nb_line_";
  ...
  protected final String TEXT_241 = "_QUERY\", query_";
  protected final String TEXT_242 = ".toString().trim());";
  ...
  protected final String TEXT_246 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_258 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_263 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_264 = "++;";
  protected final String TEXT_265 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_276 = NL + "\t            commitCounter_";
  protected final String TEXT_277 = "++;" + NL + "\t            " + NL + "\t            if(commitEvery_";
  protected final String TEXT_278 = " <= commitCounter_";
  protected final String TEXT_279 = ") {" + NL + "\t            " + NL + "\t                conn_";
  protected final String TEXT_280 = ".commit();" + NL + "\t                " + NL + "\t                commitCounter_";
  protected final String TEXT_281 = "=0;" + NL + "\t            " + NL + "\t            }" + NL + "\t        " + NL + "\t        ";
