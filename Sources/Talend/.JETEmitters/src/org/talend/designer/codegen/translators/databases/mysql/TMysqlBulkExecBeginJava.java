...
public class TMysqlBulkExecBeginJava {
  ...
  protected final String TEXT_90 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_94 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_95 = ".equals(schema_";
  protected final String TEXT_96 = ") || (schema_";
  protected final String TEXT_97 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_98 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_107 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_108 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_109 = " == null || dbschema_";
  protected final String TEXT_110 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_111 = " = conn_";
  protected final String TEXT_112 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_113 = " = stmtSchema_";
  protected final String TEXT_114 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_115 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_116 = " = rsSchema_";
  protected final String TEXT_117 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_118 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_119 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_134 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_135 = ".equals";
  protected final String TEXT_136 = "IgnoreCase";
  protected final String TEXT_137 = "(schema_";
  ...
  protected final String TEXT_149 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_172 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_178 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_182 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_185 = " = stmtTruncCount_";
  protected final String TEXT_186 = ".executeQuery(\"";
  protected final String TEXT_187 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_190 = ".executeUpdate(\"";
  protected final String TEXT_191 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_192 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_193 = " += rsTruncCount_";
  protected final String TEXT_194 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_195 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_196 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_197 = ".close();            ";
  protected final String TEXT_198 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_199 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_200 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_201 = " " + NL + "String lines_separator_";
  protected final String TEXT_202 = " = ";
  protected final String TEXT_203 = ";" + NL + "String field_separator_";
  protected final String TEXT_204 = " = ";
  protected final String TEXT_205 = ";" + NL + "String escaped_str_";
  protected final String TEXT_206 = " = ";
  protected final String TEXT_207 = ";" + NL + "String enclosed_str_";
  protected final String TEXT_208 = " = ";
  protected final String TEXT_209 = ";" + NL + "String file_";
  protected final String TEXT_210 = " = ";
  protected final String TEXT_211 = ";" + NL + "file_";
  protected final String TEXT_212 = " = file_";
  protected final String TEXT_213 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "String replace_";
  protected final String TEXT_214 = " = null;";
  protected final String TEXT_215 = NL + "        int keyCount_";
  protected final String TEXT_216 = " = ";
  protected final String TEXT_217 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_218 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }        " + NL + "        tableName_";
  protected final String TEXT_219 = " = \"tmp_";
  protected final String TEXT_220 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtTmpCreate_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".createStatement();" + NL + "        stmtTmpCreate_";
  protected final String TEXT_223 = ".execute(\"";
  protected final String TEXT_224 = ")\");" + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_227 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_228 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_229 = ".execute(" + NL + "            \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_230 = " + \"' \"  " + NL + "            + \" INTO TABLE \" + tableName_";
  protected final String TEXT_231 = NL + "            + \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_232 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "            + \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_233 = ")?\"\\\\\":\"\")+ enclosed_str_";
  protected final String TEXT_234 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "            + \" ESCAPED BY '\" +(\"'\".equals(escaped_str_";
  protected final String TEXT_235 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_236 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\")+ \"'\"" + NL + "            + \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_237 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_238 = "\"    ";
  protected final String TEXT_239 = NL + "\t\t\t+ \" SET\"";
  protected final String TEXT_240 = NL + "\t\t\t+ \" ";
  protected final String TEXT_241 = "=CAST(@";
  protected final String TEXT_242 = "_";
  protected final String TEXT_243 = " AS UNSIGNED)\"";
  protected final String TEXT_244 = NL + "\t\t\t+ \",\"\t";
  protected final String TEXT_245 = "          " + NL + "        );" + NL + "        tableName_";
  protected final String TEXT_246 = " = ";
  protected final String TEXT_247 = ";" + NL + "        String tmpTableName_";
  protected final String TEXT_248 = " = \"tmp_";
  protected final String TEXT_249 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_250 = " = conn_";
  protected final String TEXT_251 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_252 = ".executeUpdate(\"";
  protected final String TEXT_253 = "\");" + NL + "        tableName_";
  protected final String TEXT_254 = " = tmpTableName_";
  protected final String TEXT_255 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_258 = ".execute(\"";
  protected final String TEXT_259 = "\");";
  protected final String TEXT_260 = NL + "        replace_";
  protected final String TEXT_261 = " = \"REPLACE\";";
  protected final String TEXT_262 = NL + "        replace_";
  protected final String TEXT_263 = " = \"IGNORE\";";
  protected final String TEXT_264 = NL + "        replace_";
  protected final String TEXT_265 = " = \"\";";
  protected final String TEXT_266 = NL + "    java.sql.Statement stmt_";
  protected final String TEXT_267 = "=conn_";
  protected final String TEXT_268 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_269 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_270 = ");" + NL + "    stmt_";
  protected final String TEXT_271 = ".execute(" + NL + "        \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_272 = " + \"' \" " + NL + "        + replace_";
  protected final String TEXT_273 = " " + NL + "        + \" INTO TABLE \" + tableName_";
  protected final String TEXT_274 = NL + "        + \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_275 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "        + \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_276 = ")?\"\\\\\":\"\") + enclosed_str_";
  protected final String TEXT_277 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "        + \" ESCAPED BY '\" + (\"'\".equals(escaped_str_";
  protected final String TEXT_278 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_279 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "        + \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_280 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_281 = "\"  ";
  protected final String TEXT_282 = NL + "\t\t+ \" SET\"";
  protected final String TEXT_283 = NL + "\t\t+ \" ";
  protected final String TEXT_284 = "=CAST(@";
  protected final String TEXT_285 = "_";
  protected final String TEXT_286 = " AS UNSIGNED)\"";
