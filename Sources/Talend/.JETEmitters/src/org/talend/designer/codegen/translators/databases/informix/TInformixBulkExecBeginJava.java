...
public class TInformixBulkExecBeginJava {
  ...
  protected final String TEXT_110 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_114 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_115 = ".equals(schema_";
  protected final String TEXT_116 = ") || (schema_";
  protected final String TEXT_117 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_118 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_127 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_128 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_129 = " == null || dbschema_";
  protected final String TEXT_130 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_137 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_138 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_139 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  protected final String TEXT_140 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_141 = " = rsTable_";
  protected final String TEXT_142 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  ...
  protected final String TEXT_180 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_185 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_188 = ".execute(\"";
  protected final String TEXT_189 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_190 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_196 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_202 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_205 = " = stmtTruncCount_";
  protected final String TEXT_206 = ".executeQuery(\"";
  protected final String TEXT_207 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_210 = ".executeUpdate(\"";
  protected final String TEXT_211 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_212 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_213 = " += rsTruncCount_";
  protected final String TEXT_214 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_215 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_216 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_217 = ".close();            ";
  protected final String TEXT_218 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_219 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_220 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_221 = NL + NL + "\t\tString fileName_";
  protected final String TEXT_222 = " = ";
  protected final String TEXT_223 = ";" + NL + "\t\tString cmdFile_";
  protected final String TEXT_224 = " = fileName_";
  protected final String TEXT_225 = " + \".cmd\";" + NL + "\t\tString logFile_";
  protected final String TEXT_226 = " = fileName_";
  protected final String TEXT_227 = " + \".log\";" + NL + "\t\t" + NL + " \t\tjava.io.BufferedWriter bw_";
  protected final String TEXT_228 = " = new java.io.BufferedWriter(new java.io.FileWriter(cmdFile_";
  protected final String TEXT_229 = "));" + NL + "    \tjava.io.PrintWriter pw_";
  protected final String TEXT_230 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_231 = " ,false) ;" + NL + "    \t//file \"c:\\informix_bulk.txt\" delimiter \"|\" 7 ;insert into feature9999;" + NL + "    \tpw_";
  protected final String TEXT_232 = ".print(\"FILE \\\"\" + ";
  protected final String TEXT_233 = " + \"\\\"\" );" + NL + "    \tpw_";
  protected final String TEXT_234 = ".print(\" DELIMITER \\\"\" + ";
  protected final String TEXT_235 = " + \"\\\"\");" + NL + "    \tpw_";
  protected final String TEXT_236 = ".println(\" \" + ";
  protected final String TEXT_237 = " +\" ;\" );";
  protected final String TEXT_238 = NL + "\t\tpw_";
  protected final String TEXT_239 = ".println(\"INSERT INTO \" + tableName_";
  protected final String TEXT_240 = " + \"(";
  protected final String TEXT_241 = ");\" );";
  protected final String TEXT_242 = NL + "\tbw_";
  protected final String TEXT_243 = ".close();" + NL + "\tpw_";
  protected final String TEXT_244 = ".close();" + NL + "\t//-----------------------dbload command" + NL + "\tStringBuilder command_";
  protected final String TEXT_245 = " =  new StringBuilder();" + NL + "\t//-------------------------1. add dbload cmd";
  protected final String TEXT_246 = NL + "\tcommand_";
  protected final String TEXT_247 = ".append(\"dbload \");";
  protected final String TEXT_248 = NL + "\tcommand_";
  protected final String TEXT_249 = ".append(\"./dbload \");";
  protected final String TEXT_250 = NL + "\t//-------------------------2.add database name" + NL + "\tcommand_";
  protected final String TEXT_251 = ".append(\"-d \" + dbName_";
  protected final String TEXT_252 = " + \" \");" + NL + "\t//-------------------------3.add command file" + NL + "\tcommand_";
  protected final String TEXT_253 = ".append(\"-c \" + cmdFile_";
  protected final String TEXT_254 = " + \" \");" + NL + "\t//-------------------------4.add  error log file" + NL + "\tcommand_";
  protected final String TEXT_255 = ".append(\"-l \" + logFile_";
  protected final String TEXT_256 = " + \" \");" + NL + "\t//-------------------------5.add  bad rows before abort" + NL + "\tcommand_";
  protected final String TEXT_257 = ".append(\"-e \" + ";
  protected final String TEXT_258 = " + \" \");" + NL + "\t//-------------------------6.add commit interval" + NL + "\tcommand_";
  protected final String TEXT_259 = ".append(\"-n \" + ";
  protected final String TEXT_260 = " + \";\"); " + NL + "\t" + NL + "\t//----------------get envionment variables";
  protected final String TEXT_261 = NL + "\tProcess ev_";
  protected final String TEXT_262 = " = Runtime.getRuntime().exec(\"cmd /c set\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_263 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_264 = ".getInputStream()));";
  protected final String TEXT_265 = NL + NL + "\tProcess ev_";
  protected final String TEXT_266 = " = Runtime.getRuntime().exec(\"env\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_267 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_268 = ".getInputStream()));";
  protected final String TEXT_269 = NL + "\tjava.util.List<String> evPara_";
  protected final String TEXT_270 = " = new java.util.ArrayList();" + NL + "\tString line_";
  protected final String TEXT_271 = " = null;" + NL + "\twhile((line_";
  protected final String TEXT_272 = " = evReader_";
  protected final String TEXT_273 = ".readLine()) != null) {" + NL + "\t   evPara_";
  protected final String TEXT_274 = ".add(line_";
  protected final String TEXT_275 = ");" + NL + "\t}" + NL + "\tevReader_";
  protected final String TEXT_276 = ".close();" + NL + "" + NL + "\tevPara_";
  protected final String TEXT_277 = ".add(\"INFORMIXDIR=\" + ";
  protected final String TEXT_278 = ");" + NL + "\tevPara_";
  protected final String TEXT_279 = ".add(\"INFORMIXSERVER=\" + dbServer_";
  protected final String TEXT_280 = ");" + NL + "\tevPara_";
  protected final String TEXT_281 = ".add(\"DBDATE=\" + \"";
  protected final String TEXT_282 = "\");" + NL + "\t";
  protected final String TEXT_283 = NL + "\tevPara_";
  protected final String TEXT_284 = ".add(\"DBMONEY=\" + ";
  protected final String TEXT_285 = ");";
  protected final String TEXT_286 = NL + "\t//----------------get envionment variables end" + NL + "\t" + NL + "\t//------------------get dbload directory" + NL + "\tjava.io.File dbLoadDirectory_";
  protected final String TEXT_287 = " = new java.io.File (";
  protected final String TEXT_288 = "+\"/bin\");" + NL + "\tdbLoadDirectory_";
  protected final String TEXT_289 = ".exists();" + NL + "\t\t\t\t" + NL + " \tRuntime runtime_";
  protected final String TEXT_290 = " = Runtime.getRuntime();";
  protected final String TEXT_291 = NL + "\tfinal Process ps_";
  protected final String TEXT_292 = " = runtime_";
  protected final String TEXT_293 = ".exec(new String[]{\"cmd.exe\",\"/c\",command_";
  protected final String TEXT_294 = ".toString()}," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_295 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_296 = ");";
  protected final String TEXT_297 = NL + "\tfinal Process ps_";
  protected final String TEXT_298 = " = runtime_";
  protected final String TEXT_299 = ".exec(command_";
  protected final String TEXT_300 = ".toString()," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_301 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_302 = ");";
  protected final String TEXT_303 = NL;
  protected final String TEXT_304 = NL + NL + "Thread normal_";
  protected final String TEXT_305 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_306 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_307 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_308 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_309 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_310 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_311 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_312 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_313 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_314 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_315 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_316 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_317 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_318 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_319 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_320 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_321 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_322 = ".interrupt();" + NL + "error_";
  protected final String TEXT_323 = ".interrupt();" + NL + NL + NL + NL;
