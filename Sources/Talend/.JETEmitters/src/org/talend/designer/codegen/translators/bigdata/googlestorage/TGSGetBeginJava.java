...
public class TGSGetBeginJava
{
  ...
  protected final String TEXT_88 = ".get(\"OBJECT_DELIMITER\"));" + NL + "\t\t\t\t}catch(org.jets3t.service.ServiceException e_";
  protected final String TEXT_89 = "){";
  protected final String TEXT_90 = NL + "\t\t\t\t\tthrow(e_";
  protected final String TEXT_91 = ");";
  protected final String TEXT_92 = NL + "\t\t\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_93 = ":\");" + NL + "\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_94 = ".getMessage());" + NL + "\t\t\t\t\tif(e_";
  protected final String TEXT_95 = ".getErrorCode()!=null){" + NL + "\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_96 = ".getErrorCode());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif(e_";
  protected final String TEXT_97 = ".getErrorMessage()!=null){" + NL + "\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_98 = ".getErrorMessage());" + NL + "\t\t\t\t\t}";
  protected final String TEXT_99 = NL + "\t\t\t\t}";
  protected final String TEXT_100 = NL + "\t\t\t\tfor (org.jets3t.service.model.GSObject objectSummary_";
  protected final String TEXT_101 = " : objects_";
  protected final String TEXT_102 = ") {" + NL + "\t\t\t\t\tString objkey_";
  protected final String TEXT_103 = " = objectSummary_";
  protected final String TEXT_104 = ".getKey();" + NL + "\t\t\t\t\tjava.io.File file_";
  protected final String TEXT_105 = " = new java.io.File(";
  protected final String TEXT_106 = "+objkey_";
  protected final String TEXT_107 = ");" + NL + "\t\t\t\t\torg.jets3t.service.model.GSObject obj_";
  protected final String TEXT_108 = " = service_";
  protected final String TEXT_109 = ".getObject(currentBucketName_";
  protected final String TEXT_110 = ", objkey_";
  protected final String TEXT_111 = ");";
  protected final String TEXT_112 = NL + "\t\t\t\tfor (java.util.Map<String, String> map_";
  protected final String TEXT_113 = ": list_";
  protected final String TEXT_114 = ") {" + NL + "\t\t\t\t\tString currentBucketName_";
  protected final String TEXT_115 = "=map_";
  protected final String TEXT_116 = ".get(\"BUCKET_NAME\");" + NL + "\t\t\t\t\tjava.io.File file_";
  protected final String TEXT_117 = " = new java.io.File(";
  protected final String TEXT_118 = "+map_";
  protected final String TEXT_119 = ".get(\"OBJECT_NEWNAME\"));" + NL + "\t\t\t\t\torg.jets3t.service.model.GSObject obj_";
  protected final String TEXT_120 = " =null;" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\tobj_";
  protected final String TEXT_121 = " = service_";
  protected final String TEXT_122 = ".getObject(currentBucketName_";
  protected final String TEXT_123 = ", map_";
  protected final String TEXT_124 = ".get(\"OBJECT_KEY\"));" + NL + "\t\t\t\t\t}catch(org.jets3t.service.ServiceException e_";
  protected final String TEXT_125 = "){";
  protected final String TEXT_126 = NL + "\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "\t\t\t\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_129 = ":\");" + NL + "\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_130 = ".getMessage());" + NL + "\t\t\t\t\t\tif(e_";
  protected final String TEXT_131 = ".getErrorCode()!=null){" + NL + "\t\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_132 = ".getErrorCode());" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif(e_";
  protected final String TEXT_133 = ".getErrorMessage()!=null){" + NL + "\t\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_134 = ".getErrorMessage());" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_135 = NL + "\t\t\t\t\t}";
  protected final String TEXT_136 = NL + "\t\t\t\t\tif(obj_";
  protected final String TEXT_137 = "!=null){" + NL + "\t\t\t\t\t\tnb_line_";
  protected final String TEXT_138 = "++;" + NL + "\t\t\t\t\t\tboolean isDirectory_";
  protected final String TEXT_139 = "=false;" + NL + "\t\t\t\t\t\tString fileName_";
  protected final String TEXT_140 = " =file_";
  protected final String TEXT_141 = " .getAbsolutePath();" + NL + "\t\t\t\t\t\tfileName_";
  protected final String TEXT_142 = " =fileName_";
  protected final String TEXT_143 = " .replace(\"\\\\\", \"/\");" + NL + "\t\t\t\t\t\tString createDir_";
  protected final String TEXT_144 = "=\"\";" + NL + "\t\t\t\t\t\tif(obj_";
  protected final String TEXT_145 = ".isDirectoryPlaceholder()){" + NL + "\t\t\t\t\t\t\tcreateDir_";
  protected final String TEXT_146 = " = fileName_";
  protected final String TEXT_147 = ";" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\tcreateDir_";
  protected final String TEXT_148 = "=\tfileName_";
  protected final String TEXT_149 = ".substring(0,fileName_";
  protected final String TEXT_150 = ".indexOf(\"/\"));" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif (!\"\".equals(createDir_";
  protected final String TEXT_151 = ")) {" + NL + "\t\t\t\t\t\t\tjava.io.File parentDir_";
  protected final String TEXT_152 = "=new java.io.File(createDir_";
  protected final String TEXT_153 = ");" + NL + "\t\t\t\t\t\t\tif(!parentDir_";
  protected final String TEXT_154 = ".exists()){" + NL + "\t\t\t\t\t\t\t\tparentDir_";
  protected final String TEXT_155 = ".mkdirs();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif(!obj_";
  protected final String TEXT_156 = ".isDirectoryPlaceholder()){" + NL + "\t\t\t\t\t\t\tjava.io.File parentDir_";
  protected final String TEXT_157 = "=new java.io.File(file_";
  protected final String TEXT_158 = ".getParent());" + NL + "\t\t\t\t\t\t\tif(!parentDir_";
  protected final String TEXT_159 = ".exists()){" + NL + "\t\t\t\t\t\t\t\tparentDir_";
  protected final String TEXT_160 = ".mkdirs();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tjava.io.InputStream input_";
  protected final String TEXT_161 = " = obj_";
  protected final String TEXT_162 = ".getDataInputStream();" + NL + "\t\t\t\t\t\t\tbyte bytes_";
  protected final String TEXT_163 = "[] = new byte[4 * 1024];" + NL + "\t\t\t\t\t\t\tint len_";
  protected final String TEXT_164 = " = -1;" + NL + "\t\t\t\t\t\t\tjava.io.FileOutputStream out_";
  protected final String TEXT_165 = " = new java.io.FileOutputStream(file_";
  protected final String TEXT_166 = ");" + NL + "\t" + NL + "\t\t\t\t\t\t\twhile ((len_";
  protected final String TEXT_167 = " = input_";
  protected final String TEXT_168 = ".read(bytes_";
  protected final String TEXT_169 = ")) != -1) {" + NL + "\t\t\t\t\t\t\t\tout_";
  protected final String TEXT_170 = ".write(bytes_";
  protected final String TEXT_171 = ", 0, len_";
  protected final String TEXT_172 = ");" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tout_";
  protected final String TEXT_173 = ".flush();" + NL + "\t\t\t\t\t\t\tinput_";
  protected final String TEXT_174 = ".close(); " + NL + "\t\t\t\t\t\t\tout_";
  protected final String TEXT_175 = ".close(); " + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tobj_";
  protected final String TEXT_176 = ".closeDataInputStream();";
