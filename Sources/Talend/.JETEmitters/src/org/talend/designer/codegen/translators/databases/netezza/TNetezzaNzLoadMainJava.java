...
public class TNetezzaNzLoadMainJava {
  ...
  protected final String TEXT_137 = NL + "            log4jSb_";
  protected final String TEXT_138 = ".append(sb_";
  protected final String TEXT_139 = ".toString());" + NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_140 = " - Loading the record :\" + log4jSb_";
  protected final String TEXT_141 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_142 = ".delete(0,log4jSb_";
