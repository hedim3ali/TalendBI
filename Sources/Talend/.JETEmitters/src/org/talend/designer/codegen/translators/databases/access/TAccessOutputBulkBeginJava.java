...
public class TAccessOutputBulkBeginJava
{
  ...
  protected final String TEXT_25 = "\t\t" + NL + "\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_26 = "=new java.io.File(";
  protected final String TEXT_27 = ");" + NL + "\t\tfinal java.io.BufferedWriter out";
  protected final String TEXT_28 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        \t\tnew java.io.FileOutputStream(file_";
  protected final String TEXT_29 = ", ";
  protected final String TEXT_30 = "),";
  protected final String TEXT_31 = "));" + NL + "       \tresourceMap.put(\"out";
  ...
  protected final String TEXT_39 = "out";
  protected final String TEXT_40 = ".write(OUT_DELIM_";
  protected final String TEXT_41 = ");";
  protected final String TEXT_42 = NL + "    \t\tout";
  protected final String TEXT_43 = ".write(OUT_DELIM_ROWSEP_";
  protected final String TEXT_44 = ");" + NL + "    \t\tout";
  protected final String TEXT_45 = ".flush();" + NL + "    \t}";
