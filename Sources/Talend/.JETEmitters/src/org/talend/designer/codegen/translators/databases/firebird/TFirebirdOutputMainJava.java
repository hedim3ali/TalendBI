...
public class TFirebirdOutputMainJava {
  ...
  protected final String TEXT_38 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_39 = NL + "                        ";
  protected final String TEXT_40 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_61 = NL + "            try {" + NL + "                updatedCount_";
  ...
  protected final String TEXT_89 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_90 = " = pstmt_";
  protected final String TEXT_91 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_92 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_93 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_94 = " = rs_";
  protected final String TEXT_95 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_116 = " + pstmtUpdate_";
  protected final String TEXT_117 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_145 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_146 = " = insertedCount_";
  protected final String TEXT_147 = " + pstmtInsert_";
  protected final String TEXT_148 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_168 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_169 = "++;" + NL + "    \t\t";
  protected final String TEXT_170 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_187 = "_QUERY\", query_";
  protected final String TEXT_188 = ".toString().trim());";
  protected final String TEXT_189 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_190 = "=pstmtUpdate_";
  protected final String TEXT_191 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_192 = " = updatedCount_";
  protected final String TEXT_193 = " + updateFlag_";
  protected final String TEXT_194 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_205 = NL + "                        rejectedCount_";
  protected final String TEXT_206 = " = rejectedCount_";
  protected final String TEXT_207 = " + 1;";
  protected final String TEXT_208 = NL + "                        ";
  protected final String TEXT_209 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_210 = NL + "                        ";
  protected final String TEXT_211 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_212 = ";";
  protected final String TEXT_213 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_214 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_215 = " == 0) {" + NL + "            \t";
  protected final String TEXT_216 = NL + "\t\t\t\tquery_";
  protected final String TEXT_217 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_263 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_264 = " = deletedCount_";
  protected final String TEXT_265 = " + pstmt_";
  protected final String TEXT_266 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_286 = NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_299 = NL + "                commitCounter_";
  protected final String TEXT_300 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_301 = " <= commitCounter_";
  protected final String TEXT_302 = ") {" + NL + "                " + NL + "                \tconn_";
  protected final String TEXT_303 = ".commit();" + NL + "                \t" + NL + "                \tcommitCounter_";
  protected final String TEXT_304 = "=0;" + NL + "                " + NL + "                }" + NL + "        \t";
