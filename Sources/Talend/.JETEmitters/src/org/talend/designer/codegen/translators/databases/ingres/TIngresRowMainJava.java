...
public class TIngresRowMainJava
{
  ...
  protected final String TEXT_50 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_71 = NL + "\t    if(commitEvery_";
  protected final String TEXT_72 = "<=commitCounter_";
  protected final String TEXT_73 = "){" + NL + "\t    " + NL + "\t    \tconn_";
  protected final String TEXT_74 = ".commit();" + NL + "\t    \t" + NL + "\t    \tcommitCounter_";
  protected final String TEXT_75 = "=0;" + NL + "\t    \t" + NL + "\t    }" + NL + "\t    ";
