...
public class TInformixInputBeginJava
{
  ...
  protected final String TEXT_214 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_215 = " + \":\" + ";
  protected final String TEXT_216 = " + \"/\" + ";
  protected final String TEXT_217 = " + \":informixserver=\" + ";
  protected final String TEXT_218 = ";";
  protected final String TEXT_219 = NL + "\t\t        String url_";
  protected final String TEXT_220 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_221 = " + \":\" + ";
  protected final String TEXT_222 = " + \"/\" + ";
  protected final String TEXT_223 = " + \":informixserver=\" + ";
  protected final String TEXT_224 = " + \";\" + ";
  protected final String TEXT_225 = ";";
  protected final String TEXT_226 = NL + "    " + NL + "\t";
  protected final String TEXT_227 = NL + "\t\t    int nb_line_";
  protected final String TEXT_228 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_229 = " = null;";
  protected final String TEXT_230 = NL + "\t\t        conn_";
  protected final String TEXT_231 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_232 = "\");";
  protected final String TEXT_233 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_234 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_235 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_236 = " = dataSources_";
  protected final String TEXT_237 = ".get(";
  protected final String TEXT_238 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_243 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_244 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_245 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_246 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_247 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_281 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_293 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_318 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_319 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_320 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_321 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_333 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_345 = " = (List)rs_";
  protected final String TEXT_346 = ".getObject(column_index_";
  protected final String TEXT_347 = ");";
  protected final String TEXT_348 = NL + "\t\t                         ";
  protected final String TEXT_349 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_350 = ".getObject(column_index_";
  protected final String TEXT_351 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_352 = NL + "                                    ";
  protected final String TEXT_353 = ".";
  protected final String TEXT_354 = " = new Geometry(wktValue);";
  protected final String TEXT_355 = NL + "                                        ";
  protected final String TEXT_356 = ".";
  protected final String TEXT_357 = ".setEPSG(";
  protected final String TEXT_358 = ");";
  protected final String TEXT_359 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_360 = NL + "                                  ";
  protected final String TEXT_361 = ".";
  protected final String TEXT_362 = "=dcg_";
  protected final String TEXT_363 = ";";
  protected final String TEXT_364 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_365 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_366 = " = ";
  protected final String TEXT_367 = "; i_";
  protected final String TEXT_368 = "  <= rsmd_";
  protected final String TEXT_369 = ".getColumnCount(); i_";
  protected final String TEXT_370 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_371 = ".getColumnTypeName(i_";
  protected final String TEXT_372 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_373 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_374 = ".getClob(i_";
  protected final String TEXT_375 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_376 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_377 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_378 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_379 = ".add(tNTextImpl_";
  protected final String TEXT_380 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_381 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_387 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_397 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_398 = ".getObject(column_index_";
  protected final String TEXT_399 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_414 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_415 = " - Content of the record \" + nb_line_";
  protected final String TEXT_416 = " + \": \" + log4jSb_";
  protected final String TEXT_417 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_418 = ".delete(0,log4jSb_";
  protected final String TEXT_419 = ".length());" + NL + "\t\t\t\t\t";
