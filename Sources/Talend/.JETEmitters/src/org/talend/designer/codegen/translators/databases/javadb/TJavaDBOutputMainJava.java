...
public class TJavaDBOutputMainJava {
  ...
  protected final String TEXT_68 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_69 = NL + "                        ";
  protected final String TEXT_70 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_71 = ";";
  protected final String TEXT_72 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_73 = NL + "            }";
  protected final String TEXT_74 = NL + "                    ";
  protected final String TEXT_75 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_76 = " = pstmt_";
  protected final String TEXT_77 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_78 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_79 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_80 = " = rs_";
  protected final String TEXT_81 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_92 = "_QUERY\", query_";
  protected final String TEXT_93 = ".toString().trim());";
  protected final String TEXT_94 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_95 = " = updatedCount_";
  protected final String TEXT_96 = " + pstmtUpdate_";
  protected final String TEXT_97 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_109 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_110 = NL + "                            ";
  protected final String TEXT_111 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_112 = ";";
  protected final String TEXT_113 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_114 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_115 = NL + "                        ";
  protected final String TEXT_116 = NL + "                            query_";
  protected final String TEXT_117 = " = ";
  protected final String TEXT_118 = ";";
  protected final String TEXT_119 = NL + "                    globalMap.put(\"";
  protected final String TEXT_120 = "_QUERY\", query_";
  protected final String TEXT_121 = ".toString().trim());";
  protected final String TEXT_122 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_123 = " = insertedCount_";
  protected final String TEXT_124 = " + pstmtInsert_";
  protected final String TEXT_125 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_142 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_143 = "++;";
  protected final String TEXT_144 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_157 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_158 = "=pstmtUpdate_";
  protected final String TEXT_159 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_160 = " = updatedCount_";
  protected final String TEXT_161 = "+updateFlag_";
  ...
  protected final String TEXT_174 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_175 = NL + "                        ";
  protected final String TEXT_176 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_177 = ";";
  protected final String TEXT_178 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_179 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_180 = " == 0) {" + NL + "            \t";
  protected final String TEXT_181 = NL + "\t\t\t\tquery_";
  protected final String TEXT_182 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_189 = ".toString().trim());";
  ...
  protected final String TEXT_253 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_254 = " <= commitCounter_";
  protected final String TEXT_255 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_256 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_257 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
