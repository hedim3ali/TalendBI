...
public class TRedshiftOutputMainJava {
  ...
  protected final String TEXT_29 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_38 = ".setNull(counter";
  ...
  protected final String TEXT_43 = ".setNull(counter";
  protected final String TEXT_44 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_46 = ".";
  protected final String TEXT_47 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_48 = ".setNull(counter";
  protected final String TEXT_49 = ",java.sql.Types.ARRAY);         " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_54 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_59 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_60 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_61 = ".";
  protected final String TEXT_62 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_63 = ".setNull(counter";
  protected final String TEXT_64 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_69 = ",java.sql.Types.BOOLEAN);   " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_71 = ".";
  protected final String TEXT_72 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_73 = ".setNull(counter";
  protected final String TEXT_74 = ",java.sql.Types.DOUBLE);    " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_79 = ",java.sql.Types.FLOAT); " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_85 = NL + "\t\t\t\t\t\t\t\tif((\"null\").equals(String.valueOf(";
  protected final String TEXT_86 = ".";
  protected final String TEXT_87 = ").toLowerCase())){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_88 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_89 = ".setNull(counter";
  protected final String TEXT_90 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}else if(";
  protected final String TEXT_91 = ".";
  protected final String TEXT_92 = " == '\\0'){" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_93 = ".setString(counter";
  protected final String TEXT_94 = ",\"\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_95 = ".setString(counter";
  protected final String TEXT_96 = ",String.valueOf(";
  protected final String TEXT_97 = ".";
  protected final String TEXT_98 = "));" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_100 = ".";
  protected final String TEXT_101 = "!=null){" + NL + "\t\t\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\t\t\tdate_";
  protected final String TEXT_102 = " = ";
  protected final String TEXT_103 = ".";
  protected final String TEXT_104 = ".getTime();" + NL + "\t\t\t\t\t\t\t\tif (date_";
  protected final String TEXT_105 = " < year1_";
  protected final String TEXT_106 = " || date_";
  protected final String TEXT_107 = " >= year10000_";
  protected final String TEXT_108 = ") {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_109 = ".setString(counter";
  protected final String TEXT_110 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_111 = ".setTimestamp(counter";
  protected final String TEXT_112 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_113 = "));" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_114 = ".setNull(counter";
  protected final String TEXT_115 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_123 = NL + "\t\t\t\tint counter";
  protected final String TEXT_124 = " = rowCount";
  protected final String TEXT_125 = " * ";
  protected final String TEXT_126 = " + 1;";
  protected final String TEXT_127 = NL + "\t\t\t\t\t\tcounter";
  protected final String TEXT_128 = "++;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\texInsertColValue";
  protected final String TEXT_130 = " = new BufferLine_";
  protected final String TEXT_131 = "(";
  protected final String TEXT_132 = NL + "\t                            ,";
  protected final String TEXT_133 = NL + "\t                        ";
  protected final String TEXT_134 = ".";
  protected final String TEXT_135 = "              ";
  protected final String TEXT_136 = "  " + NL + "\t\t\t\t); " + NL + "\t               " + NL + "\t\t\t\texInsertColValueList";
  protected final String TEXT_137 = ".add(exInsertColValue";
  protected final String TEXT_138 = ");" + NL + "\t\t\t\trowCount";
  protected final String TEXT_139 = "++;" + NL + "\t\t\t\t" + NL + "\t\t\t\tif(rowCount";
  protected final String TEXT_140 = " == ";
  protected final String TEXT_141 = "){ " + NL + "\t                    insertedCount_";
  protected final String TEXT_142 = " = insertedCount_";
  protected final String TEXT_143 = " + pstmt_";
  protected final String TEXT_144 = ".executeUpdate();" + NL + "\t                    exInsertColValueList";
  protected final String TEXT_145 = ".clear();" + NL + "\t                    rowCount";
  protected final String TEXT_146 = " = 0;" + NL + "\t\t\t\t\t\tcounter";
  protected final String TEXT_147 = "=1;" + NL + "\t\t\t\t} ";
  ...
  protected final String TEXT_156 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_157 = " = updatedCount_";
  protected final String TEXT_158 = " + pstmt_";
  protected final String TEXT_159 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_185 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_186 = " = pstmt_";
  protected final String TEXT_187 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_188 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_189 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_190 = " = rs_";
  protected final String TEXT_191 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_192 = " > 0) {";
  ...
  protected final String TEXT_200 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_201 = " = updatedCount_";
  protected final String TEXT_202 = " + pstmtUpdate_";
  ...
  protected final String TEXT_214 = NL + "                            rejectedCount_";
  protected final String TEXT_215 = " = rejectedCount_";
  protected final String TEXT_216 = " + 1;";
  protected final String TEXT_217 = NL + "                            ";
  protected final String TEXT_218 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_219 = NL + "                            ";
  protected final String TEXT_220 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_221 = ";";
  protected final String TEXT_222 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_223 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_224 = NL + "                        ";
  protected final String TEXT_225 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_226 = " = insertedCount_";
  protected final String TEXT_227 = " + pstmtInsert_";
  ...
  protected final String TEXT_250 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_259 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_260 = "=pstmtUpdate_";
  protected final String TEXT_261 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_262 = " = updatedCount_";
  protected final String TEXT_263 = "+updateFlag_";
  ...
  protected final String TEXT_284 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_285 = " == 0) {";
  protected final String TEXT_286 = NL + "                        ";
  protected final String TEXT_287 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_288 = " = insertedCount_";
  protected final String TEXT_289 = " + pstmtInsert_";
  protected final String TEXT_290 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_301 = NL + "                            rejectedCount_";
  protected final String TEXT_302 = " = rejectedCount_";
  ...
  protected final String TEXT_310 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_321 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_341 = NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_354 = NL + "                commitCounter_";
  protected final String TEXT_355 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_356 = "<=commitCounter_";
  protected final String TEXT_357 = ") {" + NL + "                " + NL + "                    conn_";
  protected final String TEXT_358 = ".commit();" + NL + "                    " + NL + "                    commitCounter_";
