...
public class TGSCopyMainJava
{
  ...
  protected final String TEXT_91 = " instanceof org.jets3t.service.ServiceException){" + NL + "\t\t\torg.jets3t.service.ServiceException servError_";
  protected final String TEXT_92 = " = (org.jets3t.service.ServiceException)e_";
  protected final String TEXT_93 = ";" + NL + "\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_94 = ":\");" + NL + "\t\t\tSystem.err.println(servError_";
  protected final String TEXT_95 = ".getMessage());" + NL + "\t\t\tif(servError_";
  protected final String TEXT_96 = ".getErrorCode()!=null){" + NL + "\t\t\t\tSystem.err.println(servError_";
  protected final String TEXT_97 = ".getErrorCode());" + NL + "\t\t\t}" + NL + "\t\t\tif(servError_";
  protected final String TEXT_98 = ".getErrorMessage()!=null){" + NL + "\t\t\t\tSystem.err.println(servError_";
  protected final String TEXT_99 = ".getErrorMessage());" + NL + "\t\t\t}" + NL + "" + NL + "\t\t}else{" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_100 = ".getMessage());" + NL + "\t\t}";
  protected final String TEXT_101 = NL + "\t}finally{" + NL + "\t\tif(service_";
  protected final String TEXT_102 = " !=null){" + NL + "\t\t\tservice_";
  protected final String TEXT_103 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
