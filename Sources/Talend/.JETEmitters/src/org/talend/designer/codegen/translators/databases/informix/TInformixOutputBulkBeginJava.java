...
public class TInformixOutputBulkBeginJava
{
  ...
  protected final String TEXT_16 = ")));" + NL + "        resourceMap.put(\"csvWriter_";
  protected final String TEXT_17 = "\", csvWriter_";
  protected final String TEXT_18 = "); " + NL + "        csvWriter_";
  protected final String TEXT_19 = ".setSeparator(fieldSeparator_";
  protected final String TEXT_20 = ");" + NL + "        " + NL + "        csvWriter_";
  protected final String TEXT_21 = ".setLineEnd(\"\"+rowSeparator_";
  protected final String TEXT_22 = ");" + NL + "        csvWriter_";
  protected final String TEXT_23 = ".setEscapeChar('\\\\');" + NL + "      \tcsvWriter_";
  protected final String TEXT_24 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.NO);  ";
