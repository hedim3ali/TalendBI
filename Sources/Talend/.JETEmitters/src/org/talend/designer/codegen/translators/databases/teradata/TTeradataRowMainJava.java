...
public class TTeradataRowMainJava
{
  ...
  protected final String TEXT_52 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_53 = NL + "                ";
  protected final String TEXT_54 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_55 = ";";
  protected final String TEXT_56 = NL + "                System.err.print(e.getMessage());";
  protected final String TEXT_57 = NL + "    }" + NL + "\t";
  protected final String TEXT_58 = NL + "    if(!whetherReject_";
  ...
  protected final String TEXT_73 = NL + "        commitCounter_";
  protected final String TEXT_74 = "++;" + NL + "        if(commitEvery_";
  protected final String TEXT_75 = " <= commitCounter_";
  protected final String TEXT_76 = ") {" + NL + "        " + NL + "\t\t\t";
  protected final String TEXT_77 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_78 = " - Starting to commit.\");" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "        \tconn_";
  protected final String TEXT_80 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_82 = " - Commit has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "        \t" + NL + "        \tcommitCounter_";
