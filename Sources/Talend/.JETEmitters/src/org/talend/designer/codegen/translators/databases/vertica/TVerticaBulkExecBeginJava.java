...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_93 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_97 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_98 = ".equals(schema_";
  protected final String TEXT_99 = ") || (schema_";
  protected final String TEXT_100 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_101 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_110 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_111 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_112 = " == null || dbschema_";
  protected final String TEXT_113 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_131 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_137 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_138 = ".equals";
  protected final String TEXT_139 = "IgnoreCase";
  protected final String TEXT_140 = "(schema_";
  ...
  protected final String TEXT_152 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_157 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_163 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_170 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_171 = ".execute(\"";
  protected final String TEXT_172 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_173 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_179 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_185 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_188 = " = stmtTruncCount_";
  protected final String TEXT_189 = ".executeQuery(\"";
  protected final String TEXT_190 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_193 = ".executeUpdate(\"";
  protected final String TEXT_194 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_195 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_196 = " += rsTruncCount_";
  protected final String TEXT_197 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_198 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_199 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_200 = ".close();            ";
  protected final String TEXT_201 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  ...
  protected final String TEXT_205 = NL + "        int keyCount_";
  protected final String TEXT_206 = " = ";
  protected final String TEXT_207 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_208 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tableName_";
  protected final String TEXT_209 = " = \"tmp_";
  protected final String TEXT_210 = "\";" + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_213 = ".execute(\"";
  protected final String TEXT_214 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_215 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_216 = " + \"_proj (";
  protected final String TEXT_217 = ") AS SELECT ";
  protected final String TEXT_218 = " FROM \" + tableName_";
  protected final String TEXT_219 = ");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_220 = ".close();" + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_223 = ".execute(\"COPY \" + ";
  protected final String TEXT_224 = " + \".\" + tableName_";
  protected final String TEXT_225 = " + \" FROM '\" + ";
  protected final String TEXT_226 = " + \"' WITH DELIMITER '\" +";
  protected final String TEXT_227 = " + \"'\" ";
  protected final String TEXT_228 = " + \" NULL '\" +";
  protected final String TEXT_229 = " + \"'\"";
  protected final String TEXT_230 = " + \" DIRECT\"";
  protected final String TEXT_231 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_232 = ".close();" + NL + "        tableName_";
  protected final String TEXT_233 = " = ";
  protected final String TEXT_234 = ";" + NL + "        String tmpTableName_";
  protected final String TEXT_235 = " = \"tmp_";
  protected final String TEXT_236 = "\";" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_239 = ".executeUpdate(\"";
  protected final String TEXT_240 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_241 = ".close();" + NL + "        tableName_";
  protected final String TEXT_242 = " = tmpTableName_";
  protected final String TEXT_243 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_244 = " = conn_";
  protected final String TEXT_245 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_246 = ".execute(\"";
  protected final String TEXT_247 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_248 = ".close();        ";
  protected final String TEXT_249 = NL + "\tString sql_";
  protected final String TEXT_250 = " = \"COPY \" + tableName_";
  protected final String TEXT_251 = " + \" FROM STDIN DELIMITER '\" +";
  protected final String TEXT_252 = " + \"'\" ";
  protected final String TEXT_253 = " + \" NULL '\"  + ";
  protected final String TEXT_254 = " + \"'\"" + NL + "\t";
  protected final String TEXT_255 = NL + "\t";
  protected final String TEXT_256 = " + \" DIRECT\"";
  protected final String TEXT_257 = ";" + NL + "    fis_";
  protected final String TEXT_258 = " = new java.io.FileInputStream(new java.io.File(";
  protected final String TEXT_259 = "));";
  protected final String TEXT_260 = NL + "\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_261 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_262 = ",sql_";
  protected final String TEXT_263 = ");" + NL + "\tvcs_";
  protected final String TEXT_264 = ".start();" + NL + "\tvcs_";
  protected final String TEXT_265 = ".addStream(fis_";
  protected final String TEXT_266 = ");" + NL + "\tvcs_";
  protected final String TEXT_267 = ".execute();" + NL + "\tvcs_";
  protected final String TEXT_268 = ".finish();" + NL + "\tlong copyNumber_";
  protected final String TEXT_269 = " = vcs_";
  protected final String TEXT_270 = ".getRowCount();" + NL + "\tif(copyNumber_";
  protected final String TEXT_271 = " <= 0){" + NL + "\t\t";
  protected final String TEXT_272 = NL + "\tthrow new RuntimeException(\"No record was loaded into component ";
  protected final String TEXT_273 = "\");" + NL + "\t\t";
  protected final String TEXT_274 = NL + "\t}" + NL + "\tSystem.out.println(\"Number of records loaded into table \" + tableName_";
  protected final String TEXT_275 = " + \" by ";
  protected final String TEXT_276 = ": \" + (copyNumber_";
  protected final String TEXT_277 = "));";
  protected final String TEXT_278 = NL + "    java.sql.Statement stmt_";
  protected final String TEXT_279 = " = conn_";
  protected final String TEXT_280 = ".createStatement();" + NL + "    java.sql.ResultSet rs_";
  protected final String TEXT_281 = " = stmt_";
  protected final String TEXT_282 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_283 = ");" + NL + "    int nbLineBeforeLoad_";
  protected final String TEXT_284 = " = 0;" + NL + "    while (rs_";
  protected final String TEXT_285 = ".next()) {" + NL + "    \tnbLineBeforeLoad_";
  protected final String TEXT_286 = " = rs_";
  protected final String TEXT_287 = ".getInt(1);" + NL + "\t}" + NL + "    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_288 = ").startCopyIn(sql_";
  protected final String TEXT_289 = ", fis_";
  protected final String TEXT_290 = ");" + NL + "    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_291 = ").addStreamToCopyIn(fis_";
  protected final String TEXT_292 = ");" + NL + "    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_293 = ").finishCopyIn();" + NL + "\trs_";
  protected final String TEXT_294 = " = stmt_";
  protected final String TEXT_295 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_296 = ");" + NL + "    int nbLineAfterLoad_";
  protected final String TEXT_297 = " = 0;" + NL + "    while (rs_";
  protected final String TEXT_298 = ".next()) {" + NL + "    \tnbLineAfterLoad_";
  protected final String TEXT_299 = " = rs_";
  protected final String TEXT_300 = ".getInt(1);" + NL + "\t}" + NL + "\tif(nbLineBeforeLoad_";
  protected final String TEXT_301 = " >= nbLineAfterLoad_";
  protected final String TEXT_302 = "){" + NL + "\t\t";
  protected final String TEXT_303 = NL + "\tstmt_";
  protected final String TEXT_304 = ".close();" + NL + "\tthrow new RuntimeException(\"No record was loaded in component ";
  protected final String TEXT_305 = "\");" + NL + "\t\t";
  protected final String TEXT_306 = NL + "\t}" + NL + "\tSystem.out.println(\"Number of records loaded to table \" + tableName_";
  protected final String TEXT_307 = " + \" by ";
  protected final String TEXT_308 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_309 = " - nbLineBeforeLoad_";
  protected final String TEXT_310 = "));" + NL + "    stmt_";
  protected final String TEXT_311 = ".close();";
  protected final String TEXT_312 = NL + "}finally{" + NL + "\tif(fis_";
  protected final String TEXT_313 = "!=null)" + NL + "\t\tfis_";
  protected final String TEXT_314 = ".close();";
  protected final String TEXT_315 = NL + "\t     conn_";
  protected final String TEXT_316 = ".close();";
  protected final String TEXT_317 = NL + "}" + NL + NL + NL + NL + NL + NL + NL;
