...
public class Component_part_headerJava
{
  ...
  protected final String TEXT_34 = NL + NL + "\t\t\tif (execStat) {" + NL + "\t\t\t    java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap_";
  protected final String TEXT_35 = " = (java.util.concurrent.ConcurrentHashMap) globalMap.get(\"concurrentHashMap\");" + NL + "\t\t\t\tconcurrentHashMap_";
  protected final String TEXT_36 = ".putIfAbsent(\"";
  protected final String TEXT_37 = "\" + iterateLoop,new java.util.concurrent.atomic.AtomicInteger(0));" + NL + "\t\t\t\tjava.util.concurrent.atomic.AtomicInteger stats_";
  protected final String TEXT_38 = " = (java.util.concurrent.atomic.AtomicInteger) concurrentHashMap_";
  protected final String TEXT_39 = ".get(\"";
  protected final String TEXT_40 = "\" + iterateLoop);" + NL + "\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_41 = "\" + iterateId, stats_";
  protected final String TEXT_42 = ".incrementAndGet()<=1?0:1, 0);" + NL + "\t\t\t} " + NL + "" + NL + "\t\t";
