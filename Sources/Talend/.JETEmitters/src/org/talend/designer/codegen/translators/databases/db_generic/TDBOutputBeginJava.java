...
public class TDBOutputBeginJava {
  ...
  protected final String TEXT_48 = ";" + NL + "String dbProperties_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "java.sql.Connection conn_";
  protected final String TEXT_51 = " = null;" + NL + "if(dbProperties_";
  protected final String TEXT_52 = " == null || dbProperties_";
  protected final String TEXT_53 = ".trim().length() == 0) {" + NL + "\tconn_";
  ...
  protected final String TEXT_57 = ");" + NL + "}else{" + NL + "\tdbProperties_";
  protected final String TEXT_58 = " = dbProperties_";
  protected final String TEXT_59 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_60 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_61 = ".put(\"user\",dbUser_";
  protected final String TEXT_62 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_63 = ".put(\"password\",dbPwd_";
  protected final String TEXT_64 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_65 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  protected final String TEXT_66 = ".getBytes()));" + NL + "\tconn_";
  protected final String TEXT_67 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_68 = ", atnParamsPrope_";
  protected final String TEXT_69 = ");" + NL + "}" + NL + "conn_";
  protected final String TEXT_70 = ".setAutoCommit(false);";
  protected final String TEXT_71 = NL + "    java.sql.Statement stmtClear_";
  protected final String TEXT_72 = " = conn_";
  protected final String TEXT_73 = ".createStatement();" + NL + "    deletedCount_";
  protected final String TEXT_74 = " = deletedCount_";
  protected final String TEXT_75 = " + stmtClear_";
  protected final String TEXT_76 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_77 = ");";
  protected final String TEXT_78 = NL + "\t    String insert_";
  protected final String TEXT_79 = " = \"INSERT INTO \" + ";
  protected final String TEXT_80 = " + \" (";
  protected final String TEXT_81 = ") VALUES (";
  protected final String TEXT_82 = ")\";" + NL + "\t\t";
  protected final String TEXT_83 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_84 = " = conn_";
  protected final String TEXT_85 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_86 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_95 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_98 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_99 = " = conn_";
  protected final String TEXT_100 = ".prepareStatement(update_";
  protected final String TEXT_101 = ");" + NL + "\t    ";
  protected final String TEXT_102 = NL + "\t    \tString checkExist_";
  protected final String TEXT_103 = " = \"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_109 = ")\";" + NL + "\t    \tString update_";
  protected final String TEXT_110 = " = \"UPDATE \" + ";
  protected final String TEXT_111 = " + \" SET ";
  protected final String TEXT_112 = " WHERE ";
  protected final String TEXT_113 = "\";" + NL + "\t    ";
  protected final String TEXT_114 = NL + "\t    \tString[] checkExistSQLSplits_";
  protected final String TEXT_115 = " = (checkExist_";
  protected final String TEXT_116 = "+\" \").split(\"\\\\?\");" + NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_117 = " = conn_";
  protected final String TEXT_118 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtInsert_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtUpdate_";
  ...
  protected final String TEXT_125 = ".prepareStatement(checkExist_";
  protected final String TEXT_126 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_133 = NL + "\t    String update_";
  protected final String TEXT_134 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_142 = NL + "\t\t    java.sql.Statement pstmtUpdate_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = ".createStatement();" + NL + "\t\t    java.sql.Statement pstmtInsert_";
  ...
  protected final String TEXT_150 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".prepareStatement(insert_";
  protected final String TEXT_153 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_154 = NL + "\t    String delete_";
  protected final String TEXT_155 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_156 = " + \" WHERE ";
  protected final String TEXT_157 = "\";" + NL + "\t    ";
  protected final String TEXT_158 = NL + "\t    \tjava.sql.Statement pstmt_";
  ...
  protected final String TEXT_163 = ".prepareStatement(delete_";
  protected final String TEXT_164 = ");" + NL + "\t    ";
  protected final String TEXT_165 = NL + "        StringBuffer query_";
  protected final String TEXT_166 = " = null;" + NL + "       \t";
  protected final String TEXT_167 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_168 = " = insert_";
  protected final String TEXT_169 = ".split(\"\\\\?\");";
  protected final String TEXT_170 = NL + "\t\t\tupdate_";
  protected final String TEXT_171 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_172 = " = update_";
  protected final String TEXT_173 = ".split(\"\\\\?\");";
  protected final String TEXT_174 = NL + "\t\t\tupdate_";
  protected final String TEXT_175 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_176 = " = update_";
  protected final String TEXT_177 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_178 = " = insert_";
  protected final String TEXT_179 = ".split(\"\\\\?\");";
  protected final String TEXT_180 = NL + "\t\t\tdelete_";
  protected final String TEXT_181 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_182 = " = delete_";
  protected final String TEXT_183 = ".split(\"\\\\?\");";
  protected final String TEXT_184 = NL + "\t\t\treplace_";
  protected final String TEXT_185 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_186 = " = replace_";
  protected final String TEXT_187 = ".split(\"\\\\?\");";
  protected final String TEXT_188 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_189 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_190 = " = insertIgnore_";
  protected final String TEXT_191 = ".split(\"\\\\?\");";
  protected final String TEXT_192 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_193 = " = insert_";
  protected final String TEXT_194 = ".split(\"\\\\?\");";
  protected final String TEXT_195 = NL + "\t    int commitEvery_";
  protected final String TEXT_196 = " = ";
  protected final String TEXT_197 = ";" + NL + "\t    int commitCounter_";
