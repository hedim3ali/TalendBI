...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_214 = " = \"jdbc:sasiom://\"+";
  protected final String TEXT_215 = "+\":\"+";
  protected final String TEXT_216 = ";";
  protected final String TEXT_217 = NL + "\t\t\tjava.lang.Class.forName(\"";
  protected final String TEXT_218 = "\");" + NL + "\t\t\t" + NL + "\t\t\tString dbUser_";
  protected final String TEXT_219 = " = ";
  protected final String TEXT_220 = ";" + NL + "\t\t\tString dbPwd_";
  protected final String TEXT_221 = " = ";
  protected final String TEXT_222 = ";" + NL + "\t\t\tjava.util.Properties property_";
  protected final String TEXT_223 = " = new java.util.Properties();" + NL + "\t\t\t" + NL + "\t\t\tproperty_";
  protected final String TEXT_224 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_225 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_226 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_227 = ");" + NL + "\t\t\t";
  protected final String TEXT_228 = NL + "\t\t\tconn_";
  protected final String TEXT_229 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_230 = ", property_";
  protected final String TEXT_231 = ");";
  protected final String TEXT_232 = NL + "\t\t\tif(rs_";
  protected final String TEXT_233 = ".getString(column_index_";
  protected final String TEXT_234 = ")!=null&&(rs_";
  protected final String TEXT_235 = ".getString(column_index_";
  protected final String TEXT_236 = ")).length()>0){" + NL + "\t\t\t\t";
  protected final String TEXT_237 = ".";
  protected final String TEXT_238 = "=rs_";
  protected final String TEXT_239 = ".getString(column_index_";
  protected final String TEXT_240 = ").charAt(0);" + NL + "\t\t\t}else{\t\t\t  \t";
  protected final String TEXT_241 = NL + "\t\t\t\t\tif((rs_";
  protected final String TEXT_242 = ".getString(column_index_";
  ...
  protected final String TEXT_249 = ".getString(column_index_";
  protected final String TEXT_250 = ")).equals(\"\")){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_251 = ".";
  protected final String TEXT_252 = " = '\\0';" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\tthrow new RuntimeException(" + NL + "\t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_253 = "', value is invalid or this column should be nullable or have a default value.\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t  \t\t";
  protected final String TEXT_254 = NL + "\t\t\t  " + NL + "\t\t\t}\t\t";
  protected final String TEXT_255 = NL + "    " + NL + "\t";
  protected final String TEXT_256 = NL + "\t\t    int nb_line_";
  protected final String TEXT_257 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_258 = " = null;";
  protected final String TEXT_259 = NL + "\t\t        conn_";
  protected final String TEXT_260 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_261 = "\");";
  protected final String TEXT_262 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_263 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_264 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_265 = " = dataSources_";
  protected final String TEXT_266 = ".get(";
  protected final String TEXT_267 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_268 = "\", conn_";
  protected final String TEXT_269 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_270 = NL + "\t\t\t\t";
  protected final String TEXT_271 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_272 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_273 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_274 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_275 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_276 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_277 = NL + NL + "\t\t    ";
  protected final String TEXT_278 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_279 = " = ";
  protected final String TEXT_280 = ";";
  protected final String TEXT_281 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_282 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_283 = " + \"'.\");";
  protected final String TEXT_284 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_285 = "_QUERY\",dbquery_";
  protected final String TEXT_286 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_287 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_288 = " = stmt_";
  protected final String TEXT_289 = ".executeQuery(dbquery_";
  protected final String TEXT_290 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_291 = " = rs_";
  protected final String TEXT_292 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_293 = " = rsmd_";
  protected final String TEXT_294 = ".getColumnCount();" + NL;
  protected final String TEXT_295 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_296 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_297 = ".setDbmsId(\"";
  protected final String TEXT_298 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_299 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_300 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_301 = ".add(\"";
  protected final String TEXT_302 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_303 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_304 = " = ";
  protected final String TEXT_305 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_306 = "; i <= rsmd_";
  protected final String TEXT_307 = ".getColumnCount()-";
  protected final String TEXT_308 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_309 = ".contains(rsmd_";
  protected final String TEXT_310 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_311 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_312 = ".setName(rsmd_";
  protected final String TEXT_313 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_314 = ".setDbName(rsmd_";
  protected final String TEXT_315 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_316 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_317 = "\", rsmd_";
  protected final String TEXT_318 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_319 = ".getPrecision(i), rsmd_";
  protected final String TEXT_320 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_321 = ".setDbType(rsmd_";
  protected final String TEXT_322 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_347 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_348 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_349 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_350 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_351 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_352 = NL + "\t\t    while (rs_";
  protected final String TEXT_353 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_354 = "++;" + NL + "\t\t        ";
  protected final String TEXT_355 = NL + "\t\t                        column_index_";
  protected final String TEXT_356 = " = ";
  protected final String TEXT_357 = " + dcg_";
  protected final String TEXT_358 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_359 = NL + "\t\t                        column_index_";
  ...
  protected final String TEXT_375 = ".getObject(column_index_";
  protected final String TEXT_376 = ");";
  protected final String TEXT_377 = NL + "\t\t                         ";
  protected final String TEXT_378 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_379 = ".getObject(column_index_";
  protected final String TEXT_380 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_381 = NL + "                                    ";
  protected final String TEXT_382 = ".";
  protected final String TEXT_383 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_393 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_394 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_410 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_411 = ".";
  protected final String TEXT_412 = ", rs_";
  protected final String TEXT_413 = ", fixedColumnCount_";
  protected final String TEXT_414 = ",list_";
  protected final String TEXT_415 = ");";
  protected final String TEXT_416 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_427 = ".getObject(column_index_";
  ...
  protected final String TEXT_434 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_435 = ".append(";
  protected final String TEXT_436 = ".";
  protected final String TEXT_437 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  ...
  protected final String TEXT_443 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_444 = " - Content of the record \" + nb_line_";
  protected final String TEXT_445 = " + \": \" + log4jSb_";
  protected final String TEXT_446 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_447 = ".delete(0,log4jSb_";
  protected final String TEXT_448 = ".length());" + NL + "\t\t\t\t\t";
