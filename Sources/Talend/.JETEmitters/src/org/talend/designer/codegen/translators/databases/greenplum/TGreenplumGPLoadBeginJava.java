...
public class TGreenplumGPLoadBeginJava {
  ...
  protected final String TEXT_97 = NL + "\tint deletedCount_";
  protected final String TEXT_98 = " = 0;" + NL + "\tint insertedCount_";
  protected final String TEXT_99 = " = 0;";
  protected final String TEXT_100 = NL + "\t\tboolean missConfiguration_";
  protected final String TEXT_101 = " = true;" + NL + "\t\tString missConfigurationMsg_";
  protected final String TEXT_102 = " = \"";
  protected final String TEXT_103 = "\";" + NL + "\t\tif (missConfiguration_";
  protected final String TEXT_104 = ") {" + NL + "\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\t\tlog.fatal(\"";
  protected final String TEXT_106 = " - \" + missConfigurationMsg_";
  protected final String TEXT_107 = ");" + NL + "\t\t\t";
  protected final String TEXT_108 = NL + "\t\t\tthrow new java.lang.Exception(missConfigurationMsg_";
  protected final String TEXT_109 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_110 = NL + NL + "\tString tableName_";
  protected final String TEXT_111 = " = ";
  protected final String TEXT_112 = ";" + NL + "\tString dbschema_";
  protected final String TEXT_113 = " = ";
  protected final String TEXT_114 = ";" + NL + "\tString tableName4Load_";
  protected final String TEXT_115 = " = \"\\\"\" + tableName_";
  protected final String TEXT_116 = " + \"\\\"\";" + NL + "\tif(dbschema_";
  ...
  protected final String TEXT_121 = ";" + NL + "\t\ttableName4Load_";
  protected final String TEXT_122 = " = \"\\\"\"+dbschema_";
  protected final String TEXT_123 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_124 = "+\"\\\"\";" + NL + "\t}";
  protected final String TEXT_125 = NL + NL + "\t\tjava.lang.Class.forName(\"org.postgresql.Driver\");    " + NL + "\t\tString url_";
  protected final String TEXT_126 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_127 = "+\":\"+";
  protected final String TEXT_128 = "+\"/\"+";
  protected final String TEXT_129 = ";" + NL + "\t\tString dbUser_";
  protected final String TEXT_130 = " = ";
  protected final String TEXT_131 = ";" + NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_137 = " - Connection attempt to '\" + url_";
  protected final String TEXT_138 = " + \"' with the username '\" + dbUser_";
  ...
  protected final String TEXT_146 = " - Connection to '\" + url_";
  protected final String TEXT_147 = " + \"' has succeeded.\" );" + NL + "\t\t";
  ...
  protected final String TEXT_153 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_166 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_172 = " - Create table '\" + tableName_";
  protected final String TEXT_173 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_175 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_176 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_177 = " - Table '\" + tableName4Load_";
  protected final String TEXT_178 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_179 = NL + "\t\t\t\t\tthrow new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_180 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_181 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_182 = " - Table '\" + tableName4Load_";
  protected final String TEXT_183 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_184 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_185 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_186 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_190 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_196 = " - Create table '\" + tableName_";
  protected final String TEXT_197 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_199 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_200 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_201 = " - Table '\" + tableName4Load_";
  protected final String TEXT_202 = " + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_204 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_206 = " - Table '\" + tableName4Load_";
  protected final String TEXT_207 = " + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_247 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_253 = " - Create table '\" + tableName_";
  protected final String TEXT_254 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_255 = " " + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_256 = "){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_257 = NL + "\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_258 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_259 = "  + \"'. process terminated \");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_261 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_262 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_263 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_264 = "  + \"'. process terminated \");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_265 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_266 = NL + "                if(whetherExist_";
  protected final String TEXT_267 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_268 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_272 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_278 = " - Drop table '\" + tableName_";
  protected final String TEXT_279 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_280 = NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_281 = "){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_282 = NL + "\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_283 = " - Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_284 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_285 = NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_286 = "  + \"'. process terminated  \");" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_287 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_288 = " - Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_289 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_290 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_291 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_301 = " - Create table '\" + tableName_";
  protected final String TEXT_302 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_303 = "           " + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_304 = "){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_305 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_306 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_307 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_309 = "  + \"'. process terminated\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_310 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_311 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_312 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_313 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_314 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_315 = " = conn_";
  protected final String TEXT_316 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_317 = " = stmtClearCount_";
  ...
  protected final String TEXT_323 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_331 = NL + "            while(rsClearCount_";
  protected final String TEXT_332 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_333 = " = rsClearCount_";
  protected final String TEXT_334 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_335 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_336 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  ...
  protected final String TEXT_340 = " - Clearing table '\" + tableName_";
  protected final String TEXT_341 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_342 = NL + "            \tdeletedCount_";
  protected final String TEXT_343 = " = stmtClear_";
  protected final String TEXT_344 = ".executeUpdate(\"";
  protected final String TEXT_345 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_347 = "- Clear table '\" + tableName_";
  protected final String TEXT_348 = " +  \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_349 = NL + "            \tstmtClear_";
  protected final String TEXT_350 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_351 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_352 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_353 = " - Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_354 = " + \"'. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_356 = "  + \"'. process terminated\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_357 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_358 = " - Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_359 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t";
  protected final String TEXT_360 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_361 = NL + "        conn_";
  protected final String TEXT_362 = ".close();";
  protected final String TEXT_363 = NL;
  protected final String TEXT_364 = NL + "\t\tString delim_";
  protected final String TEXT_365 = " = ";
  protected final String TEXT_366 = ";" + NL + "\t\tString escape_";
  protected final String TEXT_367 = " = ";
  protected final String TEXT_368 = ";" + NL + "\t\tString quote_";
  protected final String TEXT_369 = " = ";
  protected final String TEXT_370 = ";" + NL + "\t\tdelim_";
  protected final String TEXT_371 = " = \"\\t\".equals(delim_";
  protected final String TEXT_372 = ") ? \"\\\\t\" : delim_";
  protected final String TEXT_373 = ";" + NL + "\t\t" + NL + "\t\tjava.io.PrintWriter gpctrl_";
  protected final String TEXT_374 = " = new java.io.PrintWriter(new java.io.FileOutputStream(";
  protected final String TEXT_375 = ", false), true);" + NL + "\t\tgpctrl_";
  protected final String TEXT_376 = ".println(\"---\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_377 = ".println(\"VERSION: 1.0.0.1\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_378 = ".println(\"DATABASE: \" + ";
  protected final String TEXT_379 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_380 = ".println(\"USER: \" + ";
  protected final String TEXT_381 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_382 = ".println(\"HOST: \" + ";
  protected final String TEXT_383 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_384 = ".println(\"PORT: \" + ";
  protected final String TEXT_385 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_386 = ".println(\"GPLOAD:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_387 = ".println(\"  INPUT:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_388 = ".println(\"    - SOURCE:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_389 = ".println(\"        FILE:\");" + NL + "\t\t";
  protected final String TEXT_390 = NL + "\t\tgpctrl_";
  protected final String TEXT_391 = ".println(\"          - \" + (new com.infobright.io.NamedPipeFactory()).getNativePipeName(";
  protected final String TEXT_392 = "));" + NL + "\t\t";
  protected final String TEXT_393 = NL + "\t\tgpctrl_";
  protected final String TEXT_394 = ".println(\"          - \" + ";
  protected final String TEXT_395 = ");" + NL + "\t\t";
  protected final String TEXT_396 = NL + "\t\tgpctrl_";
  protected final String TEXT_397 = ".println(\"    - DELIMITER: '\" + delim_";
  protected final String TEXT_398 = " + \"'\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_399 = ".println(\"    - ESCAPE: '\" + escape_";
  protected final String TEXT_400 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_401 = NL + "\t\tgpctrl_";
  protected final String TEXT_402 = ".println(\"    - FORMAT: csv\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_403 = ".println(\"    - QUOTE: '\" + quote_";
  protected final String TEXT_404 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_405 = NL + "\t\tgpctrl_";
  protected final String TEXT_406 = ".println(\"    - FORMAT: text\");" + NL + "\t\t";
  protected final String TEXT_407 = NL + "\t\t";
  protected final String TEXT_408 = NL + "\t\tgpctrl_";
  protected final String TEXT_409 = ".println(\"    - HEADER: true\");" + NL + "\t\t";
  protected final String TEXT_410 = NL + "\t\tgpctrl_";
  protected final String TEXT_411 = ".println(\"    - ENCODING: \" + ";
  protected final String TEXT_412 = ");" + NL + "\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_414 = ".println(\"    - ";
  protected final String TEXT_415 = ": \" + ";
  protected final String TEXT_416 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\tgpctrl_";
  protected final String TEXT_418 = ".println(\"  OUTPUT: \");" + NL + "\t\tgpctrl_";
  protected final String TEXT_419 = ".println(\"    - TABLE: '\" + tableName4Load_";
  protected final String TEXT_420 = "+\"'\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_421 = ".println(\"    - MODE: ";
  protected final String TEXT_422 = "\");" + NL + "\t\t";
  protected final String TEXT_423 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_424 = ".println(\"    - MATCH_COLUMNS:\");" + NL + "\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_426 = ".println(\"      - ";
  protected final String TEXT_427 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_429 = ".println(\"    - UPDATE_COLUMNS:\");" + NL + "\t\t\t";
  protected final String TEXT_430 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_431 = ".println(\"      - ";
  protected final String TEXT_432 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_434 = ".println(\"    - UPDATE_CONDITION: \" + ";
  protected final String TEXT_435 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_436 = NL + "\t\tgpctrl_";
  protected final String TEXT_437 = ".close();" + NL + "\t\t";
  protected final String TEXT_438 = NL + NL + "\tfinal StringBuilder gploadOutput_";
  protected final String TEXT_439 = " = new StringBuilder(200);" + NL + "\tThread gploadThread_";
  protected final String TEXT_440 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_441 = ",";
  protected final String TEXT_442 = "};" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tgploadOutput_";
  protected final String TEXT_443 = ".append(line);" + NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_444 = NL + "\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_445 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_446 = NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_447 = "_GPLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL;
  protected final String TEXT_448 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_449 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_450 = ", true, true, 1024000, 10000);" + NL + "\t\t\tgploadThread_";
  protected final String TEXT_451 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by gpload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_452 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_453 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_454 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_455 = NL + "\t\t";
  protected final String TEXT_456 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_457 = " - Loading data into database.\");" + NL + "\t\t";
  protected final String TEXT_458 = NL + "\tgploadThread_";
  protected final String TEXT_459 = ".start();" + NL + "\tgploadThread_";
  protected final String TEXT_460 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_461 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_462 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_463 = "_NB_LINE\", insertedCount_";
  protected final String TEXT_464 = ");" + NL + "\t\t";
  protected final String TEXT_465 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_466 = " - Loaded records count:\" + insertedCount_";
  protected final String TEXT_467 = " + \".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_468 = " - Has finished.\");" + NL + "\t\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_134);
	   		...
	   		log4jCodeGenerateUtil.debugConnectionParams(node,"org.postgresql.Driver");	
