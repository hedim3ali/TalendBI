...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_148 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_156 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_335 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_340 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_344 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_350 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_357 = " - Creating table '\" + tableName_";
  protected final String TEXT_358 = " + \"'.\" );" + NL + "\t\t\t\t\t";
  protected final String TEXT_359 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_360 = ".execute((\"";
  protected final String TEXT_361 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_375 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_376 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_382 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_388 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_401 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_410 = " - Truncate table '\" + tableName_";
  protected final String TEXT_411 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_412 = NL + "            while(rsTruncCount_";
  protected final String TEXT_413 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_414 = " += rsTruncCount_";
  protected final String TEXT_415 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_416 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_417 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_421 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_422 = " = stmtTruncCount_";
  protected final String TEXT_423 = ".executeQuery(\"";
  protected final String TEXT_424 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_428 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_437 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_451 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_452 = " = new StringBuffer(insert_";
  protected final String TEXT_453 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_454 = ".insert(insert_";
  protected final String TEXT_455 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_456 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_457 = " =insertStringBuffer_";
  ...
  protected final String TEXT_466 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_467 = " = conn_";
  protected final String TEXT_468 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_469 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_470 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_471 = ",insert_";
  protected final String TEXT_472 = ",keyPsmt_";
  ...
  protected final String TEXT_509 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_534 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_535 = " = new StringBuffer(update_";
  protected final String TEXT_536 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_537 = ".insert(update_";
  protected final String TEXT_538 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_539 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_540 = " =updateStringBuffer_";
  protected final String TEXT_541 = ".toString(); ";
  protected final String TEXT_542 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_562 = NL + "\t    String delete_";
  protected final String TEXT_563 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_564 = " + \" WHERE ";
  protected final String TEXT_565 = "\";" + NL + "\t    ";
  protected final String TEXT_566 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_567 = " = new StringBuffer(delete_";
  protected final String TEXT_568 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_569 = ".insert(delete_";
  protected final String TEXT_570 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_571 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_572 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_576 = ".prepareStatement(delete_";
  protected final String TEXT_577 = ");" + NL + "\t    ";
  protected final String TEXT_578 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_584 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_585 = " = update_";
  ...
  protected final String TEXT_589 = " = update_";
  protected final String TEXT_590 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_591 = " = insert_";
  protected final String TEXT_592 = ".split(\"\\\\?\");";
  protected final String TEXT_593 = NL + "\t\t\tdelete_";
  protected final String TEXT_594 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_595 = " = delete_";
  protected final String TEXT_596 = ".split(\"\\\\?\");";
  protected final String TEXT_597 = NL + "\t\t\treplace_";
  protected final String TEXT_598 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_599 = " = replace_";
  protected final String TEXT_600 = ".split(\"\\\\?\");";
  protected final String TEXT_601 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_602 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_603 = " = insertIgnore_";
  protected final String TEXT_604 = ".split(\"\\\\?\");";
  protected final String TEXT_605 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_606 = " = insert_";
  protected final String TEXT_607 = ".split(\"\\\\?\");";
  protected final String TEXT_608 = NL + "\t   ";
  protected final String TEXT_609 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_610 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_611 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_612 = " = true;" + NL + "    \t";
  protected final String TEXT_613 = NL + "\tclass XMLTypeUtil_";
  ...
  protected final String TEXT_615 = " xmlTypeUtil_";
  protected final String TEXT_616 = " = null;" + NL + "\txmlTypeUtil_";
  protected final String TEXT_617 = " = new XMLTypeUtil_";
  protected final String TEXT_618 = "();";
  protected final String TEXT_619 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_620 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_621 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_622 = " =null;";
  protected final String TEXT_623 = NL + NL + NL + NL;
