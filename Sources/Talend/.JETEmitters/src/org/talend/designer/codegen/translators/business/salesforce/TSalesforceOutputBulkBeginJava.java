...
public class TSalesforceOutputBulkBeginJava
{
  ...
  protected final String TEXT_8 = "), \"UTF-8\")));" + NL + "resourceMap.put(\"csvWriter_";
  protected final String TEXT_9 = "\", csvWriter_";
  protected final String TEXT_10 = "); ";
  protected final String TEXT_11 = "  \t" + NL + "\t\t\t\t\t\t\tif(file_";
  protected final String TEXT_12 = ".length()==0){" + NL + "\t                    \t\tString[] header_";
  protected final String TEXT_13 = "=new String[";
  protected final String TEXT_14 = "];" + NL + "\t                    \t";
  protected final String TEXT_15 = NL + "\t\t\t\t\t\t\t\theader_";
  protected final String TEXT_16 = "[";
  protected final String TEXT_17 = "] = \"";
  protected final String TEXT_18 = "\";";
  protected final String TEXT_19 = NL + "\t\t\t\t\t\t\t\theader_";
  ...
  protected final String TEXT_27 = ".writeNext(header_";
