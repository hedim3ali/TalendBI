...
public class TAccessConnectionBeginJava
{
  ...
  protected final String TEXT_60 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_61 = "\", conn_";
  protected final String TEXT_62 = ");";
  protected final String TEXT_63 = NL + "\t}";
  protected final String TEXT_64 = NL + "\tif (null != conn_";
  protected final String TEXT_65 = ") {" + NL + "\t\t";
  protected final String TEXT_66 = NL + "\t}";
  protected final String TEXT_67 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
