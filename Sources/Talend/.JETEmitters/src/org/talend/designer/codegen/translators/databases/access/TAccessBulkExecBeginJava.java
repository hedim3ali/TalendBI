...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_112 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  protected final String TEXT_113 = " = rsTable_";
  protected final String TEXT_114 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_115 = ".equals(";
  protected final String TEXT_116 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_117 = ".equals(schema_";
  protected final String TEXT_118 = ") || (schema_";
  protected final String TEXT_119 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_120 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_129 = " = false;" + NL + "\t            String defaultSchema_";
  ...
  protected final String TEXT_182 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_187 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_190 = ".execute(\"";
  protected final String TEXT_191 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_192 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_198 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_220 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_221 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_222 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_223 = " " + NL;
  protected final String TEXT_224 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_225 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_226 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_227 = " + \";HDR=";
  protected final String TEXT_228 = "].[\" + fileName_";
  protected final String TEXT_229 = " + \"]\";";
  protected final String TEXT_230 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_233 = ".execute(bulkInsert_";
  protected final String TEXT_234 = ");" + NL + "" + NL + "\tstmt_";
