...
public class TNetezzaOutputBeginJava {
  ...
  protected final String TEXT_121 = "=0;" + NL + "int rejectedCount_";
  ...
  protected final String TEXT_139 = " != null) {" + NL + "\t\t\tif(conn_";
  protected final String TEXT_140 = ".getMetaData() != null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_141 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_142 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_143 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_144 = NL + "\t";
  protected final String TEXT_145 = NL + "\tjava.lang.Class.forName(\"";
  protected final String TEXT_146 = "\");" + NL + "\t";
  protected final String TEXT_147 = NL + "\t    String url_";
  protected final String TEXT_148 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_149 = " + \":\" + ";
  protected final String TEXT_150 = " + \"/\" + ";
  protected final String TEXT_151 = ";" + NL + "\t    ";
  protected final String TEXT_152 = NL + "\t    String url_";
  protected final String TEXT_153 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_154 = " + \":\" + ";
  protected final String TEXT_155 = " + \"/\" + ";
  protected final String TEXT_156 = " + \"?\" + ";
  protected final String TEXT_157 = ";" + NL + "\t    ";
  protected final String TEXT_158 = NL + "\tString dbUser_";
  ...
  protected final String TEXT_165 = " - Connection attempt to '\" + url_";
  protected final String TEXT_166 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_167 = " + \"'.\");" + NL + "\t";
  protected final String TEXT_168 = "\t" + NL + "\tconn_";
  protected final String TEXT_169 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_170 = ", dbUser_";
  protected final String TEXT_171 = ", dbPwd_";
  protected final String TEXT_172 = ");" + NL + "\t";
  protected final String TEXT_173 = NL + "\t\tlog.info(\"";
  protected final String TEXT_174 = " - Connection to '\" + url_";
  protected final String TEXT_175 = " + \"' has succeeded.\");" + NL + "\t";
  protected final String TEXT_176 = NL + "\t";
  protected final String TEXT_177 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_181 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_187 = " - Drop table '\" + tableName_";
  protected final String TEXT_188 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_189 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_192 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_193 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_211 = " - Creata table '\" + tableName_";
  ...
  protected final String TEXT_222 = ".equalsIgnoreCase(";
  protected final String TEXT_223 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_224 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_230 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_236 = " - Create table '\" + tableName_";
  protected final String TEXT_237 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_244 = " - Droping tableName_";
  ...
  protected final String TEXT_252 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_256 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_264 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_265 = " = conn_";
  protected final String TEXT_266 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_267 = " = stmtClearCount_";
  ...
  protected final String TEXT_273 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_279 = " - Truncate table '\" + tableName_";
  protected final String TEXT_280 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_281 = NL + "            while(rsClearCount_";
  protected final String TEXT_282 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_283 = " += rsClearCount_";
  protected final String TEXT_284 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_285 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_289 = " - Clearing table '\" + tableName_";
  protected final String TEXT_290 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_291 = NL + "            deletedCount_";
  protected final String TEXT_292 = " = deletedCount_";
  protected final String TEXT_293 = " + stmtClear_";
  protected final String TEXT_294 = ".executeUpdate(\"";
  protected final String TEXT_295 = "\");" + NL + "\t\t\t";
  protected final String TEXT_296 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_297 = " - Clear table '\" + tableName_";
  ...
  protected final String TEXT_302 = ".setAutoCommit(false);";
  protected final String TEXT_303 = "      \t    " + NL + "\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_304 = " = conn_";
  protected final String TEXT_305 = ".prepareStatement(\"INSERT INTO \"+";
  protected final String TEXT_306 = "+\" (";
  protected final String TEXT_307 = ") VALUES (";
  protected final String TEXT_308 = ")\");\t        " + NL + "\t        ";
  protected final String TEXT_309 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_310 = " = conn_";
  protected final String TEXT_311 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_317 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_318 = " + \" WHERE ";
  protected final String TEXT_319 = "\");\t" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_320 = " = conn_";
  protected final String TEXT_321 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_322 = " + \" (";
  protected final String TEXT_323 = ") VALUES (";
  protected final String TEXT_324 = ")\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_325 = " = conn_";
  protected final String TEXT_326 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_332 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_333 = " + \" SET ";
  protected final String TEXT_334 = " WHERE ";
  protected final String TEXT_335 = "\");" + NL + "" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_336 = " = conn_";
  protected final String TEXT_337 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_338 = " + \" (";
  protected final String TEXT_339 = ") VALUES (";
  protected final String TEXT_340 = ")\");" + NL + "\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_341 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_342 = " = conn_";
  protected final String TEXT_343 = ".prepareStatement(\"DELETE  FROM \" + ";
  protected final String TEXT_344 = " + \" WHERE ";
  protected final String TEXT_345 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_346 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_347 = " = ";
  protected final String TEXT_348 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_349 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_350 = NL + "\t   int batchSize_";
  protected final String TEXT_351 = " = ";
  protected final String TEXT_352 = ";" + NL + "\t   int batchSizeCounter_";
