...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_143 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  ...
  protected final String TEXT_154 = " = dataSources_";
  protected final String TEXT_155 = ".get(";
  protected final String TEXT_156 = ").getConnection();" + NL + "\t\t} else {";
  protected final String TEXT_157 = NL + "\t\tString dbProperties_";
  protected final String TEXT_158 = " = ";
  protected final String TEXT_159 = ";" + NL + "\t\tString url_";
  protected final String TEXT_160 = " = null;" + NL + "\t\tif(dbProperties_";
  protected final String TEXT_161 = " == null || dbProperties_";
  protected final String TEXT_162 = ".trim().length() == 0) {" + NL + "\t\t\turl_";
  protected final String TEXT_163 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_164 = " + \":\" + ";
  protected final String TEXT_165 = " + \"/\" + ";
  protected final String TEXT_166 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t\t} else {" + NL + "\t\t\tString properties_";
  protected final String TEXT_167 = " = ";
  protected final String TEXT_168 = ";" + NL + "\t\t\tif (!properties_";
  protected final String TEXT_169 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\t\tproperties_";
  protected final String TEXT_170 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\turl_";
  protected final String TEXT_171 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_172 = " + \":\" + ";
  protected final String TEXT_173 = " + \"/\" + ";
  protected final String TEXT_174 = " + \"?\" + properties_";
  protected final String TEXT_175 = ";" + NL + "\t\t}" + NL + "\t\tString dbUser_";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = ";" + NL + "\t\tString dbPwd_";
  protected final String TEXT_178 = " = ";
  protected final String TEXT_179 = ";    " + NL + "\t\tjava.lang.Class.forName(\"";
  protected final String TEXT_180 = "\");" + NL + "\t\t";
  protected final String TEXT_181 = "\t" + NL + "\t\t";
  protected final String TEXT_182 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_183 = " - Connection attempt to '\" + url_";
  protected final String TEXT_184 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_185 = " + \"'.\");" + NL + "\t\t";
  protected final String TEXT_186 = "\t" + NL + "\t\tconn_";
  protected final String TEXT_187 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_188 = ", dbUser_";
  protected final String TEXT_189 = ", dbPwd_";
  protected final String TEXT_190 = ");" + NL + "\t\t";
  protected final String TEXT_191 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_192 = " - Connection to '\" + url_";
  protected final String TEXT_193 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_194 = NL + "\t";
  protected final String TEXT_195 = NL + "\t}";
  protected final String TEXT_196 = NL + "        conn_";
  protected final String TEXT_197 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  ...
  protected final String TEXT_206 = NL + "int count_";
  ...
  protected final String TEXT_213 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_219 = " - Drop table '\" + tableName_";
  protected final String TEXT_220 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_221 = NL + "            stmtDrop_";
  protected final String TEXT_222 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_284 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_285 = " = conn_";
  protected final String TEXT_286 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_287 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_288 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_289 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_290 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_291 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_296 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_297 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_298 = " = tableNameForSearch_";
  protected final String TEXT_299 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_300 = " = tableNameForSearch_";
  protected final String TEXT_301 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_302 = " = dbMetaData_";
  protected final String TEXT_303 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_304 = ", tableNameForSearch_";
  ...
  protected final String TEXT_351 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_352 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_361 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_362 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_363 = " == null || dbschema_";
  protected final String TEXT_364 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_371 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_372 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_373 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  protected final String TEXT_374 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_375 = " = rsTable_";
  protected final String TEXT_376 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_377 = " = rsTable_";
  protected final String TEXT_378 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_379 = ".equals";
  protected final String TEXT_380 = "IgnoreCase";
  protected final String TEXT_381 = "(";
  protected final String TEXT_382 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_383 = ".equals";
  protected final String TEXT_384 = "IgnoreCase";
  protected final String TEXT_385 = "(dbschema_";
  protected final String TEXT_386 = ") || ((dbschema_";
  protected final String TEXT_387 = " ==null || dbschema_";
  protected final String TEXT_388 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_389 = ".equals";
  protected final String TEXT_390 = "IgnoreCase";
  protected final String TEXT_391 = "(schema_";
  ...
  protected final String TEXT_397 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_398 = " = dbMetaData_";
  protected final String TEXT_399 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_400 = " = false;" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_413 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_427 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_431 = NL + "                if(whetherExist_";
  protected final String TEXT_432 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_433 = " = conn_";
  protected final String TEXT_434 = ".createStatement();" + NL + "\t    \t    \t";
  protected final String TEXT_435 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_436 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_442 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_449 = " - Creating table '\" + tableName_";
  protected final String TEXT_450 = " + \"'.\" );" + NL + "\t\t\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_452 = ".execute((\"";
  protected final String TEXT_453 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_463 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_470 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_474 = " - Clearing table '\" + tableName_";
  protected final String TEXT_475 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_476 = NL + "            stmtClear_";
  ...
  protected final String TEXT_480 = "- Clear table '\" + tableName_";
  protected final String TEXT_481 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_482 = NL + "            stmtClear_";
  ...
  protected final String TEXT_493 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_502 = " - Truncate table '\" + tableName_";
  protected final String TEXT_503 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_504 = NL + "            while(rsTruncCount_";
  protected final String TEXT_505 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_506 = " += rsTruncCount_";
  protected final String TEXT_507 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_508 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_509 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_510 = ".close();            ";
  protected final String TEXT_511 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_512 = " = conn_";
  protected final String TEXT_513 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_514 = " = stmtTruncCount_";
  protected final String TEXT_515 = ".executeQuery(\"";
  protected final String TEXT_516 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_517 = " = conn_";
  protected final String TEXT_518 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_519 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_520 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_521 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_522 = NL + "\t\t\t";
  protected final String TEXT_523 = NL + "\t\t\tconn_";
  protected final String TEXT_524 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_525 = NL + "            stmtTrunc_";
  protected final String TEXT_526 = ".executeUpdate(\"";
  protected final String TEXT_527 = "\");" + NL + "   \t    \t";
  protected final String TEXT_528 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_529 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_530 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_531 = NL + "             while(rsTruncCount_";
  protected final String TEXT_532 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_533 = " += rsTruncCount_";
  protected final String TEXT_534 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_535 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_536 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_537 = ".close();";
  protected final String TEXT_538 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_539 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_540 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_541 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_542 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_543 = ".append (\"`\" +  ";
  protected final String TEXT_544 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_545 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_558 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_559 = " = new StringBuffer(insert_";
  protected final String TEXT_560 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_561 = ".insert(insert_";
  protected final String TEXT_562 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_563 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_564 = " =insertStringBuffer_";
  ...
  protected final String TEXT_573 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_574 = " = conn_";
  protected final String TEXT_575 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_576 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_577 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_578 = ",insert_";
  protected final String TEXT_579 = ",keyPsmt_";
  protected final String TEXT_580 = ");";
  protected final String TEXT_581 = NL + "\t        \t        ";
  protected final String TEXT_582 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_583 = " {" + NL + "    \t            ";
  protected final String TEXT_584 = NL + "                            ";
  protected final String TEXT_585 = " ";
  protected final String TEXT_586 = ";                ";
  protected final String TEXT_587 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_596 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_597 = "> exInsertColValueList";
  protected final String TEXT_598 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_599 = " exInsertColValue";
  protected final String TEXT_600 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_601 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_602 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_603 = ".append(\"(";
  protected final String TEXT_604 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_605 = "-1) extendInsertValueStmt_";
  protected final String TEXT_606 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_607 = " = \"INSERT INTO `\"+";
  protected final String TEXT_608 = "+\"` (";
  protected final String TEXT_609 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_610 = ".toString();";
  protected final String TEXT_611 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_612 = " += \tduplidateClause_";
  ...
  protected final String TEXT_626 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_627 = " = \"";
  protected final String TEXT_628 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_629 = " =  \"";
  protected final String TEXT_630 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_631 = " = 0;\t ";
  ...
  protected final String TEXT_638 = " += \tduplidateClause_";
  protected final String TEXT_639 = ".toString();";
  protected final String TEXT_640 = NL + "\t\t        int batchSize_";
  protected final String TEXT_641 = " = ";
  protected final String TEXT_642 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_643 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_644 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_645 = " = new StringBuffer(insert_";
  protected final String TEXT_646 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_647 = ".insert(insert_";
  protected final String TEXT_648 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_649 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_650 = " =insertStringBuffer_";
  ...
  protected final String TEXT_654 = ".prepareStatement(insert_";
  protected final String TEXT_655 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_656 = NL + "\t    String update_";
  protected final String TEXT_657 = " = \"UPDATE `\" + ";
  protected final String TEXT_658 = " + \"` SET ";
  protected final String TEXT_659 = " WHERE ";
  protected final String TEXT_660 = "\";" + NL + "\t    ";
  protected final String TEXT_661 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_662 = " = new StringBuffer(update_";
  protected final String TEXT_663 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_664 = ".insert(update_";
  protected final String TEXT_665 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_666 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_667 = " =updateStringBuffer_";
  protected final String TEXT_668 = ".toString(); ";
  protected final String TEXT_669 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_670 = " = conn_";
  protected final String TEXT_671 = ".prepareStatement(update_";
  ...
  protected final String TEXT_677 = "\");" + NL + "\t    String insert_";
  ...
  protected final String TEXT_690 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_691 = " = conn_";
  protected final String TEXT_692 = ".prepareStatement(insert_";
  protected final String TEXT_693 = ");" + NL + "\t    String update_";
  protected final String TEXT_694 = " = \"UPDATE `\" + ";
  protected final String TEXT_695 = " + \"` SET ";
  protected final String TEXT_696 = " WHERE ";
  protected final String TEXT_697 = "\";" + NL + "\t    ";
  protected final String TEXT_698 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_699 = " = new StringBuffer(update_";
  protected final String TEXT_700 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_701 = ".insert(update_";
  protected final String TEXT_702 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_703 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_704 = " =updateStringBuffer_";
  protected final String TEXT_705 = ".toString(); ";
  protected final String TEXT_706 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_707 = " = conn_";
  protected final String TEXT_708 = ".prepareStatement(update_";
  protected final String TEXT_709 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_710 = NL + "\t    String update_";
  protected final String TEXT_711 = " = \"UPDATE `\" + ";
  protected final String TEXT_712 = " + \"` SET ";
  protected final String TEXT_713 = " WHERE ";
  protected final String TEXT_714 = "\";" + NL + "\t    ";
  protected final String TEXT_715 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_716 = " = new StringBuffer(update_";
  protected final String TEXT_717 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_718 = ".insert(update_";
  protected final String TEXT_719 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_720 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_721 = " =updateStringBuffer_";
  protected final String TEXT_722 = ".toString(); ";
  protected final String TEXT_723 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_724 = " = conn_";
  protected final String TEXT_725 = ".prepareStatement(update_";
  protected final String TEXT_726 = ");" + NL + "\t    String insert_";
  protected final String TEXT_727 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_739 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_743 = NL + "\t    String delete_";
  protected final String TEXT_744 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_745 = " + \"` WHERE ";
  protected final String TEXT_746 = "\";" + NL + "\t    ";
  protected final String TEXT_747 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_748 = " = new StringBuffer(delete_";
  protected final String TEXT_749 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_750 = ".insert(delete_";
  protected final String TEXT_751 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_752 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_753 = " =deleteStringBuffer_";
  protected final String TEXT_754 = ".toString();  ";
  protected final String TEXT_755 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_756 = " = conn_";
  protected final String TEXT_757 = ".prepareStatement(delete_";
  protected final String TEXT_758 = ");" + NL + "\t    ";
  protected final String TEXT_759 = NL + "\t    String replace_";
  protected final String TEXT_760 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_761 = " + \"` (";
  protected final String TEXT_762 = ") VALUES (";
  protected final String TEXT_763 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_764 = " = conn_";
  protected final String TEXT_765 = ".prepareStatement(replace_";
  protected final String TEXT_766 = ");" + NL + "\t    ";
  protected final String TEXT_767 = NL + "\t    String insertIgnore_";
  protected final String TEXT_768 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_769 = " + \"` (";
  protected final String TEXT_770 = ") VALUES (";
  protected final String TEXT_771 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_772 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_773 = " = conn_";
  protected final String TEXT_774 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_775 = ");" + NL + "\t    ";
  protected final String TEXT_776 = NL + "\t    String insert_";
  protected final String TEXT_777 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_778 = " + \"` (";
  protected final String TEXT_779 = ") VALUES (";
  protected final String TEXT_780 = ")\";" + NL + "\t    ";
  protected final String TEXT_781 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_782 = " = new StringBuffer(insert_";
  protected final String TEXT_783 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_784 = ".insert(insert_";
  protected final String TEXT_785 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_786 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_787 = " =insertStringBuffer_";
  protected final String TEXT_788 = ".toString(); ";
  protected final String TEXT_789 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_790 = " = conn_";
  protected final String TEXT_791 = ".prepareStatement(insert_";
  protected final String TEXT_792 = ");" + NL + "\t    ";
  protected final String TEXT_793 = NL + "        StringBuffer query_";
  protected final String TEXT_794 = " = null;" + NL + "       \t";
  protected final String TEXT_795 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_796 = " = insert_";
  protected final String TEXT_797 = ".split(\"\\\\?\");";
  protected final String TEXT_798 = NL + "\t\t\tupdate_";
  protected final String TEXT_799 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_800 = " = update_";
  protected final String TEXT_801 = ".split(\"\\\\?\");";
  protected final String TEXT_802 = NL + "\t\t\tupdate_";
  protected final String TEXT_803 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_804 = " = update_";
  protected final String TEXT_805 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_806 = " = insert_";
  protected final String TEXT_807 = ".split(\"\\\\?\");";
  protected final String TEXT_808 = NL + "\t\t\tdelete_";
  protected final String TEXT_809 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_810 = " = delete_";
  protected final String TEXT_811 = ".split(\"\\\\?\");";
  protected final String TEXT_812 = NL + "\t\t\treplace_";
  protected final String TEXT_813 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_814 = " = replace_";
  protected final String TEXT_815 = ".split(\"\\\\?\");";
  protected final String TEXT_816 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_817 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_818 = " = insertIgnore_";
  protected final String TEXT_819 = ".split(\"\\\\?\");";
  protected final String TEXT_820 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_821 = " = insert_";
  protected final String TEXT_822 = ".split(\"\\\\?\");";
  protected final String TEXT_823 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_824 = " {" + NL + "    \t            ";
  protected final String TEXT_825 = NL + "                            ";
  protected final String TEXT_826 = " ";
  protected final String TEXT_827 = ";                ";
  protected final String TEXT_828 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_829 = ";" + NL + "\t\t\t";
  protected final String TEXT_830 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_831 = "(";
  protected final String TEXT_832 = NL + "                                ,";
  protected final String TEXT_833 = NL + "                            ";
  protected final String TEXT_834 = " ";
  protected final String TEXT_835 = NL + "\t\t\t\t, Dynamic ";
  protected final String TEXT_836 = NL + "\t\t\t";
  protected final String TEXT_837 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_838 = NL + "                                this.";
  protected final String TEXT_839 = " = ";
  protected final String TEXT_840 = ";              ";
  protected final String TEXT_841 = NL + "\t\t\t\tthis.";
  protected final String TEXT_842 = "=";
  protected final String TEXT_843 = ";" + NL + "\t\t\t";
  protected final String TEXT_844 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_845 = "> exInsertColValueList";
  protected final String TEXT_846 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_847 = " exInsertColValue";
  protected final String TEXT_848 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_849 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_850 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_851 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_852 = "=1;";
  protected final String TEXT_853 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_854 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_855 = "=0;";
  protected final String TEXT_856 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_857 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_858 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_859 = " =null;" + NL + "\tint rowCount";
