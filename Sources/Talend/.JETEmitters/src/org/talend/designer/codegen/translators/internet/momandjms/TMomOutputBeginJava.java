...
public class TMomOutputBeginJava
{
  ...
  protected final String TEXT_3 = "=new java.util.Hashtable();" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_30 = ".setDeliveryMode(javax.jms.DeliveryMode.NON_PERSISTENT);" + NL + "\t\t\t";
  protected final String TEXT_31 = NL + "\t\t\t\tproducer_";
  protected final String TEXT_32 = ".setDeliveryMode(javax.jms.DeliveryMode.PERSISTENT);" + NL + "\t\t\t";
  protected final String TEXT_33 = NL + "\t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_34 = NL + "        \tresourceMap.put(\"session_";
  protected final String TEXT_35 = "\", session_";
  protected final String TEXT_36 = ");" + NL + "        \tresourceMap.put(\"producer_";
  protected final String TEXT_37 = "\", producer_";
  protected final String TEXT_38 = ");" + NL + "\t\t\tresourceMap.put(\"connection_";
  ...
  protected final String TEXT_51 = ".lookup(\"ConnectionFactory\");\t" + NL + "\t\t\t\t" + NL + "\t\t";
  ...
  protected final String TEXT_86 = ".createConnection();" + NL + "\t\t";
  ...
  protected final String TEXT_112 = ".setDeliveryMode(javax.jms.DeliveryMode.NON_PERSISTENT);" + NL + "\t\t";
  protected final String TEXT_113 = NL + "\t\t\tproducer_";
  protected final String TEXT_114 = ".setDeliveryMode(javax.jms.DeliveryMode.PERSISTENT);" + NL + "\t\t";
  protected final String TEXT_115 = NL + "\t\t";
  protected final String TEXT_116 = NL + "\t\t\tresourceMap.put(\"session_";
  protected final String TEXT_117 = "\", session_";
  protected final String TEXT_118 = ");" + NL + "\t\t\tresourceMap.put(\"producer_";
  protected final String TEXT_119 = "\", producer_";
  protected final String TEXT_120 = ");" + NL + "\t\t\tresourceMap.put(\"connection_";
  ...
  protected final String TEXT_125 = ".put(\"hostname\", ";
  protected final String TEXT_126 = ");" + NL + "\t    props_";
  protected final String TEXT_127 = ".put(\"port\", Integer.valueOf(";
  protected final String TEXT_128 = "));" + NL + "\t    props_";
  protected final String TEXT_129 = ".put(\"channel\", ";
  protected final String TEXT_130 = ");" + NL + "\t    props_";
  protected final String TEXT_131 = ".put(\"CCSID\", new Integer(1208));" + NL + "\t    props_";
  protected final String TEXT_132 = ".put(\"transport\", \"MQSeries\");" + NL + "\t    " + NL + "\t    ";
  protected final String TEXT_133 = NL + "\t\t\tcom.ibm.mq.MQEnvironment.sslCipherSuite = \"";
  protected final String TEXT_134 = "\";" + NL + "\t\t";
  protected final String TEXT_135 = NL + "\t\t\tprops_";
  protected final String TEXT_136 = ".put(\"userID\",";
  protected final String TEXT_137 = ");" + NL + "\t\t\tprops_";
  protected final String TEXT_138 = ".put(\"password\",";
  protected final String TEXT_139 = ");" + NL + "\t\t";
  protected final String TEXT_140 = NL + "\t" + NL + "\t\tcom.ibm.mq.MQQueueManager qMgr_";
  protected final String TEXT_141 = " = new com.ibm.mq.MQQueueManager(";
  protected final String TEXT_142 = ", props_";
  protected final String TEXT_143 = ");" + NL + "\t    com.ibm.mq.MQQueue remoteQ_";
  protected final String TEXT_144 = " = qMgr_";
  protected final String TEXT_145 = ".accessQueue(";
  protected final String TEXT_146 = ", 16);" + NL + "\t    com.ibm.mq.MQPutMessageOptions opM_";
  protected final String TEXT_147 = " = new com.ibm.mq.MQPutMessageOptions();" + NL + "\t\t";
  protected final String TEXT_148 = "\t" + NL + "\t\t\topM_";
  protected final String TEXT_149 = ".options=opM_";
  protected final String TEXT_150 = ".options+com.ibm.mq.MQC.MQGMO_SYNCPOINT;" + NL + "\t\t";
  protected final String TEXT_151 = NL + "\t\t\tif(producer_";
  protected final String TEXT_152 = "!=null){" + NL + "\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\t\t\tproducer_";
  protected final String TEXT_154 = ".setTimeToLive(";
  protected final String TEXT_155 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t\t\tproducer_";
  protected final String TEXT_157 = ".setPriority(";
  protected final String TEXT_158 = ");\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\t\t\tproducer_";
  protected final String TEXT_160 = ".setDisableMessageTimestamp(false);" + NL + "\t\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\t\tproducer_";
  protected final String TEXT_162 = ".setDeliveryMode(";
  protected final String TEXT_163 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_164 = NL + "\t\t\t}" + NL + "\t\t\tglobalMap.put(\"producer_";
  protected final String TEXT_165 = "\",producer_";
  protected final String TEXT_166 = ");" + NL + "\t\t\tglobalMap.put(\"session_";
  protected final String TEXT_167 = "\",session_";
  protected final String TEXT_168 = ");" + NL + "\t\t\tglobalMap.put(\"connection_";
