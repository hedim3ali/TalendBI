...
public class THiveRowBeginJava
{
  ...
  protected final String TEXT_202 = ".execute(\"SET dfs.namenode.kerberos.principal=\" + ";
  protected final String TEXT_203 = ");" + NL + "\t\t\t\tinit_";
  protected final String TEXT_204 = ".execute(\"SET mapreduce.jobtracker.kerberos.principal=\" + ";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "        \t\tinit_";
  protected final String TEXT_207 = ".execute(\"SET mapreduce.framework.name=yarn\");" + NL + "        \t\tinit_";
  protected final String TEXT_208 = ".execute(\"SET yarn.resourcemanager.address=\" + ";
  protected final String TEXT_209 = ");";
  protected final String TEXT_210 = NL + "\t\t\t\tinit_";
  protected final String TEXT_211 = ".execute(\"SET yarn.resourcemanager.scheduler.address=\" + ";
  protected final String TEXT_212 = ");";
  protected final String TEXT_213 = NL + "    \t\t//set default yarn classpath with environment variable" + NL + "    \t\t\tinit_";
  protected final String TEXT_214 = ".execute(\"SET yarn.application.classpath=$HADOOP_CONF_DIR,$HADOOP_COMMON_HOME/*,$HADOOP_COMMON_HOME/lib/*,$HADOOP_HDFS_HOME/*,$HADOOP_HDFS_HOME/lib/*,$HADOOP_MAPRED_HOME/*,$HADOOP_MAPRED_HOME/lib/*,$YARN_HOME/*,$YARN_HOME/lib/*,$HADOOP_YARN_HOME/*,$HADOOP_YARN_HOME/lib/*,$HADOOP_COMMON_HOME/share/hadoop/common/*,$HADOOP_COMMON_HOME/share/hadoop/common/lib/*,$HADOOP_HDFS_HOME/share/hadoop/hdfs/*,$HADOOP_HDFS_HOME/share/hadoop/hdfs/lib/*,$HADOOP_YARN_HOME/share/hadoop/yarn/*,$HADOOP_YARN_HOME/share/hadoop/yarn/lib/*\");";
  protected final String TEXT_215 = NL + "    \t\t\tinit_";
  protected final String TEXT_216 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_217 = ");" + NL + "    \t\t\tinit_";
  protected final String TEXT_218 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_219 = ");" + NL + "    \t\t\tinit_";
  protected final String TEXT_220 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "\t\t\t\tinit_";
  protected final String TEXT_223 = ".execute(\"SET \"+";
  protected final String TEXT_224 = "+\"=\"+";
  protected final String TEXT_225 = ");";
  protected final String TEXT_226 = NL + "\t\tinit_";
  protected final String TEXT_227 = ".close();" + NL + "\t\t" + NL + "    \tString dbname_";
  protected final String TEXT_228 = " = ";
  protected final String TEXT_229 = ";" + NL + "    \tif(dbname_";
  protected final String TEXT_230 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_231 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_232 = ".trim())) {" + NL + "        \tjava.sql.Statement goToDatabase_";
  protected final String TEXT_233 = " = conn_";
  protected final String TEXT_234 = ".createStatement();" + NL + "        \tgoToDatabase_";
  protected final String TEXT_235 = ".execute(\"use \" + dbname_";
  protected final String TEXT_236 = ");" + NL + "        \tgoToDatabase_";
  protected final String TEXT_237 = ".close();" + NL + "    \t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_238 = NL + "    \t\tjava.sql.Statement statement_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = ".createStatement();" + NL + "    \t\t";
  protected final String TEXT_241 = NL + "    \t\t\tstatement_";
  protected final String TEXT_242 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_243 = ");" + NL + "    \t\t";
  protected final String TEXT_244 = NL + "    \t" + NL + "        \t";
  protected final String TEXT_245 = NL + "        \t\tstatement_";
  protected final String TEXT_246 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_247 = ");" + NL + "        \t";
  protected final String TEXT_248 = NL + "    \t" + NL + "        \t";
  protected final String TEXT_249 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_250 = ".execute(\"add jar \"+";
  protected final String TEXT_251 = ");" + NL + "    \t\t";
  protected final String TEXT_252 = NL + "    \t\tstatement_";
  protected final String TEXT_253 = ".close();";
  protected final String TEXT_254 = NL;
  protected final String TEXT_255 = NL + "        if(conn_";
  protected final String TEXT_256 = ".getAutoCommit()) {" + NL + "            conn_";
  protected final String TEXT_257 = ".setAutoCommit(false);" + NL + "        }        " + NL + "        int commitEvery_";
  protected final String TEXT_258 = " = ";
  protected final String TEXT_259 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_260 = " = 0;";
  protected final String TEXT_261 = NL;
  protected final String TEXT_262 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_263 = " = conn_";
  protected final String TEXT_264 = ".prepareStatement(";
  ...
  protected final String TEXT_269 = NL + "String query_";
  protected final String TEXT_270 = " = \"\";" + NL + "boolean whetherReject_";
