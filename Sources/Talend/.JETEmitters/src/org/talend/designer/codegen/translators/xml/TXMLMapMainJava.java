...
public class TXMLMapMainJava {
  ...
  protected final String TEXT_255 = NL + "\t\t\t\t\t\t\t\t\t//begin to lookup Document Object (case 1:lookup doc key exists),(case 2:lookup doc key not exists but lookup line doc output exist)" + NL + "\t\t\t\t\t\t\t\t\troutines.system.Document lookupDoc_";
  ...
  protected final String TEXT_379 = NL + "\t\t\t\t\t\t\t\t\troutines.system.Document lookupDoc_";
