...
public class TXMLMapBeginJava {
  ...
  protected final String TEXT_159 = "\")!=null) {" + NL + "\t\t\troutines.system.NestXMLTool.setText(";
  ...
  protected final String TEXT_190 = NL + "class GenerateDocument_";
  protected final String TEXT_191 = " {" + NL;
  protected final String TEXT_192 = NL + "\t\tTreeNode_API_";
  protected final String TEXT_193 = " treeNodeAPI = null;";
  protected final String TEXT_194 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\troutines.system.DocumentGenerateOrderHelper orderHelper = new routines.system.DocumentGenerateOrderHelper(";
  protected final String TEXT_195 = ");" + NL + "\t\t" + NL + "\torg.dom4j.Document doc = null;" + NL + "\t" + NL + "\torg.dom4j.Element root4Group = null;" + NL + "\t" + NL + "\torg.dom4j.io.OutputFormat format = null;" + NL + "\t" + NL + "\tjava.util.List<java.util.List<String>> groupbyList = null;" + NL + "\tjava.util.List<org.dom4j.Element> groupElementList = null;" + NL + "\tint order = 0;" + NL + "\t" + NL + "\tboolean isFirst = true;" + NL + "\t" + NL + "\tboolean\tneedRoot = true;";
  protected final String TEXT_196 = NL + "\t" + NL + "    public GenerateDocument_";
  protected final String TEXT_197 = "() {" + NL + "//    \tthis.treeNodeAPI = treeNodeAPI;" + NL + "    \t" + NL + "    \tvalueMap = new java.util.HashMap<String,Object>();" + NL + "    \t" + NL + "    \tgroupbyList =  new java.util.ArrayList<java.util.List<String>>();" + NL + "\t\tgroupElementList = new java.util.ArrayList<org.dom4j.Element>();" + NL + "    \t" + NL + "    \tdoc = org.dom4j.DocumentHelper.createDocument();" + NL + "    \tformat = org.dom4j.io.OutputFormat.createPrettyPrint();" + NL + "    \tformat.setTrimText(false);" + NL + "    }" + NL + "    " + NL + "    public org.dom4j.Document getDocument(){" + NL + "\t\tgenerateOk();" + NL + "    \treturn this.doc;" + NL + "    }" + NL + "    " + NL + "    //do some work after document has been generated" + NL + "    private void generateOk() {" + NL + "    \troutines.system.NestXMLTool.replaceDefaultNameSpace(this.doc.getRootElement(),null);";
  protected final String TEXT_198 = NL + "\t\troutines.system.NestXMLTool.removeEmptyElement(this.doc.getRootElement());";
  protected final String TEXT_199 = NL + "    }" + NL + "\t" + NL + "\t//We generate the TreeNode_API object only if there is a document in the main input table." + NL + "    void generateElements(";
  protected final String TEXT_200 = "TreeNode_API_";
  protected final String TEXT_201 = " treeNodeAPI,";
  protected final String TEXT_202 = "boolean isInnerJoin";
  protected final String TEXT_203 = ", ";
  protected final String TEXT_204 = " ";
  protected final String TEXT_205 = NL + "\t";
  protected final String TEXT_206 = ") {" + NL + "\t" + NL + "\t" + NL + "\t/*if(this.treeNodeAPI==null) {" + NL + "\t\tthis.treeNodeAPI = treeNodeAPI;" + NL + "\t}*/" + NL + "\t" + NL + "\torg.dom4j.Element subTreeRootParent = null;" + NL + "// build root xml tree " + NL + "if (needRoot) {" + NL + "\tneedRoot=false;";
  protected final String TEXT_207 = NL + "\t\troot4Group = subTreeRootParent;" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent=root4Group;" + NL + "\t}" + NL + "\t/* build group xml tree */" + NL + "\tboolean isNewElement = false;";
  protected final String TEXT_208 = NL + "\t\tisNewElement = false;";
  protected final String TEXT_209 = NL + "\t\t}" + NL + "    }" + NL;
  protected final String TEXT_210 = NL;
  protected final String TEXT_211 = NL + "\t            class SortableRow_";
  protected final String TEXT_212 = " implements Comparable<SortableRow_";
  protected final String TEXT_213 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_214 = "> { // G_TM_B_001 " + NL + "\t" + NL + "\t\t\t\t\tboolean is__rejectedInnerJoin;" + NL + "\t\t\t\t\t";
  protected final String TEXT_215 = " exprKey_";
  ...
  protected final String TEXT_223 = NL + "\t\t\t        public void fillFrom(";
  protected final String TEXT_224 = " ";
  protected final String TEXT_225 = "Struct ";
  protected final String TEXT_226 = " ";
  protected final String TEXT_227 = " exprKey_";
  ...
  protected final String TEXT_238 = " = exprKey_";
  protected final String TEXT_239 = "__";
  protected final String TEXT_240 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_241 = NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        public void copyDataTo(";
  ...
  protected final String TEXT_248 = NL + "\t\t\t        }" + NL + "\t\t\t\t\tpublic String toString() {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\t\t\t\t\tsb.append(super.toString());" + NL + "\t\t\t\t\t\tsb.append(\"[\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_249 = NL + "\t\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_250 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_251 = NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_252 = "__";
  protected final String TEXT_253 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_254 = "__";
  protected final String TEXT_255 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_256 = NL + "\t\t\t\t\t\tsb.append(\"]\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\treturn sb.toString();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_257 = " other) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            ";
  protected final String TEXT_258 = NL + "\t\t\t            \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_259 = "__";
  protected final String TEXT_260 = ", other.exprKey_";
  protected final String TEXT_261 = "__";
  protected final String TEXT_262 = ");" + NL + "\t\t\t            \tif (returnValue != 0) {" + NL + "\t\t\t                    return returnValue;" + NL + "\t\t\t            \t}" + NL + "\t\t\t            ";
  protected final String TEXT_263 = NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int checkNullsAndCompare(Object object1, Object object2) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            if (object1 instanceof Comparable && object2 instanceof Comparable) {" + NL + "\t\t\t                returnValue = ((Comparable) object1).compareTo(object2);" + NL + "\t\t\t            } else if (object1 != null && object2 != null) {" + NL + "\t\t\t                returnValue = compareStrings(object1.toString(), object2" + NL + "\t\t\t                        .toString());" + NL + "\t\t\t            } else if (object1 == null && object2 != null) {" + NL + "\t\t\t                returnValue = 1;" + NL + "\t\t\t            } else if (object1 != null && object2 == null) {" + NL + "\t\t\t                returnValue = -1;" + NL + "\t\t\t            } else {" + NL + "\t\t\t                returnValue = 0;" + NL + "\t\t\t            }" + NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int compareStrings(String string1, String string2) {" + NL + "\t\t\t            return string1.compareTo(string2);" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t\t\tpublic void readData(ObjectInputStream dis) {" + NL + "\t\t\t\t\t\tsynchronized(";
  protected final String TEXT_264 = "Struct.commonByteArrayLock_";
  protected final String TEXT_265 = "_";
  protected final String TEXT_266 = ") {" + NL + "\t\t\t\t\t\t    try {" + NL + "\t\t\t\t\t\t\t\tint length = 0;" + NL + "\t\t\t\t\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\t\t            this.";
  protected final String TEXT_268 = "__";
  protected final String TEXT_269 = " = dis.read";
  protected final String TEXT_270 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_271 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_272 = "__";
  protected final String TEXT_273 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_274 = "Struct.commonByteArray_";
  protected final String TEXT_275 = "_";
  protected final String TEXT_276 = ".length) {" + NL + "\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_277 = "Struct.commonByteArray_";
  protected final String TEXT_278 = "_";
  protected final String TEXT_279 = ".length == 0) {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_280 = "Struct.commonByteArray_";
  protected final String TEXT_281 = "_";
  protected final String TEXT_282 = " = new byte[1024];" + NL + "\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_283 = "Struct.commonByteArray_";
  protected final String TEXT_284 = "_";
  protected final String TEXT_285 = " = new byte[2 * length];" + NL + "\t\t\t           \t\t\t\t}" + NL + "\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_286 = "Struct.commonByteArray_";
  protected final String TEXT_287 = "_";
  protected final String TEXT_288 = ", 0, length);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_289 = "__";
  protected final String TEXT_290 = " = new String(";
  protected final String TEXT_291 = "Struct.commonByteArray_";
  protected final String TEXT_292 = "_";
  protected final String TEXT_293 = ", 0, length);" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_295 = "__";
  protected final String TEXT_296 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.";
  protected final String TEXT_297 = "__";
  protected final String TEXT_298 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_300 = "__";
  protected final String TEXT_301 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_302 = "__";
  protected final String TEXT_303 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_304 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_305 = "__";
  protected final String TEXT_306 = " = (";
  protected final String TEXT_307 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_309 = "__";
  protected final String TEXT_310 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.";
  protected final String TEXT_311 = "__";
  protected final String TEXT_312 = " = dis.read";
  protected final String TEXT_313 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_314 = NL + "\t\t\t            ";
  protected final String TEXT_315 = NL + "\t\t\t\t            this.exprKey_";
  protected final String TEXT_316 = "__";
  protected final String TEXT_317 = " = dis.read";
  protected final String TEXT_318 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_319 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_320 = "__";
  protected final String TEXT_321 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.exprKey_";
  protected final String TEXT_322 = "__";
  protected final String TEXT_323 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_324 = NL + "\t\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_325 = "__";
  protected final String TEXT_326 = " = null;" + NL + "\t\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_327 = "Struct.commonByteArray_";
  protected final String TEXT_328 = "_";
  protected final String TEXT_329 = ".length) {" + NL + "\t\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_330 = "Struct.commonByteArray_";
  protected final String TEXT_331 = "_";
  protected final String TEXT_332 = ".length == 0) {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_333 = "Struct.commonByteArray_";
  protected final String TEXT_334 = "_";
  protected final String TEXT_335 = " = new byte[1024];" + NL + "\t\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_336 = "Struct.commonByteArray_";
  protected final String TEXT_337 = "_";
  protected final String TEXT_338 = " = new byte[2 * length];" + NL + "\t\t\t\t           \t\t\t\t}" + NL + "\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_339 = "Struct.commonByteArray_";
  protected final String TEXT_340 = "_";
  protected final String TEXT_341 = ", 0, length);" + NL + "\t\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_342 = "__";
  protected final String TEXT_343 = " = new String(";
  protected final String TEXT_344 = "Struct.commonByteArray_";
  protected final String TEXT_345 = "_";
  protected final String TEXT_346 = ", 0, length);" + NL + "\t\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_348 = "__";
  protected final String TEXT_349 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_350 = "__";
  protected final String TEXT_351 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_352 = NL + "\t\t\t   \t\t\t\tthis.exprKey_";
  protected final String TEXT_353 = "__";
  protected final String TEXT_354 = " = (";
  protected final String TEXT_355 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_357 = "__";
  protected final String TEXT_358 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.exprKey_";
  protected final String TEXT_359 = "__";
  protected final String TEXT_360 = " = dis.read";
  protected final String TEXT_361 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_362 = NL + "\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t";
  protected final String TEXT_363 = NL + "\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t} " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\tpublic void writeData(ObjectOutputStream dos) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t   \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "\t\t\t\t\t";
  protected final String TEXT_366 = NL + "\t\t\t            \tdos.write";
  ...
  protected final String TEXT_372 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_373 = "__";
  protected final String TEXT_374 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_375 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_376 = "__";
  protected final String TEXT_377 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_378 = "__";
  protected final String TEXT_379 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_381 = "__";
  protected final String TEXT_382 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_383 = "__";
  protected final String TEXT_384 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.";
  protected final String TEXT_385 = "__";
  protected final String TEXT_386 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_387 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_388 = "__";
  protected final String TEXT_389 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_391 = "__";
  protected final String TEXT_392 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_393 = "(this.";
  protected final String TEXT_394 = "__";
  protected final String TEXT_395 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t            ";
  protected final String TEXT_397 = NL + "\t\t\t\t            dos.write";
  protected final String TEXT_398 = "(this.exprKey_";
  ...
  protected final String TEXT_403 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_404 = "__";
  protected final String TEXT_405 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_406 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_407 = "__";
  protected final String TEXT_408 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_409 = "__";
  protected final String TEXT_410 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_412 = "__";
  protected final String TEXT_413 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_414 = "__";
  protected final String TEXT_415 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_416 = "__";
  protected final String TEXT_417 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_418 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.exprKey_";
  ...
  protected final String TEXT_423 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_424 = "(this.exprKey_";
  protected final String TEXT_425 = "__";
  protected final String TEXT_426 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_427 = NL + "\t\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t    }" + NL + "\t\t\t}" + NL + "\t     }" + NL + "\t   ";
