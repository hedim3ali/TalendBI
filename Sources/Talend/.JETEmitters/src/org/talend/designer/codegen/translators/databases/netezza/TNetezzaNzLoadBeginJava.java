...
public class TNetezzaNzLoadBeginJava {
  ...
  protected final String TEXT_111 = NL + "\t\tjava.lang.Class.forName(\"org.netezza.Driver\");" + NL + "\t\tString url_";
  protected final String TEXT_112 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_119 = ";" + NL + "\t\tString tableName_";
  ...
  protected final String TEXT_125 = " - Connection attempt to '\" + url_";
  protected final String TEXT_126 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_127 = " + \"'.\");" + NL + "\t\t";
  protected final String TEXT_128 = NL + "\t\tconn_";
  protected final String TEXT_129 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_130 = ", dbUser_";
  protected final String TEXT_131 = ", dbPwd_";
  protected final String TEXT_132 = ");" + NL + "\t\t";
  protected final String TEXT_133 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_134 = " - Connection to '\" + url_";
  ...
  protected final String TEXT_141 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_147 = " - Drop table '\" + tableName_";
  protected final String TEXT_148 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_150 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_164 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_165 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_166 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_167 = " - Failure on DROP_CREATE action, process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\t\t\t throw new RuntimeException (\"Failure on DROP_CREATE action, process terminated\");" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_169 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_170 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_174 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_180 = " - Create table '\" + tableName_";
  protected final String TEXT_181 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_183 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_184 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_186 = " - Table '\" + tableName_";
  protected final String TEXT_187 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName_";
  protected final String TEXT_189 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_191 = " - Table '\" + tableName_";
  protected final String TEXT_192 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_218 = " - Create table \" + tableName_";
  protected final String TEXT_219 = " + \"' has succeeded. \");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_220 = " " + NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_221 = ".close();" + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_222 = "){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_223 = NL + "\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_224 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_225 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_227 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_228 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_229 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_230 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_232 = NL + "                if(whetherExist_";
  protected final String TEXT_233 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_234 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".createStatement();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_237 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_238 = " - Droping table '\" + tableName_";
  protected final String TEXT_239 = " + \"'.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_240 = NL + "                    \tstmtDrop_";
  protected final String TEXT_241 = ".execute(\"";
  protected final String TEXT_242 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_243 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_244 = " - Drop table '\" + tableName_";
  protected final String TEXT_245 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_246 = NL + "\t\t\t\t\t\tstmtDrop_";
  protected final String TEXT_247 = ".close();" + NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_248 = ")" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_249 = NL + "\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_250 = " - Failure to drop table '\" + tableName_";
  protected final String TEXT_251 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_252 = NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName_";
  protected final String TEXT_253 = "  + \"'. process terminated\");" + NL + "                    \t" + NL + "                    \telse" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_254 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_255 = " - Failure to drop table '\" + tableName_";
  protected final String TEXT_256 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_257 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_268 = " - Drop table '\" + tableName_";
  protected final String TEXT_269 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_271 = ".close();" + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_272 = "){" + NL + "                \t\t";
  protected final String TEXT_273 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_274 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_275 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_277 = "  + \"'. process terminated\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_278 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_279 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_280 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_282 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_283 = " = conn_";
  protected final String TEXT_284 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_285 = " = stmtClearCount_";
  protected final String TEXT_286 = ".executeQuery(\"";
  protected final String TEXT_287 = "\");" + NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_291 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_297 = " - Truncate table '\" + tableName_";
  protected final String TEXT_298 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_299 = NL + "            while(rsClearCount_";
  protected final String TEXT_300 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_301 = " = rsClearCount_";
  protected final String TEXT_302 = ".getInt(1);" + NL + "            }" + NL + "            stmtClearCount_";
  protected final String TEXT_303 = ".close();" + NL + "\t\t\tstmtClear_";
  protected final String TEXT_304 = ".close();";
  protected final String TEXT_305 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_306 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  ...
  protected final String TEXT_310 = " - Clearing table '\" + tableName_";
  protected final String TEXT_311 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_312 = NL + "            \tdeletedCount_";
  protected final String TEXT_313 = " = stmtClear_";
  protected final String TEXT_314 = ".executeUpdate(\"";
  protected final String TEXT_315 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_317 = " - Clear table '\" + tableName_";
  protected final String TEXT_318 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_319 = NL + "            \tstmtClear_";
  protected final String TEXT_320 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_321 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_323 = " - Failure to clear table '\" + tableName_";
  protected final String TEXT_324 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName_";
  protected final String TEXT_326 = "  + \"'. process terminated\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_328 = " - Failure to clear table '\" + tableName_";
  protected final String TEXT_329 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_330 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_331 = NL + "        conn_";
  protected final String TEXT_332 = ".close();";
  protected final String TEXT_333 = NL;
  protected final String TEXT_334 = NL + "\tfinal StringBuilder nzloadOutput_";
  protected final String TEXT_335 = " = new StringBuilder(200);" + NL + "\t//final " + NL + "\t" + NL + "\tThread nzloadThread_";
  protected final String TEXT_336 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_337 = " ";
  protected final String TEXT_338 = ",";
  protected final String TEXT_339 = "};" + NL + "\t\t\t\t" + NL + "\t\t\t\t// added \"print command\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_340 = NL + "\t\t\t\t    System.out.println(\"INFO: executing nzload command:\");" + NL + "\t\t\t\t    for( String cmd : cmds ) {" + NL + "\t\t\t\t\t       System.out.print(cmd + \" \");" + NL + "\t\t\t\t\t }" + NL + "\t\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\t\t" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\t" + NL + "" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\t// fixed no showing of error messages" + NL + "\t\t\t\tjava.io.BufferedReader errReader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getErrorStream()));" + NL + "\t\t\t\t" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\tString errLine = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tif((errLine = errReader.readLine()) != null) {" + NL + "\t\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_342 = ".append(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_343 = NL + "\t\t\t\t\t\t\t\tSystem.out.println(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_345 = ".append(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_348 = NL + "\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_349 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_350 = NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_351 = "_NZLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\t";
  protected final String TEXT_352 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_353 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_354 = ", true, true, 1024000, 10000);" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_355 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by nzload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_356 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_357 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_358 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_359 = NL + "\t\t";
  protected final String TEXT_360 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_361 = " - Loading data into database.\");" + NL + "\t\t";
  protected final String TEXT_362 = NL + "\tnzloadThread_";
  protected final String TEXT_363 = ".start();" + NL + "\tnzloadThread_";
  protected final String TEXT_364 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_365 = "_NZLOAD_OUTPUT\", nzloadOutput_";
  protected final String TEXT_366 = ".toString());" + NL + "\t\t";
  protected final String TEXT_367 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_368 = " - Loaded data finished.\");" + NL + "\t\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_122);
	   		...
	   		log4jCodeGenerateUtil.debugConnectionParams(node,"org.netezza.Driver");	
