...
public class TGSDeleteBeginJava
{
  ...
  protected final String TEXT_65 = ".get(\"OBJECT_DELIMITER\"));" + NL + "\t\t\t\t}catch(org.jets3t.service.ServiceException e_";
  protected final String TEXT_66 = "){";
  protected final String TEXT_67 = NL + "\t\t\t\t\tthrow(e_";
  protected final String TEXT_68 = ");";
  protected final String TEXT_69 = NL + "\t\t\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_70 = ":\");" + NL + "\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_71 = ".getMessage());" + NL + "\t\t\t\t\tif(e_";
  protected final String TEXT_72 = ".getErrorCode()!=null){" + NL + "\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_73 = ".getErrorCode());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif(e_";
  protected final String TEXT_74 = ".getErrorMessage()!=null){" + NL + "\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_75 = ".getErrorMessage());" + NL + "\t\t\t\t\t}";
  protected final String TEXT_76 = NL + "\t\t\t\t}";
  protected final String TEXT_77 = NL + "\t\t\t\tfor (org.jets3t.service.model.GSObject objectSummary_";
  protected final String TEXT_78 = " : objects_";
  protected final String TEXT_79 = ") {" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_80 = "++;" + NL + "\t\t\t\t\tservice_";
  protected final String TEXT_81 = ".deleteObject(currentBucketName_";
  protected final String TEXT_82 = ",objectSummary_";
