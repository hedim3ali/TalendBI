...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_24 = ";" + NL + "    \tString schema_";
  ...
  protected final String TEXT_31 = NL + "\t\tString tableName_";
  ...
  protected final String TEXT_37 = " = schema_";
  protected final String TEXT_38 = " +  \"\\\".\\\"\" + ";
  protected final String TEXT_39 = ";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString fileName_";
  protected final String TEXT_40 = " = ";
  protected final String TEXT_41 = ";" + NL + "\t\t";
  protected final String TEXT_42 = NL;
  protected final String TEXT_43 = NL + "\t\tString sqlLoadPending_";
  protected final String TEXT_44 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\tjava.sql.CallableStatement callStmtLoadPending_";
  protected final String TEXT_45 = " = conn_";
  protected final String TEXT_46 = ".prepareCall(sqlLoadPending_";
  protected final String TEXT_47 = ");" + NL + "        callStmtLoadPending_";
  protected final String TEXT_48 = ".setString(1, \"load from  /dev/null  of del terminate into \\\"\" + tableName_";
  protected final String TEXT_49 = " + \"\\\"\");" + NL + "        try {" + NL + "        \tcallStmtLoadPending_";
  protected final String TEXT_50 = ".execute();   " + NL + "        } catch (java.sql.SQLException e) { " + NL + "        \t//when table not in load pending mode will throw exception." + NL + "        \t//and do nothing." + NL + "        }" + NL + "        callStmtLoadPending_";
  ...
  protected final String TEXT_55 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_79 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_80 = " = dbMetaData_";
  protected final String TEXT_81 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_82 = ", tableNameForSearch_";
  protected final String TEXT_83 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_84 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_85 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_86 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_90 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_91 = " = dbMetaData_";
  protected final String TEXT_92 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_93 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_94 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_95 = " = rsTable_";
  protected final String TEXT_96 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_97 = " = rsTable_";
  protected final String TEXT_98 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_99 = ".equalsIgnoreCase(";
  protected final String TEXT_100 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_101 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_102 = ") || dbschema_";
  protected final String TEXT_103 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_104 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_108 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_109 = " = dbMetaData_";
  protected final String TEXT_110 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_111 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_112 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_113 = " = rsTable_";
  protected final String TEXT_114 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  protected final String TEXT_115 = " = rsTable_";
  protected final String TEXT_116 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_117 = ".equals(";
  protected final String TEXT_118 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_119 = ".equals(schema_";
  protected final String TEXT_120 = ") || (schema_";
  protected final String TEXT_121 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_122 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_131 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_132 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_133 = " == null || dbschema_";
  protected final String TEXT_134 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_137 = " = stmtSchema_";
  protected final String TEXT_138 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_139 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_140 = " = rsSchema_";
  protected final String TEXT_141 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_142 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_143 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_157 = " ==null || dbschema_";
  protected final String TEXT_158 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_181 = NL + "                if(!whetherExist_";
  protected final String TEXT_182 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_189 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_192 = ".execute(\"";
  protected final String TEXT_193 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_194 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_200 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_203 = ".executeUpdate(\"";
  ...
  protected final String TEXT_222 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_223 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_224 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_225 = NL;
  protected final String TEXT_226 = NL;
  protected final String TEXT_227 = NL + "        String action_";
  protected final String TEXT_228 = " = \"";
  protected final String TEXT_229 = "\";" + NL + "        java.sql.CallableStatement callStmt_";
  protected final String TEXT_230 = " = null;" + NL + "        String sql_";
  protected final String TEXT_231 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        String param_";
  protected final String TEXT_232 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_233 = " + \"\\\" OF ";
  protected final String TEXT_234 = " DEL MODIFIED BY COLDEL\"+ ";
  protected final String TEXT_235 = " + " + NL + "        \t\t\t\t\" dateformat=\\\"\"+ ";
  protected final String TEXT_236 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_237 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_238 = " +\"\\\" ";
  protected final String TEXT_239 = " \" +" + NL + "        \t\t\t\t action_";
  protected final String TEXT_240 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_241 = " + \"\\\" ";
  protected final String TEXT_242 = "\";     \t\t\t" + NL + "        callStmt_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".prepareCall(sql_";
  protected final String TEXT_245 = ");" + NL + "        callStmt_";
  protected final String TEXT_246 = ".setString(1, param_";
  protected final String TEXT_247 = ");" + NL + "        callStmt_";
  protected final String TEXT_248 = ".execute();        " + NL + "        callStmt_";
  protected final String TEXT_249 = ".close();";
  protected final String TEXT_250 = NL + "            int keyCount_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_253 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_254 = " = tableName_";
  protected final String TEXT_255 = ";" + NL + "            tableName_";
  protected final String TEXT_256 = " = \"tmp_";
  protected final String TEXT_257 = "\" + \"_\" + pid; " + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_258 = " = conn_";
  protected final String TEXT_259 = ".createStatement();" + NL + "            " + NL + "" + NL + "            " + NL + "            stmtCreateTmp_";
  protected final String TEXT_260 = ".execute(\"";
  protected final String TEXT_261 = "\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_262 = ".close();" + NL + "                        " + NL + "        \tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_263 = " = null;" + NL + "        \tString sql_";
  protected final String TEXT_264 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        \tString param_";
  protected final String TEXT_265 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_266 = ".replace(\"\\\\\",\"/\") + \"\\\" OF ";
  protected final String TEXT_267 = " DEL MODIFIED BY COLDEL\" + ";
  protected final String TEXT_268 = " + " + NL + "        \t\t\t\t\t\t\t\" dateformat=\\\"\"+";
  protected final String TEXT_269 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_270 = "+ \"\\\" timestampformat=\\\"\" + ";
  protected final String TEXT_271 = "+\"\\\"\" + " + NL + "        \t\t\t\t\t\t\t\" ";
  protected final String TEXT_272 = " INSERT INTO \\\"\"  + tableName_";
  protected final String TEXT_273 = " + \"\\\" ";
  protected final String TEXT_274 = "\"; \t        \t\t\t" + NL + "        \t" + NL + "        \tcallStmt_";
  protected final String TEXT_275 = " = conn_";
  protected final String TEXT_276 = ".prepareCall(sql_";
  protected final String TEXT_277 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_278 = ".setString(1, param_";
  protected final String TEXT_279 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_280 = ".execute();        " + NL + "        \tcallStmt_";
  protected final String TEXT_281 = ".close();            " + NL + "                    \t\t\t" + NL + "            tableName_";
  protected final String TEXT_282 = " = tmpTableName_";
  protected final String TEXT_283 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_284 = " = \"tmp_";
  protected final String TEXT_285 = "\"+ \"_\" + pid;             " + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_286 = " = conn_";
  protected final String TEXT_287 = ".createStatement();" + NL + "                        " + NL + "            stmtUpdateBulk_";
  protected final String TEXT_288 = ".executeUpdate(\"";
  protected final String TEXT_289 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_290 = ".close();           " + NL + "            " + NL + "            tableName_";
  protected final String TEXT_291 = " = \"tmp_";
  protected final String TEXT_292 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_293 = " = conn_";
  protected final String TEXT_294 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_295 = ".execute(\"";
  protected final String TEXT_296 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_297 = ".close();";
  protected final String TEXT_298 = NL + NL + NL + NL + NL + NL;
