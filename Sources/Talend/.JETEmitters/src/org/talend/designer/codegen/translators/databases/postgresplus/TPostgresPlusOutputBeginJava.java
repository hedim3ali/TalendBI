...
public class TPostgresPlusOutputBeginJava {
  ...
  protected final String TEXT_84 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_85 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_86 = " == null || dbschema_";
  protected final String TEXT_87 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_88 = " = conn_";
  protected final String TEXT_89 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_90 = " = stmtSchema_";
  protected final String TEXT_91 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_92 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_93 = " = rsSchema_";
  protected final String TEXT_94 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_95 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_96 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  ...
  protected final String TEXT_102 = ".equals(";
  protected final String TEXT_103 = ") " + NL + "                \t&& (schema_";
  protected final String TEXT_104 = ".equals(dbschema_";
  protected final String TEXT_105 = ") || ((dbschema_";
  protected final String TEXT_106 = " == null || dbschema_";
  protected final String TEXT_107 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_108 = ".equals(schema_";
  ...
  protected final String TEXT_115 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_125 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_163 = NL + "\t    String update_";
  protected final String TEXT_164 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_169 = ".prepareStatement(update_";
  protected final String TEXT_170 = ");" + NL + "\t    ";
  protected final String TEXT_171 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_172 = " = conn_";
  protected final String TEXT_173 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_179 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_183 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_184 = " + \"\\\" SET ";
  protected final String TEXT_185 = " WHERE ";
  protected final String TEXT_186 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_191 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_198 = " = \"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_205 = NL + "\t    String delete_";
  protected final String TEXT_206 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_210 = ".prepareStatement(delete_";
