...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_214 = " = \"jdbc:sqlite:\" + \"/\" + ";
  ...
  protected final String TEXT_238 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_239 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_240 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_241 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_242 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_250 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  ...
  protected final String TEXT_392 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_393 = ".getObject(column_index_";
  protected final String TEXT_394 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_395 = ".";
  protected final String TEXT_396 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_405 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_406 = NL + "\t\t\t\t\t";
  protected final String TEXT_407 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_408 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_409 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_410 = " - Content of the record \" + nb_line_";
  protected final String TEXT_411 = " + \": \" + log4jSb_";
  protected final String TEXT_412 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_413 = ".delete(0,log4jSb_";
  protected final String TEXT_414 = ".length());" + NL + "\t\t\t\t\t";
