...
public class TGreenplumGPLoadEndJava {
  ...
  protected final String TEXT_7 = " - Loading data into database.\");" + NL + "\t\t\t";
  protected final String TEXT_8 = NL + "\t";
  protected final String TEXT_9 = NL + "\t\t\tgploadThread_";
  protected final String TEXT_10 = ".join(0);" + NL + "\t\t\t";
  protected final String TEXT_11 = NL + "\t\t\tgploadThread_";
  protected final String TEXT_12 = ".start();" + NL + "\t\t\tgploadThread_";
  protected final String TEXT_13 = ".join(0);" + NL + "\t\t\t";
  protected final String TEXT_14 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_15 = " - Loaded records count:\"+insertedCount_";
  protected final String TEXT_16 = " + \".\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_17 = " - Done.\");" + NL + "\t\t\t";
  protected final String TEXT_18 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_19 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_20 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_21 = "_NB_LINE\", insertedCount_";
