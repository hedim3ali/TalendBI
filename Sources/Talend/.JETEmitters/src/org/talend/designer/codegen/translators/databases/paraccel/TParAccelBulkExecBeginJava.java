...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_18 = NL + "\tString xpxSQL_";
  protected final String TEXT_19 = "=\"\";" + NL + "\tString bulkSQL_";
  protected final String TEXT_20 = "=\"\";";
  protected final String TEXT_21 = NL + "\txpxSQL_";
  protected final String TEXT_22 = " += \"xpx 'localize \\\"\" + tableName_";
  protected final String TEXT_23 = " +\"\\\"\" + ";
  protected final String TEXT_24 = " + \" ";
  protected final String TEXT_25 = "'\";" + NL + "\tbulkSQL_";
  protected final String TEXT_26 = " += \"COPY \\\"\" + tableName_";
  protected final String TEXT_27 = " + \"\\\"\" + " + NL + "\t\t\" FROM 'local' WITH PARALLEL ";
  protected final String TEXT_28 = " \";";
  protected final String TEXT_29 = NL + "\tbulkSQL_";
  protected final String TEXT_30 = " += \"COPY \\\"\" + tableName_";
  protected final String TEXT_31 = " + \"\\\"\" + \"";
  protected final String TEXT_32 = "FROM '\" +" + NL + "\t\t";
  protected final String TEXT_33 = " + \"' WITH ";
  protected final String TEXT_34 = " \";";
  protected final String TEXT_35 = NL + "\tbulkSQL_";
  protected final String TEXT_36 = " += \"DELIMITER '\" + ";
  protected final String TEXT_37 = " + \"' \";";
  protected final String TEXT_38 = NL + "\t\t\tbulkSQL_";
  protected final String TEXT_39 = " += \"FIXEDWIDTH '\" + ";
  protected final String TEXT_40 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_41 = NL + "\t\tbulkSQL_";
  protected final String TEXT_42 = " += \"FIXEDWIDTH '\";" + NL + "\t\t";
  ...
  protected final String TEXT_54 = " += \"REMOVEQUOTES \";";
  protected final String TEXT_55 = NL + "\tbulkSQL_";
  protected final String TEXT_56 = " += \"EXPLICIT_IDS \";";
  protected final String TEXT_57 = NL + "\tbulkSQL_";
  protected final String TEXT_58 = " += \"MAXERROR \" + ";
  protected final String TEXT_59 = " + \" \";";
  protected final String TEXT_60 = NL + "\tbulkSQL_";
  protected final String TEXT_61 = " += \"DATEFORMAT '\" + ";
  protected final String TEXT_62 = " + \"' \";";
  protected final String TEXT_63 = NL + "\tbulkSQL_";
  protected final String TEXT_64 = " += \"TIMEFORMAT '\" + ";
  protected final String TEXT_65 = " + \"' \";";
  protected final String TEXT_66 = NL + "\tbulkSQL_";
  protected final String TEXT_67 = " += ";
  protected final String TEXT_68 = " + \" \";";
  protected final String TEXT_69 = " " + NL + "if (";
  protected final String TEXT_70 = " > 0) {" + NL + "\tjava.io.Writer output_";
  protected final String TEXT_71 = " = new java.io.FileWriter(";
  protected final String TEXT_72 = ", true);" + NL + "\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_73 = ",true));" + NL + "}\t" + NL + "com.paraccel.Driver.setLogLevel(";
  ...
  protected final String TEXT_79 = NL + "\t\tjava.lang.Class.forName(\"com.paraccel.Driver\").newInstance();" + NL + "\t\tconn_";
  protected final String TEXT_80 = " = java.sql.DriverManager.getConnection(\"jdbc:paraccel://\" + ";
  protected final String TEXT_81 = " + \":\" + ";
  protected final String TEXT_82 = " + \"/\" + ";
  protected final String TEXT_83 = "+\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_84 = "+\"&protocolVersion=3\", ";
  protected final String TEXT_85 = ", ";
  protected final String TEXT_86 = ");" + NL + "\t";
  protected final String TEXT_87 = NL;
  protected final String TEXT_88 = NL + "\t";
  protected final String TEXT_89 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_90 = " = conn_";
  protected final String TEXT_91 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_92 = ".execute(\"";
  protected final String TEXT_93 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_94 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_136 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_137 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_138 = ") || dbschema_";
  protected final String TEXT_139 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_150 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_154 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_155 = ".equals(schema_";
  protected final String TEXT_156 = ") || (schema_";
  protected final String TEXT_157 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_158 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_217 = NL + "                if(!whetherExist_";
  protected final String TEXT_218 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_232 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_238 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_239 = ".executeUpdate(\"";
  protected final String TEXT_240 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_241 = ".close();";
  protected final String TEXT_242 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_245 = " = stmtTruncCount_";
  protected final String TEXT_246 = ".executeQuery(\"";
  protected final String TEXT_247 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_248 = " = conn_";
  protected final String TEXT_249 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_250 = ".executeUpdate(\"";
  protected final String TEXT_251 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_252 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_253 = " += rsTruncCount_";
  protected final String TEXT_254 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_255 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_256 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_257 = ".close();            ";
  protected final String TEXT_258 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_259 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_260 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_261 = NL + "\t";
  protected final String TEXT_262 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_263 = " = conn_";
  protected final String TEXT_264 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_265 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_266 = " = conn_";
  protected final String TEXT_267 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_268 = ".execute(xpxSQL_";
  protected final String TEXT_269 = ");" + NL + "    stmtXPX_";
  protected final String TEXT_270 = ".close();    ";
  protected final String TEXT_271 = NL + "    stmtBulk_";
  protected final String TEXT_272 = ".execute(bulkSQL_";
  protected final String TEXT_273 = ");" + NL + "    stmtBulk_";
