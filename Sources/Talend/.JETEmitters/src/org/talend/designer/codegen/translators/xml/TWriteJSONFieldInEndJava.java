...
public class TWriteJSONFieldInEndJava
{
  ...
  protected final String TEXT_2 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif (globalMap.containsKey(readFinishMarkWithPipeId_";
  protected final String TEXT_3 = ")) {" + NL + "\t\t\t\t\t\tif (queue_";
  ...
  protected final String TEXT_10 = NL + "\t\t\t\tglobalMap.put(readFinishMarkWithPipeId_";
  protected final String TEXT_11 = ",null);//syn" + NL + "\t\t\t\tglobalMap.remove(readFinishMarkWithPipeId_";
