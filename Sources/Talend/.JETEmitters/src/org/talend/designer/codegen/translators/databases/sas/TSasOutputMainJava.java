...
public class TSasOutputMainJava {
  ...
  protected final String TEXT_34 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_46 = "_QUERY\", query_";
  protected final String TEXT_47 = ".toString().trim());";
  protected final String TEXT_48 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_49 = " = updatedCount_";
  protected final String TEXT_50 = " + pstmt_";
  protected final String TEXT_51 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_52 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_64 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_65 = NL + "                        ";
  protected final String TEXT_66 = ".errorMessage = e.getMessage();";
  protected final String TEXT_67 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_89 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_90 = " = updatedCount_";
  protected final String TEXT_91 = " + pstmtUpdate_";
  protected final String TEXT_92 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_93 = " = true;";
  protected final String TEXT_94 = NL + "                        throw(e);";
  ...
  protected final String TEXT_104 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_133 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_148 = "_QUERY\", query_";
  protected final String TEXT_149 = ".toString().trim());";
  protected final String TEXT_150 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_151 = " = pstmtUpdate_";
  protected final String TEXT_152 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_153 = " = updatedCount_";
  protected final String TEXT_154 = " + updateFlag_";
  protected final String TEXT_155 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_169 = ".errorMessage = e.getMessage();";
  protected final String TEXT_170 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_171 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_172 = " == 0) {" + NL + "            \t";
  protected final String TEXT_173 = NL + "\t\t\t\tquery_";
  protected final String TEXT_174 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_185 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_199 = ".errorMessage = e.getMessage();";
  protected final String TEXT_200 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_201 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  ...
  protected final String TEXT_210 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_211 = " = deletedCount_";
  protected final String TEXT_212 = " + pstmt_";
  protected final String TEXT_213 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_227 = ".errorMessage = e.getMessage();";
  protected final String TEXT_228 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_229 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_230 = "++;";
  protected final String TEXT_231 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_242 = NL + "                commitCounter_";
  protected final String TEXT_243 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_244 = " <= commitCounter_";
  protected final String TEXT_245 = ") {" + NL + "                    connection_";
  protected final String TEXT_246 = ".commit();" + NL + "                    commitCounter_";
