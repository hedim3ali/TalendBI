...
public class THSQLDbOutputMainJava {
  ...
  protected final String TEXT_70 = NL + "                        rejectedCount_";
  protected final String TEXT_71 = " = rejectedCount_";
  protected final String TEXT_72 = " + 1;";
  protected final String TEXT_73 = NL + "                        ";
  protected final String TEXT_74 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_75 = NL + "                        ";
  protected final String TEXT_76 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_77 = ";";
  protected final String TEXT_78 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_123 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_154 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_155 = "++;";
  protected final String TEXT_156 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_169 = "  " + NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_194 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_195 = " == 0) {" + NL + "            \t";
  protected final String TEXT_196 = NL + "\t\t\t\tquery_";
  protected final String TEXT_197 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_208 = ".executeUpdate();  " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_228 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_237 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_238 = " = deletedCount_";
  protected final String TEXT_239 = " + pstmt_";
  protected final String TEXT_240 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_241 = " = true;";
  protected final String TEXT_242 = NL + "                    throw(e);";
  ...
  protected final String TEXT_251 = NL + "                        rejectedCount_";
  protected final String TEXT_252 = " = rejectedCount_";
  protected final String TEXT_253 = " + 1;";
  protected final String TEXT_254 = NL + "                        ";
  protected final String TEXT_255 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_256 = NL + "                        ";
  protected final String TEXT_257 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_258 = ";";
  protected final String TEXT_259 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_260 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_261 = "++;";
  protected final String TEXT_262 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_273 = NL + "            commitCounter_";
  protected final String TEXT_274 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_275 = " <= commitCounter_";
  protected final String TEXT_276 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_277 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_278 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
