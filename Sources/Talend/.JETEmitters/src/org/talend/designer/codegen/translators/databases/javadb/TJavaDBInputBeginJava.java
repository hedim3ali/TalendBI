...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_213 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_216 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_217 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_218 = "),Integer.parseInt(";
  protected final String TEXT_219 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_220 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_221 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_222 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_223 = " && timeOut_";
  protected final String TEXT_224 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_225 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_226 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_227 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_228 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tSystem.exit(1);\t" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_229 = NL + "\t\t\t\tString url_";
  protected final String TEXT_230 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_231 = ";";
  protected final String TEXT_232 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_233 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_234 = " + \":\" + ";
  protected final String TEXT_235 = " + \"/\" + ";
  protected final String TEXT_236 = ";";
  protected final String TEXT_237 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_238 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_239 = " + \":\" + ";
  protected final String TEXT_240 = " + \"/\" + ";
  protected final String TEXT_241 = ";";
  protected final String TEXT_242 = NL + "\t\t\t    java.lang.Class.forName(\"";
  protected final String TEXT_243 = "\").newInstance();" + NL + "\t\t\t\t";
  protected final String TEXT_244 = NL + "\t\t        String dbUser_";
  protected final String TEXT_245 = " = ";
  protected final String TEXT_246 = ";" + NL + "\t\t        String dbPwd_";
  protected final String TEXT_247 = " = ";
  protected final String TEXT_248 = ";" + NL + "\t\t        conn_";
  protected final String TEXT_249 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_250 = ",dbUser_";
  protected final String TEXT_251 = ",dbPwd_";
  ...
  protected final String TEXT_261 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_262 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_263 = " = dataSources_";
  protected final String TEXT_264 = ".get(";
  protected final String TEXT_265 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_284 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_308 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_320 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_345 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_346 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_347 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_348 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_349 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_350 = NL + "\t\t    while (rs_";
  protected final String TEXT_351 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_352 = "++;" + NL + "\t\t        ";
  protected final String TEXT_353 = NL + "\t\t                        column_index_";
  protected final String TEXT_354 = " = ";
  protected final String TEXT_355 = " + dcg_";
  protected final String TEXT_356 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_357 = NL + "\t\t                        column_index_";
  protected final String TEXT_358 = " = ";
  protected final String TEXT_359 = ";" + NL + "\t\t                    ";
  protected final String TEXT_360 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_372 = " = (List)rs_";
  protected final String TEXT_373 = ".getObject(column_index_";
  protected final String TEXT_374 = ");";
  protected final String TEXT_375 = NL + "\t\t                         ";
  protected final String TEXT_376 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_377 = ".getObject(column_index_";
  protected final String TEXT_378 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_379 = NL + "                                    ";
  protected final String TEXT_380 = ".";
  protected final String TEXT_381 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_391 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_392 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_408 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_414 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_424 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_425 = ".getObject(column_index_";
  protected final String TEXT_426 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_427 = ".";
  protected final String TEXT_428 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_437 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\t\t";
  protected final String TEXT_439 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_440 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_441 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_442 = " - Content of the record \" + nb_line_";
  protected final String TEXT_443 = " + \": \" + log4jSb_";
  protected final String TEXT_444 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_445 = ".delete(0,log4jSb_";
  protected final String TEXT_446 = ".length());" + NL + "\t\t\t\t\t";
