...
public class TGSBucketCreateMainJava
{
  ...
  protected final String TEXT_26 = NL + "\t}catch(org.jets3t.service.ServiceException e_";
  protected final String TEXT_27 = ") {";
  protected final String TEXT_28 = NL + "\t\tthrow(e_";
  protected final String TEXT_29 = ");";
  protected final String TEXT_30 = NL + "\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_31 = ":\");" + NL + "\t\tSystem.err.println(e_";
  protected final String TEXT_32 = ".getMessage());" + NL + "\t\tif(e_";
  protected final String TEXT_33 = ".getErrorCode()!=null){" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_34 = ".getErrorCode());" + NL + "\t\t}" + NL + "\t\tif(e_";
  protected final String TEXT_35 = ".getErrorMessage()!=null){" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_36 = ".getErrorMessage());" + NL + "\t\t}";
  protected final String TEXT_37 = NL + "\t}finally{" + NL + "\t\tif(service_";
  protected final String TEXT_38 = " !=null){" + NL + "\t\t\tservice_";
  protected final String TEXT_39 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
