...
public class TMysqlSCDBeginJava {
  ...
  protected final String TEXT_48 = ";" + NL + "            \tif(tableName4Search_";
  protected final String TEXT_49 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_50 = " = tableName4Search_";
  protected final String TEXT_51 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_52 = " = tableName4Search_";
  protected final String TEXT_53 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_54 = " = dbMetaData_";
  protected final String TEXT_55 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_56 = ", tableName4Search_";
  ...
  protected final String TEXT_62 = NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_68 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_69 = ".equalsIgnoreCase(";
  protected final String TEXT_70 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_71 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  ...
  protected final String TEXT_79 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_80 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_81 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_82 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_83 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_84 = " = calendarYear0_";
  protected final String TEXT_85 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_86 = " = calendar_";
  protected final String TEXT_87 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_88 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_89 = " = calendar_";
  protected final String TEXT_90 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_91 = " = 0;    " + NL + "    String dateStr_";
  protected final String TEXT_92 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_93 = " = null;    ";
  protected final String TEXT_94 = NL + "        String searching_";
  protected final String TEXT_95 = " = \"";
  protected final String TEXT_96 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  ...
  protected final String TEXT_103 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_104 = " = connection_";
  protected final String TEXT_105 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_106 = " = statement_";
  protected final String TEXT_107 = ".executeQuery(search_";
  protected final String TEXT_108 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_109 = ", SCDStruct_";
  protected final String TEXT_110 = "> cache_";
  protected final String TEXT_111 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_112 = ", SCDStruct_";
  protected final String TEXT_113 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_114 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_115 = " sk_";
  protected final String TEXT_116 = " = new SCDSK_";
  protected final String TEXT_117 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_118 = " row_";
  protected final String TEXT_119 = " = new SCDStruct_";
  protected final String TEXT_120 = "();";
  protected final String TEXT_121 = NL + "                    tmpValue_";
  protected final String TEXT_122 = " = resultSet_";
  protected final String TEXT_123 = ".getString(";
  protected final String TEXT_124 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_125 = " != null && tmpValue_";
  protected final String TEXT_126 = ".length() > 0) {";
  protected final String TEXT_127 = NL + "                        ";
  protected final String TEXT_128 = ".";
  protected final String TEXT_129 = " = tmpValue_";
  protected final String TEXT_130 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_131 = NL + "                            if(tmpValue_";
  ...
  protected final String TEXT_139 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_140 = ")) {";
  protected final String TEXT_141 = NL + "                                ";
  protected final String TEXT_142 = ".";
  protected final String TEXT_143 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  ...
  protected final String TEXT_147 = NL + "                    dateStr_";
  protected final String TEXT_148 = " = resultSet_";
  protected final String TEXT_149 = ".getString(";
  protected final String TEXT_150 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_151 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_152 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_153 = ")) {";
  protected final String TEXT_154 = NL + "                            ";
  protected final String TEXT_155 = ".";
  protected final String TEXT_156 = " = new java.util.Date(resultSet_";
  protected final String TEXT_157 = ".getTimestamp(";
  protected final String TEXT_158 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_159 = NL + "                            ";
  protected final String TEXT_160 = ".";
  protected final String TEXT_161 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_162 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  protected final String TEXT_163 = NL + "                        ";
  protected final String TEXT_164 = ".";
  protected final String TEXT_165 = " = null;" + NL + "                    }";
  protected final String TEXT_166 = NL + "                    if(resultSet_";
  ...
  protected final String TEXT_175 = NL + "            cache_";
  protected final String TEXT_176 = ".put(sk_";
  protected final String TEXT_177 = ", row_";
  protected final String TEXT_178 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_179 = ".close();" + NL + "        statement_";
  protected final String TEXT_180 = ".close();";
  protected final String TEXT_181 = NL + "            System.out.println(\"[";
  protected final String TEXT_182 = "] comparison cache loaded\");";
  protected final String TEXT_183 = NL + "        ";
  protected final String TEXT_184 = " nextSurrogateKey_";
  protected final String TEXT_185 = " = 1;";
  protected final String TEXT_186 = NL + "            if(cache_";
  protected final String TEXT_187 = ".size() > 0) {";
  protected final String TEXT_188 = NL + "        String tmpQuery_";
  protected final String TEXT_189 = " = \"SELECT MAX(`";
  protected final String TEXT_190 = "`) FROM `\" + tableName_";
  protected final String TEXT_191 = " + \"`\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_192 = " = connection_";
  protected final String TEXT_193 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_194 = " = tmpStmt_";
  protected final String TEXT_195 = ".executeQuery(tmpQuery_";
  protected final String TEXT_196 = ");";
  protected final String TEXT_197 = NL + "        if(tmpRS_";
  protected final String TEXT_198 = ".next() && tmpRS_";
  protected final String TEXT_199 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_200 = " = tmpRS_";
  protected final String TEXT_201 = ".get";
  protected final String TEXT_202 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_203 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_204 = ".close();";
  protected final String TEXT_205 = NL + "            }            ";
  protected final String TEXT_206 = NL + "    String insertionSQL_";
  protected final String TEXT_207 = " = \"";
  protected final String TEXT_208 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_209 = " = connection_";
  protected final String TEXT_210 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_211 = ");";
  protected final String TEXT_212 = NL + "            insertionStatement_";
  protected final String TEXT_213 = ".setTimestamp(";
  protected final String TEXT_214 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_215 = "\")));";
  protected final String TEXT_216 = NL + "            insertionStatement_";
  protected final String TEXT_217 = ".setNull(";
  protected final String TEXT_218 = ", java.sql.Types.DATE);";
  protected final String TEXT_219 = NL + "            insertionStatement_";
  protected final String TEXT_220 = ".setTimestamp(";
  protected final String TEXT_221 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_222 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_223 = NL + "        String updateSQLForType1_";
  protected final String TEXT_224 = " = \"";
  protected final String TEXT_225 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_226 = " = connection_";
  protected final String TEXT_227 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_228 = ");        ";
  protected final String TEXT_229 = NL + "        String updateSQLForType2_";
  protected final String TEXT_230 = " = \"";
  protected final String TEXT_231 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_232 = " = connection_";
  protected final String TEXT_233 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_234 = ");";
  protected final String TEXT_235 = NL + "            updateForType2_";
  protected final String TEXT_236 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_237 = "\")));";
  protected final String TEXT_238 = NL + "        String updateSQLForType3_";
  protected final String TEXT_239 = " = \"";
  protected final String TEXT_240 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_241 = " = connection_";
  protected final String TEXT_242 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_243 = ");";
  protected final String TEXT_244 = NL + "    ";
  protected final String TEXT_245 = NL + "        SCDSK_";
  protected final String TEXT_246 = " lookUpKey_";
