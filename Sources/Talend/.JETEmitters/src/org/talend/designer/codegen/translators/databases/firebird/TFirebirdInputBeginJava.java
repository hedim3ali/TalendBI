...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_214 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_275 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_287 = ".getColumnTypeName(i));";
  protected final String TEXT_288 = NL + "                \tdcm_";
  protected final String TEXT_289 = ".setFormat(";
  protected final String TEXT_290 = ");";
  protected final String TEXT_291 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_292 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_293 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_294 = ".setLength(rsmd_";
  protected final String TEXT_295 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_296 = ".setLength(rsmd_";
  protected final String TEXT_297 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_298 = NL + "\t\t\tdcm_";
  protected final String TEXT_299 = ".setLength(rsmd_";
  protected final String TEXT_300 = ".getPrecision(i));";
  protected final String TEXT_301 = NL + "                \tdcm_";
  protected final String TEXT_302 = ".setPrecision(rsmd_";
  protected final String TEXT_303 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_304 = ".setNullable(rsmd_";
  protected final String TEXT_305 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_306 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_307 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_308 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_309 = ".metadatas.add(dcm_";
  protected final String TEXT_310 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_311 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_312 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_313 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_314 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_315 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_327 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_339 = " = (List)rs_";
  protected final String TEXT_340 = ".getObject(column_index_";
  protected final String TEXT_341 = ");";
  protected final String TEXT_342 = NL + "\t\t                         ";
  protected final String TEXT_343 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_344 = ".getObject(column_index_";
  protected final String TEXT_345 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_346 = NL + "                                    ";
  protected final String TEXT_347 = ".";
  protected final String TEXT_348 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_358 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_359 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_375 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_391 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_392 = ".getObject(column_index_";
  protected final String TEXT_393 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_394 = ".";
  protected final String TEXT_395 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_404 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\t\t";
  protected final String TEXT_406 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_407 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_408 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_409 = " - Content of the record \" + nb_line_";
  protected final String TEXT_410 = " + \": \" + log4jSb_";
  protected final String TEXT_411 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_412 = ".delete(0,log4jSb_";
  protected final String TEXT_413 = ".length());" + NL + "\t\t\t\t\t";
