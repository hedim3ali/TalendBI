...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_503 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_504 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_505 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_506 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_507 = " = buffersSize_";
  protected final String TEXT_508 = ";";
  protected final String TEXT_509 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_510 = " = buffersSize_";
  protected final String TEXT_511 = ";";
  protected final String TEXT_512 = NL + "        whetherReject_";
  protected final String TEXT_513 = " = false;";
  protected final String TEXT_514 = NL + "                    ";
  protected final String TEXT_515 = NL + "                        query_";
  protected final String TEXT_516 = " = ";
  protected final String TEXT_517 = ";";
  protected final String TEXT_518 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_528 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_533 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_534 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_535 = " = insertedCount_";
  ...
  protected final String TEXT_552 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_553 = NL + "                        ";
  protected final String TEXT_554 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_555 = ";";
  protected final String TEXT_556 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_589 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_590 = " = updatedCount_";
  protected final String TEXT_591 = " + pstmt_";
  protected final String TEXT_592 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_616 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_617 = " = pstmt_";
  protected final String TEXT_618 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_619 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_620 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_621 = " = rs_";
  protected final String TEXT_622 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_623 = " > 0) {";
  protected final String TEXT_624 = NL + "                        ";
  protected final String TEXT_625 = NL + "                            query_";
  protected final String TEXT_626 = " = ";
  protected final String TEXT_627 = ";";
  protected final String TEXT_628 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_647 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_648 = " = updatedCount_";
  protected final String TEXT_649 = " + pstmtUpdate_";
  protected final String TEXT_650 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_651 = " = true;";
  protected final String TEXT_652 = NL + "                        throw(e);";
  protected final String TEXT_653 = NL + "                            ";
  protected final String TEXT_654 = " = new ";
  protected final String TEXT_655 = "Struct();";
  protected final String TEXT_656 = NL + "                                ";
  protected final String TEXT_657 = ".";
  protected final String TEXT_658 = " = ";
  protected final String TEXT_659 = ".";
  protected final String TEXT_660 = ";";
  protected final String TEXT_661 = NL + "                            rejectedCount_";
  protected final String TEXT_662 = " = rejectedCount_";
  protected final String TEXT_663 = " + 1;";
  protected final String TEXT_664 = NL + "                            ";
  protected final String TEXT_665 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_666 = NL + "                            ";
  protected final String TEXT_667 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_668 = ";";
  protected final String TEXT_669 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_670 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_671 = NL + "                        ";
  protected final String TEXT_672 = NL + "                            query_";
  protected final String TEXT_673 = " = ";
  protected final String TEXT_674 = ";";
  protected final String TEXT_675 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_676 = ".";
  protected final String TEXT_677 = ", pstmtInsert_";
  ...
  protected final String TEXT_684 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_685 = " = insertedCount_";
  protected final String TEXT_686 = " + pstmtInsert_";
  protected final String TEXT_687 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_688 = " = true;";
  protected final String TEXT_689 = NL + "                        throw(e);";
  protected final String TEXT_690 = NL + "                            ";
  protected final String TEXT_691 = " = new ";
  protected final String TEXT_692 = "Struct();";
  protected final String TEXT_693 = NL + "                                ";
  protected final String TEXT_694 = ".";
  protected final String TEXT_695 = " = ";
  protected final String TEXT_696 = ".";
  protected final String TEXT_697 = ";";
  protected final String TEXT_698 = NL + "                            rejectedCount_";
  protected final String TEXT_699 = " = rejectedCount_";
  protected final String TEXT_700 = " + 1;";
  protected final String TEXT_701 = NL + "                            ";
  protected final String TEXT_702 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_707 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_708 = "++;";
  protected final String TEXT_709 = NL + "            int updateFlag_";
  protected final String TEXT_710 = " = 0;";
  ...
  protected final String TEXT_779 = ".executeUpdate(); " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_794 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_799 = NL + "                }" + NL + "            }" + NL + "            " + NL + "            nb_line_";
  ...
  protected final String TEXT_814 = ".addBatch();" + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_815 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_816 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_817 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_818 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_819 = " = deletedCount_";
  protected final String TEXT_820 = " + pstmt_";
  protected final String TEXT_821 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_826 = "Struct();";
  protected final String TEXT_827 = NL + "                            ";
  protected final String TEXT_828 = ".";
  protected final String TEXT_829 = " = ";
  protected final String TEXT_830 = ".";
  protected final String TEXT_831 = ";";
  protected final String TEXT_832 = NL + "                        rejectedCount_";
  protected final String TEXT_833 = " = rejectedCount_";
  protected final String TEXT_834 = " + 1;";
  protected final String TEXT_835 = NL + "                        ";
  protected final String TEXT_836 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_837 = NL + "                        ";
  protected final String TEXT_838 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_839 = ";";
  protected final String TEXT_840 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_841 = NL + "            }" + NL + "           \t";
  protected final String TEXT_842 = NL + "            nb_line_";
  protected final String TEXT_843 = "++;";
  protected final String TEXT_844 = NL + "            if(!whetherReject_";
  protected final String TEXT_845 = ") {";
  protected final String TEXT_846 = NL + "                            ";
  protected final String TEXT_847 = " = new ";
  protected final String TEXT_848 = "Struct();";
  ...
  protected final String TEXT_855 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_856 = " <= batchSizeCounter_";
  protected final String TEXT_857 = ") {                ";
  protected final String TEXT_858 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_859 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_860 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_861 = ": pstmt_";
  protected final String TEXT_862 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_875 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_876 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_877 = NL + "                \tint countSum_";
  protected final String TEXT_878 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_879 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_880 = " += (countEach_";
  protected final String TEXT_881 = " < 0 ? 0 : countEach_";
  protected final String TEXT_882 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_883 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_884 = " += countSum_";
  protected final String TEXT_885 = "; " + NL + "\t\t\t    \t";
  protected final String TEXT_886 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_887 = " += countSum_";
  protected final String TEXT_888 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_889 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_890 = " += countSum_";
  protected final String TEXT_891 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_892 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_893 = NL + "                }";
  protected final String TEXT_894 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_895 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_896 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_897 = " <= commitCounter_";
  protected final String TEXT_898 = ") {" + NL + "                ";
  protected final String TEXT_899 = NL + "                try {" + NL + "                \t";
  protected final String TEXT_900 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_901 = " > 0 ) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_902 = NL + "                \t\tint countSum_";
  protected final String TEXT_903 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_904 = ": pstmt_";
  protected final String TEXT_905 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_906 = " += (countEach_";
  protected final String TEXT_907 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_912 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_913 = " += countSum_";
  protected final String TEXT_914 = ";" + NL + "            \t    \t";
  protected final String TEXT_915 = NL + "            \t    \t    deletedCount_";
  ...
  protected final String TEXT_920 = " = 0;  " + NL + "\t                \t";
  protected final String TEXT_921 = NL + "            \t   ";
  protected final String TEXT_922 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_923 = "          \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_924 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_925 = NL + "\t                \tint countSum_";
  protected final String TEXT_926 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_927 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_931 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_932 = " += countSum_";
  protected final String TEXT_933 = ";" + NL + "            \t    \t";
  protected final String TEXT_934 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_935 = " += countSum_";
  protected final String TEXT_936 = ";" + NL + "            \t    \t";
  protected final String TEXT_937 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_938 = " += countSum_";
  protected final String TEXT_939 = ";" + NL + "            \t    \t";
  protected final String TEXT_940 = " " + NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_941 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_942 = NL + "                \tconn_";
  protected final String TEXT_943 = ".commit();                " + NL + "                \tcommitCounter_";
