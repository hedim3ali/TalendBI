...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_2 = "=0;" + NL + "String tableName_";
  protected final String TEXT_3 = " = null;" + NL + "String dbschema_";
  ...
  protected final String TEXT_15 = ";" + NL + "} else {" + NL + "\ttableName_";
  protected final String TEXT_16 = " = dbschema_";
  protected final String TEXT_17 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_18 = ";" + NL + "}";
  protected final String TEXT_19 = NL + "     String tmpTableName_";
  protected final String TEXT_20 = " = \"tmp_";
  protected final String TEXT_21 = "_\" + pid; //tableName not end. will add pid when create a temp table for update.";
  protected final String TEXT_22 = NL + "String bulkSQL_";
  protected final String TEXT_23 = " = \"COPY \\\"\" + ";
  protected final String TEXT_24 = "tmpTableName_";
  protected final String TEXT_25 = "tableName_";
  protected final String TEXT_26 = " ";
  protected final String TEXT_27 = NL + "+ \"\\\"";
  protected final String TEXT_28 = "FROM '\" + ";
  protected final String TEXT_29 = " + \"' WITH \";";
  protected final String TEXT_30 = NL + "    bulkSQL_";
  protected final String TEXT_31 = " += \"BINARY ";
  protected final String TEXT_32 = "\";";
  protected final String TEXT_33 = NL + "    bulkSQL_";
  protected final String TEXT_34 = " += \"";
  protected final String TEXT_35 = " \" + \"DELIMITER AS '\" + ";
  protected final String TEXT_36 = " + \"' \";" + NL + "\t";
  protected final String TEXT_37 = NL + "\t\tbulkSQL_";
  protected final String TEXT_38 = " += \"NULL AS '\" + ";
  protected final String TEXT_39 = " + \"' \";" + NL + "\t";
  protected final String TEXT_40 = NL + "\t\tbulkSQL_";
  protected final String TEXT_41 = " += \"NULL AS '\" + ";
  protected final String TEXT_42 = ".replaceAll(\"\\\\\\\\\",\"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t";
  protected final String TEXT_43 = NL + "            \tbulkSQL_";
  protected final String TEXT_44 = " += \"CSV ";
  protected final String TEXT_45 = " QUOTE AS '\" + ";
  protected final String TEXT_46 = "+ \"' \";" + NL + "\t\t";
  protected final String TEXT_47 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_48 = " += \"CSV ";
  protected final String TEXT_49 = " QUOTE AS \" + (\"'\".equals(";
  protected final String TEXT_50 = ")?\"E\":\"\") + \"'\" +(\"'\".equals(";
  protected final String TEXT_51 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_52 = "+ \"' \";" + NL + "\t\t";
  protected final String TEXT_53 = NL + "\t\t\t\tbulkSQL_";
  protected final String TEXT_54 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_55 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_56 = NL + "\t        \tbulkSQL_";
  protected final String TEXT_57 = " += \"ESCAPE AS \" + (\"'\".equals(";
  protected final String TEXT_58 = ")?\"E\":\"\")  + \"'\" +(\"'\".equals(";
  protected final String TEXT_59 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_60 = " + \"' \"; ";
  protected final String TEXT_61 = NL + NL + "       \t\t\tbulkSQL_";
  protected final String TEXT_62 = " += \"CSV ";
  protected final String TEXT_63 = " QUOTE AS '\" +  ";
  protected final String TEXT_64 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_65 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_66 = " += \"CSV ";
  protected final String TEXT_67 = " QUOTE AS '\" + (\"'\".equals(";
  protected final String TEXT_68 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_69 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_71 = " += \"ESCAPE AS '\"+ ";
  protected final String TEXT_72 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_73 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_74 = " += \"ESCAPE AS '\"+ (\"'\".equals(";
  protected final String TEXT_75 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_76 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_77 = "        " + NL + "        bulkSQL_";
  ...
  protected final String TEXT_85 = NL + "\t\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\t\tconn_";
  protected final String TEXT_86 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_96 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_97 = ".execute(\"";
  protected final String TEXT_98 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_99 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_115 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_116 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_117 = " = tableNameForSearch_";
  protected final String TEXT_118 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_119 = " = tableNameForSearch_";
  protected final String TEXT_120 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_121 = " = dbMetaData_";
  protected final String TEXT_122 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_123 = ", tableNameForSearch_";
  protected final String TEXT_124 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_125 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_126 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_127 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_137 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_138 = " = rsTable_";
  protected final String TEXT_139 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_140 = ".equalsIgnoreCase(";
  protected final String TEXT_141 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_142 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_143 = ") || dbschema_";
  protected final String TEXT_144 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_145 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_155 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_159 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_160 = ".equals(schema_";
  protected final String TEXT_161 = ") || (schema_";
  protected final String TEXT_162 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_163 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_225 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_237 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_263 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_264 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_265 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_266 = NL + "\t";
  protected final String TEXT_267 = NL + "        int keyCount_";
  protected final String TEXT_268 = " = ";
  protected final String TEXT_269 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_270 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        tmpTableName_";
  protected final String TEXT_271 = " = tableName_";
  protected final String TEXT_272 = ";" + NL + "        tableName_";
  protected final String TEXT_273 = " = \"tmp_";
  protected final String TEXT_274 = "\" + \"_\" + pid ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_275 = " = conn_";
  protected final String TEXT_276 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_277 = ".execute(\"";
  protected final String TEXT_278 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_279 = ".close();" + NL + "        " + NL + "        ";
  protected final String TEXT_280 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_281 = " =conn_";
  protected final String TEXT_282 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_283 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_284 = ".close();" + NL + "   \t\t";
  protected final String TEXT_285 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_286 = " = conn_";
  protected final String TEXT_287 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_288 = ".execute(bulkSQL_";
  protected final String TEXT_289 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_290 = ".close();" + NL + "        " + NL + "        tableName_";
  protected final String TEXT_291 = " = tmpTableName_";
  protected final String TEXT_292 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_293 = " = \"tmp_";
  protected final String TEXT_294 = "\" + \"_\" + pid;" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_295 = " = conn_";
  protected final String TEXT_296 = ".createStatement();" + NL + "        " + NL + "        stmtUpdateBulk_";
  protected final String TEXT_297 = ".executeUpdate(\"";
  protected final String TEXT_298 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_299 = ".close();" + NL + "        tableName_";
  protected final String TEXT_300 = " = tmpTableName_";
  protected final String TEXT_301 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_302 = " = conn_";
  protected final String TEXT_303 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_304 = ".execute(\"";
  protected final String TEXT_305 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_306 = ".close();";
  protected final String TEXT_307 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_308 = " =conn_";
  protected final String TEXT_309 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_310 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_311 = ".close();";
  protected final String TEXT_312 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_313 = " = conn_";
  protected final String TEXT_314 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_315 = ".execute(bulkSQL_";
  protected final String TEXT_316 = ");" + NL + "    stmtBulk_";
