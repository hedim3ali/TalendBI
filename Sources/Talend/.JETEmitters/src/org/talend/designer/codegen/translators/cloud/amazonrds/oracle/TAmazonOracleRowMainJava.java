...
public class TAmazonOracleRowMainJava
{
  ...
  protected final String TEXT_57 = NL + NL + "    } catch (java.lang.Exception e) {" + NL + "        whetherReject_";
  ...
  protected final String TEXT_69 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_75 = NL + "    if(!whetherReject_";
  ...
  protected final String TEXT_90 = NL + "\t    commitCounter_";
  protected final String TEXT_91 = "++;" + NL + "        if(commitEvery_";
  protected final String TEXT_92 = " <= commitCounter_";
  protected final String TEXT_93 = ") {" + NL + "        " + NL + "        \tconn_";
  protected final String TEXT_94 = ".commit();" + NL + "        \t" + NL + "        \tcommitCounter_";
  protected final String TEXT_95 = "=0;" + NL + "        \t" + NL + "        }";
