...
public class TSybaseInputBeginJava
{
  ...
  protected final String TEXT_215 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_216 = " + \":\" + ";
  protected final String TEXT_217 = " + \"/\" + ";
  protected final String TEXT_218 = ";";
  protected final String TEXT_219 = NL + "\t\t\t\tString url_";
  protected final String TEXT_220 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_232 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_233 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_234 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_235 = " = dataSources_";
  protected final String TEXT_236 = ".get(";
  protected final String TEXT_237 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_238 = "\", conn_";
  protected final String TEXT_239 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_240 = NL + "\t\t\t\t";
  protected final String TEXT_241 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_242 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_243 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_244 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_245 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_246 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_254 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  ...
  protected final String TEXT_280 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_292 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_317 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_318 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_319 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_320 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_321 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_322 = NL + "\t\t    while (rs_";
  protected final String TEXT_323 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_324 = "++;" + NL + "\t\t        ";
  protected final String TEXT_325 = NL + "\t\t                        column_index_";
  protected final String TEXT_326 = " = ";
  protected final String TEXT_327 = " + dcg_";
  ...
  protected final String TEXT_348 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_349 = ".getObject(column_index_";
  protected final String TEXT_350 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_351 = NL + "                                    ";
  protected final String TEXT_352 = ".";
  protected final String TEXT_353 = " = new Geometry(wktValue);";
  protected final String TEXT_354 = NL + "                                        ";
  protected final String TEXT_355 = ".";
  protected final String TEXT_356 = ".setEPSG(";
  protected final String TEXT_357 = ");";
  protected final String TEXT_358 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_359 = NL + "                                  ";
  protected final String TEXT_360 = ".";
  protected final String TEXT_361 = "=dcg_";
  protected final String TEXT_362 = ";";
  protected final String TEXT_363 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_364 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_365 = " = ";
  protected final String TEXT_366 = "; i_";
  protected final String TEXT_367 = "  <= rsmd_";
  protected final String TEXT_368 = ".getColumnCount(); i_";
  protected final String TEXT_369 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_370 = ".getColumnTypeName(i_";
  protected final String TEXT_371 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_372 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_373 = ".getClob(i_";
  protected final String TEXT_374 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_375 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_376 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_377 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_378 = ".add(tNTextImpl_";
  protected final String TEXT_379 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_380 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_381 = ".";
  protected final String TEXT_382 = ", rs_";
  protected final String TEXT_383 = ", fixedColumnCount_";
  protected final String TEXT_384 = ",list_";
  ...
  protected final String TEXT_396 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_397 = ".getObject(column_index_";
  protected final String TEXT_398 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_399 = ".";
  protected final String TEXT_400 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_408 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_409 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_410 = NL + "\t\t\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_412 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_413 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_414 = " - Content of the record \" + nb_line_";
  protected final String TEXT_415 = " + \": \" + log4jSb_";
  protected final String TEXT_416 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_417 = ".delete(0,log4jSb_";
  protected final String TEXT_418 = ".length());" + NL + "\t\t\t\t\t";
