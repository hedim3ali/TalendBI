...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_131 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_135 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_136 = ".equals(schema_";
  protected final String TEXT_137 = ") || (schema_";
  protected final String TEXT_138 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_139 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_178 = "(schema_";
  ...
  protected final String TEXT_201 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_205 = NL + "                if(whetherExist_";
  protected final String TEXT_206 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_209 = ".execute(\"";
  protected final String TEXT_210 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_211 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_217 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_220 = ".executeUpdate(\"";
  protected final String TEXT_221 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_222 = ".close();";
  protected final String TEXT_223 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_226 = " = stmtTruncCount_";
  protected final String TEXT_227 = ".executeQuery(\"";
  protected final String TEXT_228 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_229 = " = conn_";
  protected final String TEXT_230 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_231 = ".executeUpdate(\"";
  protected final String TEXT_232 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_233 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_234 = " += rsTruncCount_";
  protected final String TEXT_235 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_236 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_237 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_238 = ".close();            ";
  protected final String TEXT_239 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_240 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_241 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_242 = NL + "        java.sql.Statement stmtBulkInsert_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".createStatement();" + NL + "        stmtBulkInsert_";
  protected final String TEXT_245 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_246 = " + \"] FROM '\" + ";
  protected final String TEXT_247 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_248 = " + \"',DATAFILETYPE='";
  protected final String TEXT_249 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_250 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_251 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_252 = "+\"')\");" + NL + "        stmtBulkInsert_";
  protected final String TEXT_253 = ".close();        ";
  protected final String TEXT_254 = NL + "            int keyCount_";
  protected final String TEXT_255 = " = ";
  protected final String TEXT_256 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_257 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_258 = " = tableName_";
  protected final String TEXT_259 = ";" + NL + "            tableName_";
  protected final String TEXT_260 = " = \"tmp_";
  protected final String TEXT_261 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_262 = " = conn_";
  protected final String TEXT_263 = ".createStatement();" + NL + "            stmtCreateTmp_";
  protected final String TEXT_264 = ".execute(\"";
  protected final String TEXT_265 = ")\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_266 = ".close();" + NL + "            java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_267 = " = conn_";
  protected final String TEXT_268 = ".createStatement();" + NL + "            stmtTmpBulk_";
  protected final String TEXT_269 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_270 = " + \"] FROM '\" + ";
  protected final String TEXT_271 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_272 = " + \"',DATAFILETYPE='";
  protected final String TEXT_273 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_274 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_275 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_276 = "+\"')\");" + NL + "            stmtTmpBulk_";
  protected final String TEXT_277 = ".close();" + NL + "            tableName_";
  protected final String TEXT_278 = " = tmpTableName_";
  protected final String TEXT_279 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_280 = " = \"tmp_";
  protected final String TEXT_281 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_282 = " = conn_";
  protected final String TEXT_283 = ".createStatement();" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_284 = ".executeUpdate(\"";
  protected final String TEXT_285 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_286 = ".close();" + NL + "            tableName_";
  protected final String TEXT_287 = " = \"tmp_";
  protected final String TEXT_288 = "\" + \"_\" +pid;" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_289 = " = conn_";
  protected final String TEXT_290 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_291 = ".execute(\"";
  protected final String TEXT_292 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_293 = ".close();";
  protected final String TEXT_294 = NL + "        if(conn_";
  protected final String TEXT_295 = " != null && !conn_";
  protected final String TEXT_296 = ".isClosed()) {" + NL + "            conn_";
