...
public class TAccessOutputMainJava {
  ...
  protected final String TEXT_75 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_129 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_137 = NL + "                try{" + NL + "        \t\t\tinsertedCount_";
  protected final String TEXT_138 = " = insertedCount_";
  protected final String TEXT_139 = " + pstmtInsert_";
  protected final String TEXT_140 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_141 = " = true;";
  protected final String TEXT_142 = NL + "                        throw(e);";
  ...
  protected final String TEXT_175 = "_QUERY\", query_";
  protected final String TEXT_176 = ".toString().trim());";
  protected final String TEXT_177 = NL + "    " + NL + "             try {" + NL + "                 updateFlag_";
  protected final String TEXT_178 = "=pstmtUpdate_";
  protected final String TEXT_179 = ".executeUpdate();" + NL + "                 updatedCount_";
  protected final String TEXT_180 = " = updatedCount_";
  protected final String TEXT_181 = "+updateFlag_";
  protected final String TEXT_182 = ";" + NL + "             } catch(java.lang.Exception e) {" + NL + "                 whetherReject_";
  protected final String TEXT_183 = " = true;";
  ...
  protected final String TEXT_202 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_210 = NL + "                 try {" + NL + "        \t\t\tinsertedCount_";
  protected final String TEXT_211 = " = insertedCount_";
  protected final String TEXT_212 = " + pstmtInsert_";
  ...
  protected final String TEXT_245 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_246 = " = deletedCount_";
  protected final String TEXT_247 = " + pstmt_";
  protected final String TEXT_248 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_265 = NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_278 = NL + "\t            commitCounter_";
  protected final String TEXT_279 = "++;" + NL + "\t            " + NL + "\t            if(commitEvery_";
  protected final String TEXT_280 = "<=commitCounter_";
  protected final String TEXT_281 = ") {" + NL + "\t            " + NL + "\t            \tconn_";
  protected final String TEXT_282 = ".commit();" + NL + "\t            \t" + NL + "\t            \tcommitCounter_";
  protected final String TEXT_283 = "=0;\t" + NL + "\t            }\t" + NL + "\t            ";
