...
public class TParAccelOutputMainJava {
  ...
  protected final String TEXT_30 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_44 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_45 = " = updatedCount_";
  protected final String TEXT_46 = " + pstmt_";
  protected final String TEXT_47 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_48 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_59 = NL + "                        rejectedCount_";
  protected final String TEXT_60 = " = rejectedCount_";
  ...
  protected final String TEXT_88 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_89 = " = updatedCount_";
  protected final String TEXT_90 = " + pstmtUpdate_";
  protected final String TEXT_91 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_102 = NL + "                            rejectedCount_";
  ...
  protected final String TEXT_110 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_111 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_112 = NL + "                        ";
  protected final String TEXT_113 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_114 = " = insertedCount_";
  protected final String TEXT_115 = " + pstmtInsert_";
  ...
  protected final String TEXT_136 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_137 = "++;";
  protected final String TEXT_138 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_147 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_148 = "=pstmtUpdate_";
  protected final String TEXT_149 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_150 = " = updatedCount_";
  protected final String TEXT_151 = "+updateFlag_";
  ...
  protected final String TEXT_172 = NL + "            }" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_178 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_206 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_207 = " = deletedCount_";
  protected final String TEXT_208 = " + pstmt_";
  protected final String TEXT_209 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_243 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_244 = "<=commitCounter_";
  protected final String TEXT_245 = ") {" + NL + "                " + NL + "                    conn_";
  protected final String TEXT_246 = ".commit();" + NL + "                    " + NL + "                    commitCounter_";
  protected final String TEXT_247 = "=0;" + NL + "        " + NL + "                }";
