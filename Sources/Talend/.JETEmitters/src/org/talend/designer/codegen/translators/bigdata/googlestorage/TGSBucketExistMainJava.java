...
public class TGSBucketExistMainJava
{
  ...
  protected final String TEXT_18 = "=true;" + NL + "\t\t}" + NL + "\t}catch(org.jets3t.service.ServiceException e_";
  protected final String TEXT_19 = ") {";
  protected final String TEXT_20 = NL + "\t\tthrow(e_";
  protected final String TEXT_21 = ");";
  protected final String TEXT_22 = NL + "\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_23 = ":\");" + NL + "\t\tSystem.err.println(e_";
  protected final String TEXT_24 = ".getMessage());" + NL + "\t\tif(e_";
  protected final String TEXT_25 = ".getErrorCode()!=null){" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_26 = ".getErrorCode());" + NL + "\t\t}" + NL + "\t\tif(e_";
  protected final String TEXT_27 = ".getErrorMessage()!=null){" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_28 = ".getErrorMessage());" + NL + "\t\t}";
  protected final String TEXT_29 = NL + "\t}finally{" + NL + "\t\tif(service_";
  protected final String TEXT_30 = " !=null){" + NL + "\t\t\tservice_";
  protected final String TEXT_31 = ".shutdown();" + NL + "\t\t}";
  protected final String TEXT_32 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_33 = "_BUCKET_NAME\", ";
  protected final String TEXT_34 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_35 = "_BUCKET_EXIST\", bucketExist_";
