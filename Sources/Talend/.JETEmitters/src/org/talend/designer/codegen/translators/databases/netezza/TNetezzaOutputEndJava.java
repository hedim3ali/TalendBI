...
public class TNetezzaOutputEndJava {
  ...
  protected final String TEXT_15 = " > 0 ) {" + NL + "    \t\t";
  protected final String TEXT_16 = NL + "    \t\tlog.debug(\"";
  protected final String TEXT_17 = " - Executing the ";
  protected final String TEXT_18 = " batch.\");" + NL + "    \t\t";
  protected final String TEXT_19 = NL + "\t\t\tpstmt_";
  protected final String TEXT_20 = ".executeBatch(); " + NL + "\t\t\tpstmt_";
  protected final String TEXT_21 = ".clearBatch(); " + NL + "    \t\t";
  protected final String TEXT_22 = NL + "    \t\tlog.debug(\"";
  protected final String TEXT_23 = " - The ";
  protected final String TEXT_24 = " batch execution has succeeded.\");" + NL + "    \t\t";
  protected final String TEXT_25 = NL + "\t    \t";
  protected final String TEXT_26 = NL + "\t    \tinsertedCount_";
  protected final String TEXT_27 = " +=pstmt_";
  protected final String TEXT_28 = ".getUpdateCount(); " + NL + "\t    \t";
  protected final String TEXT_29 = NL + "\t    \tupdatedCount_";
  protected final String TEXT_30 = " += pstmt_";
  protected final String TEXT_31 = ".getUpdateCount();" + NL + "\t    \t";
  protected final String TEXT_32 = NL + "\t    \tdeletedCount_";
  protected final String TEXT_33 = " += pstmt_";
  protected final String TEXT_34 = ".getUpdateCount();" + NL + "\t    \t";
  protected final String TEXT_35 = NL + "\t    }\t                \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  ...
  protected final String TEXT_43 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_44 = "                \t" + NL + "\t}catch (java.sql.SQLException e){" + NL + "\t\t";
  protected final String TEXT_45 = NL + "\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t\tlog.fatal(\"";
  protected final String TEXT_47 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\tthrow(e);" + NL + "\t\t";
  ...
  protected final String TEXT_54 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_55 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_56 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_57 = NL;
  protected final String TEXT_58 = NL + "\t\t\t";
  protected final String TEXT_59 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_60 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_61 = " + \" records.\");" + NL + "\t\t\t";
  protected final String TEXT_62 = NL + "\t\t\t\tconn_";
  protected final String TEXT_63 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_65 = " - Commit has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_66 = NL + "    \t\t";
  protected final String TEXT_67 = "\t" + NL + "\t\t";
  protected final String TEXT_68 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_69 = " - Closing the connection to the database.\");" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t\tconn_";
  protected final String TEXT_71 = " .close();" + NL + "\t\t";
  protected final String TEXT_72 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_73 = " - Connection to the database closed.\");" + NL + "\t\t";
  protected final String TEXT_74 = NL + "    \t";
  protected final String TEXT_75 = NL + NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_99 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_100 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_101 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_102 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_103 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_104 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_105 = " - Has deleted \" + nb_line_deleted_";
  protected final String TEXT_106 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_107 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_108 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_109 = " + \" records.\");" + NL + "\t  \tlog.info(\"";
  protected final String TEXT_110 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_111 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_112 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_113 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_114 = " + \" records.\");" + NL + "\t  \tlog.info(\"";
  protected final String TEXT_115 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_116 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_117 = NL + "\t\tlog.info(\"";
  protected final String TEXT_118 = " - Has rejected \" + nb_line_rejected_";
  protected final String TEXT_119 = " + \"records.\");" + NL + "\t";
  protected final String TEXT_120 = NL + "\t\tlog.info(\"";
  protected final String TEXT_121 = " - Done.\");" + NL + "\t";
