...
public class TPostgresPlusOutputMainJava {
  ...
  protected final String TEXT_185 = "_QUERY\", query_";
  protected final String TEXT_186 = ".toString().trim());";
  protected final String TEXT_187 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_188 = "=pstmtUpdate_";
  protected final String TEXT_189 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_190 = " = updatedCount_";
  protected final String TEXT_191 = "+updateFlag_";
  protected final String TEXT_192 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_203 = NL + "                        rejectedCount_";
  protected final String TEXT_204 = " = rejectedCount_";
  protected final String TEXT_205 = " + 1;";
  protected final String TEXT_206 = NL + "                        ";
  protected final String TEXT_207 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_208 = NL + "                        ";
  protected final String TEXT_209 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_210 = ";";
  protected final String TEXT_211 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_212 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_213 = " == 0) {" + NL + "            \t";
  protected final String TEXT_214 = NL + "\t\t\t\tquery_";
  protected final String TEXT_215 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_223 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_224 = " = insertedCount_";
  protected final String TEXT_225 = " + pstmtInsert_";
  protected final String TEXT_226 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_246 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_263 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_283 = NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_296 = NL + "                commitCounter_";
  protected final String TEXT_297 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_298 = "<=commitCounter_";
  protected final String TEXT_299 = ") {" + NL + "                " + NL + "                    conn_";
  protected final String TEXT_300 = ".commit();" + NL + "                    " + NL + "                    commitCounter_";
  protected final String TEXT_301 = "=0;" + NL + "        " + NL + "                }";
