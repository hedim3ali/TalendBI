...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_101 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_102 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_103 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_104 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_105 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_106 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_107 = " = ";
  protected final String TEXT_108 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_109 = " = false;";
  protected final String TEXT_110 = NL + "   int batchSize_";
  protected final String TEXT_111 = " = ";
  protected final String TEXT_112 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_120 = " - For update, Schema must have a key\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_129 = NL + "\t String dbname_";
  ...
  protected final String TEXT_136 = ".getMetaData() != null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_137 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_138 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_139 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_140 = NL + "\t";
  protected final String TEXT_141 = NL + "    String dbname_";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = ";" + NL + "    java.lang.Class.forName(\"com.teradata.jdbc.TeraDriver\");       " + NL + "    String dbProperties_";
  protected final String TEXT_144 = " = ";
  protected final String TEXT_145 = ";" + NL + "\tString url_";
  protected final String TEXT_146 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_147 = " == null || dbProperties_";
  protected final String TEXT_148 = ".trim().length() == 0) {" + NL + "\t\turl_";
  protected final String TEXT_149 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_150 = ";     " + NL + "\t} else {" + NL + "\t    url_";
  protected final String TEXT_151 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_152 = " + \"/\" + ";
  protected final String TEXT_153 = ";" + NL + "\t}       " + NL + "    String dbUser_";
  protected final String TEXT_154 = " = ";
  protected final String TEXT_155 = ";        " + NL + "    String dbPwd_";
  protected final String TEXT_156 = " = ";
  protected final String TEXT_157 = ";        " + NL + "\t";
  protected final String TEXT_158 = "\t " + NL + "\t";
  protected final String TEXT_159 = NL + "\t\tlog.info(\"";
  protected final String TEXT_160 = " - Connection attempt to '\" + url_";
  protected final String TEXT_161 = " + \"' with the username '\" + dbUser_";
  ...
  protected final String TEXT_169 = " - Connection to '\" + url_";
  ...
  protected final String TEXT_176 = NL + "if(dbname_";
  protected final String TEXT_177 = " == null || dbname_";
  protected final String TEXT_178 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_179 = " = ";
  protected final String TEXT_180 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_181 = " = dbname_";
  protected final String TEXT_182 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_183 = ";" + NL + "}";
  protected final String TEXT_184 = NL + "int count_";
  protected final String TEXT_185 = "=0;";
  ...
  protected final String TEXT_190 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_196 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_203 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_217 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_225 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_239 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_244 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_245 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_252 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_255 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_256 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_257 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_258 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_259 = ")== null){";
  protected final String TEXT_260 = "              ";
  protected final String TEXT_261 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_262 = " = conn_";
  protected final String TEXT_263 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_264 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_265 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_266 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_267 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_268 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_273 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_274 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_275 = " = tableNameForSearch_";
  protected final String TEXT_276 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_277 = " = tableNameForSearch_";
  protected final String TEXT_278 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_279 = " = dbMetaData_";
  protected final String TEXT_280 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_281 = ", tableNameForSearch_";
  ...
  protected final String TEXT_306 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_307 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_390 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_404 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_413 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_419 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_426 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_440 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_447 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_451 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_457 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_468 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_469 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_470 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_479 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_497 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_506 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_507 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_514 = ".close();";
