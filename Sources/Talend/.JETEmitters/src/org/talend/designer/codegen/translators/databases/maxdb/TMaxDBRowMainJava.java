...
public class TMaxDBRowMainJava
{
  ...
  protected final String TEXT_38 = NL + "\t} catch (java.lang.Exception e) {" + NL + "        whetherReject_";
  ...
  protected final String TEXT_47 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_48 = NL + "                ";
  protected final String TEXT_49 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_50 = ";";
  protected final String TEXT_51 = NL + "                System.err.print(e.getMessage());";
  ...
  protected final String TEXT_65 = NL + "    if(commitEvery_";
  protected final String TEXT_66 = "<=commitCounter_";
  protected final String TEXT_67 = "){" + NL + "    " + NL + "    \tconn_";
  protected final String TEXT_68 = ".commit();" + NL + "    \t" + NL + "    \tcommitCounter_";
