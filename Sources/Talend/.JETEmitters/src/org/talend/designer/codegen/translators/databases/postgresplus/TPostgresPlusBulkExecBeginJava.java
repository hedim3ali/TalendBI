...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_37 = " += \"NULL AS '\" + ";
  protected final String TEXT_38 = " + \"' \";";
  protected final String TEXT_39 = NL + "        bulkSQL_";
  protected final String TEXT_40 = " += \"CSV ";
  protected final String TEXT_41 = " QUOTE AS '\" + ";
  ...
  protected final String TEXT_46 = NL + "        bulkSQL_";
  protected final String TEXT_47 = " += \"ESCAPE AS '\" + ";
  ...
  protected final String TEXT_57 = NL + "\t\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\t\tconn_";
  protected final String TEXT_58 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_85 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_86 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_87 = " = tableNameForSearch_";
  protected final String TEXT_88 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_89 = " = tableNameForSearch_";
  protected final String TEXT_90 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_91 = " = dbMetaData_";
  protected final String TEXT_92 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_93 = ", tableNameForSearch_";
  protected final String TEXT_94 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_95 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_96 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_97 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_107 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_108 = " = rsTable_";
  protected final String TEXT_109 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_110 = ".equalsIgnoreCase(";
  protected final String TEXT_111 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_112 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_125 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_129 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_130 = ".equals(schema_";
  protected final String TEXT_131 = ") || (schema_";
  protected final String TEXT_132 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_133 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_142 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_143 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_144 = " == null || dbschema_";
  protected final String TEXT_145 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_148 = " = stmtSchema_";
  protected final String TEXT_149 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_150 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_151 = " = rsSchema_";
  protected final String TEXT_152 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_153 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_154 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_169 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_170 = ".equals";
  protected final String TEXT_171 = "IgnoreCase";
  protected final String TEXT_172 = "(schema_";
  ...
  protected final String TEXT_195 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_200 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_203 = ".execute(\"";
  protected final String TEXT_204 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_205 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_211 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_233 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_234 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_235 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_236 = NL + "\t";
  protected final String TEXT_237 = NL + "        int keyCount_";
  protected final String TEXT_238 = " = ";
  protected final String TEXT_239 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_240 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_241 = " = tableName_";
  protected final String TEXT_242 = ";" + NL + "        tableName_";
  protected final String TEXT_243 = " = \"tmp_";
  protected final String TEXT_244 = "\" + \"_\" + pid;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_245 = " = conn_";
  protected final String TEXT_246 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_247 = ".execute(\"";
  protected final String TEXT_248 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_249 = ".close();";
  protected final String TEXT_250 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_251 = " =conn_";
  protected final String TEXT_252 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_253 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_254 = ".close();" + NL + "   \t\t";
  protected final String TEXT_255 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_258 = ".execute(bulkSQL_";
  protected final String TEXT_259 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_260 = ".close();" + NL + "        tableName_";
  protected final String TEXT_261 = " = tmpTableName_";
  protected final String TEXT_262 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_263 = " = \"tmp_";
  protected final String TEXT_264 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_265 = " = conn_";
  protected final String TEXT_266 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_267 = ".executeUpdate(\"";
  protected final String TEXT_268 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_269 = ".close();" + NL + "        tableName_";
  protected final String TEXT_270 = " = tmpTableName_";
  protected final String TEXT_271 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_272 = " = conn_";
  protected final String TEXT_273 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_274 = ".execute(\"";
  protected final String TEXT_275 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_276 = ".close();";
  protected final String TEXT_277 = NL + "\t    ";
  protected final String TEXT_278 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_279 = " =conn_";
  protected final String TEXT_280 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_281 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_282 = ".close();" + NL + "   \t\t";
  protected final String TEXT_283 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_284 = " = conn_";
  protected final String TEXT_285 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_286 = ".execute(bulkSQL_";
  protected final String TEXT_287 = ");" + NL + "    stmtBulk_";
