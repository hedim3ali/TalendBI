...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_72 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_73 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_74 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_80 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_85 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_86 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_87 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_101 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_109 = " - Creating table '\" + tableName_";
  protected final String TEXT_110 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_111 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_112 = ".execute((\"";
  protected final String TEXT_113 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_123 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_201 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_202 = " = rsTable_";
  protected final String TEXT_203 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_204 = ".equals";
  protected final String TEXT_205 = "IgnoreCase";
  protected final String TEXT_206 = "(";
  protected final String TEXT_207 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_208 = ".equals";
  protected final String TEXT_209 = "IgnoreCase";
  protected final String TEXT_210 = "(dbschema_";
  protected final String TEXT_211 = ") || (dbschema_";
  protected final String TEXT_212 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_213 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_222 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_223 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_224 = " == null || dbschema_";
  protected final String TEXT_225 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_228 = " = stmtSchema_";
  protected final String TEXT_229 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_230 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_231 = " = rsSchema_";
  protected final String TEXT_232 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_233 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_234 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_248 = " ==null || dbschema_";
  protected final String TEXT_249 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_250 = ".equals";
  protected final String TEXT_251 = "IgnoreCase";
  protected final String TEXT_252 = "(schema_";
  ...
  protected final String TEXT_270 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_288 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_297 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_303 = " - Drop table '\" + tableName_";
  protected final String TEXT_304 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_305 = NL + "                    stmtDrop_";
  protected final String TEXT_306 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_310 = " - Creating table '\" + tableName_";
  protected final String TEXT_311 = " + \"'.\" );" + NL + "\t\t\t\t\t";
  protected final String TEXT_312 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_313 = ".execute((\"";
  protected final String TEXT_314 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_324 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_331 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_335 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_341 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_354 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_360 = ".executeUpdate(\"";
  protected final String TEXT_361 = "\");" + NL + "   \t    \t";
  protected final String TEXT_362 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_363 = " - Truncate table '\" + tableName_";
  protected final String TEXT_364 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_365 = NL + "            while(rsTruncCount_";
  protected final String TEXT_366 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_367 = " += rsTruncCount_";
  protected final String TEXT_368 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_369 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_370 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_371 = ".close();            ";
  protected final String TEXT_372 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_373 = " = conn_";
  protected final String TEXT_374 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_375 = " = stmtTruncCount_";
  protected final String TEXT_376 = ".executeQuery(\"";
  protected final String TEXT_377 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_378 = " = conn_";
  protected final String TEXT_379 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_380 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_381 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_390 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_411 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_417 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_422 = ") VALUES (";
  protected final String TEXT_423 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_438 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_439 = " = conn_";
  protected final String TEXT_440 = ".prepareStatement(update_";
  protected final String TEXT_441 = ");" + NL + "\t    String insert_";
  protected final String TEXT_442 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_443 = " + \" (";
  protected final String TEXT_444 = ") VALUES (";
  ...
  protected final String TEXT_454 = ".prepareStatement(delete_";
  protected final String TEXT_455 = ");" + NL + "\t    ";
  protected final String TEXT_456 = NL + "        StringBuffer query_";
  protected final String TEXT_457 = " = null;" + NL + "       \t";
  protected final String TEXT_458 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_459 = " = insert_";
  protected final String TEXT_460 = ".split(\"\\\\?\");";
  protected final String TEXT_461 = NL + "\t\t\tupdate_";
  protected final String TEXT_462 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_463 = " = update_";
  ...
  protected final String TEXT_468 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_469 = " = insert_";
  ...
  protected final String TEXT_473 = " = delete_";
  protected final String TEXT_474 = ".split(\"\\\\?\");";
  protected final String TEXT_475 = NL + "\t\t\treplace_";
  protected final String TEXT_476 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_477 = " = replace_";
  protected final String TEXT_478 = ".split(\"\\\\?\");";
  protected final String TEXT_479 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_480 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_481 = " = insertIgnore_";
  protected final String TEXT_482 = ".split(\"\\\\?\");";
  protected final String TEXT_483 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_484 = " = insert_";
  protected final String TEXT_485 = ".split(\"\\\\?\");";
  protected final String TEXT_486 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_487 = " = conn_";
  protected final String TEXT_488 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_489 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_490 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_491 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_492 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_493 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
