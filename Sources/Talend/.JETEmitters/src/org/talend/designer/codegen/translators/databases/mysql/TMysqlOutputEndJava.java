...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_196 = " - Executing the ";
  protected final String TEXT_197 = " batch.\");" + NL + "\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_199 = ": pstmt_";
  protected final String TEXT_200 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_201 = " += (countEach_";
  protected final String TEXT_202 = " < 0 ? 0 : countEach_";
  protected final String TEXT_203 = ");" + NL + "\t\t\t}       \t" + NL + "\t\t\t";
  protected final String TEXT_204 = "\t\t\t\t\t\t" + NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_205 = " - The ";
  protected final String TEXT_206 = " batch execution has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_207 = NL + "\t    \t";
  protected final String TEXT_208 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_209 = " += countSum_";
  protected final String TEXT_210 = "; " + NL + "\t    \t";
  protected final String TEXT_211 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_212 = " += countSum_";
  protected final String TEXT_213 = ";" + NL + "\t    \t";
  protected final String TEXT_214 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_215 = " += countSum_";
  protected final String TEXT_216 = ";" + NL + "\t    \t";
  protected final String TEXT_217 = "            \t    " + NL + "\t    }" + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_218 = NL + "\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\t\tlog.fatal(\"";
  protected final String TEXT_220 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_221 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_222 = NL + "\t\t";
  protected final String TEXT_223 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_224 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_225 = NL + "    \tint countSum_";
  protected final String TEXT_226 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_227 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_228 = " += (countEach_";
  protected final String TEXT_229 = " < 0 ? 0 : countEach_";
  protected final String TEXT_230 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_231 = NL + "    \tinsertedCount_";
  protected final String TEXT_232 = " += countSum_";
  protected final String TEXT_233 = ";" + NL + "    \t";
  protected final String TEXT_234 = "            \t    \t\t" + NL + "    \tupdatedCount_";
  protected final String TEXT_235 = " += countSum_";
  protected final String TEXT_236 = ";" + NL + "    \t";
  protected final String TEXT_237 = NL + "    \tdeletedCount_";
  protected final String TEXT_238 = " += countSum_";
  protected final String TEXT_239 = ";" + NL + "    \t";
  protected final String TEXT_240 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_241 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_242 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_243 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_245 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_246 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_247 = ");   " + NL + "\t\t\t";
  protected final String TEXT_248 = "              " + NL + "        }        ";
  protected final String TEXT_249 = NL;
  protected final String TEXT_250 = NL + "\t\t\t";
  protected final String TEXT_251 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_252 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_253 = " + \" records.\");" + NL + "\t\t\t";
  protected final String TEXT_254 = NL + "    \t\tconn_";
  protected final String TEXT_255 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_256 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_257 = " - Commit has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_258 = NL + "    \t\t";
  protected final String TEXT_259 = "\t" + NL + "\t\t";
  protected final String TEXT_260 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_261 = " - Closing the connection to the database.\");" + NL + "\t\t";
  ...
  protected final String TEXT_265 = " - Connection to the database closed.\");" + NL + "\t\t";
  protected final String TEXT_266 = NL + "    \t";
  protected final String TEXT_267 = NL + NL + "\tnb_line_deleted_";
  protected final String TEXT_268 = "=nb_line_deleted_";
  protected final String TEXT_269 = "+ deletedCount_";
  protected final String TEXT_270 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_271 = "=nb_line_update_";
  protected final String TEXT_272 = " + updatedCount_";
  protected final String TEXT_273 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_274 = "=nb_line_inserted_";
  protected final String TEXT_275 = " + insertedCount_";
  protected final String TEXT_276 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_277 = "=nb_line_rejected_";
  protected final String TEXT_278 = " + rejectedCount_";
  protected final String TEXT_279 = ";" + NL + "" + NL + "    globalMap.put(\"";
  protected final String TEXT_280 = "_NB_LINE\",nb_line_";
  protected final String TEXT_281 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_282 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_283 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_284 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_285 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_286 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_287 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_288 = "_NB_LINE_REJECTED\", nb_line_rejected_";
  protected final String TEXT_289 = ");" + NL + "    " + NL + "\t";
  protected final String TEXT_290 = NL + "\t\tlog.info(\"";
  protected final String TEXT_291 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_292 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_293 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_294 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_295 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_296 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_297 = " - Has deleted \" + nb_line_deleted_";
  protected final String TEXT_298 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_299 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_300 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_301 = " + \" records.\");" + NL + "\t  \tlog.info(\"";
  protected final String TEXT_302 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_303 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_304 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_305 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_306 = " + \" records.\");" + NL + "\t  \tlog.info(\"";
  protected final String TEXT_307 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_308 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_309 = NL + "\t\tlog.info(\"";
  protected final String TEXT_310 = " - Has rejected \" + nb_line_rejected_";
  protected final String TEXT_311 = " + \"records.\");" + NL + "\t";
  protected final String TEXT_312 = NL + "\t\tlog.info(\"";
  protected final String TEXT_313 = " - Done.\");" + NL + "\t";
