...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_122 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_126 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_127 = ".equals(schema_";
  protected final String TEXT_128 = ") || (schema_";
  protected final String TEXT_129 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_130 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_139 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_140 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_141 = " == null || dbschema_";
  protected final String TEXT_142 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_145 = " = stmtSchema_";
  protected final String TEXT_146 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_147 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_148 = " = rsSchema_";
  protected final String TEXT_149 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_150 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_151 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_166 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_204 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_208 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_211 = ".executeUpdate(\"";
  protected final String TEXT_212 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_213 = ".close();";
  protected final String TEXT_214 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_217 = " = stmtTruncCount_";
  protected final String TEXT_218 = ".executeQuery(\"";
  protected final String TEXT_219 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_222 = ".executeUpdate(\"";
  protected final String TEXT_223 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_224 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_225 = " += rsTruncCount_";
  protected final String TEXT_226 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_227 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_228 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_229 = ".close();            ";
  protected final String TEXT_230 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_231 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_232 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_233 = NL + "\t";
  protected final String TEXT_234 = NL + NL + "StringBuilder command_";
  protected final String TEXT_235 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_236 = ".append(";
  protected final String TEXT_237 = " + \" \");";
  protected final String TEXT_238 = NL + "    String tmpTableName_";
  protected final String TEXT_239 = " = tableName_";
  protected final String TEXT_240 = ";" + NL + "    tableName_";
  protected final String TEXT_241 = " = \"tmp_";
  protected final String TEXT_242 = "\" + \"_\" + pid;";
  protected final String TEXT_243 = NL + "if(dbschema_";
  protected final String TEXT_244 = " != null && dbschema_";
  protected final String TEXT_245 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_246 = ".append(db_";
  protected final String TEXT_247 = " + \".\" + tableName_";
  protected final String TEXT_248 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_249 = ".append(db_";
  protected final String TEXT_250 = " + \"..\" + tableName_";
  protected final String TEXT_251 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_252 = ".append(\" in \" + ";
  protected final String TEXT_253 = ");" + NL + "String headRow_";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ";" + NL + "if(headRow_";
  protected final String TEXT_256 = " != null && headRow_";
  protected final String TEXT_257 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_258 = ".append(\" -F \" + headRow_";
  protected final String TEXT_259 = ");" + NL + "}" + NL;
  protected final String TEXT_260 = NL + "\tcommand_";
  protected final String TEXT_261 = ".append(\" -b \" + ";
  protected final String TEXT_262 = ");";
  protected final String TEXT_263 = NL + NL + "command_";
  protected final String TEXT_264 = ".append(\" -t \" + ";
  protected final String TEXT_265 = ");" + NL + "command_";
  protected final String TEXT_266 = ".append(\" -r \" + ";
  protected final String TEXT_267 = ");" + NL + "command_";
  protected final String TEXT_268 = ".append(\" -c -U \" + user_";
  protected final String TEXT_269 = " + \" -P \" + pass_";
  protected final String TEXT_270 = ");";
  protected final String TEXT_271 = NL + "command_";
  protected final String TEXT_272 = ".append(\" -I \" + ";
  protected final String TEXT_273 = ");";
  protected final String TEXT_274 = NL + "    command_";
  protected final String TEXT_275 = ".append(\" -S \" + ";
  protected final String TEXT_276 = ");";
  protected final String TEXT_277 = NL + "\tcommand_";
  protected final String TEXT_278 = ".append(\" -S \" + host_";
  protected final String TEXT_279 = ");";
  protected final String TEXT_280 = NL + "String encoding_";
  protected final String TEXT_281 = " = ";
  protected final String TEXT_282 = ";" + NL + "if(encoding_";
  protected final String TEXT_283 = " != null && encoding_";
  protected final String TEXT_284 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_285 = ".append(\" -J \" + encoding_";
  protected final String TEXT_286 = ");" + NL + "}" + NL;
  protected final String TEXT_287 = NL + "    Runtime runtime_";
  protected final String TEXT_288 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_289 = " = runtime_";
  protected final String TEXT_290 = ".exec(command_";
  protected final String TEXT_291 = ".toString());";
  protected final String TEXT_292 = NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_293 = " = conn_";
  protected final String TEXT_294 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_295 = ".execute(\"";
  protected final String TEXT_296 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_297 = ".close();            " + NL + "        Runtime runtime_";
  protected final String TEXT_298 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_299 = " = runtime_";
  protected final String TEXT_300 = ".exec(command_";
  protected final String TEXT_301 = ".toString());       ";
  protected final String TEXT_302 = NL + NL + "Thread normal_";
  protected final String TEXT_303 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_304 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_305 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_306 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_307 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_308 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_309 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_310 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_311 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_312 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_313 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_314 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_315 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_316 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_317 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_318 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_319 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_320 = ".interrupt();" + NL + "error_";
  protected final String TEXT_321 = ".interrupt();" + NL;
