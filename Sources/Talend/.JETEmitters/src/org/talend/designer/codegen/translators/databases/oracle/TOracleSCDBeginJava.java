...
public class TOracleSCDBeginJava {
  ...
  protected final String TEXT_80 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tString tableName4Search_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";" + NL + "            \tif(tableName4Search_";
  protected final String TEXT_83 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_84 = " = tableName4Search_";
  protected final String TEXT_85 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_86 = " = tableName4Search_";
  ...
  protected final String TEXT_90 = ", tableName4Search_";
  ...
  protected final String TEXT_96 = NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_105 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  ...
  protected final String TEXT_113 = NL + "    " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_114 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_115 = " = null;    ";
  protected final String TEXT_116 = NL + "        String searching_";
  protected final String TEXT_117 = " = \"";
  protected final String TEXT_118 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_119 = " = connection_";
  protected final String TEXT_120 = ".prepareStatement(searching_";
  protected final String TEXT_121 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_122 = " = null;";
  protected final String TEXT_123 = NL + "        String search_";
  protected final String TEXT_124 = " = \"";
  protected final String TEXT_125 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_126 = " = connection_";
  protected final String TEXT_127 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_128 = " = statement_";
  protected final String TEXT_129 = ".executeQuery(search_";
  protected final String TEXT_130 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_131 = ", SCDStruct_";
  protected final String TEXT_132 = "> cache_";
  protected final String TEXT_133 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_134 = ", SCDStruct_";
  protected final String TEXT_135 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_136 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_137 = " sk_";
  protected final String TEXT_138 = " = new SCDSK_";
  protected final String TEXT_139 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_140 = " row_";
  protected final String TEXT_141 = " = new SCDStruct_";
  protected final String TEXT_142 = "();";
  protected final String TEXT_143 = NL + "                    tmpValue_";
  protected final String TEXT_144 = " = resultSet_";
  protected final String TEXT_145 = ".getString(";
  protected final String TEXT_146 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_147 = " != null && tmpValue_";
  protected final String TEXT_148 = ".length() > 0) {";
  protected final String TEXT_149 = NL + "                        ";
  protected final String TEXT_150 = ".";
  protected final String TEXT_151 = " = tmpValue_";
  protected final String TEXT_152 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_153 = NL + "                            if(tmpValue_";
  ...
  protected final String TEXT_161 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_162 = ")) {";
  protected final String TEXT_163 = NL + "                                ";
  protected final String TEXT_164 = ".";
  protected final String TEXT_165 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_166 = "' in '";
  protected final String TEXT_167 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_168 = NL + "                    }";
  protected final String TEXT_169 = NL + "\t                    if(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_170 = ").getTIMESTAMPTZ(";
  protected final String TEXT_171 = ") != null){" + NL + "\t                    \t";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = " = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_174 = ").getTIMESTAMPTZ(";
  protected final String TEXT_175 = ").toBytes());" + NL + "\t                    }else{" + NL + "\t                    \t";
  protected final String TEXT_176 = ".";
  protected final String TEXT_177 = " = null;" + NL + "\t                    }" + NL + "\t                ";
  protected final String TEXT_178 = NL + "\t                    timestamp_";
  protected final String TEXT_179 = " = resultSet_";
  protected final String TEXT_180 = ".getTimestamp(";
  protected final String TEXT_181 = ");" + NL + "\t                    if(timestamp_";
  protected final String TEXT_182 = " != null) {" + NL + "\t                        ";
  protected final String TEXT_183 = ".";
  protected final String TEXT_184 = " = new java.util.Date(timestamp_";
  protected final String TEXT_185 = ".getTime());" + NL + "\t                    } else {" + NL + "\t                        ";
  protected final String TEXT_186 = ".";
  protected final String TEXT_187 = " = null;" + NL + "\t                    }";
  protected final String TEXT_188 = NL + "                    if(resultSet_";
  protected final String TEXT_189 = ".getObject(";
  protected final String TEXT_190 = ") != null) {";
  protected final String TEXT_191 = NL + "                        ";
  protected final String TEXT_192 = ".";
  protected final String TEXT_193 = " = resultSet_";
  protected final String TEXT_194 = ".get";
  protected final String TEXT_195 = "(";
  protected final String TEXT_196 = ");" + NL + "                    }";
  protected final String TEXT_197 = NL + "            cache_";
  protected final String TEXT_198 = ".put(sk_";
  protected final String TEXT_199 = ", row_";
  protected final String TEXT_200 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_201 = ".close();" + NL + "        statement_";
  protected final String TEXT_202 = ".close();";
  protected final String TEXT_203 = NL + "            System.out.println(\"[";
  protected final String TEXT_204 = "] comparison cache loaded\");";
  protected final String TEXT_205 = NL + "        ";
  protected final String TEXT_206 = " nextSurrogateKey_";
  protected final String TEXT_207 = " = 1;";
  protected final String TEXT_208 = NL + "            if(cache_";
  protected final String TEXT_209 = ".size() > 0) {";
  protected final String TEXT_210 = NL + "        String tmpQuery_";
  protected final String TEXT_211 = " = \"SELECT MAX(";
  protected final String TEXT_212 = ") FROM \" + tableName_";
  ...
  protected final String TEXT_219 = NL + "        if(tmpRS_";
  ...
  protected final String TEXT_224 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  ...
  protected final String TEXT_238 = NL + "            insertionStatement_";
  protected final String TEXT_239 = ".setNull(";
  protected final String TEXT_240 = ", java.sql.Types.DATE);";
  protected final String TEXT_241 = NL + "            insertionStatement_";
  ...
  protected final String TEXT_245 = NL + "        String updateSQLForType1_";
  ...
  protected final String TEXT_260 = NL + "        String updateSQLForType3_";
  ...
  protected final String TEXT_267 = NL + "        SCDSK_";
  protected final String TEXT_268 = " lookUpKey_";
  protected final String TEXT_269 = " = null;        ";
  protected final String TEXT_270 = NL + "    SCDStruct_";
