...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_78 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_84 = " - Drop table '\" + tableName_";
  protected final String TEXT_85 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_91 = " - Creating table '\" + tableName_";
  protected final String TEXT_92 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_94 = ".execute((\"";
  protected final String TEXT_95 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_105 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_113 = " - Creating table '\" + tableName_";
  protected final String TEXT_114 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_116 = ".execute((\"";
  protected final String TEXT_117 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_127 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_149 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_152 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_153 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_154 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_155 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_156 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  protected final String TEXT_157 = ".close();";
  protected final String TEXT_158 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_162 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_163 = " = tableNameForSearch_";
  protected final String TEXT_164 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_165 = " = tableNameForSearch_";
  protected final String TEXT_166 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_202 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_203 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_204 = " = rsTable_";
  protected final String TEXT_205 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_206 = " = rsTable_";
  protected final String TEXT_207 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_216 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_217 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_229 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_236 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_237 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_238 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_253 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_254 = ".equals";
  protected final String TEXT_255 = "IgnoreCase";
  protected final String TEXT_256 = "(schema_";
  ...
  protected final String TEXT_268 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_269 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_273 = NL + "                if(!whetherExist_";
  protected final String TEXT_274 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_275 = " = conn_";
  protected final String TEXT_276 = ".createStatement();" + NL + "        \t\t\t";
  protected final String TEXT_277 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_278 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_292 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_301 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_307 = " - Drop table '\" + tableName_";
  protected final String TEXT_308 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_309 = NL + "                    stmtDrop_";
  protected final String TEXT_310 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_314 = " - Creating table '\" + tableName_";
  protected final String TEXT_315 = " + \"'.\" );" + NL + "\t\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_317 = ".execute((\"";
  protected final String TEXT_318 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_328 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_339 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_345 = "- Clear table '\" + tableName_";
  protected final String TEXT_346 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_347 = NL + "            stmtClear_";
  protected final String TEXT_348 = ".close();";
  protected final String TEXT_349 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_354 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_358 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_367 = " - Truncate table '\" + tableName_";
  protected final String TEXT_368 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_369 = NL + "            while(rsTruncCount_";
  protected final String TEXT_370 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_371 = " += rsTruncCount_";
  protected final String TEXT_372 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_373 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_374 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_385 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_394 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_395 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_396 = NL + "             while(rsTruncCount_";
  protected final String TEXT_397 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_398 = " += rsTruncCount_";
  protected final String TEXT_399 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_400 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_401 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_421 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  protected final String TEXT_422 = " + \" WHERE ";
  protected final String TEXT_423 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_424 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_425 = " + \" (";
  protected final String TEXT_426 = ") VALUES (";
  protected final String TEXT_427 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_434 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_490 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_491 = " = ";
  protected final String TEXT_492 = ";" + NL + "        " + NL + "        int commitCounter_";
  protected final String TEXT_493 = " = 0;" + NL + "        ";
  protected final String TEXT_494 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_495 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_496 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
