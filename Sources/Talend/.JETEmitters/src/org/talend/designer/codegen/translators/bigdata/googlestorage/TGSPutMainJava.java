...
public class TGSPutMainJava
{
  ...
  protected final String TEXT_57 = NL + "\t\tif(e_";
  protected final String TEXT_58 = " instanceof org.jets3t.service.ServiceException){" + NL + "\t\t\torg.jets3t.service.ServiceException servError_";
  protected final String TEXT_59 = " = (org.jets3t.service.ServiceException)e_";
  protected final String TEXT_60 = ";" + NL + "\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_61 = ":\");" + NL + "\t\t\tSystem.err.println(servError_";
  protected final String TEXT_62 = ".getMessage());" + NL + "\t\t\tif(servError_";
  protected final String TEXT_63 = ".getErrorCode()!=null){" + NL + "\t\t\t\tSystem.err.println(servError_";
  protected final String TEXT_64 = ".getErrorCode());" + NL + "\t\t\t}" + NL + "\t\t\tif(servError_";
  protected final String TEXT_65 = ".getErrorMessage()!=null){" + NL + "\t\t\t\tSystem.err.println(servError_";
  protected final String TEXT_66 = ".getErrorMessage());" + NL + "\t\t\t}" + NL + "" + NL + "\t\t}else{" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_67 = ".getMessage());" + NL + "\t\t}";
  protected final String TEXT_68 = NL + "\t}finally{" + NL + "\t\tif(service_";
  protected final String TEXT_69 = " !=null){" + NL + "\t\t\tservice_";
  protected final String TEXT_70 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
