...
public class TMSSqlConnectionBeginJava
{
  ...
  protected final String TEXT_56 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_57 = "\", ";
  protected final String TEXT_58 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_59 = "\",  ";
  protected final String TEXT_60 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_61 = "\",conn_";
  protected final String TEXT_62 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
