...
public class Iterate_subprocess_headerJava
{
  ...
  protected final String TEXT_37 = NL + "\t\t}" + NL + "" + NL + "" + NL + "\t\tpublic void run() {\t\t" + NL + "" + NL + "\t\t\tjava.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "\t\t\tthreadRunResultMap.put(\"errorCode\", null);" + NL + "\t\t\tthreadRunResultMap.put(\"status\", \"\");" + NL + "\t\t\tthreadLocal.set(threadRunResultMap);" + NL + "\t\t\t" + NL + "\t\t\tthis.isRunning = true;" + NL + "\t\t\tString currentComponent = \"\";" + NL + "\t\t\tjava.util.Map<String, Object> resourceMap = new java.util.HashMap<String, Object>();";
  protected final String TEXT_38 = NL + "\t\t\tString currentVirtualComponent = null;";
  protected final String TEXT_39 = NL + "\t\t\ttry {\t\t\t";
  protected final String TEXT_40 = NL + "if(execStat){" + NL + "\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_41 = "\",0,\"exec\"+iterateId);" + NL + "}\t\t\t\t";
  protected final String TEXT_42 = NL;
  protected final String TEXT_43 = NL + "if(execStat){\t\t\t\t" + NL + "           \t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_44 = "\", 3, 0);" + NL + "}           \t\t\t";
  protected final String TEXT_45 = "        \t\t" + NL + "if(execStat){" + NL + "\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_46 = "\", 1, \"exec\" + NB_ITERATE_";
  protected final String TEXT_47 = ");" + NL + "\t\t\t\t//Thread.sleep(1000);" + NL + "}\t\t\t\t";
