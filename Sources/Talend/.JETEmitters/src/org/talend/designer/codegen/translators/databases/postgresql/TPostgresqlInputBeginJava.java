...
public class TPostgresqlInputBeginJava
{
  ...
  protected final String TEXT_214 = " = \"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_239 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_240 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_241 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_242 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_243 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_244 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_252 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  ...
  protected final String TEXT_315 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_316 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_317 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_318 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_343 = ".getObject(column_index_";
  protected final String TEXT_344 = ");";
  protected final String TEXT_345 = NL + "\t\t                         ";
  protected final String TEXT_346 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_347 = ".getObject(column_index_";
  protected final String TEXT_348 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_349 = NL + "                                    ";
  protected final String TEXT_350 = ".";
  protected final String TEXT_351 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_361 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_362 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_394 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_395 = ".getObject(column_index_";
  protected final String TEXT_396 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_397 = ".";
  protected final String TEXT_398 = " = new Geometry(sb.toString());";
  protected final String TEXT_399 = NL + "\t\t                          ";
  protected final String TEXT_400 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_401 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_403 = ".append(";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_406 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  ...
  protected final String TEXT_411 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_412 = " - Content of the record \" + nb_line_";
  protected final String TEXT_413 = " + \": \" + log4jSb_";
  protected final String TEXT_414 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_415 = ".delete(0,log4jSb_";
  protected final String TEXT_416 = ".length());" + NL + "\t\t\t\t\t";
