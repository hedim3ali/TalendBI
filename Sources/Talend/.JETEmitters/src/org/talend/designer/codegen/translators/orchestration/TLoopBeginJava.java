...
public class TLoopBeginJava
{
  ...
  protected final String TEXT_9 = " + \" with a step of \" + ";
  protected final String TEXT_10 = " + \" (\" + ";
  protected final String TEXT_11 = " + \").\");";
  protected final String TEXT_12 = NL + NL + "for(int loop";
  ...
  protected final String TEXT_20 = NL + "for(int loop";
  protected final String TEXT_21 = " =";
  protected final String TEXT_22 = "; loop";
  protected final String TEXT_23 = ">=";
  protected final String TEXT_24 = "; loop";
  protected final String TEXT_25 = "=loop";
  protected final String TEXT_26 = "+";
  protected final String TEXT_27 = "){";
  protected final String TEXT_28 = NL + "\t";
  protected final String TEXT_29 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_30 = " - Iteration value is \" + loop";
  protected final String TEXT_31 = ");" + NL + "\t";
  protected final String TEXT_32 = NL + "current_iteration_";
  protected final String TEXT_33 = "++;" + NL + "globalMap.put(\"";
  protected final String TEXT_34 = "_CURRENT_VALUE\",loop";
  protected final String TEXT_35 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_36 = "_CURRENT_ITERATION\",current_iteration_";
  protected final String TEXT_37 = ");" + NL;
  protected final String TEXT_38 = NL;
  protected final String TEXT_39 = NL;
  protected final String TEXT_40 = ";" + NL + "\t";
  protected final String TEXT_41 = NL + "\t\tlog.info(\"";
  protected final String TEXT_42 = " - Start to loop using a while loop. Initial declaration: '\" + \"";
  protected final String TEXT_43 = "\" + \"'. Condition: '\" + ";
  protected final String TEXT_44 = " + \"'.\");" + NL + "\t";
  protected final String TEXT_45 = NL + "while(";
  protected final String TEXT_46 = "){" + NL + "\t";
  protected final String TEXT_47 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_48 = " - Current iteration value: \" + current_iteration_";
  protected final String TEXT_49 = ");" + NL + "\t";
  protected final String TEXT_50 = NL + "current_iteration_";
  protected final String TEXT_51 = "++;" + NL + "globalMap.put(\"";
  protected final String TEXT_52 = "_CURRENT_ITERATION\",current_iteration_";
