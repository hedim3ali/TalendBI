...
public class THiveConnectionBeginJava
{
  ...
  protected final String TEXT_88 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_89 = "\", conn_";
  protected final String TEXT_90 = ");";
  protected final String TEXT_91 = NL + "\t}";
  protected final String TEXT_92 = NL + "\tif (null != conn_";
  protected final String TEXT_93 = ") {" + NL + "\t\t";
  protected final String TEXT_94 = NL + "\t}";
  protected final String TEXT_95 = NL;
  protected final String TEXT_96 = NL + "\tglobalMap.put(\"current_client_path_separator\", System.getProperty(\"path.separator\"));" + NL + "\tSystem.setProperty(\"path.separator\", ";
  protected final String TEXT_97 = ");" + NL + "\t" + NL + "\tjava.sql.Statement init_";
  ...
  protected final String TEXT_101 = ".execute(\"SET mapred.job.map.memory.mb=\" + ";
  protected final String TEXT_102 = ");" + NL + "\t    init_";
  protected final String TEXT_103 = ".execute(\"SET mapred.job.reduce.memory.mb=\" + ";
  protected final String TEXT_104 = ");";
  protected final String TEXT_105 = NL + "\t\t\tinit_";
  protected final String TEXT_106 = ".execute(\"SET dfs.namenode.kerberos.principal=\" + ";
  protected final String TEXT_107 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_108 = ".execute(\"SET mapreduce.jobtracker.kerberos.principal=\" + ";
  protected final String TEXT_109 = ");";
  protected final String TEXT_110 = NL + "    \t\tinit_";
  protected final String TEXT_111 = ".execute(\"SET mapreduce.framework.name=yarn\");" + NL + "    \t\tinit_";
  protected final String TEXT_112 = ".execute(\"SET yarn.resourcemanager.address=\" + ";
  protected final String TEXT_113 = ");";
  protected final String TEXT_114 = NL + "\t\t\tinit_";
  protected final String TEXT_115 = ".execute(\"SET yarn.resourcemanager.scheduler.address=\" + ";
  protected final String TEXT_116 = ");";
  protected final String TEXT_117 = NL + "    \t\t//set default yarn classpath with environment variable" + NL + "    \t\tinit_";
  protected final String TEXT_118 = ".execute(\"SET yarn.application.classpath=$HADOOP_CONF_DIR,$HADOOP_COMMON_HOME/*,$HADOOP_COMMON_HOME/lib/*,$HADOOP_HDFS_HOME/*,$HADOOP_HDFS_HOME/lib/*,$HADOOP_MAPRED_HOME/*,$HADOOP_MAPRED_HOME/lib/*,$YARN_HOME/*,$YARN_HOME/lib/*,$HADOOP_YARN_HOME/*,$HADOOP_YARN_HOME/lib/*,$HADOOP_COMMON_HOME/share/hadoop/common/*,$HADOOP_COMMON_HOME/share/hadoop/common/lib/*,$HADOOP_HDFS_HOME/share/hadoop/hdfs/*,$HADOOP_HDFS_HOME/share/hadoop/hdfs/lib/*,$HADOOP_YARN_HOME/share/hadoop/yarn/*,$HADOOP_YARN_HOME/share/hadoop/yarn/lib/*\");";
  protected final String TEXT_119 = NL + "\t\t\tinit_";
  protected final String TEXT_120 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_121 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_122 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_123 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_124 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_125 = ");";
  protected final String TEXT_126 = NL + "\t\t\tinit_";
  protected final String TEXT_127 = ".execute(\"SET \"+";
  protected final String TEXT_128 = "+\"=\"+";
  protected final String TEXT_129 = ");";
  protected final String TEXT_130 = NL + "\tinit_";
  protected final String TEXT_131 = ".close();" + NL + "\t" + NL + "\t";
  protected final String TEXT_132 = NL + "\t\tjava.sql.Statement statement_";
  protected final String TEXT_133 = " = conn_";
  protected final String TEXT_134 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_135 = NL + "\t\t\tstatement_";
  protected final String TEXT_136 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_137 = ");" + NL + "\t\t";
  protected final String TEXT_138 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_139 = NL + "\t\t\tstatement_";
  protected final String TEXT_140 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_141 = ");" + NL + "\t\t";
  protected final String TEXT_142 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_144 = ".execute(\"add jar \"+";
  protected final String TEXT_145 = ");" + NL + "\t\t";
  protected final String TEXT_146 = NL + "\t\tstatement_";
  protected final String TEXT_147 = ".close();" + NL + "\t";
  protected final String TEXT_148 = NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_149 = "\",conn_";
  protected final String TEXT_150 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_151 = "\",";
  protected final String TEXT_152 = ");" + NL + "\t" + NL + "\tString currentClientPathSeparator_";
  protected final String TEXT_153 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "\tif(currentClientPathSeparator_";
  protected final String TEXT_154 = "!=null) {" + NL + "\t\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_155 = ");" + NL + "\t\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "\t}" + NL + "\t" + NL + "\tString currentClientUsername_";
  protected final String TEXT_156 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "\tif(currentClientUsername_";
  protected final String TEXT_157 = "!=null) {" + NL + "\t\tSystem.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_158 = ");" + NL + "\t\tglobalMap.put(\"current_client_user_name\", null);" + NL + "\t}" + NL + "\t" + NL + "\tString originalHadoopUsername_";
  protected final String TEXT_159 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_160 = "\");" + NL + "\tif(originalHadoopUsername_";
  protected final String TEXT_161 = "!=null) {" + NL + "\t\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_162 = ");" + NL + "\t\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_163 = "\", null);" + NL + "\t} else {" + NL + "\t\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "\t}";
