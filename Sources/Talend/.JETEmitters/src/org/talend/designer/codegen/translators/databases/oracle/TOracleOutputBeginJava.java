...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_146 = " != null) {" + NL + "\t\t\tif(conn_";
  protected final String TEXT_147 = ".getMetaData() != null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_148 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_149 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_150 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_151 = NL + "\t";
  protected final String TEXT_152 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_153 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (null != dataSources_";
  protected final String TEXT_154 = ") {" + NL + "\t\tconn_";
  protected final String TEXT_155 = " = dataSources_";
  protected final String TEXT_156 = ".get(";
  protected final String TEXT_157 = ").getConnection();" + NL + "\t} else {";
  protected final String TEXT_158 = NL + "\t\t";
  protected final String TEXT_159 = NL + "\t\t\tjava.lang.Class.forName(\"oracle.jdbc.OracleDriver\");\t" + NL + "\t\t";
  protected final String TEXT_160 = NL + "\t\t\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");\t" + NL + "\t\t";
  ...
  protected final String TEXT_167 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_168 = " + \":\" + ";
  protected final String TEXT_169 = " + \":\" + ";
  protected final String TEXT_170 = ";";
  protected final String TEXT_171 = NL + "\t\t\turl_";
  protected final String TEXT_172 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_173 = " + \")(port=\" + ";
  protected final String TEXT_174 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_175 = " + \")))\";";
  protected final String TEXT_176 = NL + "\t\t\turl_";
  protected final String TEXT_177 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_178 = ";;";
  protected final String TEXT_179 = NL + "\t\t\turl_";
  protected final String TEXT_180 = " = ";
  protected final String TEXT_181 = ";";
  protected final String TEXT_182 = NL + "\t\tString dbUser_";
  protected final String TEXT_183 = " = ";
  protected final String TEXT_184 = ";" + NL + "\t\tString dbPwd_";
  protected final String TEXT_185 = " = ";
  protected final String TEXT_186 = ";" + NL + "\t\tdbschema_";
  protected final String TEXT_187 = " = ";
  protected final String TEXT_188 = ";\t" + NL + "\t\t";
  protected final String TEXT_189 = "\t" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_191 = " - Connection attempt to '\" + url_";
  protected final String TEXT_192 = " +\"' with the username '\" + dbUser_";
  ...
  protected final String TEXT_197 = ");" + NL + "\t\t\tif(dbschema_";
  protected final String TEXT_198 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_199 = ")) //get schema from connection" + NL + "\t\t\t\t{" + NL + "\t\t\t\tdbschema_";
  protected final String TEXT_200 = "=conn_";
  protected final String TEXT_201 = ".getMetaData().getUserName();" + NL + "\t\t\t\t}" + NL + "\t\t";
  protected final String TEXT_202 = NL + "\t\t\tconn_";
  protected final String TEXT_203 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_204 = ", dbUser_";
  protected final String TEXT_205 = ", dbPwd_";
  protected final String TEXT_206 = ");";
  protected final String TEXT_207 = NL + "\t\tString atnParams_";
  protected final String TEXT_208 = " = ";
  protected final String TEXT_209 = ";" + NL + "\t\tatnParams_";
  protected final String TEXT_210 = " = atnParams_";
  protected final String TEXT_211 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_212 = " = new java.util.Properties();" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_213 = ".put(\"user\",dbUser_";
  protected final String TEXT_214 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_215 = ".put(\"password\",dbPwd_";
  protected final String TEXT_216 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_217 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_218 = ".getBytes()));" + NL + "\t\tconn_";
  protected final String TEXT_219 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_220 = ", atnParamsPrope_";
  ...
  protected final String TEXT_228 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_229 = " = ";
  protected final String TEXT_230 = ";        " + NL + "        int commitCounter_";
  protected final String TEXT_231 = " = 0;        ";
  protected final String TEXT_232 = NL + "   int batchSize_";
  protected final String TEXT_233 = " = ";
  protected final String TEXT_234 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_235 = "=0;";
  protected final String TEXT_236 = " " + NL;
  protected final String TEXT_237 = NL + "int count_";
  protected final String TEXT_238 = "=0;";
  protected final String TEXT_239 = NL + NL + "if(dbschema_";
  protected final String TEXT_240 = " == null || dbschema_";
  protected final String TEXT_241 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_242 = " = ";
  protected final String TEXT_243 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_244 = " = dbschema_";
  protected final String TEXT_245 = " + \".\" + ";
  protected final String TEXT_246 = ";    " + NL + "}";
  protected final String TEXT_247 = NL + "  \ttableName_";
  protected final String TEXT_248 = " += \" \" +";
  protected final String TEXT_249 = ";";
  protected final String TEXT_250 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_251 = " = conn_";
  protected final String TEXT_252 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_253 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_254 = " - Droping table '\" + tableName_";
  protected final String TEXT_255 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_256 = NL + "            stmtDrop_";
  protected final String TEXT_257 = ".execute(\"";
  protected final String TEXT_258 = "\");" + NL + "        \t";
  protected final String TEXT_259 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_260 = " - Drop table '\" + tableName_";
  protected final String TEXT_261 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_262 = NL + "            stmtDrop_";
  protected final String TEXT_263 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_266 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_267 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_281 = " - Create table '\" + tableName_";
  protected final String TEXT_282 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_283 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_284 = ".close();";
  protected final String TEXT_285 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_286 = " = conn_";
  protected final String TEXT_287 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_288 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_289 = " - Creating table '\" + tableName_";
  protected final String TEXT_290 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_292 = ".execute((\"";
  protected final String TEXT_293 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_303 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_308 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_309 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_310 = "+\"][\"+";
  protected final String TEXT_311 = "+\"][\"+";
  protected final String TEXT_312 = "+\"][\"+";
  protected final String TEXT_313 = "+\"][\"+";
  protected final String TEXT_314 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_315 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_316 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_317 = " = conn_";
  protected final String TEXT_318 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_319 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_320 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_321 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_322 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_323 = ")== null){";
  protected final String TEXT_324 = "              ";
  protected final String TEXT_325 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_326 = " = conn_";
  protected final String TEXT_327 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_328 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_329 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_330 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_331 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_332 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_337 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_338 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_339 = " = tableNameForSearch_";
  protected final String TEXT_340 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_341 = " = tableNameForSearch_";
  protected final String TEXT_342 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_343 = " = dbMetaData_";
  protected final String TEXT_344 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_345 = ", tableNameForSearch_";
  ...
  protected final String TEXT_359 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_360 = " = rsTable_";
  protected final String TEXT_361 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_362 = ".equals";
  protected final String TEXT_363 = "IgnoreCase";
  protected final String TEXT_364 = "(";
  protected final String TEXT_365 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_366 = ".equals";
  protected final String TEXT_367 = "IgnoreCase";
  protected final String TEXT_368 = "(dbschema_";
  protected final String TEXT_369 = ") || dbschema_";
  protected final String TEXT_370 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_371 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_372 = ".close();";
  protected final String TEXT_373 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_374 = " = conn_";
  protected final String TEXT_375 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_376 = " = dbMetaData_";
  protected final String TEXT_377 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_378 = " = false;" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_392 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_393 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_394 = ")))) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_395 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_401 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_402 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_403 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_404 = " == null || dbschema_";
  protected final String TEXT_405 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_406 = " = conn_";
  protected final String TEXT_407 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_408 = " = stmtSchema_";
  protected final String TEXT_409 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_410 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_411 = " = rsSchema_";
  protected final String TEXT_412 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_413 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_414 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  protected final String TEXT_415 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_416 = " = rsTable_";
  protected final String TEXT_417 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_418 = " = rsTable_";
  protected final String TEXT_419 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_420 = ".equals";
  protected final String TEXT_421 = "IgnoreCase";
  protected final String TEXT_422 = "(";
  protected final String TEXT_423 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_424 = ".equals";
  protected final String TEXT_425 = "IgnoreCase";
  protected final String TEXT_426 = "(dbschema_";
  protected final String TEXT_427 = ") || ((dbschema_";
  protected final String TEXT_428 = " ==null || dbschema_";
  protected final String TEXT_429 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_430 = ".equals";
  protected final String TEXT_431 = "IgnoreCase";
  protected final String TEXT_432 = "(schema_";
  ...
  protected final String TEXT_436 = "      " + NL + "\t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_437 = " = conn_";
  protected final String TEXT_438 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_439 = " = dbMetaData_";
  protected final String TEXT_440 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_441 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_442 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_443 = " = rsTable_";
  protected final String TEXT_444 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_445 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_449 = NL + "                if(!whetherExist_";
  protected final String TEXT_450 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_454 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_468 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_472 = NL + "                if(whetherExist_";
  protected final String TEXT_473 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_477 = " - Droping table '\" + tableName_";
  protected final String TEXT_478 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_479 = NL + "                    stmtDrop_";
  protected final String TEXT_480 = ".execute(\"";
  protected final String TEXT_481 = "\");" + NL + "\t    \t    \t";
  protected final String TEXT_482 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_483 = " - Drop table '\" + tableName_";
  protected final String TEXT_484 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_485 = NL + "                    stmtDrop_";
  protected final String TEXT_486 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_490 = " - Creating table '\" + tableName_";
  protected final String TEXT_491 = " + \"'.\" );" + NL + "\t\t\t\t\t";
  protected final String TEXT_492 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_493 = ".execute((\"";
  protected final String TEXT_494 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_495 = ".";
  protected final String TEXT_496 = ", \"";
  protected final String TEXT_497 = "\"))+\")";
  protected final String TEXT_498 = "\");";
  protected final String TEXT_499 = NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_504 = " - Create table '\" + tableName_";
  protected final String TEXT_505 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_506 = NL + "                stmtCreate_";
  protected final String TEXT_507 = ".close();";
  protected final String TEXT_508 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_509 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_510 = "            ";
  protected final String TEXT_511 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_515 = " - Clearing table '\" + tableName_";
  protected final String TEXT_516 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_517 = NL + "            stmtClear_";
  ...
  protected final String TEXT_521 = "- Clear table '\" + tableName_";
  protected final String TEXT_522 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_523 = NL + "            stmtClear_";
  protected final String TEXT_524 = ".close();";
  protected final String TEXT_525 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_526 = " = conn_";
  protected final String TEXT_527 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_528 = " = stmtTruncCount_";
  protected final String TEXT_529 = ".executeQuery(\"";
  protected final String TEXT_530 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_543 = " - Truncate table '\" + tableName_";
  protected final String TEXT_544 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_545 = NL + "            while(rsTruncCount_";
  protected final String TEXT_546 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_547 = " += rsTruncCount_";
  protected final String TEXT_548 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_549 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_550 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_561 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_570 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_584 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_585 = " = new StringBuffer(insert_";
  protected final String TEXT_586 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_587 = ".insert(insert_";
  protected final String TEXT_588 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_589 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_590 = " =insertStringBuffer_";
  ...
  protected final String TEXT_599 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_600 = " = conn_";
  protected final String TEXT_601 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_602 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_603 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_604 = ",insert_";
  protected final String TEXT_605 = ",keyPsmt_";
  ...
  protected final String TEXT_613 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_614 = " = new StringBuffer(update_";
  protected final String TEXT_615 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_616 = ".insert(update_";
  protected final String TEXT_617 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_618 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_619 = " =updateStringBuffer_";
  protected final String TEXT_620 = ".toString(); ";
  protected final String TEXT_621 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_622 = " = conn_";
  protected final String TEXT_623 = ".prepareStatement(update_";
  ...
  protected final String TEXT_627 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_632 = ") VALUES (";
  protected final String TEXT_633 = ")\";" + NL + "\t   \t";
  protected final String TEXT_634 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_635 = " = new StringBuffer(insert_";
  protected final String TEXT_636 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_637 = ".insert(insert_";
  protected final String TEXT_638 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_639 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_640 = " =insertStringBuffer_";
  protected final String TEXT_641 = ".toString(); ";
  protected final String TEXT_642 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_643 = " = conn_";
  protected final String TEXT_644 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_650 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_651 = " = new StringBuffer(update_";
  protected final String TEXT_652 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_653 = ".insert(update_";
  protected final String TEXT_654 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_655 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_656 = " =updateStringBuffer_";
  protected final String TEXT_657 = ".toString(); ";
  protected final String TEXT_658 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_659 = " = conn_";
  protected final String TEXT_660 = ".prepareStatement(update_";
  protected final String TEXT_661 = ");" + NL + "\t    ";
  protected final String TEXT_662 = NL + "\t    String update_";
  protected final String TEXT_663 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_664 = " + \" SET ";
  protected final String TEXT_665 = " WHERE ";
  protected final String TEXT_666 = "\";" + NL + "\t   \t";
  protected final String TEXT_667 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_668 = " = new StringBuffer(update_";
  protected final String TEXT_669 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_670 = ".insert(update_";
  protected final String TEXT_671 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_672 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_673 = " =updateStringBuffer_";
  protected final String TEXT_674 = ".toString(); ";
  protected final String TEXT_675 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_676 = " = conn_";
  protected final String TEXT_677 = ".prepareStatement(update_";
  protected final String TEXT_678 = ");\t    " + NL + "\t    String insert_";
  protected final String TEXT_679 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_680 = " + \" (";
  protected final String TEXT_681 = ") VALUES (";
  protected final String TEXT_682 = ")\";" + NL + "\t   \t";
  protected final String TEXT_683 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_684 = " = new StringBuffer(insert_";
  protected final String TEXT_685 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_686 = ".insert(insert_";
  protected final String TEXT_687 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_688 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_689 = " =insertStringBuffer_";
  protected final String TEXT_690 = ".toString(); ";
  protected final String TEXT_691 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_692 = " = conn_";
  protected final String TEXT_693 = ".prepareStatement(insert_";
  protected final String TEXT_694 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_695 = NL + "\t    String delete_";
  protected final String TEXT_696 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_697 = " + \" WHERE ";
  protected final String TEXT_698 = "\";" + NL + "\t    ";
  protected final String TEXT_699 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_700 = " = new StringBuffer(delete_";
  protected final String TEXT_701 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_702 = ".insert(delete_";
  protected final String TEXT_703 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_704 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_705 = " =deleteStringBuffer_";
  protected final String TEXT_706 = ".toString();  ";
  protected final String TEXT_707 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_708 = " = conn_";
  protected final String TEXT_709 = ".prepareStatement(delete_";
  protected final String TEXT_710 = ");" + NL + "\t    ";
  protected final String TEXT_711 = NL + "        StringBuffer query_";
  protected final String TEXT_712 = " = null;" + NL + "\t   ";
  protected final String TEXT_713 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_714 = " = insert_";
  protected final String TEXT_715 = ".split(\"\\\\?\");";
  protected final String TEXT_716 = NL + "\t\t\tupdate_";
  protected final String TEXT_717 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_718 = " = update_";
  protected final String TEXT_719 = ".split(\"\\\\?\");";
  protected final String TEXT_720 = NL + "\t\t\tupdate_";
  protected final String TEXT_721 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_722 = " = update_";
  protected final String TEXT_723 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_724 = " = insert_";
  protected final String TEXT_725 = ".split(\"\\\\?\");";
  protected final String TEXT_726 = NL + "\t\t\tdelete_";
  protected final String TEXT_727 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_728 = " = delete_";
  protected final String TEXT_729 = ".split(\"\\\\?\");";
  protected final String TEXT_730 = NL + "\t\t\treplace_";
  protected final String TEXT_731 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_732 = " = replace_";
  protected final String TEXT_733 = ".split(\"\\\\?\");";
  protected final String TEXT_734 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_735 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_736 = " = insertIgnore_";
  ...
  protected final String TEXT_742 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_743 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_744 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_745 = " = true;" + NL + "    \t";
  protected final String TEXT_746 = NL + "\tclass XMLTypeUtil_";
  ...
  protected final String TEXT_748 = NL + "\t\t  \t\tlog.error(\"";
  protected final String TEXT_749 = " - \" + sqlexp.getMessage());" + NL + "\t\t  \t";
  protected final String TEXT_750 = NL + "\t\t    tempClob.freeTemporary(); " + NL + "\t\t    sqlexp.printStackTrace();" + NL + "\t\t  } catch(java.lang.Exception exp){" + NL + "\t\t  \t";
  protected final String TEXT_751 = NL + "\t\t  \t\tlog.error(\"";
  protected final String TEXT_752 = " - \" + exp.getMessage());" + NL + "\t\t  \t";
  protected final String TEXT_753 = NL + "\t\t    tempClob.freeTemporary(); " + NL + "\t\t    exp.printStackTrace();" + NL + "\t\t  }" + NL + "\t\t  return tempClob; " + NL + "\t\t}" + NL + "\t}" + NL + "\tXMLTypeUtil_";
  protected final String TEXT_754 = " xmlTypeUtil_";
  protected final String TEXT_755 = " = null;" + NL + "\txmlTypeUtil_";
  protected final String TEXT_756 = " = new XMLTypeUtil_";
  protected final String TEXT_757 = "();";
  protected final String TEXT_758 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_759 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_760 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
