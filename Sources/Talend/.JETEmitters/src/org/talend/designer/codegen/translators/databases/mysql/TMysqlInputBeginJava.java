...
public class TMysqlInputBeginJava
{
  ...
  protected final String TEXT_213 = NL + "\t\t    java.util.Calendar calendar_";
  protected final String TEXT_214 = " = java.util.Calendar.getInstance();" + NL + "\t\t    calendar_";
  protected final String TEXT_215 = ".set(0, 0, 0, 0, 0, 0);" + NL + "\t\t    java.util.Date year0_";
  protected final String TEXT_216 = " = calendar_";
  protected final String TEXT_217 = ".getTime();";
  protected final String TEXT_218 = NL + "\t\t\t\tString url_";
  protected final String TEXT_219 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_220 = " + \":\" + ";
  protected final String TEXT_221 = " + \"/\" + ";
  protected final String TEXT_222 = ";";
  protected final String TEXT_223 = NL + "\t\t\t\tString url_";
  protected final String TEXT_224 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_225 = " + \":\" + ";
  protected final String TEXT_226 = " + \"/\" + ";
  protected final String TEXT_227 = " + \"?\" + ";
  protected final String TEXT_228 = ";";
  protected final String TEXT_229 = NL + "\t\t        ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_230 = ").enableStreamingResults();";
  protected final String TEXT_231 = NL + "\t        if(rs_";
  protected final String TEXT_232 = ".getString(column_index_";
  protected final String TEXT_233 = ") != null) {" + NL + "\t            String dateString_";
  protected final String TEXT_234 = " = rs_";
  protected final String TEXT_235 = ".getString(column_index_";
  protected final String TEXT_236 = ");" + NL + "\t            if (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_237 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
  protected final String TEXT_238 = ")) {" + NL + "\t                ";
  protected final String TEXT_239 = ".";
  protected final String TEXT_240 = " = rs_";
  protected final String TEXT_241 = ".getTimestamp(column_index_";
  protected final String TEXT_242 = ");" + NL + "\t            } else {" + NL + "\t                ";
  protected final String TEXT_243 = ".";
  protected final String TEXT_244 = " = (java.util.Date) year0_";
  protected final String TEXT_245 = ".clone();" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            ";
  ...
  protected final String TEXT_255 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_256 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_257 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_258 = " = dataSources_";
  protected final String TEXT_259 = ".get(";
  protected final String TEXT_260 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_261 = "\", conn_";
  protected final String TEXT_262 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_263 = NL + "\t\t\t\t";
  protected final String TEXT_264 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_265 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_266 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_267 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_268 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_269 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_277 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_278 = "_QUERY\",dbquery_";
  protected final String TEXT_279 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_280 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_281 = " = stmt_";
  protected final String TEXT_282 = ".executeQuery(dbquery_";
  protected final String TEXT_283 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_284 = " = rs_";
  protected final String TEXT_285 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_286 = " = rsmd_";
  protected final String TEXT_287 = ".getColumnCount();" + NL;
  protected final String TEXT_288 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_289 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_290 = ".setDbmsId(\"";
  protected final String TEXT_291 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_292 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_293 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_294 = ".add(\"";
  protected final String TEXT_295 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_296 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_297 = " = ";
  protected final String TEXT_298 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_299 = "; i <= rsmd_";
  protected final String TEXT_300 = ".getColumnCount()-";
  protected final String TEXT_301 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_302 = ".contains(rsmd_";
  protected final String TEXT_303 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_304 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_305 = ".setName(rsmd_";
  protected final String TEXT_306 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_307 = ".setDbName(rsmd_";
  protected final String TEXT_308 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_309 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_310 = "\", rsmd_";
  protected final String TEXT_311 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_312 = ".getPrecision(i), rsmd_";
  protected final String TEXT_313 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_314 = ".setDbType(rsmd_";
  protected final String TEXT_315 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_340 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_341 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_342 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_343 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_360 = "; \t\t\t" + NL + "\t\t                    } else {";
  ...
  protected final String TEXT_368 = ".getObject(column_index_";
  protected final String TEXT_369 = ");";
  protected final String TEXT_370 = NL + "\t\t                         ";
  protected final String TEXT_371 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_372 = ".getObject(column_index_";
  protected final String TEXT_373 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_374 = NL + "                                    ";
  protected final String TEXT_375 = ".";
  protected final String TEXT_376 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_387 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_414 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_415 = ".";
  protected final String TEXT_416 = ", rs_";
  protected final String TEXT_417 = ", fixedColumnCount_";
  protected final String TEXT_418 = ");";
  protected final String TEXT_419 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_420 = ".getObject(column_index_";
  protected final String TEXT_421 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_422 = ".";
  protected final String TEXT_423 = " = new Geometry(sb.toString());";
  protected final String TEXT_424 = NL + "\t\t                          ";
  protected final String TEXT_425 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_427 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_428 = ".append(";
  protected final String TEXT_429 = ".";
  protected final String TEXT_430 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_432 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_436 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_437 = " - Content of the record \" + nb_line_";
  protected final String TEXT_438 = " + \": \" + log4jSb_";
  protected final String TEXT_439 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_440 = ".delete(0,log4jSb_";
  protected final String TEXT_441 = ".length());" + NL + "\t\t\t\t\t";
