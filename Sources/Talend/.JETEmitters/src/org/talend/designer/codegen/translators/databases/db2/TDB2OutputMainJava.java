...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_533 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_582 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_583 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_584 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_585 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_586 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_587 = " = updatedCount_";
  protected final String TEXT_588 = " + pstmt_";
  protected final String TEXT_589 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_600 = NL + "                        rejectedCount_";
  protected final String TEXT_601 = " = rejectedCount_";
  protected final String TEXT_602 = " + 1;";
  protected final String TEXT_603 = NL + "                        ";
  protected final String TEXT_604 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_605 = NL + "                        ";
  protected final String TEXT_606 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_607 = ";";
  protected final String TEXT_608 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_613 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_614 = " = pstmt_";
  protected final String TEXT_615 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_616 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_617 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_618 = " = rs_";
  protected final String TEXT_619 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_620 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_621 = NL + "                        ";
  protected final String TEXT_622 = NL + "                            query_";
  protected final String TEXT_623 = " = ";
  protected final String TEXT_624 = ";";
  protected final String TEXT_625 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_626 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_627 = ".";
  protected final String TEXT_628 = ", pstmtUpdate_";
  ...
  protected final String TEXT_641 = NL + "                    globalMap.put(\"";
  protected final String TEXT_642 = "_QUERY\", query_";
  protected final String TEXT_643 = ".toString().trim());";
  protected final String TEXT_644 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_645 = " = updatedCount_";
  protected final String TEXT_646 = " + pstmtUpdate_";
  protected final String TEXT_647 = ".executeUpdate(); " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_648 = " = true;";
  protected final String TEXT_649 = NL + "                        throw(e);";
  protected final String TEXT_650 = NL + "                            ";
  protected final String TEXT_651 = " = new ";
  protected final String TEXT_652 = "Struct();";
  ...
  protected final String TEXT_667 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_681 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_682 = " = insertedCount_";
  protected final String TEXT_683 = " + pstmtInsert_";
  protected final String TEXT_684 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_685 = " = true;";
  protected final String TEXT_686 = NL + "                        throw(e);";
  protected final String TEXT_687 = NL + "                            ";
  protected final String TEXT_688 = " = new ";
  protected final String TEXT_689 = "Struct();";
  protected final String TEXT_690 = NL + "                                ";
  protected final String TEXT_691 = ".";
  protected final String TEXT_692 = " = ";
  protected final String TEXT_693 = ".";
  protected final String TEXT_694 = ";";
  protected final String TEXT_695 = NL + "                            rejectedCount_";
  protected final String TEXT_696 = " = rejectedCount_";
  protected final String TEXT_697 = " + 1;";
  protected final String TEXT_698 = NL + "                            ";
  protected final String TEXT_699 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_700 = NL + "                            ";
  protected final String TEXT_701 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_702 = ";";
  protected final String TEXT_703 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_704 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_705 = "++;" + NL + "    \t\t";
  protected final String TEXT_706 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_732 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_733 = "=pstmtUpdate_";
  protected final String TEXT_734 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_735 = " = updatedCount_";
  protected final String TEXT_736 = " + updateFlag_";
  ...
  protected final String TEXT_758 = " == 0) {" + NL + "            \t";
  ...
  protected final String TEXT_777 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_797 = NL + "                }" + NL + "            } " + NL + "    " + NL + "            nb_line_";
  ...
  protected final String TEXT_858 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_859 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_860 = ": pstmt_";
  protected final String TEXT_861 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_862 = " += (countEach_";
  protected final String TEXT_863 = " < 0 ? 0 : countEach_";
  protected final String TEXT_864 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "            \t    \t";
  protected final String TEXT_865 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_866 = " += countSum_";
  protected final String TEXT_867 = ";" + NL + "            \t    \t";
  protected final String TEXT_868 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_869 = " += countSum_";
  protected final String TEXT_870 = ";" + NL + "            \t    \t";
  protected final String TEXT_871 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_872 = " += countSum_";
  protected final String TEXT_873 = ";" + NL + "            \t    \t";
  protected final String TEXT_874 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_875 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  ...
  protected final String TEXT_899 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_900 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_901 = ": pstmt_";
  protected final String TEXT_902 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_915 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_916 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_917 = NL + "                \t\tint countSum_";
  protected final String TEXT_918 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_919 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_920 = " += (countEach_";
  protected final String TEXT_921 = " < 0 ? 0 : countEach_";
  protected final String TEXT_922 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_923 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_924 = " += countSum_";
  protected final String TEXT_925 = ";" + NL + "            \t    \t";
  protected final String TEXT_926 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_927 = " += countSum_";
  protected final String TEXT_928 = ";" + NL + "            \t    \t";
  protected final String TEXT_929 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_930 = " += countSum_";
  protected final String TEXT_931 = ";" + NL + "            \t    \t";
  protected final String TEXT_932 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_933 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_934 = NL + "                \tconn_";
  protected final String TEXT_935 = ".commit();                " + NL + "                \tcommitCounter_";
