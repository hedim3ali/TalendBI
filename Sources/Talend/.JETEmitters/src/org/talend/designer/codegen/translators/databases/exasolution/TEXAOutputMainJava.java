...
public class TEXAOutputMainJava {
  ...
  protected final String TEXT_36 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_37 = NL + "                        ";
  protected final String TEXT_38 = ".errorMessage = e.getMessage();";
  protected final String TEXT_39 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_40 = NL + "            }";
  protected final String TEXT_41 = NL + "                query_";
  protected final String TEXT_42 = " = new String(update_";
  ...
  protected final String TEXT_71 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_72 = NL + "                        ";
  protected final String TEXT_73 = ".errorMessage = e.getMessage();";
  protected final String TEXT_74 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_80 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_81 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_82 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_83 = " = rs_";
  protected final String TEXT_84 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_85 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_86 = NL + "                    query_";
  protected final String TEXT_87 = " = new String(update_";
  ...
  protected final String TEXT_102 = " + pstmtUpdate_";
  protected final String TEXT_103 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_118 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_119 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_120 = NL + "                    query_";
  protected final String TEXT_121 = " = new String(insert_";
  ...
  protected final String TEXT_130 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_131 = " = insertedCount_";
  protected final String TEXT_132 = " + pstmtInsert_";
  ...
  protected final String TEXT_145 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_146 = NL + "                            ";
  protected final String TEXT_147 = ".errorMessage = e.getMessage();";
  protected final String TEXT_148 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_152 = " = new String(update_";
  protected final String TEXT_153 = ");";
  protected final String TEXT_154 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_167 = "\t" + NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_186 = ".errorMessage = e.getMessage();";
  protected final String TEXT_187 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_188 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_189 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_190 = NL + "                    query_";
  protected final String TEXT_191 = " = new String(insert_";
  ...
  protected final String TEXT_218 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_219 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  protected final String TEXT_220 = "++;";
  protected final String TEXT_221 = NL + "                query_";
  protected final String TEXT_222 = " = new String(delete_";
  ...
  protected final String TEXT_248 = ".errorMessage = e.getMessage();";
  protected final String TEXT_249 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_250 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_251 = "++;" + NL + "    \t";
  protected final String TEXT_252 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_263 = NL + "                    commitCounter_";
  protected final String TEXT_264 = "++;                " + NL + "                    if(commitEvery_";
  protected final String TEXT_265 = " <= commitCounter_";
  protected final String TEXT_266 = ") {   " + NL + "                        conn_";
  protected final String TEXT_267 = ".commit();                \t" + NL + "                        commitCounter_";
