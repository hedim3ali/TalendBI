...
public class TSQLiteRowMainJava
{
  ...
  protected final String TEXT_36 = NL + "    } catch (java.lang.Exception e) {" + NL + "        whetherReject_";
  ...
  protected final String TEXT_48 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_69 = NL + "        commitCounter_";
  ...
  protected final String TEXT_73 = ".commit();    \t" + NL + "        \tcommitCounter_";
