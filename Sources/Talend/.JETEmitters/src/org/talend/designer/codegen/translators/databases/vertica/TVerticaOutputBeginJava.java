...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_101 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_102 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_103 = " == null || dbschema_";
  protected final String TEXT_104 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_105 = " = conn_";
  protected final String TEXT_106 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_107 = " = stmtSchema_";
  protected final String TEXT_108 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_109 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_110 = " = rsSchema_";
  protected final String TEXT_111 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_112 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_113 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  ...
  protected final String TEXT_121 = ".equals(dbschema_";
  protected final String TEXT_122 = ") || ((dbschema_";
  protected final String TEXT_123 = " == null || dbschema_";
  protected final String TEXT_124 = ".trim().length() == 0) && defaultSchema_";
  protected final String TEXT_125 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_126 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_127 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_135 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_136 = " + \"_proj (";
  protected final String TEXT_137 = ") AS SELECT ";
  protected final String TEXT_138 = " FROM \" + tableName_";
  ...
  protected final String TEXT_153 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_154 = " + \"_proj (";
  protected final String TEXT_155 = ") AS SELECT ";
  protected final String TEXT_156 = " FROM \" + tableName_";
  protected final String TEXT_157 = ");//";
  protected final String TEXT_158 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_161 = " = stmtClear_";
  ...
  protected final String TEXT_167 = ") VALUES (";
  protected final String TEXT_168 = ")\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_169 = " = conn_";
  protected final String TEXT_170 = ".prepareStatement(insert_";
  protected final String TEXT_171 = ");";
  protected final String TEXT_172 = NL + "        int batchCount_";
  protected final String TEXT_173 = " = 0;";
  protected final String TEXT_174 = NL + "        String update_";
  protected final String TEXT_175 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_184 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_185 = " + \" WHERE ";
  protected final String TEXT_186 = "\");" + NL + "        String insert_";
  protected final String TEXT_187 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_188 = " + \" (";
  protected final String TEXT_189 = ") VALUES (";
  protected final String TEXT_190 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".prepareStatement(insert_";
  protected final String TEXT_193 = ");" + NL + "        String update_";
  protected final String TEXT_194 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_202 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_217 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_223 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_224 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".createStatement();\t" + NL + "        String template_";
  protected final String TEXT_227 = " = \"COPY \" + tableName_";
  protected final String TEXT_228 = " +\" (";
  protected final String TEXT_229 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
