...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_217 = ".setFetchSize(";
  protected final String TEXT_218 = ");";
  protected final String TEXT_219 = NL + "\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_220 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\tif (null != dataSources_";
  protected final String TEXT_221 = ") {" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_222 = " = dataSources_";
  protected final String TEXT_223 = ".get(";
  protected final String TEXT_224 = ").getConnection();" + NL + "\t\t\t\t} else {";
  protected final String TEXT_225 = NL + "\t\t\t\t\tjava.lang.Class.forName(";
  protected final String TEXT_226 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_227 = NL + "\t\t\t\t\tString dbUser_";
  protected final String TEXT_228 = " = ";
  protected final String TEXT_229 = ";" + NL + "\t\t\t\t\tString dbPwd_";
  ...
  protected final String TEXT_237 = NL + "            java.util.Date date_";
  protected final String TEXT_238 = " = null;" + NL + "            try{" + NL + "            \tdate_";
  protected final String TEXT_239 = " = rs_";
  protected final String TEXT_240 = ".getTimestamp(column_index_";
  protected final String TEXT_241 = ");" + NL + "            }catch(java.lang.Exception e){" + NL + "            \tdate_";
  protected final String TEXT_242 = " = rs_";
  protected final String TEXT_243 = ".getDate(column_index_";
  protected final String TEXT_244 = ");" + NL + "            }";
  protected final String TEXT_245 = NL + "            ";
  protected final String TEXT_246 = ".";
  protected final String TEXT_247 = " = date_";
  protected final String TEXT_248 = ";";
  protected final String TEXT_249 = NL + "    " + NL + "\t";
  protected final String TEXT_250 = NL + "\t\t    int nb_line_";
  protected final String TEXT_251 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_252 = " = null;";
  protected final String TEXT_253 = NL + "\t\t        conn_";
  protected final String TEXT_254 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_255 = "\");";
  protected final String TEXT_256 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_257 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_258 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_259 = " = dataSources_";
  protected final String TEXT_260 = ".get(";
  protected final String TEXT_261 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_266 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_267 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_268 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_269 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_270 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_278 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_279 = "_QUERY\",dbquery_";
  protected final String TEXT_280 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_281 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  ...
  protected final String TEXT_293 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_294 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_295 = ".add(\"";
  protected final String TEXT_296 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_297 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_298 = " = ";
  protected final String TEXT_299 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_300 = "; i <= rsmd_";
  protected final String TEXT_301 = ".getColumnCount()-";
  protected final String TEXT_302 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_303 = ".contains(rsmd_";
  protected final String TEXT_304 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_305 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_306 = ".setName(rsmd_";
  protected final String TEXT_307 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_308 = ".setDbName(rsmd_";
  protected final String TEXT_309 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_310 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_311 = "\", rsmd_";
  protected final String TEXT_312 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_313 = ".getPrecision(i), rsmd_";
  protected final String TEXT_314 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_315 = ".setDbType(rsmd_";
  protected final String TEXT_316 = ".getColumnTypeName(i));";
  protected final String TEXT_317 = NL + "                \tdcm_";
  protected final String TEXT_318 = ".setFormat(";
  protected final String TEXT_319 = ");";
  protected final String TEXT_320 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_321 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_322 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_323 = ".setLength(rsmd_";
  protected final String TEXT_324 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_325 = ".setLength(rsmd_";
  protected final String TEXT_326 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_327 = NL + "\t\t\tdcm_";
  protected final String TEXT_328 = ".setLength(rsmd_";
  protected final String TEXT_329 = ".getPrecision(i));";
  protected final String TEXT_330 = NL + "                \tdcm_";
  protected final String TEXT_331 = ".setPrecision(rsmd_";
  protected final String TEXT_332 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_333 = ".setNullable(rsmd_";
  protected final String TEXT_334 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_335 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_336 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_337 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_338 = ".metadatas.add(dcm_";
  protected final String TEXT_339 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_340 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_341 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_342 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_343 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_344 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_372 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_373 = ".getObject(column_index_";
  protected final String TEXT_374 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_375 = NL + "                                    ";
  protected final String TEXT_376 = ".";
  protected final String TEXT_377 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_387 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_388 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_448 = NL + NL + NL;
