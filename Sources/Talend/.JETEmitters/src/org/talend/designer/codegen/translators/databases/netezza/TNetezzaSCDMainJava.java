...
public class TNetezzaSCDMainJava {
  ...
  protected final String TEXT_184 = NL + "\t}//end catch";
  ...
  protected final String TEXT_200 = NL + "        cache_";
  protected final String TEXT_201 = ".put(lookUpKey_";
  protected final String TEXT_202 = ", lookUpValue_";
