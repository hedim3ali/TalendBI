...
public class TRedshiftInputBeginJava
{
  ...
  protected final String TEXT_214 = " > 0) {" + NL + "\t\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_215 = " = new java.io.FileWriter(";
  protected final String TEXT_216 = ", true);" + NL + "\t\t\t\t\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_217 = ",true));" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\torg.postgresql.Driver.setLogLevel(";
  protected final String TEXT_218 = ");" + NL + "" + NL + "\t\t\tString url_";
  protected final String TEXT_219 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_220 = " + \":\" + ";
  protected final String TEXT_221 = " + \"/\" + ";
  protected final String TEXT_222 = " +\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_223 = "+\"&protocolVersion=3\";";
  protected final String TEXT_224 = NL + "\t\t\t\tconn_";
  protected final String TEXT_225 = ".setAutoCommit(false);";
  ...
  protected final String TEXT_245 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_246 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_247 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_248 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_249 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_250 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_258 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_259 = "_QUERY\",dbquery_";
  protected final String TEXT_260 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_284 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_296 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_321 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_322 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_323 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_324 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_352 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_353 = ".getObject(column_index_";
  protected final String TEXT_354 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_355 = NL + "                                    ";
  protected final String TEXT_356 = ".";
  protected final String TEXT_357 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_367 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_368 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_384 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_400 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_401 = ".getObject(column_index_";
  protected final String TEXT_402 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_403 = ".";
  protected final String TEXT_404 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_412 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_413 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\t\t";
  protected final String TEXT_415 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_416 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_417 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_418 = " - Content of the record \" + nb_line_";
  protected final String TEXT_419 = " + \": \" + log4jSb_";
  protected final String TEXT_420 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_421 = ".delete(0,log4jSb_";
  protected final String TEXT_422 = ".length());" + NL + "\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t                            ";
  protected final String TEXT_424 = ".";
  protected final String TEXT_425 = " = ";
  protected final String TEXT_426 = ".";
  protected final String TEXT_427 = ";" + NL + "\t\t                            ";
  protected final String TEXT_428 = NL + NL + NL;
