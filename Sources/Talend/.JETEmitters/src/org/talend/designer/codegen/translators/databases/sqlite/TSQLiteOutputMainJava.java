...
public class TSQLiteOutputMainJava {
  ...
  protected final String TEXT_175 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_176 = "=pstmtUpdate_";
  protected final String TEXT_177 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_178 = " = updatedCount_";
  protected final String TEXT_179 = " + updateFlag_";
  ...
  protected final String TEXT_257 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_258 = NL + "                        ";
  protected final String TEXT_259 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_260 = ";";
  protected final String TEXT_261 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_262 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_263 = "++;";
  protected final String TEXT_264 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_275 = NL + "                commitCounter_";
  protected final String TEXT_276 = "++;    " + NL + "                if(commitEvery_";
  protected final String TEXT_277 = " <= commitCounter_";
  protected final String TEXT_278 = ") {            " + NL + "                    conn_";
  protected final String TEXT_279 = ".commit();                " + NL + "                    commitCounter_";
  protected final String TEXT_280 = "=0;                       " + NL + "                }               ";
