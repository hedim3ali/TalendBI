...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_414 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_464 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_529 = NL + "    \t\t////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_533 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_534 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_535 = " = true;";
  protected final String TEXT_536 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_537 = " - \" + e_";
  protected final String TEXT_538 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_539 = NL + "                    throw(e_";
  protected final String TEXT_540 = ");";
  protected final String TEXT_541 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_542 = " - \" + e_";
  protected final String TEXT_543 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_556 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_557 = ").getSQLState();";
  protected final String TEXT_558 = NL + "                        ";
  protected final String TEXT_559 = ".errorMessage = e_";
  protected final String TEXT_560 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_561 = ";";
  protected final String TEXT_562 = NL + "                        System.err.print(e_";
  protected final String TEXT_563 = ".getMessage());";
  ...
  protected final String TEXT_597 = NL + "    \t\t//////////////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_598 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_599 = " = updatedCount_";
  protected final String TEXT_600 = " + pstmt_";
  protected final String TEXT_601 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_602 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_603 = " = true;";
  protected final String TEXT_604 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_605 = " - \" + e_";
  protected final String TEXT_606 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_607 = NL + "                    throw(e_";
  protected final String TEXT_608 = ");";
  protected final String TEXT_609 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_610 = " - \" + e_";
  protected final String TEXT_611 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_632 = NL + "            }" + NL + "            /////////////////////////////////////    \t\t" + NL + "    \t\t";
  ...
  protected final String TEXT_637 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_638 = " = pstmt_";
  protected final String TEXT_639 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_640 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_641 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_642 = " = rs_";
  protected final String TEXT_643 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_644 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_645 = NL + "                        ";
  protected final String TEXT_646 = NL + "                            query_";
  protected final String TEXT_647 = " = ";
  protected final String TEXT_648 = ";";
  protected final String TEXT_649 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_650 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_668 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_669 = " = updatedCount_";
  protected final String TEXT_670 = " + pstmtUpdate_";
  protected final String TEXT_671 = ".executeUpdate();" + NL + "    \t\t\t} catch(java.lang.Exception e_";
  protected final String TEXT_672 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_673 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_674 = NL + "    \t                ";
  protected final String TEXT_675 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_676 = " - \" + e_";
  protected final String TEXT_677 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_678 = NL + "    \t                throw(e_";
  protected final String TEXT_679 = ");" + NL + "    \t                ";
  protected final String TEXT_680 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_681 = " - \" + e_";
  protected final String TEXT_682 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_693 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_694 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_695 = ").getSQLState();" + NL + "    \t                    ";
  protected final String TEXT_696 = ".errorMessage = e_";
  protected final String TEXT_697 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_698 = ";" + NL + "    \t                    ";
  protected final String TEXT_699 = NL + "    \t                    System.err.print(e_";
  protected final String TEXT_700 = ".getMessage());" + NL + "    \t                    ";
  protected final String TEXT_701 = NL + "    \t\t\t}" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_702 = NL + "                        ";
  protected final String TEXT_703 = NL + "                            query_";
  protected final String TEXT_704 = " = ";
  protected final String TEXT_705 = ";";
  protected final String TEXT_706 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_713 = "_QUERY\", query_";
  protected final String TEXT_714 = ".toString().trim());";
  protected final String TEXT_715 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_716 = " = insertedCount_";
  protected final String TEXT_717 = " + pstmtInsert_";
  protected final String TEXT_718 = ".executeUpdate();" + NL + "    \t\t\t} catch(java.lang.Exception e_";
  protected final String TEXT_719 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_720 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_721 = NL + "    \t                ";
  protected final String TEXT_722 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_723 = " - \" + e_";
  protected final String TEXT_724 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_725 = NL + "    \t                throw(e_";
  protected final String TEXT_726 = ");" + NL + "    \t                ";
  protected final String TEXT_727 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_728 = " - \" + e_";
  protected final String TEXT_729 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_741 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_742 = ").getSQLState();" + NL + "    \t                    ";
  ...
  protected final String TEXT_747 = ".getMessage());" + NL + "    \t                    ";
  protected final String TEXT_748 = NL + "    \t\t\t}" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_749 = "++;" + NL + "    \t\t";
  protected final String TEXT_750 = NL + "    \t    int updateFlag_";
  protected final String TEXT_751 = "=0;" + NL + "    \t    ";
  protected final String TEXT_752 = NL + "                    ";
  protected final String TEXT_753 = NL + "                        query_";
  protected final String TEXT_754 = " = ";
  protected final String TEXT_755 = ";";
  protected final String TEXT_756 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_757 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_775 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_776 = "=pstmtUpdate_";
  protected final String TEXT_777 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_778 = " = updatedCount_";
  protected final String TEXT_779 = " + updateFlag_";
  protected final String TEXT_780 = ";" + NL + "        \t} catch(java.lang.Exception e_";
  protected final String TEXT_781 = ") {" + NL + "        \t    whetherReject_";
  protected final String TEXT_782 = " = true;" + NL + "        \t    ";
  protected final String TEXT_783 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_784 = " - \" + e_";
  protected final String TEXT_785 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_786 = NL + "                    throw(e_";
  protected final String TEXT_787 = ");";
  protected final String TEXT_788 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_789 = " - \" + e_";
  protected final String TEXT_790 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_803 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_804 = ").getSQLState();";
  protected final String TEXT_805 = NL + "                        ";
  protected final String TEXT_806 = ".errorMessage = e_";
  protected final String TEXT_807 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_808 = ";";
  protected final String TEXT_809 = NL + "                        System.err.print(e_";
  protected final String TEXT_810 = ".getMessage());";
  protected final String TEXT_811 = NL + "        \t}" + NL + "        \tif(updateFlag_";
  protected final String TEXT_812 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_813 = NL + "\t\t\t\tquery_";
  protected final String TEXT_814 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_815 = NL + "                        ";
  protected final String TEXT_816 = NL + "                            query_";
  protected final String TEXT_817 = " = ";
  protected final String TEXT_818 = ";";
  protected final String TEXT_819 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_820 = ".";
  protected final String TEXT_821 = ", pstmtInsert_";
  protected final String TEXT_822 = ", ";
  protected final String TEXT_823 = ", \"";
  protected final String TEXT_824 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_825 = NL + "                    globalMap.put(\"";
  protected final String TEXT_826 = "_QUERY\", query_";
  protected final String TEXT_827 = ".toString().trim());";
  protected final String TEXT_828 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_829 = " = insertedCount_";
  protected final String TEXT_830 = " + pstmtInsert_";
  protected final String TEXT_831 = ".executeUpdate();" + NL + "        \t\t} catch(java.lang.Exception e_";
  protected final String TEXT_832 = ") {" + NL + "        \t\t    whetherReject_";
  protected final String TEXT_833 = " = true;" + NL + "        \t\t    ";
  ...
  protected final String TEXT_837 = NL + "                        throw(e_";
  protected final String TEXT_838 = ");";
  protected final String TEXT_839 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_840 = " - \" + e_";
  protected final String TEXT_841 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_854 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_855 = ").getSQLState();";
  protected final String TEXT_856 = NL + "                            ";
  protected final String TEXT_857 = ".errorMessage = e_";
  protected final String TEXT_858 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_859 = ";";
  protected final String TEXT_860 = NL + "                            System.err.print(e_";
  protected final String TEXT_861 = ".getMessage());";
  protected final String TEXT_862 = NL + "        \t\t}" + NL + "        \t} " + NL + "        \tnb_line_";
  ...
  protected final String TEXT_878 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_879 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_880 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_881 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_882 = NL + "    \t\t//////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_883 = " = deletedCount_";
  protected final String TEXT_884 = " + pstmt_";
  protected final String TEXT_885 = ".executeUpdate();" + NL + "    \t\t} catch(java.lang.Exception e_";
  protected final String TEXT_886 = ") {" + NL + "    \t\t    whetherReject_";
  protected final String TEXT_887 = " = true;" + NL + "    \t\t    ";
  protected final String TEXT_888 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_889 = " - \" + e_";
  protected final String TEXT_890 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_891 = NL + "                    throw(e_";
  protected final String TEXT_892 = ");";
  protected final String TEXT_893 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_894 = " - \" + e_";
  ...
  protected final String TEXT_919 = NL + "                log4jSb_";
  protected final String TEXT_920 = ".append(";
  protected final String TEXT_921 = ".";
  protected final String TEXT_922 = ");";
  protected final String TEXT_923 = NL + "                \tlog4jSb_";
  protected final String TEXT_924 = ".append(\"|\");";
  protected final String TEXT_925 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_926 = " - Writing the record \" + nb_line_";
  protected final String TEXT_927 = " + \" \" + log4jSb_";
  protected final String TEXT_928 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_929 = ".delete(0,log4jSb_";
  protected final String TEXT_930 = ".length());" + NL + "\t\t";
  ...
  protected final String TEXT_943 = " <= batchSizeCounter_";
  protected final String TEXT_944 = ") {                ";
  protected final String TEXT_945 = "                                                " + NL + "                try {" + NL + "                \t\tbatchSizeCounter_";
  protected final String TEXT_946 = " = 0; " + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_947 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_948 = ":pstmt_";
  protected final String TEXT_949 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_950 = " += (countEach_";
  protected final String TEXT_951 = " < 0 ? 0 : countEach_";
  protected final String TEXT_952 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_953 = NL + "            \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_959 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_960 = " += countSum_";
  protected final String TEXT_961 = ";" + NL + "            \t    \t";
  protected final String TEXT_962 = "                         \t    \t" + NL + "                }catch(java.sql.SQLException e_";
  protected final String TEXT_963 = "){" + NL + "                \t";
  protected final String TEXT_964 = NL + "\t\t\t\t\tjava.sql.SQLException e2_";
  protected final String TEXT_965 = " = e_";
  protected final String TEXT_966 = ";" + NL + "\t\t\t\t\twhile (e2_";
  protected final String TEXT_967 = " != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_968 = ".getMessage());" + NL + "\t\t\t\t\t\te2_";
  protected final String TEXT_969 = " = e2_";
  protected final String TEXT_970 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_971 = NL + "\t\t\tjava.sql.SQLException e3_";
  protected final String TEXT_972 = " = e_";
  protected final String TEXT_973 = ";" + NL + "                \tboolean isFailure = false;" + NL + "\t\t\twhile(e_";
  protected final String TEXT_974 = " != null){" + NL + "\t\t\t\tif(e_";
  protected final String TEXT_975 = ".getErrorCode() == -2801){" + NL + "\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_976 = ".getMessage());" + NL + "\t\t\t\t\te_";
  protected final String TEXT_977 = ".printStackTrace();" + NL + "\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse if(e_";
  protected final String TEXT_978 = ".getErrorCode() == 1339){" + NL + "\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse{" + NL + "\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_979 = ".getMessage());" + NL + "\t\t\t\t\te_";
  protected final String TEXT_980 = ".printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\te_";
  protected final String TEXT_981 = " = e_";
  protected final String TEXT_982 = ".getNextException();" + NL + "\t\t\t}" + NL + "\t\t\tif(isFailure && e_";
  protected final String TEXT_983 = " != null){" + NL + "\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_984 = ".getMessage());" + NL + "\t\t\t\te_";
  protected final String TEXT_985 = ".printStackTrace();" + NL + "\t\t\t}" + NL + "                \t";
  protected final String TEXT_986 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_987 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_988 = " - \" + e3_";
  protected final String TEXT_989 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_990 = NL + "\t\t\t\tthrow (e3_";
  protected final String TEXT_991 = ");" + NL + "            \t\t";
  protected final String TEXT_992 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_993 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_994 = " - \" + e3_";
  protected final String TEXT_995 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_996 = NL + "\t\t\t\tSystem.err.println(e3_";
  protected final String TEXT_997 = ".getMessage());" + NL + "                \t";
  ...
  protected final String TEXT_1001 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_1002 = " <= commitCounter_";
  protected final String TEXT_1003 = ") {" + NL + "                " + NL + "                \t";
  protected final String TEXT_1004 = NL + "\t\t                try {" + NL + "\t\t                \tcommitCounter_";
  ...
  protected final String TEXT_1011 = NL + "\t\t\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1012 = " - Executing the ";
  protected final String TEXT_1013 = " batch.\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1014 = NL + "\t\t                \t\tint countSum_";
  protected final String TEXT_1015 = " = 0;" + NL + "\t\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1016 = ": pstmt_";
  protected final String TEXT_1017 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1021 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1022 = " - The ";
  protected final String TEXT_1023 = " batch execution has succeeded.\");" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_1031 = NL + "\t\t\t\t\t\t\t\t    deletedCount_";
  ...
  protected final String TEXT_1037 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_1038 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_1039 = " + \" records.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1040 = NL + "\t\t\t        \tconn_";
  protected final String TEXT_1041 = ".commit();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1042 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_1043 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1044 = "\t\t                \t" + NL + "\t\t                }catch(java.sql.SQLException e_";
  protected final String TEXT_1045 = "){" + NL + "                    \t\t";
  protected final String TEXT_1046 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1047 = " - \" + e_";
  protected final String TEXT_1048 = ".getMessage());" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_1053 = " != null) {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_1054 = ".getMessage());" + NL + "\t\t\t\t\t\t\t\te2_";
  protected final String TEXT_1055 = " = e2_";
  protected final String TEXT_1056 = ".getNextException();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1057 = NL + "\t\t\t\t\tjava.sql.SQLException e3_";
  protected final String TEXT_1058 = " = e_";
  protected final String TEXT_1059 = ";" + NL + "\t\t                \tboolean isFailure = false;" + NL + "\t\t\t\t\twhile(e_";
  protected final String TEXT_1060 = " != null){" + NL + "\t\t\t\t\t\tif(e_";
  protected final String TEXT_1061 = ".getErrorCode() == -2801){" + NL + "\t\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1062 = ".getMessage());" + NL + "\t\t\t\t\t\t\te_";
  protected final String TEXT_1063 = ".printStackTrace();" + NL + "\t\t\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse if(e_";
  protected final String TEXT_1064 = ".getErrorCode() == 1339){" + NL + "\t\t\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1065 = ".getMessage());" + NL + "\t\t\t\t\t\t\te_";
  protected final String TEXT_1066 = ".printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\te_";
  protected final String TEXT_1067 = " = e_";
  protected final String TEXT_1068 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif(isFailure && e_";
  protected final String TEXT_1069 = " != null){" + NL + "\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1070 = ".getMessage());" + NL + "\t\t\t\t\t\te_";
  protected final String TEXT_1071 = ".printStackTrace();" + NL + "\t\t\t\t\t}" + NL + "\t\t                \t";
  protected final String TEXT_1072 = NL + "                   \t\t";
  protected final String TEXT_1073 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_1074 = " - \" + e3_";
  protected final String TEXT_1075 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1076 = NL + "\t\t\t\t\t\tthrow (e3_";
  protected final String TEXT_1077 = ");" + NL + "\t\t                \t";
  protected final String TEXT_1078 = NL + "                   \t\t";
  protected final String TEXT_1079 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1080 = " - \" + e3_";
  protected final String TEXT_1081 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1082 = NL + "\t\t\t\t\t\tSystem.err.println(e3_";
  protected final String TEXT_1083 = ".getMessage());" + NL + "\t\t                \t";
