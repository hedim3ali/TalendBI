...
public class TEXAInputBeginJava
{
  ...
  protected final String TEXT_9 = ").getConnection();" + NL + "            } else {";
  protected final String TEXT_10 = NL + "\t\t\t    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_213 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_214 = " + \":\" + ";
  protected final String TEXT_215 = "+ \";schema=\" + ";
  protected final String TEXT_216 = "; ";
  protected final String TEXT_217 = NL + "                String url_";
  protected final String TEXT_218 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_219 = " + \":\" + ";
  protected final String TEXT_220 = " + \";schema=\" + ";
  ...
  protected final String TEXT_239 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_240 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_241 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_242 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_243 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_251 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_252 = "_QUERY\",dbquery_";
  protected final String TEXT_253 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_254 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_255 = " = stmt_";
  protected final String TEXT_256 = ".executeQuery(dbquery_";
  protected final String TEXT_257 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_258 = " = rs_";
  protected final String TEXT_259 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_260 = " = rsmd_";
  protected final String TEXT_261 = ".getColumnCount();" + NL;
  protected final String TEXT_262 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_263 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_264 = ".setDbmsId(\"";
  protected final String TEXT_265 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_266 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_267 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_268 = ".add(\"";
  protected final String TEXT_269 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_270 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_271 = " = ";
  protected final String TEXT_272 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_273 = "; i <= rsmd_";
  protected final String TEXT_274 = ".getColumnCount()-";
  protected final String TEXT_275 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_276 = ".contains(rsmd_";
  protected final String TEXT_277 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_278 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_279 = ".setName(rsmd_";
  protected final String TEXT_280 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setDbName(rsmd_";
  protected final String TEXT_282 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_283 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_284 = "\", rsmd_";
  protected final String TEXT_285 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_286 = ".getPrecision(i), rsmd_";
  protected final String TEXT_287 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_288 = ".setDbType(rsmd_";
  protected final String TEXT_289 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_314 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_315 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_316 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_317 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_329 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_341 = " = (List)rs_";
  protected final String TEXT_342 = ".getObject(column_index_";
  protected final String TEXT_343 = ");";
  protected final String TEXT_344 = NL + "\t\t                         ";
  protected final String TEXT_345 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_346 = ".getObject(column_index_";
  protected final String TEXT_347 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_348 = NL + "                                    ";
  protected final String TEXT_349 = ".";
  protected final String TEXT_350 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_360 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_361 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_393 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_394 = ".getObject(column_index_";
  protected final String TEXT_395 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_396 = ".";
  protected final String TEXT_397 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_405 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  ...
  protected final String TEXT_410 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_411 = " - Content of the record \" + nb_line_";
  protected final String TEXT_412 = " + \": \" + log4jSb_";
  protected final String TEXT_413 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_414 = ".delete(0,log4jSb_";
  protected final String TEXT_415 = ".length());" + NL + "\t\t\t\t\t";
