...
public class TSCPPutMainJava
{
  ...
  protected final String TEXT_45 = "_STATUS\", \"No file transfered.\");" + NL + "        }" + NL + "    }catch(java.lang.Exception e_";
  protected final String TEXT_46 = "){" + NL + "    \t\te_";
  protected final String TEXT_47 = ".printStackTrace();" + NL + "    \t\t";
  protected final String TEXT_48 = NL + "    \t\t\tlog.warn(\"";
  protected final String TEXT_49 = " - File uploading has failed.\");" + NL + "    \t\t";
  protected final String TEXT_50 = NL + "    \t\tglobalMap.put(\"";
  protected final String TEXT_51 = "_STATUS\", \"File put fail.\");" + NL + "    }";
