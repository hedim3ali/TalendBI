...
public class TXMLMapOutBeginJava {
  ...
  protected final String TEXT_73 = " = new java.util.ArrayList<Object>();" + NL + "globalMap.put(\"allOutsForAggregate_";
  protected final String TEXT_74 = "\",allOutsForAggregate_";
  protected final String TEXT_75 = ");" + NL + "// ###############################";
  protected final String TEXT_76 = NL + "\t\t\tTreeNode_API_";
  protected final String TEXT_77 = " treeNodeAPI_";
  protected final String TEXT_78 = " = new TreeNode_API_";
  protected final String TEXT_79 = "();" + NL + "\t\t\tNameSpaceTool nsTool_";
  protected final String TEXT_80 = " = new NameSpaceTool();";
  protected final String TEXT_81 = NL + "\t\tint nb_line_";
  ...
  protected final String TEXT_90 = NL + "valueMap.put(\"";
  protected final String TEXT_91 = "\",";
  protected final String TEXT_92 = ");" + NL + "if(valueMap.get(\"";
  protected final String TEXT_93 = "\")!=null) {//open if 8080";
  protected final String TEXT_94 = NL;
  protected final String TEXT_95 = ".addNamespace(\"";
  protected final String TEXT_96 = "\", TalendString.replaceSpecialCharForXML(FormatterUtils.format(";
  ...
  protected final String TEXT_105 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(FormatterUtils.format(";
  protected final String TEXT_106 = ",";
  protected final String TEXT_107 = ")))));" + NL + "}//close if 8080";
  protected final String TEXT_108 = NL + "        \t";
  protected final String TEXT_109 = ".setQName(org.dom4j.DocumentHelper.createQName(";
  protected final String TEXT_110 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_111 = "\"))));";
  protected final String TEXT_112 = NL + "        \t";
  protected final String TEXT_113 = ".setQName(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_114 = "\"," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_115 = "\",TalendString.replaceSpecialCharForXML(FormatterUtils.format(";
  protected final String TEXT_116 = ",";
  protected final String TEXT_117 = ")))));" + NL + "}//close if 8080";
  protected final String TEXT_118 = NL + "        \t";
  protected final String TEXT_119 = ".setQName(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_120 = "\"," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"";
  ...
  protected final String TEXT_129 = ".addElement(\"";
  protected final String TEXT_130 = "\");" + NL + "        } else {" + NL + "        \t";
  protected final String TEXT_131 = " = ";
  protected final String TEXT_132 = ".addElement(\"";
  protected final String TEXT_133 = "\");" + NL + "        }";
  protected final String TEXT_134 = NL + "\t\t\t\torg.dom4j.Element ";
  protected final String TEXT_135 = " = org.dom4j.DocumentHelper.createElement(\"";
  protected final String TEXT_136 = "\");";
  protected final String TEXT_137 = NL + "\t\t\t\t";
  protected final String TEXT_138 = ".elements().add(";
  protected final String TEXT_139 = ");";
  protected final String TEXT_140 = NL + "\t\t\t\t";
  protected final String TEXT_141 = ".elements().add(orderHelper.getInsertLocation(";
  ...
  protected final String TEXT_150 = NL + "\t\tsubTreeRootParent = ";
  protected final String TEXT_151 = ";";
  protected final String TEXT_152 = NL + "//\t\tif(";
  protected final String TEXT_153 = "!=null){" + NL + "\t\t\tvalueMap.put(\"";
  protected final String TEXT_154 = "\",";
  protected final String TEXT_155 = ");" + NL + "\t\t\tif(valueMap.get(\"";
  protected final String TEXT_156 = "\")!=null) {" + NL + "\t\t\t\t";
  protected final String TEXT_157 = ".addAttribute(\"";
  protected final String TEXT_158 = "\",FormatterUtils.format(";
  protected final String TEXT_159 = ",";
  protected final String TEXT_160 = "));" + NL + "\t\t\t}";
  protected final String TEXT_161 = "else {" + NL + "\t\t\t\t";
  protected final String TEXT_162 = ".addAttribute(\"";
  protected final String TEXT_163 = "\",\"\");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_164 = NL + "//\t\t}";
  protected final String TEXT_165 = NL + "\t\t\t";
  protected final String TEXT_166 = ".addAttribute(\"";
  protected final String TEXT_167 = "\",\"\");";
  protected final String TEXT_168 = NL + "\t\tvalueMap.put(\"";
  protected final String TEXT_169 = "\",";
  protected final String TEXT_170 = ");" + NL + "\t\tif(valueMap.get(\"";
  protected final String TEXT_171 = "\")!=null) {" + NL + "\t\t\troutines.system.NestXMLTool.setText(";
  protected final String TEXT_172 = ", FormatterUtils.format(";
  protected final String TEXT_173 = ",";
  protected final String TEXT_174 = "));" + NL + "\t\t}";
  protected final String TEXT_175 = NL + "\t\t\tisNewElement = false;";
  protected final String TEXT_176 = NL + "\t\t\t\t\tif(isNewElement || groupbyList.size()<=";
  protected final String TEXT_177 = " || groupbyList.get(";
  protected final String TEXT_178 = ")==null";
  protected final String TEXT_179 = NL + "\t\t\t\t\t|| ( groupbyList.get(";
  protected final String TEXT_180 = ").get(";
  protected final String TEXT_181 = ")!=null ? !groupbyList.get(";
  protected final String TEXT_182 = ").get(";
  protected final String TEXT_183 = ").equals(FormatterUtils.format(";
  protected final String TEXT_184 = ",";
  protected final String TEXT_185 = ")) : FormatterUtils.format(";
  protected final String TEXT_186 = ",";
  protected final String TEXT_187 = ")!=null )";
  protected final String TEXT_188 = NL + "\t\t\t\t\t){" + NL;
  protected final String TEXT_189 = "\t" + NL + "\t\t\t\t\tif(groupbyList.size()<=";
  protected final String TEXT_190 = "){" + NL + "\t\t\t\t\t\tgroupbyList.add(new java.util.ArrayList<String>());" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_191 = ").clear();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_192 = NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_193 = ").add(FormatterUtils.format(";
  protected final String TEXT_194 = ",";
  protected final String TEXT_195 = "));";
  protected final String TEXT_196 = NL + "\t\t\t\t\tisNewElement=true;" + NL + "\t\t\t\t\tif(groupElementList.size()<=";
  protected final String TEXT_197 = "){" + NL + "\t\t\t\t\t\tgroupElementList.add(group";
  protected final String TEXT_198 = "_);" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupElementList.set(";
  protected final String TEXT_199 = ",group";
  protected final String TEXT_200 = "_);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tsubTreeRootParent=groupElementList.get(";
  ...
  protected final String TEXT_207 = NL + NL + "class GenerateDocument_";
  protected final String TEXT_208 = " {" + NL;
  protected final String TEXT_209 = NL + "\t\tTreeNode_API_";
  protected final String TEXT_210 = " treeNodeAPI = null;";
  protected final String TEXT_211 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\troutines.system.DocumentGenerateOrderHelper orderHelper = new routines.system.DocumentGenerateOrderHelper(";
  protected final String TEXT_212 = ");" + NL + "\t" + NL + "\torg.dom4j.Document doc = null;" + NL + "\t" + NL + "\torg.dom4j.Element root4Group = null;" + NL + "\t" + NL + "\torg.dom4j.io.OutputFormat format = null;" + NL + "\t" + NL + "\tjava.util.List<java.util.List<String>> groupbyList = null;" + NL + "\tjava.util.List<org.dom4j.Element> groupElementList = null;" + NL + "\tint order = 0;" + NL + "\t" + NL + "\tboolean isFirst = true;" + NL + "\t" + NL + "\tboolean\tneedRoot = true;";
  protected final String TEXT_213 = NL;
  protected final String TEXT_214 = NL + "\t\torg.dom4j.Element ";
  protected final String TEXT_215 = " = null;" + NL + "\t\tpublic boolean  ";
  protected final String TEXT_216 = " = false;";
  protected final String TEXT_217 = NL + "\t" + NL + "    public GenerateDocument_";
  protected final String TEXT_218 = "() {" + NL + "//    \tthis.treeNodeAPI = treeNodeAPI;" + NL + "    \t" + NL + "    \tvalueMap = new java.util.HashMap<String,Object>();" + NL + "    \t" + NL + "    \tgroupbyList =  new java.util.ArrayList<java.util.List<String>>();" + NL + "\t\tgroupElementList = new java.util.ArrayList<org.dom4j.Element>();" + NL + "    \t" + NL + "    \tdoc = org.dom4j.DocumentHelper.createDocument();" + NL + "    \tformat = org.dom4j.io.OutputFormat.createPrettyPrint();" + NL + "    \tformat.setTrimText(false);" + NL + "    }" + NL + "    " + NL + "    public org.dom4j.Document getDocument(){" + NL + "    \treturn this.doc;" + NL + "    }" + NL + "    " + NL + "\t//We generate the TreeNode_API object only if there is a document in the main input table." + NL + "    void generateElements(";
  protected final String TEXT_219 = "TreeNode_API_";
  protected final String TEXT_220 = " treeNodeAPI,";
  protected final String TEXT_221 = "boolean isInnerJoin";
  protected final String TEXT_222 = ", ";
  protected final String TEXT_223 = " ";
  protected final String TEXT_224 = NL + "\t";
  protected final String TEXT_225 = ") {" + NL + "\t" + NL + "\t" + NL + "\t/*if(this.treeNodeAPI==null) {" + NL + "\t\tthis.treeNodeAPI = treeNodeAPI;" + NL + "\t}*/" + NL + "\t" + NL + "\torg.dom4j.Element subTreeRootParent = null;" + NL + "// build root xml tree " + NL + "if (needRoot) {" + NL + "\tneedRoot=false;";
  protected final String TEXT_226 = NL + "\t\troot4Group = subTreeRootParent;" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent=root4Group;" + NL + "\t}" + NL + "\t/* build group xml tree */" + NL + "\tboolean isNewElement = false;";
  protected final String TEXT_227 = NL + "\t\tisNewElement = false;";
  protected final String TEXT_228 = NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_229 = ") {";
  protected final String TEXT_230 = NL + "\t\t\t\t\t\t}";
  protected final String TEXT_231 = NL + "\t\t}" + NL + "    }" + NL + "" + NL + "\tGenerateDocument_";
  protected final String TEXT_232 = " gen_Doc_";
  protected final String TEXT_233 = "_";
  protected final String TEXT_234 = " = new GenerateDocument_";
  protected final String TEXT_235 = "();" + NL + "\tboolean docAlreadyInstanciate_";
  protected final String TEXT_236 = " = false;";
  protected final String TEXT_237 = NL;
  protected final String TEXT_238 = NL + "\t            class SortableRow_";
  protected final String TEXT_239 = " implements Comparable<SortableRow_";
  protected final String TEXT_240 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_241 = "> { // G_TM_B_001 " + NL + "\t" + NL + "\t\t\t\t\tboolean is__rejectedInnerJoin;" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_248 = "__";
  protected final String TEXT_249 = ";" + NL + "\t\t\t                    ";
  protected final String TEXT_250 = NL + "\t\t\t        public void fillFrom(";
  ...
  protected final String TEXT_263 = "this.exprKey_";
  protected final String TEXT_264 = "__";
  protected final String TEXT_265 = " = exprKey_";
  protected final String TEXT_266 = "__";
  protected final String TEXT_267 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        public void copyDataTo(";
  ...
  protected final String TEXT_275 = NL + "\t\t\t        }" + NL + "\t\t\t\t\tpublic String toString() {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\t\t\t\t\tsb.append(super.toString());" + NL + "\t\t\t\t\t\tsb.append(\"[\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_277 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_278 = NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_279 = "__";
  protected final String TEXT_280 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_281 = "__";
  protected final String TEXT_282 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_283 = NL + "\t\t\t\t\t\tsb.append(\"]\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\treturn sb.toString();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_284 = " other) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            ";
  protected final String TEXT_285 = NL + "\t\t\t            \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_286 = "__";
  protected final String TEXT_287 = ", other.exprKey_";
  protected final String TEXT_288 = "__";
  protected final String TEXT_289 = ");" + NL + "\t\t\t            \tif (returnValue != 0) {" + NL + "\t\t\t                    return returnValue;" + NL + "\t\t\t            \t}" + NL + "\t\t\t            ";
  protected final String TEXT_290 = NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int checkNullsAndCompare(Object object1, Object object2) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            if (object1 instanceof Comparable && object2 instanceof Comparable) {" + NL + "\t\t\t                returnValue = ((Comparable) object1).compareTo(object2);" + NL + "\t\t\t            } else if (object1 != null && object2 != null) {" + NL + "\t\t\t                returnValue = compareStrings(object1.toString(), object2" + NL + "\t\t\t                        .toString());" + NL + "\t\t\t            } else if (object1 == null && object2 != null) {" + NL + "\t\t\t                returnValue = 1;" + NL + "\t\t\t            } else if (object1 != null && object2 == null) {" + NL + "\t\t\t                returnValue = -1;" + NL + "\t\t\t            } else {" + NL + "\t\t\t                returnValue = 0;" + NL + "\t\t\t            }" + NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int compareStrings(String string1, String string2) {" + NL + "\t\t\t            return string1.compareTo(string2);" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t\t\tpublic void readData(ObjectInputStream dis) {" + NL + "\t\t\t\t\t\tsynchronized(";
  protected final String TEXT_291 = "Struct.commonByteArrayLock_";
  protected final String TEXT_292 = "_";
  protected final String TEXT_293 = ") {" + NL + "\t\t\t\t\t\t    try {" + NL + "\t\t\t\t\t\t\t\tint length = 0;" + NL + "\t\t\t\t\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t            this.";
  protected final String TEXT_295 = "__";
  protected final String TEXT_296 = " = dis.read";
  protected final String TEXT_297 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_299 = "__";
  protected final String TEXT_300 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_301 = "Struct.commonByteArray_";
  protected final String TEXT_302 = "_";
  protected final String TEXT_303 = ".length) {" + NL + "\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_304 = "Struct.commonByteArray_";
  protected final String TEXT_305 = "_";
  protected final String TEXT_306 = ".length == 0) {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_307 = "Struct.commonByteArray_";
  protected final String TEXT_308 = "_";
  protected final String TEXT_309 = " = new byte[1024];" + NL + "\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_310 = "Struct.commonByteArray_";
  protected final String TEXT_311 = "_";
  protected final String TEXT_312 = " = new byte[2 * length];" + NL + "\t\t\t           \t\t\t\t}" + NL + "\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_313 = "Struct.commonByteArray_";
  protected final String TEXT_314 = "_";
  protected final String TEXT_315 = ", 0, length);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_316 = "__";
  protected final String TEXT_317 = " = new String(";
  protected final String TEXT_318 = "Struct.commonByteArray_";
  protected final String TEXT_319 = "_";
  protected final String TEXT_320 = ", 0, length);" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_326 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_327 = "__";
  protected final String TEXT_328 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_329 = "__";
  protected final String TEXT_330 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_331 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_332 = "__";
  protected final String TEXT_333 = " = (";
  protected final String TEXT_334 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_335 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_336 = "__";
  protected final String TEXT_337 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.";
  protected final String TEXT_338 = "__";
  protected final String TEXT_339 = " = dis.read";
  ...
  protected final String TEXT_344 = " = dis.read";
  ...
  protected final String TEXT_350 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_351 = NL + "\t\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_352 = "__";
  protected final String TEXT_353 = " = null;" + NL + "\t\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_354 = "Struct.commonByteArray_";
  protected final String TEXT_355 = "_";
  protected final String TEXT_356 = ".length) {" + NL + "\t\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_357 = "Struct.commonByteArray_";
  protected final String TEXT_358 = "_";
  protected final String TEXT_359 = ".length == 0) {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_360 = "Struct.commonByteArray_";
  protected final String TEXT_361 = "_";
  protected final String TEXT_362 = " = new byte[1024];" + NL + "\t\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_363 = "Struct.commonByteArray_";
  protected final String TEXT_364 = "_";
  protected final String TEXT_365 = " = new byte[2 * length];" + NL + "\t\t\t\t           \t\t\t\t}" + NL + "\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_366 = "Struct.commonByteArray_";
  protected final String TEXT_367 = "_";
  protected final String TEXT_368 = ", 0, length);" + NL + "\t\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_369 = "__";
  protected final String TEXT_370 = " = new String(";
  protected final String TEXT_371 = "Struct.commonByteArray_";
  protected final String TEXT_372 = "_";
  protected final String TEXT_373 = ", 0, length);" + NL + "\t\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_374 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_375 = "__";
  protected final String TEXT_376 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_377 = "__";
  protected final String TEXT_378 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\t   \t\t\t\tthis.exprKey_";
  protected final String TEXT_380 = "__";
  protected final String TEXT_381 = " = (";
  protected final String TEXT_382 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_383 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_384 = "__";
  protected final String TEXT_385 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.exprKey_";
  protected final String TEXT_386 = "__";
  protected final String TEXT_387 = " = dis.read";
  protected final String TEXT_388 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_389 = NL + "\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t";
  protected final String TEXT_391 = NL + "\t\t\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t\t\t";
  protected final String TEXT_392 = NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t} " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\tpublic void writeData(ObjectOutputStream dos) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t   \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "\t\t\t\t\t";
  protected final String TEXT_393 = NL + "\t\t\t            \tdos.write";
  ...
  protected final String TEXT_399 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_400 = "__";
  protected final String TEXT_401 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_403 = "__";
  protected final String TEXT_404 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_405 = "__";
  protected final String TEXT_406 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_407 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_408 = "__";
  protected final String TEXT_409 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_410 = "__";
  protected final String TEXT_411 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.";
  protected final String TEXT_412 = "__";
  protected final String TEXT_413 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_415 = "__";
  protected final String TEXT_416 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_418 = "__";
  protected final String TEXT_419 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_420 = "(this.";
  protected final String TEXT_421 = "__";
  protected final String TEXT_422 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t            ";
  protected final String TEXT_424 = NL + "\t\t\t\t            dos.write";
  protected final String TEXT_425 = "(this.exprKey_";
  ...
  protected final String TEXT_430 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_431 = "__";
  protected final String TEXT_432 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_434 = "__";
  protected final String TEXT_435 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_436 = "__";
  protected final String TEXT_437 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_439 = "__";
  protected final String TEXT_440 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_441 = "__";
  protected final String TEXT_442 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_443 = "__";
  protected final String TEXT_444 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_445 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.exprKey_";
  protected final String TEXT_446 = "__";
  protected final String TEXT_447 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_448 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_449 = "__";
  protected final String TEXT_450 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_451 = "(this.exprKey_";
  protected final String TEXT_452 = "__";
  protected final String TEXT_453 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_454 = NL + "\t\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_455 = NL + "\t\t\t    }" + NL + "\t\t\t}" + NL + "\t     }" + NL + "\t   ";
