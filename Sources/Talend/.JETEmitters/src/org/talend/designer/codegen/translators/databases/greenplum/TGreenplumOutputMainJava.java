...
public class TGreenplumOutputMainJava {
  ...
  protected final String TEXT_31 = NL + "                        rejectedCount_";
  protected final String TEXT_32 = " =  rejectedCount_";
  protected final String TEXT_33 = " + 1;";
  protected final String TEXT_34 = NL + "                        ";
  protected final String TEXT_35 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_49 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_50 = " = updatedCount_";
  protected final String TEXT_51 = " + pstmt_";
  protected final String TEXT_52 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_53 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_54 = " = true;";
  protected final String TEXT_55 = NL + "\t                ";
  protected final String TEXT_56 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_57 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_69 = NL + "                        rejectedCount_";
  protected final String TEXT_70 = " =  rejectedCount_";
  protected final String TEXT_71 = " + 1;";
  protected final String TEXT_72 = NL + "                        ";
  protected final String TEXT_73 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_74 = NL + "                        ";
  protected final String TEXT_75 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_84 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_85 = " = pstmt_";
  protected final String TEXT_86 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_87 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_88 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_89 = " = rs_";
  protected final String TEXT_90 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_102 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_109 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_127 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_135 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_136 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_137 = NL + "                        throw(e);";
  protected final String TEXT_138 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_139 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_140 = NL + "                            ";
  protected final String TEXT_141 = " = new ";
  protected final String TEXT_142 = "Struct();";
  protected final String TEXT_143 = NL + "                                ";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = " = ";
  protected final String TEXT_146 = ".";
  protected final String TEXT_147 = ";";
  protected final String TEXT_148 = NL + "                            rejectedCount_";
  protected final String TEXT_149 = " =  rejectedCount_";
  protected final String TEXT_150 = " + 1;";
  protected final String TEXT_151 = NL + "                            ";
  protected final String TEXT_152 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_153 = NL + "                            ";
  protected final String TEXT_154 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_155 = ";";
  protected final String TEXT_156 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_157 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_158 = "++;";
  protected final String TEXT_159 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_177 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_178 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_179 = NL + "                    throw(e);";
  protected final String TEXT_180 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_181 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_199 = NL + "            }" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_205 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_206 = " = true;";
  protected final String TEXT_207 = NL + "\t\t                ";
  protected final String TEXT_208 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_209 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_230 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_238 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_239 = " = deletedCount_";
  protected final String TEXT_240 = " + pstmt_";
  protected final String TEXT_241 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_242 = " = true;";
  protected final String TEXT_243 = NL + "\t                ";
  protected final String TEXT_244 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_245 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_246 = NL + "                    throw(e);";
  protected final String TEXT_247 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_248 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_261 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_262 = NL + "                        ";
  protected final String TEXT_263 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_264 = ";";
  protected final String TEXT_265 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_266 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_267 = "++;";
  protected final String TEXT_268 = NL + "                log4jSb_";
  protected final String TEXT_269 = ".append(";
  protected final String TEXT_270 = ".";
  protected final String TEXT_271 = ");";
  protected final String TEXT_272 = NL + "                \tlog4jSb_";
  protected final String TEXT_273 = ".append(\"|\");";
  protected final String TEXT_274 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_275 = " - Writing the record \" + nb_line_";
  protected final String TEXT_276 = " + \" \" + log4jSb_";
  protected final String TEXT_277 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_278 = ".delete(0,log4jSb_";
  protected final String TEXT_279 = ".length());" + NL + "\t\t";
  ...
  protected final String TEXT_291 = NL + "                commitCounter_";
  protected final String TEXT_292 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_293 = "<=commitCounter_";
  protected final String TEXT_294 = ") {" + NL + "                " + NL + "\t\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_296 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_297 = " + \" records.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t        \tconn_";
  protected final String TEXT_299 = ".commit();" + NL + "\t\t\t\t\t";
  protected final String TEXT_300 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_301 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_302 = NL + "                    " + NL + "                    commitCounter_";
  protected final String TEXT_303 = "=0;" + NL + "        " + NL + "                }";
