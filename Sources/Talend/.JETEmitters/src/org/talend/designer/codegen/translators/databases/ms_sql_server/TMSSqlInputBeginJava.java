...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_213 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_214 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_215 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_216 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_217 = ", talendToDBArray_";
  protected final String TEXT_218 = "); ";
  protected final String TEXT_219 = NL + "\t\t\tString dbschema_";
  protected final String TEXT_220 = " = (String)globalMap.get(\"";
  protected final String TEXT_221 = "\");";
  protected final String TEXT_222 = NL + "\t\t    String port_";
  protected final String TEXT_223 = " = ";
  protected final String TEXT_224 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_225 = " = ";
  protected final String TEXT_226 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_227 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_228 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_229 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_230 = " += \":\" + ";
  protected final String TEXT_231 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_232 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_233 = " += \"//\" + ";
  protected final String TEXT_234 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_235 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_236 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_237 = " = ";
  protected final String TEXT_238 = ";";
  protected final String TEXT_239 = NL + "\t\t\t";
  protected final String TEXT_240 = ".";
  protected final String TEXT_241 = " = mssqlGTU_";
  protected final String TEXT_242 = ".getDate(rsmd_";
  protected final String TEXT_243 = ", rs_";
  protected final String TEXT_244 = ", column_index_";
  protected final String TEXT_245 = ");" + NL + "\t\t\t";
  protected final String TEXT_246 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_247 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_248 = ".getClob(";
  protected final String TEXT_249 = ");" + NL + "\t\t\t\tif(clob_";
  protected final String TEXT_250 = "!=null){" + NL + "\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_251 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_252 = ");" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_253 = " = tNTextImpl_";
  protected final String TEXT_254 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_255 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_256 = NL + "           \t\ttmpContent_";
  protected final String TEXT_257 = " = rs_";
  protected final String TEXT_258 = ".getString(column_index_";
  protected final String TEXT_259 = ");";
  protected final String TEXT_260 = NL + "            if(tmpContent_";
  protected final String TEXT_261 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_262 = " .contains(rsmd_";
  protected final String TEXT_263 = ".getColumnTypeName(column_index_";
  protected final String TEXT_264 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_265 = ".";
  protected final String TEXT_266 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_267 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_268 = ".";
  protected final String TEXT_269 = " = tmpContent_";
  protected final String TEXT_270 = ";" + NL + "                }" + NL + "            } else {";
  protected final String TEXT_271 = NL + "                ";
  protected final String TEXT_272 = ".";
  protected final String TEXT_273 = " = null;" + NL + "            }";
  protected final String TEXT_274 = NL + "    " + NL + "\t";
  protected final String TEXT_275 = NL + "\t\t    int nb_line_";
  protected final String TEXT_276 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_277 = " = null;";
  protected final String TEXT_278 = NL + "\t\t        conn_";
  protected final String TEXT_279 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_280 = "\");";
  protected final String TEXT_281 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_282 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_283 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_284 = " = dataSources_";
  protected final String TEXT_285 = ".get(";
  protected final String TEXT_286 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_287 = "\", conn_";
  protected final String TEXT_288 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_289 = NL + "\t\t\t\t";
  protected final String TEXT_290 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_291 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_292 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_293 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_294 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_295 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_301 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_302 = " + \"'.\");";
  protected final String TEXT_303 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_304 = "_QUERY\",dbquery_";
  protected final String TEXT_305 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_306 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  ...
  protected final String TEXT_326 = ".getColumnCount()-";
  protected final String TEXT_327 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_328 = ".contains(rsmd_";
  protected final String TEXT_329 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_330 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_331 = ".setName(rsmd_";
  protected final String TEXT_332 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_333 = ".setDbName(rsmd_";
  protected final String TEXT_334 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_335 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_336 = "\", rsmd_";
  protected final String TEXT_337 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_338 = ".getPrecision(i), rsmd_";
  protected final String TEXT_339 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_340 = ".setDbType(rsmd_";
  protected final String TEXT_341 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_350 = ".setLength(rsmd_";
  protected final String TEXT_351 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_352 = NL + "\t\t\tdcm_";
  protected final String TEXT_353 = ".setLength(rsmd_";
  protected final String TEXT_354 = ".getPrecision(i));";
  protected final String TEXT_355 = NL + "                \tdcm_";
  protected final String TEXT_356 = ".setPrecision(rsmd_";
  protected final String TEXT_357 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_358 = ".setNullable(rsmd_";
  protected final String TEXT_359 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_360 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_361 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_362 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_363 = ".metadatas.add(dcm_";
  protected final String TEXT_364 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_365 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_366 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_367 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_368 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_369 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_370 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_371 = NL + "\t\t    while (rs_";
  protected final String TEXT_372 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_373 = "++;" + NL + "\t\t        ";
  protected final String TEXT_374 = NL + "\t\t                        column_index_";
  protected final String TEXT_375 = " = ";
  protected final String TEXT_376 = " + dcg_";
  protected final String TEXT_377 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_378 = NL + "\t\t                        column_index_";
  protected final String TEXT_379 = " = ";
  protected final String TEXT_380 = ";" + NL + "\t\t                    ";
  protected final String TEXT_381 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_393 = " = (List)rs_";
  protected final String TEXT_394 = ".getObject(column_index_";
  protected final String TEXT_395 = ");";
  protected final String TEXT_396 = NL + "\t\t                         ";
  protected final String TEXT_397 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_398 = ".getObject(column_index_";
  protected final String TEXT_399 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_400 = NL + "                                    ";
  protected final String TEXT_401 = ".";
  protected final String TEXT_402 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_412 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_413 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_435 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_445 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_446 = ".getObject(column_index_";
  protected final String TEXT_447 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_448 = ".";
  protected final String TEXT_449 = " = new Geometry(sb.toString());";
  protected final String TEXT_450 = NL + "\t\t                          ";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_452 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_453 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_454 = ".append(";
  protected final String TEXT_455 = ".";
  protected final String TEXT_456 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_457 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_458 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_459 = NL + "\t\t\t\t\t";
  protected final String TEXT_460 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_461 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_462 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_463 = " - Content of the record \" + nb_line_";
  protected final String TEXT_464 = " + \": \" + log4jSb_";
  protected final String TEXT_465 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_466 = ".delete(0,log4jSb_";
  protected final String TEXT_467 = ".length());" + NL + "\t\t\t\t\t";
  protected final String TEXT_468 = NL + "\t\t                            ";
  protected final String TEXT_469 = ".";
  protected final String TEXT_470 = " = ";
  protected final String TEXT_471 = ".";
  protected final String TEXT_472 = ";" + NL + "\t\t                            ";
  protected final String TEXT_473 = NL + NL + NL + NL + NL;
