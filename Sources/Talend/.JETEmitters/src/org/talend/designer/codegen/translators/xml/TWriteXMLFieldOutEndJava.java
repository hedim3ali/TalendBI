...
public class TWriteXMLFieldOutEndJava {
  ...
  protected final String TEXT_90 = "\t\t\t\t" + NL + "                map_";
  protected final String TEXT_91 = ".put(\"json_";
  protected final String TEXT_92 = "\",strWriter_";
  protected final String TEXT_93 = ".toString());" + NL + "                listGroupby_";
  protected final String TEXT_94 = ".add(map_";
  protected final String TEXT_95 = ");";
  protected final String TEXT_96 = NL + "    listGroupby_";
  protected final String TEXT_97 = ".add(strWriter_";
  protected final String TEXT_98 = ".toString());";
  protected final String TEXT_99 = NL + "\tif (preUnNullMaxIndex_";
  protected final String TEXT_100 = " >= 0) {" + NL + "        // output all buffer" + NL + "        for (int j_";
  protected final String TEXT_101 = " = 0; j_";
  protected final String TEXT_102 = " <= preUnNullMaxIndex_";
  protected final String TEXT_103 = "; j_";
  protected final String TEXT_104 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_105 = "[j_";
  protected final String TEXT_106 = "] != null)" + NL + "                out_";
  protected final String TEXT_107 = ".write(startTabs_";
  protected final String TEXT_108 = "[j_";
  protected final String TEXT_109 = "]);" + NL + "        }" + NL + "" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_110 = " < preNewTabIndex_";
  protected final String TEXT_111 = " ) {" + NL + "\t\t\tfor (int i_";
  protected final String TEXT_112 = " = preNewTabIndex_";
  protected final String TEXT_113 = " - 1; i_";
  protected final String TEXT_114 = " >= 0; i_";
  protected final String TEXT_115 = "--) {" + NL + "\t\t\t    if(endTabs_";
  protected final String TEXT_116 = "[i_";
  protected final String TEXT_117 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_118 = ".write(endTabs_";
  protected final String TEXT_119 = "[i_";
  protected final String TEXT_120 = "]);" + NL + "            \t}" + NL + "                out_";
  protected final String TEXT_121 = ".newLine();" + NL + "                out_";
  protected final String TEXT_122 = ".write(endTabStrs_";
  protected final String TEXT_123 = ".get(i_";
  protected final String TEXT_124 = "));" + NL + "            }" + NL + "        } else {" + NL + "            for (int i_";
  protected final String TEXT_125 = " = preUnNullMaxIndex_";
  protected final String TEXT_126 = "; i_";
  protected final String TEXT_127 = " >= 0; i_";
  protected final String TEXT_128 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_129 = "[i_";
  protected final String TEXT_130 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_131 = ".write(endTabs_";
  protected final String TEXT_132 = "[i_";
  protected final String TEXT_133 = "]);" + NL + "            \t}" + NL + "                out_";
  protected final String TEXT_134 = ".newLine();" + NL + "                out_";
  protected final String TEXT_135 = ".write(endTabStrs_";
  protected final String TEXT_136 = ".get(i_";
  protected final String TEXT_137 = "));" + NL + "            }" + NL + "        }" + NL + "    }";
  protected final String TEXT_138 = NL + "\tif(nb_line_";
  protected final String TEXT_139 = " > 0){" + NL + "    \tfor (int i_";
  protected final String TEXT_140 = " = endTabStrs_";
  protected final String TEXT_141 = ".size() - 1; i_";
  protected final String TEXT_142 = " >= 0; i_";
  protected final String TEXT_143 = "--) {" + NL + "        \tif(endTabs_";
  protected final String TEXT_144 = "[i_";
  protected final String TEXT_145 = "]!=null){" + NL + "        \t\tout_";
  protected final String TEXT_146 = ".write(endTabs_";
  protected final String TEXT_147 = "[i_";
  protected final String TEXT_148 = "]);" + NL + "        \t}" + NL + "            out_";
  protected final String TEXT_149 = ".newLine();" + NL + "            out_";
  protected final String TEXT_150 = ".write(endTabStrs_";
  protected final String TEXT_151 = ".get(i_";
  protected final String TEXT_152 = "));" + NL + "        }" + NL + "    }";
  protected final String TEXT_153 = NL + "\tout_";
  protected final String TEXT_154 = ".newLine();" + NL + "\tout_";
  protected final String TEXT_155 = ".close();" + NL + "\t" + NL + "\tlistGroupby_";
  protected final String TEXT_156 = ".add(strWriter_";
  protected final String TEXT_157 = ".toString());";
  protected final String TEXT_158 = NL;
  protected final String TEXT_159 = NL + "\torg.dom4j.Document doc_xsd_";
  protected final String TEXT_160 = "  = org.dom4j.DocumentHelper.createDocument();" + NL + "\t" + NL + "\torg.dom4j.Element root_xsd_";
  protected final String TEXT_161 = " = doc_xsd_";
  protected final String TEXT_162 = ".addElement(\"xsd:schema\");" + NL + "    root_xsd_";
  protected final String TEXT_163 = ".addNamespace(\"xsd\", \"http://www.w3.org/2001/XMLSchema\");";
  protected final String TEXT_164 = NL + "\tjava.io.FileOutputStream stream_xsd_";
  protected final String TEXT_165 = " = new java.io.FileOutputStream(";
  protected final String TEXT_166 = ");" + NL + "    org.dom4j.io.XMLWriter output_xsd_";
  protected final String TEXT_167 = " = new org.dom4j.io.XMLWriter(stream_xsd_";
  protected final String TEXT_168 = ", format_";
  protected final String TEXT_169 = ");" + NL + "    output_xsd_";
  protected final String TEXT_170 = ".write(doc_xsd_";
  protected final String TEXT_171 = " );" + NL + "    output_xsd_";
  protected final String TEXT_172 = ".close();";
  protected final String TEXT_173 = NL + "\tjava.io.BufferedWriter out_xsd_";
  protected final String TEXT_174 = " = new java.io.BufferedWriter(" + NL + "\t\tnew java.io.OutputStreamWriter(new java.io.FileOutputStream(";
  protected final String TEXT_175 = "), ";
  protected final String TEXT_176 = "));" + NL + "\tout_xsd_";
  protected final String TEXT_177 = ".write(\"<xsd:schema xmlns:xsd=\\\"http://www.w3.org/2001/XMLSchema\\\">\");" + NL + "\tout_xsd_";
  protected final String TEXT_178 = ".newLine();";
  protected final String TEXT_179 = NL + "\tout_xsd_";
  protected final String TEXT_180 = ".write(\"</xsd:schema>\");" + NL + "\tout_xsd_";
  ...
  protected final String TEXT_185 = "_FINISH\" + (listGroupby_";
  protected final String TEXT_186 = "==null?\"\":listGroupby_";
  protected final String TEXT_187 = ".hashCode()), \"true\");" + NL + "\t";
  protected final String TEXT_188 = NL + "\t\ttxf_";
  protected final String TEXT_189 = ".join();" + NL + "\t\tif(txf_";
  protected final String TEXT_190 = ".getLastException()!=null) {" + NL + "\t\t\tcurrentComponent = txf_";
  protected final String TEXT_191 = ".getCurrentComponent();" + NL + "\t\t\tthrow txf_";
  protected final String TEXT_192 = ".getLastException();" + NL + "\t\t}" + NL + "\t";
