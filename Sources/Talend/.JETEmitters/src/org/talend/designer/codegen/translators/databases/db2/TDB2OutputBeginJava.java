...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_31 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_32 = " + \":\" + ";
  protected final String TEXT_33 = " + \"/\" + ";
  protected final String TEXT_34 = ";    ";
  protected final String TEXT_35 = NL + "\t\tString url_";
  protected final String TEXT_36 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_37 = " + \":\" + ";
  protected final String TEXT_38 = " + \"/\" + ";
  protected final String TEXT_39 = " + \":\" + ";
  protected final String TEXT_40 = ";";
  protected final String TEXT_41 = NL + "    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");    " + NL + "    String dbUser_";
  ...
  protected final String TEXT_62 = " " + NL + "" + NL + "String tableName_";
  protected final String TEXT_63 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_64 = " == null || dbschema_";
  protected final String TEXT_65 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_68 = " = dbschema_";
  ...
  protected final String TEXT_75 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_76 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_77 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_83 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_90 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_104 = " - Create table '\" + tableName_";
  protected final String TEXT_105 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_110 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_111 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_112 = " - Creating table '\" + tableName_";
  protected final String TEXT_113 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_115 = ".execute((\"";
  protected final String TEXT_116 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_126 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_131 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_132 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_143 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_144 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_145 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_215 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_216 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_217 = ")))) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_218 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_225 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_226 = " = \"public\";" + NL + "\t            if(dbschema_";
  ...
  protected final String TEXT_230 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_231 = " = stmtSchema_";
  protected final String TEXT_232 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_233 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_234 = " = rsSchema_";
  protected final String TEXT_235 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_236 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_237 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_252 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_261 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_262 = " = dbMetaData_";
  protected final String TEXT_263 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  ...
  protected final String TEXT_277 = " - Creating table '\" + tableName_";
  protected final String TEXT_278 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_279 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_280 = ".execute((\"";
  protected final String TEXT_281 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_300 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_306 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_327 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_338 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_344 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_348 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_353 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_357 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_363 = ".executeUpdate(\"";
  protected final String TEXT_364 = "\");" + NL + "   \t    \t";
  protected final String TEXT_365 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_366 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_375 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_384 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_385 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t";
  protected final String TEXT_387 = NL + "\t\t\tconn_";
  protected final String TEXT_388 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_393 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_406 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_414 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_420 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_426 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_441 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_452 = NL + "\t    String delete_";
  protected final String TEXT_453 = " = \"DELETE  FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_457 = ".prepareStatement(delete_";
  protected final String TEXT_458 = ");" + NL + "\t    ";
  protected final String TEXT_459 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_460 = " = null;" + NL + "       \t";
  protected final String TEXT_461 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_462 = " = insert_";
  protected final String TEXT_463 = ".split(\"\\\\?\");";
  protected final String TEXT_464 = NL + "\t\t\tupdate_";
  protected final String TEXT_465 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_466 = " = update_";
  ...
  protected final String TEXT_471 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_472 = " = insert_";
  protected final String TEXT_473 = ".split(\"\\\\?\");";
  protected final String TEXT_474 = NL + "\t\t\tdelete_";
  protected final String TEXT_475 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_476 = " = delete_";
  protected final String TEXT_477 = ".split(\"\\\\?\");";
  protected final String TEXT_478 = NL + "\t\t\treplace_";
  protected final String TEXT_479 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_480 = " = replace_";
  protected final String TEXT_481 = ".split(\"\\\\?\");";
  protected final String TEXT_482 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_483 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_484 = " = insertIgnore_";
  ...
  protected final String TEXT_490 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_491 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
