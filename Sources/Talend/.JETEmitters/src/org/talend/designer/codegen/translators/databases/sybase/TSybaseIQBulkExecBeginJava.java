...
public class TSybaseIQBulkExecBeginJava {
  ...
  protected final String TEXT_3 = "\");" + NL + "\tString dbschema_";
  protected final String TEXT_4 = "= (String)globalMap.get(\"";
  protected final String TEXT_5 = "\");" + NL + "\tString userName_";
  ...
  protected final String TEXT_15 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_25 = NL + "\t\t String dirverName = \"com.sybase.jdbc3.jdbc.SybDriver\";";
  protected final String TEXT_26 = NL + "\t\t\tString url_";
  protected final String TEXT_27 = " = \"jdbc:odbc:dsn=\"+";
  protected final String TEXT_28 = ";";
  protected final String TEXT_29 = NL + "\t\t\tString url_";
  protected final String TEXT_30 = " = \"jdbc:odbc:FileDSN=\"+";
  protected final String TEXT_31 = ";";
  protected final String TEXT_32 = NL + "\t\t\turl_";
  protected final String TEXT_33 = " +=\";DatabaseName=\"+";
  protected final String TEXT_34 = ";";
  protected final String TEXT_35 = NL + "\t\tString dirverName = \"ianywhere.ml.jdbcodbc.IDriver\";";
  protected final String TEXT_36 = NL + "   " + NL + "    java.lang.Class.forName(dirverName);" + NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_41 = NL + NL + "\tString tableName_";
  protected final String TEXT_42 = " = userName_";
  protected final String TEXT_43 = " + \".\" + ";
  protected final String TEXT_44 = ";" + NL + "\tif(dbschema_";
  protected final String TEXT_45 = " != null && dbschema_";
  ...
  protected final String TEXT_71 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_72 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_73 = " = tableNameForSearch_";
  protected final String TEXT_74 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_75 = " = tableNameForSearch_";
  protected final String TEXT_76 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_111 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_115 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_116 = ".equals(schema_";
  protected final String TEXT_117 = ") || (schema_";
  protected final String TEXT_118 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_119 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_128 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_129 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_130 = " == null || dbschema_";
  protected final String TEXT_131 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_132 = " = conn_";
  protected final String TEXT_133 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_134 = " = stmtSchema_";
  protected final String TEXT_135 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_136 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_137 = " = rsSchema_";
  protected final String TEXT_138 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_139 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_140 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_145 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_146 = ".equals";
  protected final String TEXT_147 = "IgnoreCase";
  protected final String TEXT_148 = "(";
  protected final String TEXT_149 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_155 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_156 = ".equals";
  protected final String TEXT_157 = "IgnoreCase";
  protected final String TEXT_158 = "(schema_";
  ...
  protected final String TEXT_181 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_188 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_189 = ".execute(\"";
  protected final String TEXT_190 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_191 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_219 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_220 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_221 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_222 = NL + "\t";
  protected final String TEXT_223 = NL + NL + "\t\tStringBuilder loadingCols = new StringBuilder();";
  protected final String TEXT_224 = NL + "    \tloadingCols.append(\"(\");";
  protected final String TEXT_225 = NL + "        loadingCols.append(\"";
  protected final String TEXT_226 = "\" + \" \");";
  protected final String TEXT_227 = NL + "\t\tloadingCols.append(\"ASCII(\" + ";
  protected final String TEXT_228 = " + \"),\");";
  protected final String TEXT_229 = NL + "        loadingCols.append(\"'\" + ";
  protected final String TEXT_230 = " + \"'\" + \",\");";
  protected final String TEXT_231 = NL + "\t\tloadingCols.append(\"ASCII(\" + ";
  protected final String TEXT_232 = " + \")\");";
  protected final String TEXT_233 = NL + "        \tloadingCols.append(\"'\" + ";
  protected final String TEXT_234 = " + \"'\");";
  protected final String TEXT_235 = NL + "    loadingCols.append(\")\");";
  protected final String TEXT_236 = " " + NL + "" + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_237 = "=conn_";
  protected final String TEXT_238 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_239 = ".execute(\"SET TEMPORARY OPTION ESCAPE_CHARACTER='ON'\");" + NL + "    " + NL + "    //stmt_";
  protected final String TEXT_240 = ".execute(\"SET TEMPORARY OPTION ALLOW_READ_CLIENT_FILE='ON'\");//sybaseIQ 15 whether is set?" + NL + "        " + NL + "    String strSQL = \"LOAD TABLE \" + tableName_";
  protected final String TEXT_241 = " + loadingCols.toString() ;";
  protected final String TEXT_242 = NL + "\t\tstrSQL +=\" from '\" + ";
  protected final String TEXT_243 = " + \"' \";";
  protected final String TEXT_244 = NL + "\t\tstrSQL +=\" USING CLIENT FILE '\" + ";
  protected final String TEXT_245 = " + \"' \";";
  protected final String TEXT_246 = NL + "    ";
  protected final String TEXT_247 = NL + "     strSQL = strSQL + \" row delimited by '\" + ";
  protected final String TEXT_248 = " + \"'\";    " + NL + "\t strSQL=strSQL + \" quotes off\";";
  protected final String TEXT_249 = NL + "\tstrSQL=strSQL + \" quotes on \";";
  protected final String TEXT_250 = NL + "\tstrSQL=strSQL + \" quotes off \";";
  protected final String TEXT_251 = NL + "    strSQL =strSQL + \" escapes off \";" + NL + "    ";
  protected final String TEXT_252 = NL + "\tstrSQL =strSQL + \" skip 1 \";";
  protected final String TEXT_253 = NL + "    " + NL + "    stmt_";
  protected final String TEXT_254 = ".execute(strSQL);" + NL;
  protected final String TEXT_255 = NL + "    if(conn_";
  protected final String TEXT_256 = " != null && !conn_";
  protected final String TEXT_257 = ".isClosed()) {" + NL + "        conn_";
