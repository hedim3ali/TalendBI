...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_63 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_64 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_65 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_71 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_78 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_92 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_98 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_99 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_100 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_114 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_213 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_214 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_215 = " == null || dbschema_";
  protected final String TEXT_216 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_219 = " = stmtSchema_";
  protected final String TEXT_220 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_221 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_222 = " = rsSchema_";
  protected final String TEXT_223 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_224 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_225 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_243 = "(schema_";
  ...
  protected final String TEXT_265 = " - Creating table '\" + tableName_";
  protected final String TEXT_266 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_268 = ".execute((\"";
  protected final String TEXT_269 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_279 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_288 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_294 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_315 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_319 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_320 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_321 = "            ";
  protected final String TEXT_322 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_326 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_332 = "- Clear table '\" + tableName_";
  protected final String TEXT_333 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_334 = NL + "            stmtClear_";
  ...
  protected final String TEXT_345 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_354 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_372 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_373 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_374 = NL + "\t\t\t";
  protected final String TEXT_375 = NL + "\t\t\tconn_";
  protected final String TEXT_376 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_381 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_382 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_383 = NL + "             while(rsTruncCount_";
  protected final String TEXT_384 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_385 = " += rsTruncCount_";
  protected final String TEXT_386 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_387 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_388 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_397 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_398 = NL + "\t    String update_";
  protected final String TEXT_399 = " = \"UPDATE \" + ";
  protected final String TEXT_400 = " + \" SET ";
  protected final String TEXT_401 = " WHERE ";
  protected final String TEXT_402 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_403 = " = conn_";
  protected final String TEXT_404 = ".prepareStatement(update_";
  protected final String TEXT_405 = ");" + NL + "\t    ";
  protected final String TEXT_406 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_407 = " = conn_";
  protected final String TEXT_408 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_409 = " + \" WHERE ";
  protected final String TEXT_410 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_411 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_418 = " = \"UPDATE \" + ";
  protected final String TEXT_419 = " + \" SET ";
  protected final String TEXT_420 = " WHERE ";
  protected final String TEXT_421 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_426 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_440 = NL + "\t    String delete_";
  protected final String TEXT_441 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_445 = ".prepareStatement(delete_";
  protected final String TEXT_446 = ");" + NL + "\t    ";
  protected final String TEXT_447 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_452 = NL + "\t\t\tupdate_";
  protected final String TEXT_453 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_454 = " = update_";
  protected final String TEXT_455 = ".split(\"\\\\?\");";
  protected final String TEXT_456 = NL + "\t\t\tupdate_";
  protected final String TEXT_457 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_458 = " = update_";
  protected final String TEXT_459 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_460 = " = insert_";
  ...
  protected final String TEXT_464 = " = delete_";
  protected final String TEXT_465 = ".split(\"\\\\?\");";
  protected final String TEXT_466 = NL + "\t\t\treplace_";
  protected final String TEXT_467 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_468 = " = replace_";
  protected final String TEXT_469 = ".split(\"\\\\?\");";
  protected final String TEXT_470 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_471 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_472 = " = insertIgnore_";
  ...
  protected final String TEXT_478 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_479 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
