...
public class TIngresOutputMainJava {
  ...
  protected final String TEXT_37 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_60 = NL + "            try {" + NL + "                updatedCount_";
  ...
  protected final String TEXT_188 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_189 = "=pstmtUpdate_";
  protected final String TEXT_190 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_191 = " = updatedCount_";
  protected final String TEXT_192 = " + updateFlag_";
  ...
  protected final String TEXT_204 = NL + "                        rejectedCount_";
  protected final String TEXT_205 = " = rejectedCount_";
  protected final String TEXT_206 = " + 1;";
  protected final String TEXT_207 = NL + "                        ";
  protected final String TEXT_208 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_209 = NL + "                        ";
  protected final String TEXT_210 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_211 = ";";
  protected final String TEXT_212 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_213 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_214 = " == 0) {" + NL + "            \t";
  protected final String TEXT_215 = NL + "\t\t\t\tquery_";
  protected final String TEXT_216 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_247 = NL + "                }" + NL + "            }" + NL + "           " + NL + "            nb_line_";
  ...
  protected final String TEXT_261 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_262 = " = deletedCount_";
  protected final String TEXT_263 = " + pstmt_";
  protected final String TEXT_264 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_284 = NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_297 = NL + "\t            commitCounter_";
  protected final String TEXT_298 = "++;" + NL + "\t            " + NL + "\t            if(commitEvery_";
  protected final String TEXT_299 = " <= commitCounter_";
  protected final String TEXT_300 = ") {" + NL + "\t            " + NL + "\t                conn_";
  protected final String TEXT_301 = ".commit();" + NL + "\t                " + NL + "\t                commitCounter_";
  protected final String TEXT_302 = "=0;" + NL + "\t            " + NL + "\t            }" + NL + "\t        " + NL + "\t        ";
