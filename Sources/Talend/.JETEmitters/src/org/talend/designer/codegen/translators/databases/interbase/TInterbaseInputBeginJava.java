...
public class TInterbaseInputBeginJava
{
  ...
  protected final String TEXT_214 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_224 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_225 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_226 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_227 = " = dataSources_";
  protected final String TEXT_228 = ".get(";
  protected final String TEXT_229 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_234 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_235 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_236 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_237 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_238 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_239 = NL + NL + "\t\t    ";
  protected final String TEXT_240 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_241 = " = ";
  protected final String TEXT_242 = ";";
  protected final String TEXT_243 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_244 = " - Executing the query: '\" + dbquery_";
  ...
  protected final String TEXT_272 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_284 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_309 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_310 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_311 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_312 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_324 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_336 = " = (List)rs_";
  protected final String TEXT_337 = ".getObject(column_index_";
  protected final String TEXT_338 = ");";
  protected final String TEXT_339 = NL + "\t\t                         ";
  protected final String TEXT_340 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_341 = ".getObject(column_index_";
  protected final String TEXT_342 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_343 = NL + "                                    ";
  protected final String TEXT_344 = ".";
  protected final String TEXT_345 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_355 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_356 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_388 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_389 = ".getObject(column_index_";
  protected final String TEXT_390 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_391 = ".";
  protected final String TEXT_392 = " = new Geometry(sb.toString());";
  protected final String TEXT_393 = NL + "\t\t                          ";
  protected final String TEXT_394 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_395 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_397 = ".append(";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_400 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  ...
  protected final String TEXT_405 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_406 = " - Content of the record \" + nb_line_";
  protected final String TEXT_407 = " + \": \" + log4jSb_";
  protected final String TEXT_408 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_409 = ".delete(0,log4jSb_";
  protected final String TEXT_410 = ".length());" + NL + "\t\t\t\t\t";
