...
public class TLDAPOutputBeginJava
{
  ...
  protected final String TEXT_55 = NL + "\t\tpublic String filterNullElement(String srcData,String splitStr){" + NL + "\t\t\tString result = \"\";" + NL + "\t\t\tString[] tempArr = routines.system.StringUtils.splitNotRegex(srcData,splitStr);";
  protected final String TEXT_56 = NL + "\t\t\tfor (int i = 0 ; i < tempArr.length; i++) {" + NL + "\t\t\t\tif(tempArr[i] !=null && !\"\".equals(tempArr[i].trim())) {" + NL + "\t\t\t\t\tif(!\"\".equals(result)) {" + NL + "\t\t\t\t\t\tresult = result + splitStr;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tresult = result + tempArr[i];" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\treturn result;" + NL + "\t\t}" + NL + "\t}" + NL + "\tCheckBase64_";
  protected final String TEXT_57 = " base64_";
  protected final String TEXT_58 = " = new CheckBase64_";
  protected final String TEXT_59 = "();" + NL + "\t//check is base64 end";
