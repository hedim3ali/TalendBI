...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_513 = NL + "                            geometryColumnName_";
  protected final String TEXT_514 = " = \"";
  protected final String TEXT_515 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_516 = ") {" + NL + "                                dimension_";
  protected final String TEXT_517 = " = 2;" + NL + "                                " + NL + "                                // A null first geometry will lead to unknown coordinate system  " + NL + "                                if (";
  protected final String TEXT_518 = ".";
  protected final String TEXT_519 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_520 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_521 = " = " + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_522 = ".";
  protected final String TEXT_523 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_524 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_525 = " = refSys_";
  protected final String TEXT_526 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_527 = " = refSys_";
  protected final String TEXT_528 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_529 = " == null || ident_";
  protected final String TEXT_530 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_531 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_532 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_533 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_534 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_535 = " = Integer.parseInt(code_";
  protected final String TEXT_536 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            System.out.println(\"SRID_";
  protected final String TEXT_537 = " could not be determined\");" + NL + "                                            SRID_";
  protected final String TEXT_538 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_539 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_540 = " = false;" + NL + "                                 }" + NL + "                            }";
  ...
  protected final String TEXT_559 = NL + "                \tsp_";
  protected final String TEXT_560 = " = conn_";
  protected final String TEXT_561 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_562 = NL + "                insertedCount_";
  protected final String TEXT_563 = " = insertedCount_";
  protected final String TEXT_564 = " + pstmt_";
  protected final String TEXT_565 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_566 = NL + "\t                conn_";
  protected final String TEXT_567 = ".releaseSavepoint(sp_";
  protected final String TEXT_568 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_569 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_570 = NL + "\t                conn_";
  protected final String TEXT_571 = ".rollback(sp_";
  protected final String TEXT_572 = ");" + NL + "\t            ";
  protected final String TEXT_573 = NL + "                whetherReject_";
  protected final String TEXT_574 = " = true;";
  protected final String TEXT_575 = NL + "                    throw(e);";
  protected final String TEXT_576 = NL + "                        ";
  protected final String TEXT_577 = " = new ";
  protected final String TEXT_578 = "Struct();";
  protected final String TEXT_579 = NL + "                            ";
  protected final String TEXT_580 = ".";
  protected final String TEXT_581 = " = ";
  protected final String TEXT_582 = ".";
  protected final String TEXT_583 = ";";
  protected final String TEXT_584 = NL + "                        rejectedCount_";
  protected final String TEXT_585 = " = rejectedCount_";
  protected final String TEXT_586 = " + 1;";
  protected final String TEXT_587 = NL + "                        ";
  protected final String TEXT_588 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_589 = NL + "                        ";
  protected final String TEXT_590 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_591 = ";";
  protected final String TEXT_592 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_620 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_621 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_622 = NL + "    \t\t  batchSizeCounter_";
  ...
  protected final String TEXT_630 = NL + "                updatedCount_";
  protected final String TEXT_631 = " = updatedCount_";
  protected final String TEXT_632 = " + pstmt_";
  protected final String TEXT_633 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_634 = NL + "                \tconn_";
  protected final String TEXT_635 = ".releaseSavepoint(sp_";
  protected final String TEXT_636 = ");";
  protected final String TEXT_637 = "\t" + NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_638 = NL + "\t                conn_";
  protected final String TEXT_639 = ".rollback(sp_";
  ...
  protected final String TEXT_656 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_657 = NL + "                        ";
  protected final String TEXT_658 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_659 = ";";
  protected final String TEXT_660 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_665 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_666 = " = pstmt_";
  protected final String TEXT_667 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_668 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_669 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_670 = " = rs_";
  protected final String TEXT_671 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_672 = " > 0) {";
  protected final String TEXT_673 = NL + "                        ";
  protected final String TEXT_674 = NL + "                            query_";
  protected final String TEXT_675 = " = ";
  protected final String TEXT_676 = ";";
  protected final String TEXT_677 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_678 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_696 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_697 = NL + "\t                    sp_";
  protected final String TEXT_698 = " = conn_";
  protected final String TEXT_699 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_700 = NL + "                    updatedCount_";
  protected final String TEXT_701 = " = updatedCount_";
  protected final String TEXT_702 = " + pstmtUpdate_";
  protected final String TEXT_703 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_704 = NL + "    \t                conn_";
  protected final String TEXT_705 = ".releaseSavepoint(sp_";
  protected final String TEXT_706 = ");" + NL + "    \t            ";
  protected final String TEXT_707 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_708 = NL + "    \t                conn_";
  protected final String TEXT_709 = ".rollback(sp_";
  ...
  protected final String TEXT_731 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_732 = NL + "                        ";
  protected final String TEXT_733 = NL + "                            query_";
  protected final String TEXT_734 = " = ";
  protected final String TEXT_735 = ";";
  protected final String TEXT_736 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_737 = ".";
  protected final String TEXT_738 = ", pstmtInsert_";
  ...
  protected final String TEXT_745 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_746 = NL + "\t                    sp_";
  protected final String TEXT_747 = " = conn_";
  protected final String TEXT_748 = ".setSavepoint();" + NL + "\t                ";
  ...
  protected final String TEXT_752 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_753 = NL + "    \t                conn_";
  protected final String TEXT_754 = ".releaseSavepoint(sp_";
  protected final String TEXT_755 = ");" + NL + "    \t            ";
  protected final String TEXT_756 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_757 = NL + "    \t                conn_";
  protected final String TEXT_758 = ".rollback(sp_";
  ...
  protected final String TEXT_780 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_781 = "++;";
  protected final String TEXT_782 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_805 = NL + "                globalMap.put(\"";
  protected final String TEXT_806 = "_QUERY\", query_";
  protected final String TEXT_807 = ".toString().trim());";
  protected final String TEXT_808 = NL + "        " + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_809 = NL + "\t                sp_";
  protected final String TEXT_810 = " = conn_";
  protected final String TEXT_811 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_812 = NL + "                updateFlag_";
  protected final String TEXT_813 = "=pstmtUpdate_";
  protected final String TEXT_814 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_815 = " = updatedCount_";
  protected final String TEXT_816 = "+updateFlag_";
  protected final String TEXT_817 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_818 = NL + "\t                conn_";
  protected final String TEXT_819 = ".releaseSavepoint(sp_";
  protected final String TEXT_820 = ");" + NL + "\t            ";
  protected final String TEXT_821 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_822 = NL + "\t                conn_";
  protected final String TEXT_823 = ".rollback(sp_";
  protected final String TEXT_824 = ");" + NL + "\t            ";
  protected final String TEXT_825 = " " + NL + "                whetherReject_";
  protected final String TEXT_826 = " = true;";
  protected final String TEXT_827 = NL + "                    throw(e);";
  ...
  protected final String TEXT_845 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_846 = " == 0) {" + NL + "            \t";
  protected final String TEXT_847 = NL + "\t\t\t\tquery_";
  protected final String TEXT_848 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_862 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_863 = NL + "\t                    sp_";
  protected final String TEXT_864 = " = conn_";
  protected final String TEXT_865 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_866 = NL + "                    insertedCount_";
  protected final String TEXT_867 = " = insertedCount_";
  protected final String TEXT_868 = " + pstmtInsert_";
  protected final String TEXT_869 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_870 = NL + "    \t                conn_";
  protected final String TEXT_871 = ".releaseSavepoint(sp_";
  protected final String TEXT_872 = ");" + NL + "    \t            ";
  protected final String TEXT_873 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_874 = NL + "    \t                conn_";
  protected final String TEXT_875 = ".rollback(sp_";
  protected final String TEXT_876 = ");" + NL + "    \t            ";
  protected final String TEXT_877 = NL + "                    whetherReject_";
  ...
  protected final String TEXT_897 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_911 = NL + "    \t\tpstmt_";
  protected final String TEXT_912 = ".addBatch();" + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_913 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_914 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_915 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_916 = NL + "            try {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_923 = ".executeUpdate();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_927 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_928 = NL + "\t                conn_";
  protected final String TEXT_929 = ".rollback(sp_";
  protected final String TEXT_930 = ");" + NL + "\t            ";
  protected final String TEXT_931 = NL + "                whetherReject_";
  protected final String TEXT_932 = " = true;";
  protected final String TEXT_933 = NL + "                    throw(e);";
  ...
  protected final String TEXT_946 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_947 = NL + "                        ";
  protected final String TEXT_948 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_949 = ";";
  protected final String TEXT_950 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_951 = NL + "            }";
  protected final String TEXT_952 = NL + "            nb_line_";
  ...
  protected final String TEXT_966 = " <= batchSizeCounter_";
  protected final String TEXT_967 = ") {                ";
  protected final String TEXT_968 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_969 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_970 = ": pstmt_";
  protected final String TEXT_971 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_972 = " += (countEach_";
  protected final String TEXT_973 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_981 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_982 = " += countSum_";
  protected final String TEXT_983 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_984 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_985 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_986 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_987 = NL + "                \tint countSum_";
  protected final String TEXT_988 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_989 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_996 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_997 = " += countSum_";
  protected final String TEXT_998 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_999 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1000 = " += countSum_";
  protected final String TEXT_1001 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1002 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1003 = NL + "                }";
  protected final String TEXT_1004 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1005 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1006 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1007 = " <= commitCounter_";
  protected final String TEXT_1008 = ") {" + NL + "                ";
  protected final String TEXT_1009 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1010 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1011 = ": pstmt_";
  protected final String TEXT_1012 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1013 = " += (countEach_";
  protected final String TEXT_1014 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1025 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  ...
  protected final String TEXT_1042 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1043 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1044 = NL + "                \tconn_";
  protected final String TEXT_1045 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_1046 = "=0;" + NL + "                }\t";
