...
public class TVerticaSCDBeginJava {
  ...
  protected final String TEXT_49 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_50 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_51 = " == null || dbschema_";
  protected final String TEXT_52 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_53 = " = connection_";
  protected final String TEXT_54 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_55 = " = stmtSchema_";
  protected final String TEXT_56 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_57 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_58 = " = rsSchema_";
  protected final String TEXT_59 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_60 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_61 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  protected final String TEXT_62 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_63 = " = rsTable_";
  protected final String TEXT_64 = ".getString(\"TABLE_NAME\");" + NL + "                String schema_";
  protected final String TEXT_65 = " = rsTable_";
  protected final String TEXT_66 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_67 = ".equalsIgnoreCase(";
  protected final String TEXT_68 = ") && (schema_";
  protected final String TEXT_69 = ".equals(dbschema_";
  protected final String TEXT_70 = ") || ((dbschema_";
  protected final String TEXT_71 = " == null || dbschema_";
  protected final String TEXT_72 = ".trim().length() == 0) && defaultSchema_";
  protected final String TEXT_73 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_74 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_75 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_76 = ".close();" + NL + "            if(!whetherExist_";
  ...
  protected final String TEXT_83 = NL + "        " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_84 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_85 = " = null;    ";
  protected final String TEXT_86 = NL + "        String searching_";
  protected final String TEXT_87 = " = \"";
  protected final String TEXT_88 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_89 = " = connection_";
  protected final String TEXT_90 = ".prepareStatement(searching_";
  protected final String TEXT_91 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_92 = " = null;";
  protected final String TEXT_93 = NL + "        String search_";
  protected final String TEXT_94 = " = \"";
  protected final String TEXT_95 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_96 = " = connection_";
  protected final String TEXT_97 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_98 = " = statement_";
  protected final String TEXT_99 = ".executeQuery(search_";
  protected final String TEXT_100 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_101 = ", SCDStruct_";
  protected final String TEXT_102 = "> cache_";
  protected final String TEXT_103 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_104 = ", SCDStruct_";
  protected final String TEXT_105 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_106 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_107 = " sk_";
  protected final String TEXT_108 = " = new SCDSK_";
  protected final String TEXT_109 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_110 = " row_";
  protected final String TEXT_111 = " = new SCDStruct_";
  protected final String TEXT_112 = "();";
  protected final String TEXT_113 = NL + "                    tmpValue_";
  protected final String TEXT_114 = " = resultSet_";
  protected final String TEXT_115 = ".getString(";
  protected final String TEXT_116 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_117 = " != null && tmpValue_";
  protected final String TEXT_118 = ".length() > 0) {";
  protected final String TEXT_119 = NL + "                        ";
  protected final String TEXT_120 = ".";
  protected final String TEXT_121 = " = tmpValue_";
  protected final String TEXT_122 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_123 = NL + "                            if(tmpValue_";
  protected final String TEXT_124 = " == null) {";
  protected final String TEXT_125 = NL + "                                ";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = " = null;" + NL + "                            } else {";
  protected final String TEXT_128 = NL + "                                ";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_131 = NL + "                            if((\"\").equals(tmpValue_";
  ...
  protected final String TEXT_139 = NL + "                    timestamp_";
  protected final String TEXT_140 = " = resultSet_";
  protected final String TEXT_141 = ".getTimestamp(";
  protected final String TEXT_142 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_143 = " != null) {";
  protected final String TEXT_144 = NL + "                        ";
  protected final String TEXT_145 = ".";
  protected final String TEXT_146 = " = new java.util.Date(timestamp_";
  protected final String TEXT_147 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_148 = NL + "                        ";
  protected final String TEXT_149 = ".";
  protected final String TEXT_150 = " = null;" + NL + "                    }";
  protected final String TEXT_151 = NL + "                    if(resultSet_";
  protected final String TEXT_152 = ".getObject(";
  protected final String TEXT_153 = ") != null) {";
  protected final String TEXT_154 = NL + "                        ";
  protected final String TEXT_155 = ".";
  protected final String TEXT_156 = " = resultSet_";
  protected final String TEXT_157 = ".get";
  protected final String TEXT_158 = "(";
  protected final String TEXT_159 = ");" + NL + "                    }";
  protected final String TEXT_160 = NL + "            cache_";
  protected final String TEXT_161 = ".put(sk_";
  protected final String TEXT_162 = ", row_";
  protected final String TEXT_163 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_164 = ".close();" + NL + "        statement_";
  protected final String TEXT_165 = ".close();";
  protected final String TEXT_166 = NL + "            System.out.println(\"[";
  protected final String TEXT_167 = "] comparison cache loaded\");";
  protected final String TEXT_168 = NL + "        ";
  protected final String TEXT_169 = " nextSurrogateKey_";
  protected final String TEXT_170 = " = 1;";
  protected final String TEXT_171 = NL + "            if(cache_";
  protected final String TEXT_172 = ".size() > 0) {";
  protected final String TEXT_173 = NL + "        String tmpQuery_";
  protected final String TEXT_174 = " = \"SELECT MAX(";
  protected final String TEXT_175 = ") FROM \" + tableName_";
  protected final String TEXT_176 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_177 = " = connection_";
  protected final String TEXT_178 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_179 = " = tmpStmt_";
  protected final String TEXT_180 = ".executeQuery(tmpQuery_";
  protected final String TEXT_181 = ");";
  protected final String TEXT_182 = NL + "        if(tmpRS_";
  protected final String TEXT_183 = ".next() && tmpRS_";
  protected final String TEXT_184 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_185 = " = tmpRS_";
  protected final String TEXT_186 = ".get";
  protected final String TEXT_187 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_188 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_189 = ".close();";
  protected final String TEXT_190 = NL + "            }            ";
  protected final String TEXT_191 = NL + "    String insertionSQL_";
  protected final String TEXT_192 = " = \"";
  protected final String TEXT_193 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_194 = " = connection_";
  protected final String TEXT_195 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_196 = ");";
  protected final String TEXT_197 = NL + "            insertionStatement_";
  protected final String TEXT_198 = ".setTimestamp(";
  protected final String TEXT_199 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_200 = "\")));";
  protected final String TEXT_201 = NL + "            insertionStatement_";
  protected final String TEXT_202 = ".setNull(";
  protected final String TEXT_203 = ", java.sql.Types.DATE);";
  protected final String TEXT_204 = NL + "            insertionStatement_";
  protected final String TEXT_205 = ".setTimestamp(";
  protected final String TEXT_206 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_207 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_208 = NL + "        String updateSQLForType1_";
  protected final String TEXT_209 = " = \"";
  protected final String TEXT_210 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_211 = " = connection_";
  protected final String TEXT_212 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_213 = ");        ";
  protected final String TEXT_214 = NL + "        String updateSQLForType2_";
  protected final String TEXT_215 = " = \"";
  protected final String TEXT_216 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_217 = " = connection_";
  protected final String TEXT_218 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_219 = ");";
  protected final String TEXT_220 = NL + "            updateForType2_";
  protected final String TEXT_221 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_222 = "\")));";
  protected final String TEXT_223 = NL + "        String updateSQLForType3_";
  protected final String TEXT_224 = " = \"";
  protected final String TEXT_225 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_226 = " = connection_";
  protected final String TEXT_227 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_228 = ");";
  protected final String TEXT_229 = NL + "    ";
  protected final String TEXT_230 = NL + "        SCDSK_";
  protected final String TEXT_231 = " lookUpKey_";
  protected final String TEXT_232 = " = null;        ";
  protected final String TEXT_233 = NL + "    SCDStruct_";
  protected final String TEXT_234 = " lookUpValue_";
