...
public class Footer_routeJava
{
  ...
  protected final String TEXT_5 = NL + NL + "\t\t// add statistics which shows on the connection" + NL + "\t\tfinal routines.system.CamelStat runStat = new routines.system.CamelStat(camelContext);" + NL + "\t\t";
  ...
  protected final String TEXT_10 = NL + "\t\t//start camel context\t" + NL + "\t\tcamelContext.start();";
