...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_127 = " = \"t_";
  ...
  protected final String TEXT_192 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_196 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_197 = ".equals(schema_";
  protected final String TEXT_198 = ") || (schema_";
  protected final String TEXT_199 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_200 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_209 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_210 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_211 = " == null || dbschema_";
  protected final String TEXT_212 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_215 = " = stmtSchema_";
  protected final String TEXT_216 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_217 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_218 = " = rsSchema_";
  protected final String TEXT_219 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_220 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_221 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_236 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_251 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_262 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_269 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_270 = ".execute(\"";
  protected final String TEXT_271 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_272 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_273 = " = conn_";
  protected final String TEXT_274 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_278 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_279 = " = conn_";
  protected final String TEXT_280 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_300 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_301 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_302 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_303 = NL + "\t";
  protected final String TEXT_304 = NL + "\tString ctlf_";
  protected final String TEXT_305 = " = ";
  protected final String TEXT_306 = ";" + NL + "\tString logf_";
  protected final String TEXT_307 = " = ";
  protected final String TEXT_308 = "+\".log\";" + NL + "\t";
  protected final String TEXT_309 = NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_310 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_311 = ".append(\"OPTIONS (\");";
  protected final String TEXT_312 = NL + "    \t\toptionClause_";
  protected final String TEXT_313 = ".append(\", \");" + NL + "    \t\t";
  protected final String TEXT_314 = NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_315 = ".append(\"";
  protected final String TEXT_316 = "=(";
  protected final String TEXT_317 = ")\");" + NL + "    \t\t\t\t";
  protected final String TEXT_318 = NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_319 = ".append(\"";
  protected final String TEXT_320 = "=";
  protected final String TEXT_321 = "\");" + NL + "    \t\t\t\t";
  protected final String TEXT_322 = NL + "    \t\t\tif(";
  protected final String TEXT_323 = ".split(\",\").length>1){" + NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_324 = ".append(\"";
  protected final String TEXT_325 = "=(\"+";
  protected final String TEXT_326 = "+\")\");" + NL + "    \t\t\t}else{" + NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_327 = ".append(\"";
  protected final String TEXT_328 = "=\"+";
  protected final String TEXT_329 = ");" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_330 = NL + "    \t\t\toptionClause_";
  protected final String TEXT_331 = ".append(\"";
  protected final String TEXT_332 = "=";
  protected final String TEXT_333 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_334 = NL + "\t\t    \toptionClause_";
  protected final String TEXT_335 = ".append(\"";
  protected final String TEXT_336 = "='\"+";
  protected final String TEXT_337 = "+\"'\");" + NL + "\t\t    \t";
  protected final String TEXT_338 = NL + "    \t\t\toptionClause_";
  protected final String TEXT_339 = ".append(\"";
  protected final String TEXT_340 = "=";
  protected final String TEXT_341 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_342 = NL + "\t\t    \toptionClause_";
  protected final String TEXT_343 = ".append(\"";
  protected final String TEXT_344 = "=\"+";
  protected final String TEXT_345 = ");" + NL + "\t\t    \t";
  protected final String TEXT_346 = NL + "    optionClause_";
  protected final String TEXT_347 = ".append(\")\");";
  protected final String TEXT_348 = NL + "    String dataf_";
  protected final String TEXT_349 = " = ";
  protected final String TEXT_350 = ";" + NL + "    " + NL + "    String ctlf_";
  protected final String TEXT_351 = " = dataf_";
  protected final String TEXT_352 = " + \".ctl\";" + NL + "    " + NL + "    String badf_";
  protected final String TEXT_353 = " = dataf_";
  protected final String TEXT_354 = " + \".bad\";" + NL + "    " + NL + "    String dscf_";
  protected final String TEXT_355 = " = dataf_";
  protected final String TEXT_356 = " + \".dsc\";" + NL + "    " + NL + "    String logf_";
  protected final String TEXT_357 = " = dataf_";
  protected final String TEXT_358 = " + \".log\";" + NL + "    " + NL + "    java.io.File badFile_";
  protected final String TEXT_359 = " = new java.io.File(badf_";
  protected final String TEXT_360 = ");" + NL + "    " + NL + "    if(badFile_";
  protected final String TEXT_361 = ".exists()){" + NL + "    \t" + NL + "        badFile_";
  protected final String TEXT_362 = ".delete();" + NL + "    \t" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_363 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_364 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_365 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_366 = " ,false) ;" + NL + "    " + NL + "    pw_";
  protected final String TEXT_367 = ".println(optionClause_";
  protected final String TEXT_368 = ".toString());" + NL + "  " + NL + "    pw_";
  protected final String TEXT_369 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_370 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_371 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_372 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_373 = " + \"'\");" + NL + "        ";
  protected final String TEXT_374 = NL + "\t\tbw_";
  protected final String TEXT_375 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_376 = NL + "    " + NL + "    " + NL + "    ";
  protected final String TEXT_377 = NL + "        bw_";
  protected final String TEXT_378 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_379 = " + \"'\\\"\");";
  protected final String TEXT_380 = NL + "        bw_";
  protected final String TEXT_381 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_382 = " + \"\\\"\");";
  protected final String TEXT_383 = NL + "        bw_";
  protected final String TEXT_384 = ".write(\" \\\"var \" + ";
  protected final String TEXT_385 = " + \"\\\"\");";
  protected final String TEXT_386 = NL + "    pw_";
  protected final String TEXT_387 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_388 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_389 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_390 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_391 = " + \"'\");";
  protected final String TEXT_392 = NL + "        pw_";
  protected final String TEXT_393 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_394 = NL + "        bw_";
  protected final String TEXT_395 = ".write(";
  protected final String TEXT_396 = ");";
  protected final String TEXT_397 = NL + "\t\t\tpw_";
  protected final String TEXT_398 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_399 = ");" + NL + "\t\t\tpw_";
  protected final String TEXT_400 = ".println(\"INSERT\");";
  protected final String TEXT_401 = NL + "            pw_";
  protected final String TEXT_402 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_403 = ");" + NL + "            pw_";
  protected final String TEXT_404 = ".println(\"";
  protected final String TEXT_405 = "\");";
  protected final String TEXT_406 = NL + "                pw_";
  protected final String TEXT_407 = ".println(\"WHEN \" + ";
  protected final String TEXT_408 = ");";
  protected final String TEXT_409 = NL + "            bw_";
  protected final String TEXT_410 = ".write(\"FIELDS TERMINATED BY ";
  protected final String TEXT_411 = "\");";
  protected final String TEXT_412 = NL + "            bw_";
  protected final String TEXT_413 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_414 = " + \"\\\"\");";
  protected final String TEXT_415 = NL + "                bw_";
  protected final String TEXT_416 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_417 = NL + "                bw_";
  protected final String TEXT_418 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_419 = NL + "            bw_";
  protected final String TEXT_420 = ".write(\"'\" + ";
  protected final String TEXT_421 = " + \"'\");";
  protected final String TEXT_422 = NL + "                bw_";
  protected final String TEXT_423 = ".write(\" AND '\" + ";
  protected final String TEXT_424 = " + \"'\");";
  protected final String TEXT_425 = NL + "            pw_";
  protected final String TEXT_426 = ".println(\"\");";
  protected final String TEXT_427 = NL + "            pw_";
  protected final String TEXT_428 = ".println(\"\");";
  protected final String TEXT_429 = NL + "            pw_";
  protected final String TEXT_430 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_431 = NL + "\t        pw_";
  protected final String TEXT_432 = ".println(\"";
  ...
  protected final String TEXT_437 = NL + NL + "String command_";
  protected final String TEXT_438 = " = \"sqlldr '\" + username_";
  protected final String TEXT_439 = " + \"/\" + password_";
  protected final String TEXT_440 = " + \"@\" + serviceUrl_";
  protected final String TEXT_441 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_442 = " + \"' LOG='\" + logf_";
  protected final String TEXT_443 = " + \"'\";" + NL;
  protected final String TEXT_444 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".createStatement();" + NL + "    stmtCreateTmp_";
  protected final String TEXT_447 = ".execute(\"";
  protected final String TEXT_448 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_449 = ".close();" + NL + "\t";
  protected final String TEXT_450 = NL + "    final Process process_";
  protected final String TEXT_451 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_452 = ");";
  protected final String TEXT_453 = NL + "\t\tjava.util.ArrayList<String> envParam_";
  protected final String TEXT_454 = "=new java.util.ArrayList<String>();" + NL + "\t\tjava.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_455 = " = System.getenv();" + NL + "\t\tfor (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_456 = ".entrySet())" + NL + "\t\t{" + NL + "\t\t   envParam_";
  protected final String TEXT_457 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "\t\t}";
  protected final String TEXT_458 = NL + "\t\tenvParam_";
  protected final String TEXT_459 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_460 = "\");";
  protected final String TEXT_461 = NL + "\t\tenvParam_";
  protected final String TEXT_462 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_463 = "\");";
  protected final String TEXT_464 = NL + "\t\t\tenvParam_";
  protected final String TEXT_465 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_466 = "\");";
  protected final String TEXT_467 = NL + "        envParam_";
  protected final String TEXT_468 = ".add(\"";
  protected final String TEXT_469 = "=";
  protected final String TEXT_470 = "\");";
  protected final String TEXT_471 = NL + "    final Process process_";
  protected final String TEXT_472 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_473 = ",envParam_";
  protected final String TEXT_474 = ".toArray(new String[0]));";
  protected final String TEXT_475 = " " + NL + "" + NL + "//System.out.println(command_";
  protected final String TEXT_476 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_477 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_478 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t        ";
  protected final String TEXT_479 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_480 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_481 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_482 = "_OUTPUT\") + \"\\n\" + line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_483 = NL + "\t\t        }" + NL + "\t\t    } finally {" + NL + "\t\t         reader.close();" + NL + "\t\t    }" + NL + "\t    }catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_484 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_485 = " = new Thread() {" + NL + "    public void run() {" + NL + "\t   try {" + NL + "\t\t   java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_486 = ".getErrorStream()));" + NL + "\t\t   String line = \"\";" + NL + "\t\t   try {" + NL + "\t\t\t   while((line = reader.readLine()) != null) {" + NL + "\t\t\t   \t  globalMap.put(\"";
  protected final String TEXT_487 = "_SQLLOAD_ERROR\", \"true\");\t" + NL + "\t\t\t       ";
  protected final String TEXT_488 = NL + "\t\t\t\t\t   System.err.println(line);" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_489 = NL + "\t\t\t\t\t   globalMap.put(\"";
  protected final String TEXT_490 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_491 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_492 = NL + "\t\t\t   }" + NL + "\t\t    } finally {" + NL + "\t\t\t    reader.close();" + NL + "\t\t    }" + NL + "\t    } catch(java.io.IOException ioe) {" + NL + "\t\t   ioe.printStackTrace();" + NL + "        }" + NL + "\t}" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_493 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_494 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_495 = " = process_";
  protected final String TEXT_496 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_497 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_498 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_499 = "_SQLLOAD_ERROR\"))) {" + NL + "\tthrow new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_500 = "\" , globalMap);" + NL + "} " + NL + "\t" + NL + "java.io.BufferedReader lr_";
  protected final String TEXT_501 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_502 = "));" + NL + "int nb_line_data_";
  protected final String TEXT_503 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_504 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_505 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_506 = " = 0;" + NL + "" + NL + "/*\t1.get log file all lines count\t" + NL + "\t2.get \"Total logical records read\" line number from file end.\t" + NL + "\t3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "String tempLine_";
  protected final String TEXT_507 = " = \"\";" + NL + "int countLines_";
  protected final String TEXT_508 = " =0;//log file lines count" + NL + "//1" + NL + "class LogUtil_";
  protected final String TEXT_509 = "{" + NL + "\tpublic int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "\t\tint number=0;" + NL + "\t\tjava.util.regex.Pattern pattern = java.util.regex.Pattern.compile(\"\\\\d{1,}\");" + NL + "\t\tString tempLine = br.readLine();" + NL + "\t\tif(tempLine!=null){" + NL + "\t\t\tString str_number = tempLine.substring(tempLine.indexOf(\":\") + 1).trim();" + NL + "\t\t\tboolean isNumber= pattern.matcher(str_number).matches();" + NL + "\t\t\tif(isNumber){" + NL + "\t\t\t\tnumber = Integer.parseInt(str_number);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn number;" + NL + "\t}" + NL + "}" + NL + "int lastTableLine_";
  protected final String TEXT_510 = " = 0;//Line Number of the last table name" + NL + "while ((tempLine_";
  protected final String TEXT_511 = " = lr_";
  protected final String TEXT_512 = ".readLine() )!= null) {" + NL + "\tcountLines_";
  protected final String TEXT_513 = "++;" + NL + "\tif(tempLine_";
  protected final String TEXT_514 = ".indexOf(";
  protected final String TEXT_515 = ")>-1){" + NL + "\t\tlastTableLine_";
  protected final String TEXT_516 = " = countLines_";
  protected final String TEXT_517 = ";" + NL + "\t}" + NL + "}" + NL + "lr_";
  protected final String TEXT_518 = ".close();" + NL + "//need new instance to readLine ." + NL + "lr_";
  protected final String TEXT_519 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_520 = "));" + NL + "for (int i_";
  protected final String TEXT_521 = "=0; i_";
  protected final String TEXT_522 = "<= lastTableLine_";
  protected final String TEXT_523 = "; i_";
  protected final String TEXT_524 = "++) {" + NL + "\tlr_";
  protected final String TEXT_525 = ".readLine();" + NL + "}" + NL + "\tboolean isNumber_";
  protected final String TEXT_526 = "=false;" + NL + "\ttempLine_";
  protected final String TEXT_527 = " = lr_";
  protected final String TEXT_528 = ".readLine();" + NL + "\tint emptyLineNum_";
  protected final String TEXT_529 = " =0;//The number of empty block" + NL + "\tboolean isFirstEmptyLine = false;//Is the first empty line of empty block" + NL + "for (int i_";
  protected final String TEXT_530 = "=lastTableLine_";
  protected final String TEXT_531 = "+2; i_";
  protected final String TEXT_532 = "<= countLines_";
  protected final String TEXT_533 = "; i_";
  protected final String TEXT_534 = "++) {" + NL + "\ttempLine_";
  protected final String TEXT_535 = " = lr_";
  protected final String TEXT_536 = ".readLine();" + NL + "\tif(tempLine_";
  protected final String TEXT_537 = ".trim().length()>0){" + NL + "\t\tif(emptyLineNum_";
  protected final String TEXT_538 = "==2){" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t\tisFirstEmptyLine = false;" + NL + "\t\tcontinue;//skip rows now empty" + NL + "\t}else if (!isFirstEmptyLine){//skip empty rows " + NL + "\t\tisFirstEmptyLine = true;" + NL + "\t\temptyLineNum_";
  protected final String TEXT_539 = "++;" + NL + "\t}" + NL + "}" + NL + "\tLogUtil_";
  protected final String TEXT_540 = " lu_";
  protected final String TEXT_541 = " = new LogUtil_";
  protected final String TEXT_542 = "();" + NL + "\tnb_line_data_";
  protected final String TEXT_543 = " = lu_";
  protected final String TEXT_544 = ".getNumber(lr_";
  protected final String TEXT_545 = ");//get the number of data line" + NL + "\tnb_line_bad_";
  protected final String TEXT_546 = " = lu_";
  protected final String TEXT_547 = ".getNumber(lr_";
  protected final String TEXT_548 = ");//get the number of reject data line" + NL + "\tnb_line_discarded_";
  protected final String TEXT_549 = " = lu_";
  protected final String TEXT_550 = ".getNumber(lr_";
  protected final String TEXT_551 = ");//get the number of discarded data line" + NL + "\tnb_line_inserted_";
  protected final String TEXT_552 = " = nb_line_data_";
  protected final String TEXT_553 = " - nb_line_bad_";
  protected final String TEXT_554 = " - nb_line_discarded_";
  protected final String TEXT_555 = ";" + NL + "lr_";
  protected final String TEXT_556 = ".close();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_557 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_558 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_559 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_560 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_561 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_562 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_563 = "_RETURN_CODE\", exitCode_";
