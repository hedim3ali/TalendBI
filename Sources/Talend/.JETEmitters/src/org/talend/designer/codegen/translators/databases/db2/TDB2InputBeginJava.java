...
public class TDB2InputBeginJava
{
  ...
  protected final String TEXT_214 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_215 = " + \":\" + ";
  protected final String TEXT_216 = " + \"/\" + ";
  protected final String TEXT_217 = ";";
  protected final String TEXT_218 = NL + "\t\t\tString url_";
  protected final String TEXT_219 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_226 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_227 = " = null;";
  protected final String TEXT_228 = NL + "\t\t        conn_";
  protected final String TEXT_229 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_230 = "\");";
  protected final String TEXT_231 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_232 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_233 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_234 = " = dataSources_";
  protected final String TEXT_235 = ".get(";
  protected final String TEXT_236 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_237 = "\", conn_";
  protected final String TEXT_238 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_239 = NL + "\t\t\t\t";
  protected final String TEXT_240 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_241 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_242 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_243 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_244 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_245 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_253 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_254 = "_QUERY\",dbquery_";
  protected final String TEXT_255 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_279 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_280 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setName(rsmd_";
  protected final String TEXT_282 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_291 = ".getColumnTypeName(i));";
  protected final String TEXT_292 = NL + "                \tdcm_";
  protected final String TEXT_293 = ".setFormat(";
  protected final String TEXT_294 = ");";
  protected final String TEXT_295 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_296 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_297 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_298 = ".setLength(rsmd_";
  protected final String TEXT_299 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_300 = ".setLength(rsmd_";
  protected final String TEXT_301 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_302 = NL + "\t\t\tdcm_";
  protected final String TEXT_303 = ".setLength(rsmd_";
  protected final String TEXT_304 = ".getPrecision(i));";
  protected final String TEXT_305 = NL + "                \tdcm_";
  protected final String TEXT_306 = ".setPrecision(rsmd_";
  protected final String TEXT_307 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_308 = ".setNullable(rsmd_";
  protected final String TEXT_309 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_310 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_311 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_312 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_313 = ".metadatas.add(dcm_";
  protected final String TEXT_314 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_315 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_316 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_317 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_318 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_319 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_344 = ".getObject(column_index_";
  protected final String TEXT_345 = ");";
  protected final String TEXT_346 = NL + "\t\t                         ";
  protected final String TEXT_347 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_348 = ".getObject(column_index_";
  protected final String TEXT_349 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_350 = NL + "                                    ";
  protected final String TEXT_351 = ".";
  protected final String TEXT_352 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_362 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_363 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_395 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_396 = ".getObject(column_index_";
  protected final String TEXT_397 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = " = new Geometry(sb.toString());";
  protected final String TEXT_400 = NL + "\t\t                          ";
  protected final String TEXT_401 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_402 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_403 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_404 = ".append(";
  protected final String TEXT_405 = ".";
  protected final String TEXT_406 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_407 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_408 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_409 = NL + "\t\t\t\t\t";
  protected final String TEXT_410 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_411 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_412 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_413 = " - Content of the record \" + nb_line_";
  protected final String TEXT_414 = " + \": \" + log4jSb_";
  protected final String TEXT_415 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_416 = ".delete(0,log4jSb_";
  protected final String TEXT_417 = ".length());" + NL + "\t\t\t\t\t";
