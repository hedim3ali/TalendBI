...
public class TNetezzaInputBeginJava
{
  ...
  protected final String TEXT_214 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_215 = " + \":\" + ";
  protected final String TEXT_216 = " + \"/\" + ";
  protected final String TEXT_217 = ";";
  protected final String TEXT_218 = NL + "\t\t\t\tconn_";
  protected final String TEXT_219 = ".setAutoCommit(false); ";
  protected final String TEXT_220 = NL + "                stmt_";
  protected final String TEXT_221 = ".setFetchSize(";
  protected final String TEXT_222 = ");";
  protected final String TEXT_223 = NL + "\t\t\tif(rs_";
  ...
  protected final String TEXT_228 = " = new java.util.Date(rs_";
  protected final String TEXT_229 = ".get";
  protected final String TEXT_230 = "(column_index_";
  protected final String TEXT_231 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_236 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_237 = " = null;";
  protected final String TEXT_238 = NL + "\t\t        conn_";
  protected final String TEXT_239 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_240 = "\");";
  protected final String TEXT_241 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_242 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_243 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_244 = " = dataSources_";
  protected final String TEXT_245 = ".get(";
  protected final String TEXT_246 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_247 = "\", conn_";
  protected final String TEXT_248 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_249 = NL + "\t\t\t\t";
  protected final String TEXT_250 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_251 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_252 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_253 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_254 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_255 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_289 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_290 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_291 = ".setName(rsmd_";
  protected final String TEXT_292 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_301 = ".getColumnTypeName(i));";
  protected final String TEXT_302 = NL + "                \tdcm_";
  protected final String TEXT_303 = ".setFormat(";
  protected final String TEXT_304 = ");";
  protected final String TEXT_305 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_306 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_307 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_308 = ".setLength(rsmd_";
  protected final String TEXT_309 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_310 = ".setLength(rsmd_";
  protected final String TEXT_311 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_312 = NL + "\t\t\tdcm_";
  protected final String TEXT_313 = ".setLength(rsmd_";
  protected final String TEXT_314 = ".getPrecision(i));";
  protected final String TEXT_315 = NL + "                \tdcm_";
  protected final String TEXT_316 = ".setPrecision(rsmd_";
  protected final String TEXT_317 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_318 = ".setNullable(rsmd_";
  protected final String TEXT_319 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_320 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_321 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_322 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_323 = ".metadatas.add(dcm_";
  protected final String TEXT_324 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_325 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_326 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_327 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_328 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_329 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_354 = ".getObject(column_index_";
  protected final String TEXT_355 = ");";
  protected final String TEXT_356 = NL + "\t\t                         ";
  protected final String TEXT_357 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_358 = ".getObject(column_index_";
  protected final String TEXT_359 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_360 = NL + "                                    ";
  protected final String TEXT_361 = ".";
  protected final String TEXT_362 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_372 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_373 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_389 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_390 = ".";
  protected final String TEXT_391 = ", rs_";
  protected final String TEXT_392 = ", fixedColumnCount_";
  protected final String TEXT_393 = ",list_";
  protected final String TEXT_394 = ");";
  protected final String TEXT_395 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_396 = ".";
  protected final String TEXT_397 = ", rs_";
  protected final String TEXT_398 = ", fixedColumnCount_";
  protected final String TEXT_399 = ");";
  protected final String TEXT_400 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_401 = ".";
  protected final String TEXT_402 = ", rs_";
  protected final String TEXT_403 = ", fixedColumnCount_";
  protected final String TEXT_404 = ");";
  protected final String TEXT_405 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_406 = ".getObject(column_index_";
  protected final String TEXT_407 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_408 = ".";
  protected final String TEXT_409 = " = new Geometry(sb.toString());";
  protected final String TEXT_410 = NL + "\t\t                          ";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_412 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_414 = ".append(";
  protected final String TEXT_415 = ".";
  protected final String TEXT_416 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_418 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_422 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
