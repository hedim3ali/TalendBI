...
public class TTeradataInputBeginJava
{
  ...
  protected final String TEXT_213 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_214 = " = ";
  protected final String TEXT_215 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_216 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_217 = " == null || dbProperties_";
  protected final String TEXT_218 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_219 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_220 = " + \"/DATABASE=\" + ";
  protected final String TEXT_221 = ";    " + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_222 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_223 = " + \"/DATABASE=\" + ";
  protected final String TEXT_224 = " + \",\" + ";
  protected final String TEXT_225 = ";" + NL + "\t\t\t}       ";
  protected final String TEXT_226 = NL + "                stmt_";
  protected final String TEXT_227 = ".setFetchSize(200000);";
  ...
  protected final String TEXT_235 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_236 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_237 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_238 = " = dataSources_";
  protected final String TEXT_239 = ".get(";
  protected final String TEXT_240 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_241 = "\", conn_";
  protected final String TEXT_242 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_243 = NL + "\t\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_245 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_246 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_247 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_248 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_249 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_250 = NL + NL + "\t\t    ";
  protected final String TEXT_251 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_252 = " = ";
  protected final String TEXT_253 = ";";
  protected final String TEXT_254 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_255 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_256 = " + \"'.\");";
  protected final String TEXT_257 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_258 = "_QUERY\",dbquery_";
  protected final String TEXT_259 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_260 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  ...
  protected final String TEXT_283 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_295 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_320 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_321 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_322 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_323 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_351 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_352 = ".getObject(column_index_";
  protected final String TEXT_353 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_354 = NL + "                                    ";
  protected final String TEXT_355 = ".";
  protected final String TEXT_356 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_366 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_367 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_374 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_375 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_376 = ".getClob(i_";
  protected final String TEXT_377 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_378 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_379 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_380 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_381 = ".add(tNTextImpl_";
  protected final String TEXT_382 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_383 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_399 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_400 = ".getObject(column_index_";
  protected final String TEXT_401 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_402 = ".";
  protected final String TEXT_403 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_411 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_412 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_415 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_416 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_417 = " - Content of the record \" + nb_line_";
  protected final String TEXT_418 = " + \": \" + log4jSb_";
