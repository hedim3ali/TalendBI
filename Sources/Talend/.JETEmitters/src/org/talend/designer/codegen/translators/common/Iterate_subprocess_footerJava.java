...
public class Iterate_subprocess_footerJava
{
  ...
  protected final String TEXT_6 = NL + "\t\t\t\t\t\t\tthis.exception = te;" + NL + "\t\t\t\t\t\t\ttalendThreadPool.setErrorThread(this);" + NL + "\t\t\t\t            talendThreadPool.stopAllWorkers();" + NL + "\t" + NL + "\t\t\t\t\t\t} finally {" + NL + "\t\t\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_11 = ",threadIdCounter++);" + NL + "\t\t\t\tmtp_";
  protected final String TEXT_12 = ".execute(bt_";
  protected final String TEXT_13 = ");" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_14 = NL + "\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_15 = "\", 2, \"exec\" + NB_ITERATE_";
