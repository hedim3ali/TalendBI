...
public class TOracleInputEndJava
{
  ...
  protected final String TEXT_7 = NL + "\tif(conn_";
  protected final String TEXT_8 = " != null && !conn_";
  protected final String TEXT_9 = ".isClosed()) {" + NL + "\t\tconn_";
  protected final String TEXT_10 = " .close();" + NL + "\t}" + NL + "\t";
  protected final String TEXT_11 = NL + "\t\tlog.info(\"";
  protected final String TEXT_12 = " - Connection to the database closed.\");" + NL + "\t";
  ...
  protected final String TEXT_18 = " - Retrieved records count: \"+nb_line_";
  protected final String TEXT_19 = " + \" .\");" + NL + "\tlog.info(\"";
  protected final String TEXT_20 = " - Done.\");";
