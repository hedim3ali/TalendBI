...
public class TTeradataConnectionBeginJava
{
  ...
  protected final String TEXT_46 = NL + "\t\tglobalMap.put(\"conn_";
  ...
  protected final String TEXT_59 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_60 = "\", userName_";
  protected final String TEXT_61 = ");" + NL + "\tglobalMap.put(\"password_";
