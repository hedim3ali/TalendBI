...
public class TNetezzaBulkExecBeginJava {
  ...
  protected final String TEXT_18 = NL + "        java.sql.Connection con_";
  protected final String TEXT_19 = " = (java.sql.Connection) globalMap.get(\"";
  protected final String TEXT_20 = "\");";
  protected final String TEXT_21 = NL + "\t\tjava.lang.Class.forName(\"org.netezza.Driver\").newInstance();" + NL + "\t\tjava.sql.Connection con_";
  protected final String TEXT_22 = " = java.sql.DriverManager.getConnection(\"jdbc:netezza://\" + ";
  protected final String TEXT_23 = " + \":\" + ";
  protected final String TEXT_24 = " + \"/\" + ";
  protected final String TEXT_25 = ", ";
  protected final String TEXT_26 = ", ";
  protected final String TEXT_27 = ");";
  protected final String TEXT_28 = NL + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_29 = " = con_";
  protected final String TEXT_30 = ".createStatement();" + NL + "    stmtBulk_";
  protected final String TEXT_31 = ".execute(bulkSQL_";
  protected final String TEXT_32 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_33 = ".close();       ";
  protected final String TEXT_34 = NL + "\tcon_";
