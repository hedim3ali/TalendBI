...
public class TMapMainJava {
  ...
  protected final String TEXT_357 = NL + "\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t//if anohter java.lang.Exception when processing an java.lang.Exception" + NL + "    \t\t";
  protected final String TEXT_358 = NL + "    \t\t\tlog.error(\"";
  protected final String TEXT_359 = " - \" + e.getMessage());" + NL + "    \t\t";
  protected final String TEXT_360 = NL + "\t\t\ttry{//EE";
  ...
  protected final String TEXT_368 = ".errorMessage = e.getMessage();";
  protected final String TEXT_369 = NL + "                ";
  protected final String TEXT_370 = ".errorStackTrace = ResumeUtil.getExceptionStackTrace(e);" + NL + "              " + NL + "                ";
  protected final String TEXT_371 = "\t\t\t" + NL + "\t\t\t" + NL + "    ";
  protected final String TEXT_372 = "\t" + NL + "                \t\t";
  protected final String TEXT_373 = "_List.clear();" + NL + "            \t";
  protected final String TEXT_374 = "\t\t\t\t\t" + NL + "                \t\t";
  protected final String TEXT_375 = " = null;";
  protected final String TEXT_376 = NL + "         } catch (java.lang.Exception ee) {//EE" + NL + "        \t\t";
  protected final String TEXT_377 = NL + "        \t\t\tlog.error(\"";
  protected final String TEXT_378 = " - \" + ee.getMessage());" + NL + "        \t\t";
  protected final String TEXT_379 = NL + "\t\t\t\tee.printStackTrace();";
  protected final String TEXT_380 = "\t" + NL + "                \t\t";
  protected final String TEXT_381 = "_List.clear();" + NL + "            \t";
  protected final String TEXT_382 = "\t\t\t\t\t" + NL + "                \t\t";
  protected final String TEXT_383 = " = null;";
  protected final String TEXT_384 = NL + "\t\t}//EE  \t\t\t" + NL + "\t}//end catch";
  protected final String TEXT_385 = NL + NL + NL + NL + NL + NL + NL;
	            ...
	            if (!currentIsReject && !currentIsRejectInnerJoin || rejectValueHasJustChanged
	                ...
	                if (outputTableEntries != null && (!currentIsReject && !currentIsRejectInnerJoin || currentIsReject || currentIsRejectInnerJoin
	                    ...
	                    for (ExternalMapperTableEntry outputTableEntry : outputTableEntries) {
							if(isLog4jEnabled){
								if(currentRow != 0) {
									sb.append(cr + "log4jSb_" + outputTableName + "_" + componentNameForKeyProblem + ".append(\"|\");" + cr);
								}
							}
							currentRow++;
							...
							if(isLog4jEnabled){
								sb.append(cr + "log4jSb_" + outputTableName + "_" + componentNameForKeyProblem + ".append(" + outputExpression + ");" + cr);
							}
	                    ...
	                    if (connectionExists) {
							...
							if(isLog4jEnabled){
									sb.append(cr + "log.debug(\"" + componentNameForKeyProblem + " - Outputting the record \" + count_" + outputTableName + "_" + componentNameForKeyProblem + " + \" of the output table '" + outputTableName + "'.\");" + cr);
									sb.append(cr + "log.trace(\"" + componentNameForKeyProblem + " - Content of the record \" + count_" + outputTableName + "_" + componentNameForKeyProblem + " + \" of the output table '" + outputTableName + "': \" + log4jSb_" + outputTableName + "_" + componentNameForKeyProblem + ");" + cr);
									sb.append(cr + "log4jSb_" + outputTableName + "_" + componentNameForKeyProblem + ".delete(0, log4jSb_" + outputTableName + "_" + componentNameForKeyProblem + ".length());" + cr);
							}
