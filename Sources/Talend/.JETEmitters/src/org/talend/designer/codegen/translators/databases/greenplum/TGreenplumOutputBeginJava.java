...
public class TGreenplumOutputBeginJava {
  ...
  protected final String TEXT_101 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_102 = "\");" + NL + "\t";
  protected final String TEXT_103 = NL + "\tdbschema_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";" + NL + "\t";
  protected final String TEXT_106 = NL + NL + "String tableName_";
  protected final String TEXT_107 = " = null;" + NL + "if(dbschema_";
  ...
  protected final String TEXT_115 = NL + "        int updateKeyCount_";
  protected final String TEXT_116 = " = ";
  protected final String TEXT_117 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_118 = " < 1) {" + NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\tlog.fatal(\"";
  protected final String TEXT_120 = " - For update ,Shcema must have a key\");" + NL + "\t\t\t";
  protected final String TEXT_121 = "\t" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_122 = NL + "        int deleteKeyCount_";
  protected final String TEXT_123 = " = ";
  protected final String TEXT_124 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_125 = " < 1) {" + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tlog.fatal(\"";
  protected final String TEXT_127 = " - For delete ,Schema must have a key\");" + NL + "\t\t\t";
  protected final String TEXT_128 = "\t" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_129 = " " + NL + "int nb_line_";
  protected final String TEXT_130 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_131 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_132 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_133 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_134 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_135 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_136 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_137 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_138 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_139 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_151 = "\t" + NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");    " + NL + "    String url_";
  protected final String TEXT_152 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_153 = "+\":\"+";
  protected final String TEXT_154 = "+\"/\"+";
  protected final String TEXT_155 = ";    " + NL + "    String dbUser_";
  ...
  protected final String TEXT_162 = " - Connection attempt to '\" + url_";
  protected final String TEXT_163 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_164 = " + \"'.\");" + NL + "\t";
  protected final String TEXT_165 = NL + "    conn_";
  protected final String TEXT_166 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_167 = ",dbUser_";
  protected final String TEXT_168 = ",dbPwd_";
  protected final String TEXT_169 = ");" + NL + "\t";
  protected final String TEXT_170 = NL + "\t\tlog.info(\"";
  protected final String TEXT_171 = " - Connection to '\" + url_";
  protected final String TEXT_172 = " + \"' has succeeded. \");" + NL + "\t";
  protected final String TEXT_173 = NL + "    conn_";
  protected final String TEXT_174 = ".setAutoCommit(false);" + NL + "\t";
  ...
  protected final String TEXT_180 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_186 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_192 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_198 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_204 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_210 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_217 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_218 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_219 = " == null || dbschema_";
  protected final String TEXT_220 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_223 = " = stmtSchema_";
  protected final String TEXT_224 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_225 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_226 = " = rsSchema_";
  protected final String TEXT_227 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_228 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_229 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  ...
  protected final String TEXT_237 = ".equals(dbschema_";
  ...
  protected final String TEXT_243 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_255 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_263 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_269 = " - Drop table '\" + tableName_";
  protected final String TEXT_270 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_271 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_275 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_284 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_285 = " = conn_";
  protected final String TEXT_286 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_287 = " = stmtClearCount_";
  protected final String TEXT_288 = ".executeQuery(\"";
  protected final String TEXT_289 = "\");" + NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_293 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_299 = " - Truncate table '\" + tableName_";
  protected final String TEXT_300 = " + \"' has succeeded. \" );" + NL + "\t\t\t";
  protected final String TEXT_301 = NL + "            while(rsClearCount_";
  protected final String TEXT_302 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_303 = " += rsClearCount_";
  protected final String TEXT_304 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_305 = "\t\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_306 = " = conn_";
  protected final String TEXT_307 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_313 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_319 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_323 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_328 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_329 = " + \"\\\" SET ";
  protected final String TEXT_330 = " WHERE ";
  protected final String TEXT_331 = "\");\t" + NL + "\t    ";
  protected final String TEXT_332 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_333 = " = conn_";
  protected final String TEXT_334 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_339 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_345 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_346 = " + \"\\\" WHERE ";
  protected final String TEXT_347 = "\");" + NL + "\t    ";
  protected final String TEXT_348 = "    " + NL + "            int commitEvery_";
  protected final String TEXT_349 = " = ";
  protected final String TEXT_350 = ";            " + NL + "            int commitCounter_";
