...
public class TJDBCOutputMainJava {
  ...
  protected final String TEXT_46 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_64 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_65 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_66 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_67 = "++;";
  protected final String TEXT_68 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_69 = " = updatedCount_";
  ...
  protected final String TEXT_94 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_95 = " = pstmt_";
  protected final String TEXT_96 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_97 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_98 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_99 = " = rs_";
  protected final String TEXT_100 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_116 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_136 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_144 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_145 = " = insertedCount_";
  protected final String TEXT_146 = " + pstmtInsert_";
  protected final String TEXT_147 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_182 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_183 = " = pstmtUpdate_";
  protected final String TEXT_184 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_185 = " = updatedCount_";
  protected final String TEXT_186 = " + updateFlag_";
  ...
  protected final String TEXT_198 = NL + "                        rejectedCount_";
  protected final String TEXT_199 = " = rejectedCount_";
  protected final String TEXT_200 = " + 1;";
  protected final String TEXT_201 = NL + "                        ";
  protected final String TEXT_202 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_207 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_208 = " == 0) {" + NL + "            \t";
  protected final String TEXT_209 = NL + "\t\t\t\tquery_";
  protected final String TEXT_210 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_218 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_219 = " = insertedCount_";
  protected final String TEXT_220 = " + pstmtInsert_";
  protected final String TEXT_221 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_232 = NL + "                            rejectedCount_";
  protected final String TEXT_233 = " = rejectedCount_";
  protected final String TEXT_234 = " + 1;";
  protected final String TEXT_235 = NL + "                            ";
  protected final String TEXT_236 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_250 = NL + "    \t\tpstmt_";
  protected final String TEXT_251 = ".addBatch();" + NL + "\t\t\t";
  ...
  protected final String TEXT_257 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_272 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_273 = NL + "                        ";
  protected final String TEXT_274 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_275 = ";";
  protected final String TEXT_276 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_291 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_292 = " <= batchSizeCounter_";
  protected final String TEXT_293 = ") {                ";
  protected final String TEXT_294 = "                                                " + NL + "\t\t\t\t\tint[] status_";
  protected final String TEXT_295 = " = null;" + NL + "\t\t\t\t\tint countSum_";
  protected final String TEXT_296 = " = 0;" + NL + "\t                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_297 = " = 0;" + NL + "\t\t\t\t\t\tstatus_";
  protected final String TEXT_298 = " = pstmt_";
  protected final String TEXT_299 = ".executeBatch();" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_300 = ": status_";
  protected final String TEXT_301 = ") {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_302 = " += (countEach_";
  protected final String TEXT_303 = " < 0 ? 0 : countEach_";
  protected final String TEXT_304 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t                \t";
  protected final String TEXT_305 = NL + "\t                \t\tthrow(e);" + NL + "\t                \t";
  protected final String TEXT_306 = NL + "\t                \tfor(int countEach_";
  protected final String TEXT_307 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_308 = " += (countEach_";
  protected final String TEXT_309 = " < 0 ? 0 : countEach_";
  protected final String TEXT_310 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t                \tSystem.err.println(e.getMessage());" + NL + "\t                \t";
  protected final String TEXT_311 = NL + "\t                }" + NL + "\t                try {" + NL + "        \t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_312 = " = pstmt_";
  protected final String TEXT_313 = ".getUpdateCount();" + NL + "\t\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t                \t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_314 = " = tmp_batchUpdateCount_";
  protected final String TEXT_315 = " > countSum_";
  protected final String TEXT_316 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_317 = " : countSum_";
  protected final String TEXT_318 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_319 = NL + "\t    \t    \t\tinsertedCount_";
  protected final String TEXT_320 = " += tmp_batchUpdateCount_";
  protected final String TEXT_321 = "; " + NL + "\t    \t    \t";
  protected final String TEXT_322 = NL + "\t    \t    \t\tupdatedCount_";
  protected final String TEXT_323 = " += tmp_batchUpdateCount_";
  protected final String TEXT_324 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_325 = NL + "\t    \t    \t    deletedCount_";
  protected final String TEXT_326 = " += tmp_batchUpdateCount_";
  protected final String TEXT_327 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_328 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_329 = NL + "                commitCounter_";
  protected final String TEXT_330 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_331 = " <= commitCounter_";
  protected final String TEXT_332 = ") {" + NL + "                    connection_";
  protected final String TEXT_333 = ".commit();" + NL + "                    commitCounter_";
