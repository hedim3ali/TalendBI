...
public class TInformixSCDMainJava {
  ...
  protected final String TEXT_178 = NL + "\t}//end catch" + NL + "    ";
  ...
  protected final String TEXT_194 = NL + "        cache_";
  protected final String TEXT_195 = ".put(lookUpKey_";
  protected final String TEXT_196 = ", lookUpValue_";
