...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_22 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_23 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_24 = " - Droping table '\" + tableName_";
  protected final String TEXT_25 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_26 = NL + "            stmtDrop_";
  protected final String TEXT_27 = ".execute(\"";
  protected final String TEXT_28 = "\");" + NL + "        \t";
  protected final String TEXT_29 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_30 = " - Drop table '\" + tableName_";
  protected final String TEXT_31 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_32 = NL + "            stmtDrop_";
  protected final String TEXT_33 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_34 = " = conn_";
  protected final String TEXT_35 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_36 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_37 = " - Creating table '\" + tableName_";
  protected final String TEXT_38 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_39 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_40 = ".execute((\"";
  protected final String TEXT_41 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_51 = " - Create table '\" + tableName_";
  protected final String TEXT_52 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_59 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_73 = " - Create table '\" + tableName_";
  protected final String TEXT_74 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_88 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_89 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_90 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_91 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_92 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_93 = ")== null){";
  protected final String TEXT_94 = "              ";
  protected final String TEXT_95 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_98 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_99 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_100 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_101 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_102 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_112 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_116 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_117 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_118 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_119 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_129 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_130 = " = rsTable_";
  protected final String TEXT_131 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_132 = ".equals";
  protected final String TEXT_133 = "IgnoreCase";
  protected final String TEXT_134 = "(";
  protected final String TEXT_135 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_136 = ".equals";
  protected final String TEXT_137 = "IgnoreCase";
  protected final String TEXT_138 = "(dbschema_";
  protected final String TEXT_139 = ") || dbschema_";
  protected final String TEXT_140 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_162 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_163 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_199 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_200 = ".equals";
  protected final String TEXT_201 = "IgnoreCase";
  protected final String TEXT_202 = "(schema_";
  ...
  protected final String TEXT_222 = ".createStatement();" + NL + "        \t\t\t";
  protected final String TEXT_223 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_224 = " - Creating table '\" + tableName_";
  protected final String TEXT_225 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_227 = ".execute((\"";
  protected final String TEXT_228 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_238 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_245 = ".createStatement();" + NL + "\t    \t    \t";
  protected final String TEXT_246 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_247 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_253 = " - Drop table '\" + tableName_";
  protected final String TEXT_254 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_255 = NL + "                    stmtDrop_";
  protected final String TEXT_256 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_257 = " = conn_";
  protected final String TEXT_258 = ".createStatement();" + NL + "\t    \t    \t";
  protected final String TEXT_259 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_260 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_278 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_279 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_280 = "            ";
  protected final String TEXT_281 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_282 = " = conn_";
  protected final String TEXT_283 = ".createStatement();" + NL + "    \t   ";
  protected final String TEXT_284 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_285 = " - Clearing table '\" + tableName_";
  protected final String TEXT_286 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_287 = NL + "            stmtClear_";
  protected final String TEXT_288 = ".executeUpdate(\"";
  protected final String TEXT_289 = "\");" + NL + "   \t    \t";
  protected final String TEXT_290 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_291 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_304 = " - Trancating table '\" + tableName_";
  protected final String TEXT_305 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\tconn_";
  protected final String TEXT_308 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_309 = NL + "            stmtTrunc_";
  protected final String TEXT_310 = ".executeUpdate(\"";
  protected final String TEXT_311 = "\");" + NL + "   \t    \t";
  protected final String TEXT_312 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_313 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_325 = " = stmtTruncCount_";
  protected final String TEXT_326 = ".executeQuery(\"";
  ...
  protected final String TEXT_331 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_332 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_333 = NL + "\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\tconn_";
  ...
  protected final String TEXT_340 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_353 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_354 = ".";
  protected final String TEXT_355 = ",\"";
  protected final String TEXT_356 = "\")+\") VALUES (";
  protected final String TEXT_357 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_365 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_366 = ".";
  protected final String TEXT_367 = ")+\")\";";
  protected final String TEXT_368 = NL + "\t\t\t\t";
  protected final String TEXT_369 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_370 = " = new StringBuffer(insert_";
  protected final String TEXT_371 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_372 = ".insert(insert_";
  protected final String TEXT_373 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_374 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_375 = " =insertStringBuffer_";
  protected final String TEXT_376 = ".toString(); ";
  protected final String TEXT_377 = "    \t    " + NL + "\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\t\t\t\t\t\tpstmt_";
  ...
  protected final String TEXT_383 = NL + "\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_384 = " = null;         " + NL + "\t\t\t\t\t\t\t\t// [%connection%][psmt][tableName]" + NL + "\t\t\t\t\t\t\t\tString keyPsmt_";
  protected final String TEXT_385 = " = conn_";
  protected final String TEXT_386 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_387 = " + \"]\";" + NL + "\t\t\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_388 = ")== null){" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_389 = " = conn_";
  protected final String TEXT_390 = ".prepareStatement(insert_";
  protected final String TEXT_391 = ");\t\t" + NL + "\t\t\t\t\t\t\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_392 = ", pstmt_";
  protected final String TEXT_393 = ");" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_394 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_427 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_464 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_465 = " = new StringBuffer(insert_";
  protected final String TEXT_466 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_467 = ".insert(insert_";
  protected final String TEXT_468 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_469 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_470 = " =insertStringBuffer_";
  protected final String TEXT_471 = ".toString(); ";
  protected final String TEXT_472 = "    " + NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_473 = " = conn_";
  protected final String TEXT_474 = ".prepareStatement(insert_";
  protected final String TEXT_475 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_476 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_477 = " = new StringBuffer(update_";
  protected final String TEXT_478 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_479 = ".insert(update_";
  protected final String TEXT_480 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_481 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_482 = " =updateStringBuffer_";
  ...
  protected final String TEXT_516 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_517 = ".";
  protected final String TEXT_518 = ", \"";
  protected final String TEXT_519 = "\")+\" WHERE ";
  protected final String TEXT_520 = "\";";
  protected final String TEXT_521 = NL + "\t\t\t\t";
  protected final String TEXT_522 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_523 = " = new StringBuffer(update_";
  protected final String TEXT_524 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_525 = ".insert(update_";
  protected final String TEXT_526 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_527 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_528 = " =updateStringBuffer_";
  protected final String TEXT_529 = ".toString(); ";
  protected final String TEXT_530 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_550 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_551 = " = new StringBuffer(delete_";
  protected final String TEXT_552 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_553 = ".insert(delete_";
  protected final String TEXT_554 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_555 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_556 = " =deleteStringBuffer_";
  protected final String TEXT_557 = ".toString();  ";
  protected final String TEXT_558 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_559 = " = conn_";
  protected final String TEXT_560 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_595 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_603 = NL + "        whetherReject_";
  protected final String TEXT_604 = " = false;";
  protected final String TEXT_605 = NL + "\t\t\t\t\t     \t// TODO unable to parse integer: ";
  protected final String TEXT_606 = NL + "\t\t\t\t\t     \t// TODO error: ";
  protected final String TEXT_607 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_608 = NL + "                    \torg.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_609 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_610 = ".";
  protected final String TEXT_611 = ";" + NL + "\t                    com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_612 = " = tGeometry_";
  protected final String TEXT_613 = "._getInternalGeometry();" + NL + "                    \t" + NL + "                    \tcom.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_614 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_615 = "\");" + NL + "                    \tif (extends_";
  protected final String TEXT_616 = " == null) {" + NL + "                    \t    geometryColumnToExtends.put(\"";
  protected final String TEXT_617 = "\", geometry_";
  protected final String TEXT_618 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "                    \telse {" + NL + "                    \t    extends_";
  protected final String TEXT_619 = ".expandToInclude(geometry_";
  protected final String TEXT_620 = ".getEnvelopeInternal()); " + NL + "                    \t}" + NL + "                    \t" + NL + "\t\t\t\t\t\tString wkt_";
  protected final String TEXT_621 = " = geometry_";
  protected final String TEXT_622 = ".toText();" + NL + "\t\t\t\t\t\toracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_623 = " = new oracle.spatial.util.WKT();" + NL + "\t\t\t\t\t\toracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_624 = " = oracle_wkt_";
  protected final String TEXT_625 = ".toJGeometry(wkt_";
  protected final String TEXT_626 = ".getBytes());" + NL;
  protected final String TEXT_627 = NL + "\t\t\t\t\t\t\tjgeometry_";
  protected final String TEXT_628 = ".setSRID(";
  protected final String TEXT_629 = ");";
  protected final String TEXT_630 = NL + "               \t\tpstmt_";
  protected final String TEXT_631 = ".setObject(";
  protected final String TEXT_632 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_655 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_659 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_674 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_684 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_685 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_706 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_707 = "++;" + NL + "    \t\t";
  protected final String TEXT_708 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_709 = "++;" + NL + "    \t\t";
  protected final String TEXT_710 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_711 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_712 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_713 = " = updatedCount_";
  protected final String TEXT_714 = " + pstmt_";
  protected final String TEXT_715 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_716 = " = true;";
  protected final String TEXT_717 = NL + "                    throw(e);";
  ...
  protected final String TEXT_741 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_742 = " = pstmt_";
  protected final String TEXT_743 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_744 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_745 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_746 = " = rs_";
  protected final String TEXT_747 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_748 = " > 0) {";
  protected final String TEXT_749 = NL + "                        ";
  protected final String TEXT_750 = NL + "                            query_";
  protected final String TEXT_751 = " = ";
  protected final String TEXT_752 = ";";
  protected final String TEXT_753 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_772 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_773 = " = updatedCount_";
  protected final String TEXT_774 = " + pstmtUpdate_";
  protected final String TEXT_775 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_795 = NL + "                }" + NL + "    \t\t} else {";
  protected final String TEXT_796 = NL + "                        ";
  protected final String TEXT_797 = NL + "                            query_";
  protected final String TEXT_798 = " = ";
  protected final String TEXT_799 = ";";
  protected final String TEXT_800 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_809 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_810 = " = insertedCount_";
  protected final String TEXT_811 = " + pstmtInsert_";
  ...
  protected final String TEXT_832 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_833 = "++;" + NL + "    \t\t";
  protected final String TEXT_834 = NL + "    \t    int updateFlag_";
  protected final String TEXT_835 = " = 0;" + NL + "    \t    ";
  protected final String TEXT_836 = NL + "                    ";
  protected final String TEXT_837 = NL + "                        query_";
  protected final String TEXT_838 = " = ";
  protected final String TEXT_839 = ";";
  protected final String TEXT_840 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_841 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_842 = ".";
  protected final String TEXT_843 = ", pstmtUpdate_";
  ...
  protected final String TEXT_865 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_876 = NL + "                        rejectedCount_";
  protected final String TEXT_877 = " = rejectedCount_";
  protected final String TEXT_878 = " + 1;";
  protected final String TEXT_879 = NL + "                        ";
  protected final String TEXT_880 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_881 = NL + "                        ";
  protected final String TEXT_882 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_883 = ";";
  protected final String TEXT_884 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_885 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_886 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_887 = NL + "\t\t\t\tquery_";
  protected final String TEXT_888 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_889 = NL + "                        ";
  protected final String TEXT_890 = NL + "                            query_";
  protected final String TEXT_891 = " = ";
  protected final String TEXT_892 = ";";
  protected final String TEXT_893 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_894 = ".";
  protected final String TEXT_895 = ", pstmtInsert_";
  protected final String TEXT_896 = ", ";
  protected final String TEXT_897 = ", \"";
  protected final String TEXT_898 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_899 = NL + "                    globalMap.put(\"";
  protected final String TEXT_900 = "_QUERY\", query_";
  protected final String TEXT_901 = ".toString().trim());";
  protected final String TEXT_902 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_903 = " = insertedCount_";
  protected final String TEXT_904 = " + pstmtInsert_";
  protected final String TEXT_905 = ".executeUpdate();" + NL + "                   " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_910 = "Struct();";
  ...
  protected final String TEXT_916 = NL + "                            rejectedCount_";
  protected final String TEXT_917 = " = rejectedCount_";
  protected final String TEXT_918 = " + 1;";
  protected final String TEXT_919 = NL + "                            ";
  protected final String TEXT_920 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_936 = NL + "                globalMap.put(\"";
  protected final String TEXT_937 = "_QUERY\", query_";
  protected final String TEXT_938 = ".toString().trim());";
  protected final String TEXT_939 = NL + "    \t\t";
  protected final String TEXT_940 = NL + "    \t\tpstmt_";
  protected final String TEXT_941 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_942 = NL + "    \t\t  batchSizeCounter_";
  ...
  protected final String TEXT_948 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_963 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_964 = NL + "                        ";
  protected final String TEXT_965 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_966 = ";";
  protected final String TEXT_967 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_968 = NL + "            }    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_969 = NL + "            nb_line_";
  protected final String TEXT_970 = "++;" + NL + "    \t";
  protected final String TEXT_971 = NL + "            if(!whetherReject_";
  protected final String TEXT_972 = ") {";
  protected final String TEXT_973 = NL + "                            ";
  protected final String TEXT_974 = " = new ";
  protected final String TEXT_975 = "Struct();";
  ...
  protected final String TEXT_982 = "                                                " + NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_983 = " <= batchSizeCounter_";
  protected final String TEXT_984 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_985 = ".executeBatch();" + NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_986 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_987 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_988 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_989 = " = pstmt_";
  protected final String TEXT_990 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  ...
  protected final String TEXT_997 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_998 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_999 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_1000 = " = 0;             \t                \t                \t" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_1001 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1002 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1003 = " <= commitCounter_";
  protected final String TEXT_1004 = ") {" + NL + "                " + NL + "\t                ";
  protected final String TEXT_1005 = NL + "\t\t                try {" + NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_1006 = ".executeBatch();" + NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_1007 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_1008 = NL + "\t\t                        System.out.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_1009 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1010 = " = pstmt_";
  protected final String TEXT_1011 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  ...
  protected final String TEXT_1018 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1019 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1020 = ":0);" + NL + "\t                ";
  protected final String TEXT_1021 = NL + "                \tconn_";
  protected final String TEXT_1022 = ".commit();                " + NL + "                \tcommitCounter_";
